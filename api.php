...
<link rel="EditURI" type="application/rsd+xml" href="https://www.x3wiki.com/api.php?action=rsd"/>
...
<div class="apihelp-block apihelp-flags"><ul><li><span class="apihelp-source">Source: <span dir="ltr" lang="en">MediaWiki</span></span></li><li><span class="apihelp-license">License: <a href="/index.php/Special:Version/License/MediaWiki" title="Special:Version/License/MediaWiki"><span dir="ltr" lang="en">GPL-2.0+</span></a></span></li></ul></div>
<div class="hlist plainlinks api-main-links">
<ul><li> <a href="/index.php?title=Mw:Special:MyLanguage/API:Main_page&amp;action=edit&amp;redlink=1" class="new" title="Mw:Special:MyLanguage/API:Main page (page does not exist)">Documentation</a></li>
<li> <a href="/index.php?title=Mw:Special:MyLanguage/API:FAQ&amp;action=edit&amp;redlink=1" class="new" title="Mw:Special:MyLanguage/API:FAQ (page does not exist)">FAQ</a></li>
...
<p><strong>Status:</strong> All features shown on this page should be working, but the API is still in active development, and may change at any time. Subscribe to <a class="external text" href="https://lists.wikimedia.org/pipermail/mediawiki-api-announce/">the mediawiki-api-announce mailing list</a> for notice of updates.
</p><p><strong>Erroneous requests:</strong> When erroneous requests are sent to the API, an HTTP header will be sent with the key "MediaWiki-API-Error" and then both the value of the header and the error code sent back will be set to the same value. For more information see <a href="/index.php?title=Mw:Special:MyLanguage/API:Errors_and_warnings&amp;action=edit&amp;redlink=1" class="new" title="Mw:Special:MyLanguage/API:Errors and warnings (page does not exist)">API: Errors and warnings</a>.
</p><p><strong>Testing:</strong> For ease of testing API requests, see <a href="/index.php/Special:ApiSandbox" title="Special:ApiSandbox">Special:ApiSandbox</a>.
</p>
...
<dd><span class="apihelp-deprecated">Deprecated.</span> Get tokens for data-modifying actions.</dd></dl>
...
<dt> bc</dt>
<dd> Format used prior to MediaWiki 1.29. <var>errorlang</var> and <var>errorsuselocal</var> are ignored.</dd></dl>
...
<li> The string <kbd>now</kbd></li></ul></dd></dl>
<dl><dt>alternative multiple-value separator</dt>
<dd>Parameters that take multiple values are normally submitted with the values separated using the pipe character, e.g. <kbd>param=value1|value2</kbd> or <kbd>param=value1%7Cvalue2</kbd>. If a value must contain the pipe character, use U+001F (Unit Separator) as the separator <i>and</i> prefix the value with U+001F, e.g. <kbd>param=%1Fvalue1%1Fvalue2</kbd>.</dd></dl>

<div id="main/credits"></div><h3 class="apihelp-header" id="main.2Fcredits">Credits</h3><p>API developers:
</p>
...
Retrieved from "<a dir="ltr" href="https://www.x3wiki.com/index.php/Special:ApiHelp">https://www.x3wiki.com/index.php/Special:ApiHelp</a>"</div>
			</div>
		</div>
...
<script type="text/javascript" src="//geoiplookup.wikimedia.org/"></script><script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgBackendResponseTime":822});});</script>		</body></html>
