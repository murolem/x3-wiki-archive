...
<head>
<meta charset="UTF-8" /><title>Editing Deca.cefa - X3 Wiki</title>
...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Deca.cefa","wgTitle":"Deca.cefa","wgCurRevisionId":16123,"wgRevisionId":0,"wgArticleId":283,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Deca.cefa","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia"});
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Deca_cefa skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Deca.cefa</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Deca.cefa&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20160915015202" name="wpStarttime" />
<input type='hidden' value="20140319144449" name="wpEdittime" />
...
|Faction=Terran
|Class={{M3class}}
|Priceblock={{Priceblock|Servant of Terra| 1034066}}
|Minspeed=53
|Maxspeed=214.6
|Minaccel=12
|Maxaccel=51
...
{{Infobox close}}
==Overview==
An extremely dangerous [[Terraformer]] [[M3]] fighter, the '''#deca.cefa''' is very cheap, though not so for its weaponry.  It is lightly shielded but quite fast and lethal due to its ability to mount a non-energy-draining [[M6|corvette]]-class weapon, the [[Prototype Matter/Anti-Matter Launcher]].  A full set of these makes the #deca.cefa a very expensive asset to lose, but one of the most dangerous fighters in the game and fully capable of destroying most corvettes. It can only be purchased in [[Aldrin]] and its weapons can be very hard to stockpile without the use of an [[Cloning|exploit]].
...
The #deca.cefa is a blue-gray, blocky ship with two large cannons, and engines mounted on spindly stalks.

== Combat ==
The #deca.cefa's weapons array is capable of dealing serious injuries to corvette-class ships.  However, it is not the most heavily shielded fighter and the corvette poses almost as much risk to the #deca.cefa.  It should be used to perform a surgical strike against a medium-sized target, with plenty of distractions keeping the #deca.cefa clear of the enemy's target locks.

== Equipment ==
The #deca.cefa can mount up to eight of either [[EEMPC]]s or PMAMLs in its fixed mounts.  Its turret can carry a pair of [[EMPC]]s.  Finally, it can use [[Poltergeist Missile|Poltergeist missiles]].

== Availability ==
The #deca.cefa is available at either of the two [[Aldrin Ship Production Base]]s in Aldrin orbit.

== Suggested Roles==
The #deca.cefa is an unexceptional M3 unless used in a certain role: due to its PMAML compatibility it can be used in a small wing to effectively destroy [[:Category:Capital Ships|capital ships]] and corvettes.

== See Also==
*[[Spitfyre|Aldrin Spitfyre]]
{{M3}}
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Deca.cefa" title="Deca.cefa" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Deca.cefa&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
				<li id="ca-history"><a href="/index.php?title=Deca.cefa&amp;action=history" rel="archives" title="Past revisions of this page [h]" accesskey="h">History</a></li>
			</ul>
		</div>
	</div>
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Deca.cefa&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Deca.cefa&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
...
<a href="/index.php/Main_Page" style="background-image: url(http://www.x3wiki.com/x3.jpg);" title="Visit the main page"></a>
	...
	<div class="portlet" id="p-tb" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="t-whatlinkshere"><a href="/index.php/Special:WhatLinksHere/Deca.cefa" title="A list of all wiki pages that link here [j]" accesskey="j">What links here</a></li>
				...
				<li id="t-info"><a href="/index.php?title=Deca.cefa&amp;action=info">Page information</a></li>
			</ul>
		</div>
	</div>
