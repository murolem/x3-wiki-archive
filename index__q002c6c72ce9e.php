...
<head>
<meta charset="UTF-8"/>
<title>Editing Template:SectorTravel - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"Template","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":10,"wgPageName":"Template:SectorTravel","wgTitle":"SectorTravel","wgCurRevisionId":12928,"wgRevisionId":0,"wgArticleId":2238,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Template:SectorTravel","wgRelevantArticleId":2238,"wgRequestId":"WXxUyVkfZokAAETxxT4AAAAH","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia","wgEditMessage":"editing"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<link rel="alternate" type="application/x-wiki" title="Edit" href="/index.php?title=Template:SectorTravel&amp;action=edit"/>
<link rel="edit" title="Edit" href="/index.php?title=Template:SectorTravel&amp;action=edit"/>
...
<body class="mediawiki ltr sitedir-ltr ns-10 ns-subject page-Template_SectorTravel rootpage-Template_SectorTravel skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Template:SectorTravel</h1>
...
<input type='hidden' value="20170729092633" name="wpStarttime" />
<input type='hidden' value="20130629190635" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="12928" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{|
...
&lt;tr>
&lt;th style="background-color:#CCCCFF">[[Sectors|Sector]] travel&lt;/th>
&lt;/tr>
&lt;table cellspacing="3" width="360px"
style="background-color:white;border-width:1px;border-style:none solid solid solid;border-color:#CCCCCC;">
&lt;tr>
&lt;td style="background-color:#DDDDFF;text-align:right" width="6%">Gates&amp;nbsp;&amp;nbsp;&lt;/td>&lt;td>[[Jumpgate]] • [[Trans-Orbital Accelerator]]&lt;/td>
&lt;/tr>
&lt;tr>
&lt;td style="background-color:#DDDDFF;text-align:right" width="6%">Devices&amp;nbsp;&amp;nbsp;&lt;/td>&lt;td style="background-color:#F7F7F7">[[Jump Beacon]] • [[Jumpdrive]] • [[Unfocused Jumpdrive]]&lt;/td>
&lt;/tr>
&lt;tr>
&lt;td style="background-color:#DDDDFF;text-align:right" width="6%">Fuel&amp;nbsp;&amp;nbsp;&lt;/td>&lt;td style="background-color:#F7F7F7">[[Energy Cells]] • [[Spaceflies]]&lt;/td>
&lt;/tr>
&lt;tr>
&lt;td style="background-color:#DDDDFF;text-align:right" width="6%">Other&amp;nbsp;&amp;nbsp;&lt;/td>&lt;td>[[Universe map]] • [[Unknown_Sector_(The_Hub)|The Hub]]&lt;/td>
&lt;/tr>
&lt;/table>
&lt;/table>
|}
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Template:SectorTravel" title="Template:SectorTravel" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://x3wiki.com/index.php/Template:SectorTravel">http://x3wiki.com/index.php/Template:SectorTravel</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				<ul>
				<li id="ca-nstab-template" class="selected"><a href="/index.php/Template:SectorTravel" title="View the template [c]" accesskey="c">Template</a></li>
				<li id="ca-talk" class="new"><a href="/index.php?title=Template_talk:SectorTravel&amp;action=edit&amp;redlink=1" rel="discussion" title="Discussion about the content page [t]" accesskey="t">Discussion</a></li>
				<li id="ca-edit" class="selected"><a href="/index.php?title=Template:SectorTravel&amp;action=edit" title="Edit this page">Edit</a></li>
				<li id="ca-history"><a href="/index.php?title=Template:SectorTravel&amp;action=history" title="Past revisions of this page [h]" accesskey="h">History</a></li>
				</ul>
							</div>
		</div>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Template%3ASectorTravel&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Template%3ASectorTravel&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
		...
		<div class='pBody'>
			...
			<div class="pBody">
				<ul>
											<li id="t-whatlinkshere"><a href="/index.php/Special:WhatLinksHere/Template:SectorTravel" title="A list of all wiki pages that link here [j]" accesskey="j">What links here</a></li>
											<li id="t-recentchangeslinked"><a href="/index.php/Special:RecentChangesLinked/Template:SectorTravel" title="Recent changes in pages linked from this page [k]" accesskey="k">Related changes</a></li>
											<li id="t-specialpages"><a href="/index.php/Special:SpecialPages" title="A list of all special pages [q]" accesskey="q">Special pages</a></li>
											<li id="t-info"><a href="/index.php?title=Template:SectorTravel&amp;action=info" title="More information about this page">Page information</a></li>
									</ul>
							</div>
		</div>
