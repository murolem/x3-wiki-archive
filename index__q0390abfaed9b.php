...
<head>
<meta charset="UTF-8" /><title>Editing Lasertower Factory (section) - X3 Wiki</title>
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Lasertower Factory (section)</span></h1>
...
<input type='hidden' value="20140830090603" name="wpStarttime" />
<input type='hidden' value="20140613204016" name="wpEdittime" />
...
|- style="{{Colour/Argon}}"
| [[Argon]] || [[Meatsteak Cahoonas]] || || {{Priceblock|Trusted Ally|1 220 568}}
|- style="{{Colour/Boron}}"
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Lasertower+Factory&amp;returntoquery=action%3Dedit%26section%3D1&amp;type=signup">Create account</a></li>
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Lasertower+Factory&amp;returntoquery=action%3Dedit%26section%3D1" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
