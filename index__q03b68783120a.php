...
<head>
<meta charset="UTF-8" /><title>Editing Hades - X3 Wiki</title>
...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Hades","wgTitle":"Hades","wgCurRevisionId":16310,"wgRevisionId":0,"wgArticleId":642,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Hades","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia"});
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Hades skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Hades</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Hades&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20140910113019" name="wpStarttime" />
<input type='hidden' value="20140705020315" name="wpEdittime" />
...
|Faction=Paranid
|Class={{M8class}}
|Priceblock={{Priceblock|Priest Protectorate| 5442574}}
|Minspeed=68.8
|Maxspeed=137.5
|Minaccel=9.14
|Maxaccel=18.3
...
{{Infobox close}}
==Overview==
The Hades is the preferred [[Commonwealth]] [[M8|bomber]], being the best compromise of statistics. Many also consider it one of the best-looking ships in the game.
...
== Combat ==
Like all [[M8|bombers]], the Hades fights by loosing missiles off at a capital ship from outside its range. A good missile defence script is needed to thwart a [[Tomahawk Heavy Missile|Tomahawk]] barrage. Give its small size and fairly good maneuverability, [[:Category:Capital Ships|capital ships]] struggle to land hits on this ship. However, the Hades pilot must be wary of faster fighters, particularly of the [[M4]] and [[M4+]] classes.
...
It may also be found among [[Paranid]] patrols and [[Pirates|pirate]] wings spawned by [[Defend_Station| station defense]] missions and is vulnerable to the [[bail]] and [[claim]] mechanic.
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Hades" title="Hades" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a href="http://x3wiki.com/index.php/Hades">http://x3wiki.com/index.php/Hades</a>"</div>
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Hades&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Hades&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Hades&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
	...
	<div class="portlet" id="p-tb" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="t-info"><a href="/index.php?title=Hades&amp;action=info">Page information</a></li>
			</ul>
		</div>
	</div>
