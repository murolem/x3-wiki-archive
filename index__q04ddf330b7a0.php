...
<head>
<meta charset="UTF-8" />
<title>Editing Xenon L - X3 Wiki</title>
...
<div id="column-content"><div id="content">
	...
	<h1 id="firstHeading" class="firstHeading">Editing Xenon L</h1>
	<div id="bodyContent">
...
<form id="editform" name="editform" method="post" action="/index.php?title=Xenon_L&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="" name="wpSection" />
<input type='hidden' value="20111028053834" name="wpStarttime" />
<input type='hidden' value="20110808034117" name="wpEdittime" />
...
== See Also==
*[[Nova|Argon Nova]]
*[[Barracuda|Boron Barracuda]]
*[[Kha'ak Fighter]]
*[[Perseus|Paranid Perseus]]
*[[Blastclaw|Pirate Blastclaw]]
*[[Mamba|Split Mamba]]
...
*[[Thor|ATF Thor]]
*[[Venti|OTAS Venti]]
*[[deca.cefa|Terraformer #deca.cefa]]
{{M3category}}
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='editHelp'><a href="/index.php/Xenon_L" title="Xenon L" id="mw-editform-cancel">Cancel</a> | <a target="helpwindow" href="/index.php/Help:Editing">Editing help</a> (opens in new window)</span>
</div><!-- editButtons -->
</div><!-- editOptions -->
...
Retrieved from "<a href="http://www.x3wiki.com/index.php/Xenon_L">http://www.x3wiki.com/index.php/Xenon_L</a>"</div>
	...
	<div id="p-cactions" class="portlet">
		...
		<div class="pBody">
			<ul>
				 ...
				 <li id="ca-edit" class="selected"><a href="/index.php?title=Xenon_L&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Xenon_L&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
...
<script>if ( window.mediaWiki ) {
	mediaWiki.config.set({"wgCanonicalNamespace": "", "wgCanonicalSpecialPageName": false, "wgNamespaceNumber": 0, "wgPageName": "Xenon_L", "wgTitle": "Xenon L", "wgAction": "edit", "wgArticleId": 286, "wgIsArticle": false, "wgUserName": null, "wgUserGroups": ["*"], "wgCurRevisionId": 6850, "wgCategories": [], "wgBreakFrames": true, "wgRestrictionEdit": [], "wgRestrictionMove": []});
}
</script>
<script>if ( window.mediaWiki ) {
...
</script><!-- Served in 0.261 secs. --></body></html>