...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Energy_Bolt_Chaingun_Ammunition_Forge action-edit skin-monobook">
...
<div id="column-content"><div id="content">
	...
	<h1 id="firstHeading" class="firstHeading">Editing Energy Bolt Chaingun Ammunition Forge</h1>
	<div id="bodyContent">
...
<li class="mw-logline-delete">12:40, 10 May 2011 <a href="/index.php/User:Spychotic" title="User:Spychotic" class="mw-userlink">Spychotic</a> <span class="mw-usertoollinks">(<a href="/index.php/User_talk:Spychotic" title="User talk:Spychotic">Talk</a> | <a href="/index.php/Special:Contributions/Spychotic" title="Special:Contributions/Spychotic">contribs</a>)</span> deleted &quot;<a href="/index.php?title=Energy_Bolt_Chaingun_Ammunition_Forge&amp;action=edit&amp;redlink=1" class="new" title="Energy Bolt Chaingun Ammunition Forge (page does not exist)">Energy Bolt Chaingun Ammunition Forge</a>&quot; ‎ <span class="comment">(content was: &quot;That&#039;s a mold-breaker. Great tihnnkig!&quot; (and the only contributor was &quot;<a href="/index.php/Special:Contributions/118.22.234.149" title="Special:Contributions/118.22.234.149">118.22.234.149</a>&quot;))</span>  </li>
</ul>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Energy_Bolt_Chaingun_Ammunition_Forge&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="" name="wpSection" />
<input type='hidden' value="20120109065642" name="wpStarttime" />
<input type='hidden' value="20120109065642" name="wpEdittime" />
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='editHelp'><a href="/index.php/Energy_Bolt_Chaingun_Ammunition_Forge" title="Energy Bolt Chaingun Ammunition Forge" id="mw-editform-cancel">Cancel</a> | <a target="helpwindow" href="/index.php/Help:Editing">Editing help</a> (opens in new window)</span>
</div><!-- editButtons -->
</div><!-- editOptions -->
...
Retrieved from "<a href="http://www.x3wiki.com/index.php/Energy_Bolt_Chaingun_Ammunition_Forge">http://www.x3wiki.com/index.php/Energy_Bolt_Chaingun_Ammunition_Forge</a>"</div>
...
<div id="column-one">
	<div id="p-cactions" class="portlet">
		...
		<div class="pBody">
			<ul>
				<li id="ca-nstab-main" class="selected new"><a href="/index.php?title=Energy_Bolt_Chaingun_Ammunition_Forge&amp;action=edit&amp;redlink=1" title="View the content page [c]" accesskey="c">Page</a></li>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Energy_Bolt_Chaingun_Ammunition_Forge&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Create</a></li>
			</ul>
		</div>
	</div>
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Energy_Bolt_Chaingun_Ammunition_Forge&amp;returntoquery=action%3Dedit%26redlink%3D1" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
...
</script><script type="text/javascript" src="//geoiplookup.wikimedia.org/"></script><!-- Served in 0.228 secs. --></body></html>