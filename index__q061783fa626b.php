...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Operation_Loose_Ends rootpage-Operation_Loose_Ends skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Operation: Loose Ends</h1>
...
<input type='hidden' value="20170807122158" name="wpStarttime" />
<input type='hidden' value="20130725084720" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="13237" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{stub}}
Operation: Loose Ends was added to [[Albion Prelude]] following its release. It continues on from the [[x3ap quests|Albion Prelude Main Plot]] and can act as a pre-requisite for [[Shady Business]].

In effect, it is the [[Terran]] equivalent to the main plot, and is largely mutually exclusive.
...
* Multi-functional ship equipment


'''Note:''' ''This mission will NOT appear in your missions screen, so be careful and keep track of the messages sent regarding it - they will be your only aid through the majority of the time you play this plotline.''

== Starting Conditions ==
* Started as [[Terran]] (e.g. [[Terran Commander]] or [[Aldrin Adventurer]])
* [[Combat rank]] of ''Professional'' (or higher).
* Terran [[Reputation]] of ''Local Councillor'' (or higher).
...
== Spoilers ==
[[Operation:Loose Ends Spoilers|Click here to be taken to a separate page with the plot rewards listed.]]
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Operation:_Loose_Ends" title="Operation: Loose Ends" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Operation:_Loose_Ends">http://www.x3wiki.com/index.php/Operation:_Loose_Ends</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Operation:_Loose_Ends&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Operation%3A+Loose+Ends&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Operation%3A+Loose+Ends&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
