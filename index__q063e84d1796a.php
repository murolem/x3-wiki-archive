...
<form id="editform" name="editform" method="post" action="/index.php?title=Aegir&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="6" name="wpSection" />
<input type='hidden' value="20110910031931" name="wpStarttime" />
...
The Aegir is unbuyable, and can only be acquired by [[boarding|pirating]] one from an ATF patrol. Aegirs typically serve as escorts for larger ATF ships and likely have several [[Vali]] corvettes as escorts of their own.
...
<div id="column-one">
	...
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Aegir&amp;returntoquery=action%3Dedit%26section%3D6" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
