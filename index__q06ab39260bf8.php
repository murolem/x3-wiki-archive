...
<head>
<meta charset="UTF-8" /><title>Editing Military Base - X3 Wiki</title>
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Military_Base skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Military Base</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Military_Base&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20150425045538" name="wpStarttime" />
<input type='hidden' value="20130911213748" name="wpEdittime" />
...
|Production=none
|Docking=10 x [[TS]]/[[TP]]/[[M6]]/[[M8]] &lt;br> 2 x [[M1]]/[[M2]]/[[M7]]
}}


The Military Base is able to carry 36 [[Marines]] at a time. This makes the Base the prime spot for M7's who wish to fill up on [[Marines]] for [[Boarding]] Operations. The Military Base also carries an assortment of Goods, Weapons and Wares for the player to take advantage of.

The Military Base has almost half of the upgrades in the game and offers upgrades for player ships.

Please note that the [[Military Outpost]] is the Commonwealth's counterpart to the Terran's Military Base.
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Military_Base" title="Military Base" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<li><a href="/index.php/Template:Infobox_Station" title="Template:Infobox Station">Template:Infobox Station</a> (<a href="/index.php?title=Template:Infobox_Station&amp;action=edit" title="Template:Infobox Station">edit</a>) </li></ul></div><div class="hiddencats"></div><div class="limitreport"></div>
</form>
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Military_Base&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Military+Base&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Military+Base&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
