...
<input type='hidden' value="20100605120818" name="wpStarttime" />

<input type='hidden' value="20100602020526" name="wpEdittime" />

<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />

<input name="wpAutoSummary" type="hidden" value="0a1e73c0a0ad2012b1278e601e69edc5" />

<textarea name="wpTextbox1" id="wpTextbox1" cols="80" rows="25" tabindex="1" accesskey=",">==Physical characteristics==

The Osaka has midrange speed for an M2, but has a higher turn rate than Commonwealth M2s giving it more manoeuvrability.

It is a very flat ship, making it easy to hit from above and below but quite hard to hit from the side.
...
<div class="editOptions"><span class="mw-summary" id="wpSummaryLabel"><label for="wpSummary">Summary:</label></span> <input name="wpSummary" size="60" value="/* Physical characteristics */ " id="wpSummary" maxlength="200" tabindex="1" /><br/>
