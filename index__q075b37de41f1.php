...
<head>
<meta charset="UTF-8"/>
<title>Editing Reputation - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Reputation","wgTitle":"Reputation","wgCurRevisionId":16289,"wgRevisionId":0,"wgArticleId":254,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Reputation","wgRelevantArticleId":254,"wgRequestId":"WgnvB1kfZokAAH1wvokAAAAA","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia","wgEditMessage":"editing"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Reputation rootpage-Reputation skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Reputation</h1>
...
<p><strong>Warning:</strong> You are not logged in. Your IP address will be publicly visible if you make any edits. If you <strong><a class="external text" href="http://www.x3wiki.com/index.php?title=Special:UserLogin&amp;returnto=Reputation">log in</a></strong> or <strong><a class="external text" href="http://www.x3wiki.com/index.php?title=Special:CreateAccount&amp;returnto=Reputation">create an account</a></strong>, your edits will be attributed to your username, along with other benefits.
</p>
</div>
<div id="wikiPreview" class="ontop" style="display: none;"><div lang="en" dir="ltr" class="mw-content-ltr"></div></div><form id="editform" name="editform" method="post" action="/index.php?title=Reputation&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntispam">Anti-spam check.
...
<input type='hidden' value="20171113191415" name="wpStarttime" />
<input type='hidden' value="20140621210616" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="16289" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{See also|Ranks}}

Reputation is a reflection of how a [[Races|faction]] views you.  Sufficiently negative reputation means that the faction in question considers you an enemy, will [[combat|attempt to kill you on sight]], and are usually marked with red reticules and sector map markers for your visual convenience.

Combat and Trade Ranks can be found [[Ranks|Here]].

At a race rank of -1 you may [[docking|dock]] with a race's stations in border sectors and at a rank of 0 in core sectors.
...
An "L" displayed in-game after the race's rank indicated the player owns a [[Police License]] for that faction.

== Introduction ==

&lt;br>
===Minimum Notoriety Points for Race Rank===
{{Rank List|333,333 (to 1,000,000)
|100,000
|33,333
|10,000
|3,333
...
|
===[[Argon]]===
{{Rank List|Hero of the Federation
...
===[[Boron]]===
{{Rank List|Knight of the Kingdom
|King's Protectorate
|Kings Knight
|Queen's Protectorate
|Queens Knight
|Queen's Guard
|Noble Peer
|Trusted Courtier
...
===[[Paranid]]===
{{Rank List|Honour Guard of Xaar
...
|
===[[Split]]===
{{Rank List|Honoured Strong Arm of Rhonkar
...
|
===[[Goner]]===
{{Rank List|Protector of the Goners
...
|
===[[Duke's]]===
{{Rank List|Honour Guard of Priest Duke
...
|
===[[Plutarch]]===
{{Rank List|Industrialist Legend
|Trade Guardian
...
|
===[[Strongarms]]===
{{Rank List|Honoured Strong Arms Legend
...
&lt;sup>*&lt;/sup> Note:The Pirates and Yaki both use the same setup of notoriety ranks as other races, however these are not viewable in game and therefore have no name.
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Reputation" title="Reputation" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<li><a href="/index.php/Template:Rank_List" title="Template:Rank List">Template:Rank List</a> (<a href="/index.php?title=Template:Rank_List&amp;action=edit" title="Template:Rank List">edit</a>) </li><li><a href="/index.php/Template:See_also" title="Template:See also">Template:See also</a> (<a href="/index.php?title=Template:See_also&amp;action=edit" title="Template:See also">edit</a>) </li></ul></div><div class="hiddencats"></div><div class="limitreport"></div><input type="hidden" value="1" name="wpUltimateParam"/>
</form>
...
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Reputation">http://www.x3wiki.com/index.php/Reputation</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Reputation&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Reputation&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Reputation&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
