...
<head>
<meta charset="UTF-8" /><title>Editing Bala Gi's Joy - X3 Wiki</title>
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Bala_Gi_s_Joy skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Bala Gi's Joy</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Bala_Gi%27s_Joy&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20160817151543" name="wpStarttime" />
<input type='hidden' value="20140303134525" name="wpEdittime" />
...
{{Gateblock2|South|-10500|	0|	-22099|[[Olmancketslat's Treaty]]}}
{{Gateblock2|West|-24724|	3656|	-12687|[[Farnham's Legend]]}}
&lt;/table>
}}
==Description==
===Encyclopedia Entry===
Deep in unclaimed space, this system is little more than a long-established and well-respected ambush. Rogue [[Teladi]] and [[Argon]] stations provide cover for aggressive [[Pirate]] strike forces. A single, cratered moon holds the wrecks of many of the ships disabled, stripped and left to fall to its surface by freebooters, hullcutters and privateers.
==Default [[Stations]]==
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Bala_Gi%27s_Joy" title="Bala Gi's Joy" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Bala_Gi%27s_Joy&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Bala+Gi%27s+Joy&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Bala+Gi%27s+Joy&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
