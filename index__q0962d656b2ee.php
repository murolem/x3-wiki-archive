...
<form id="editform" name="editform" method="post" action="/index.php?title=Peregrine&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="6" name="wpSection" />
<input type='hidden' value="20110830163003" name="wpStarttime" />
...
The Peregrine is available for purchase from the [[Teladi Shipyard]] in [[Ceo's Sprite]]. It may also be [[bail|captured]] from [[Teladi]] patrols or [[Pirates|pirate]] forces typically spawned by [[Defend_Station|station defense]] missions.
	...
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Peregrine&amp;returntoquery=action%3Dedit%26section%3D6" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
