...
<input type='hidden' value="20180112022149" name="wpStarttime" />
<input type='hidden' value="20140405005835" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="db4a97e464b64811ffe035ac8a68bfdf" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="16186" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">==Overview==
The fastest mainstream TP, the Iguana also packs a 4-hardpoint front weapons battery that can give an opponent a nasty surprise. The Vanguard variant is the fastest of all TPs in Terran Conflict, being roughly 6 m/s faster than the [[Phantom|Argon Phantom]].
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Iguana&amp;returntoquery=action%3Dedit%26section%3D1" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Iguana&amp;returntoquery=action%3Dedit%26section%3D1" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
