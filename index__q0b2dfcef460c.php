...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Boreas rootpage-Boreas skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Boreas</h1>
...
<p><strong>Warning:</strong> You are not logged in. Your IP address will be publicly visible if you make any edits. If you <strong><a class="external text" href="http://x3wiki.com/index.php?title=Special:UserLogin&amp;returnto=Boreas">log in</a></strong> or <strong><a class="external text" href="http://x3wiki.com/index.php?title=Special:CreateAccount&amp;returnto=Boreas">create an account</a></strong>, your edits will be attributed to your username, along with other benefits.
</p>
</div>
<div id="wikiPreview" class="ontop" style="display: none;"><div lang="en" dir="ltr" class="mw-content-ltr"></div></div><form id="editform" name="editform" method="post" action="/index.php?title=Boreas&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntispam">Anti-spam check.
...
{{Infobox close}}
==Overview==
The Boreas is the [[OTAS]] [[M2]] class ship. The classification given to it of 'Light destroyer' is total nonsense; it is widely regarded as being the most powerful purchasable vessel in the game.

==Background==
With some sacrifice of shielding and armament for speed, this OTAS-developed light destroyer can react quickly to developing situations.

==Physical Characteristics==
The Boreas is typical of [[OTAS]] designs, with its spheroidal modules and tubular hull, lit up with distinctive yellow lighting.

Despite its great weapon loadout, it is the smallest of the [[M2|M2s]], and hence the most difficult to hit, adding to its already impressive combat ability.

== Combat ==
The Boreas can fit some sort of anti-capital ship weapon in all of its slots. The 32 equatorial slots can all take [[Photon Pulse Cannon|Photon Pulse Cannons]] and the four dorsal and four ventral slots can take [[Incendiary Bomb Launcher|Incendiary Bomb Launchers]]. This loadout represents the most powerful single broadside in the game, and is devastating to opposing capital ships, but leaves the Boreas open to fighter attack; it is more common to fit the upper and lower slots with flak cannons.

It is one of the faster destroyers, and at 10 GJ its shields are second only to the [[Terran]]/[[ATF]] [[M2|M2s]].
...
== Albion Prelude ==
The Boreas has had its shields scaled down slightly to 4x 2GJ shields it does however maintain its very impressive weapons load out and speed.
...
== Availability ==
The Boreas is available from the [[OTAS Shipyard]] in [[Legend's Home]] upon the acquisition of sufficient [[Argon]] notoriety. For the brave or insane, one each can also be found patroling [[Aladna Hill]] and Legend's Home, for boarding.

== Suggested Roles==
*Sector Defense, but preferably without [[Q|Qs]] when OoS
*Fire Support
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Boreas" title="Boreas" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://x3wiki.com/index.php/Boreas">http://x3wiki.com/index.php/Boreas</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Boreas&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Boreas&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Boreas&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
