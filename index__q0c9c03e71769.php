...
<head>
<meta charset="UTF-8" />
<title>Editing Kha'ak Destroyer (section) - X3 Wiki</title>
...
<div id="column-content"><div id="content">
	...
	<h1 id="firstHeading" class="firstHeading">Editing Kha'ak Destroyer (section)</h1>
	<div id="bodyContent">
...
<form id="editform" name="editform" method="post" action="/index.php?title=Kha%27ak_Destroyer&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="4" name="wpSection" />
<input type='hidden' value="20110910032011" name="wpStarttime" />
<input type='hidden' value="20101110164119" name="wpEdittime" />
...
As with the other Kha'ak battleships, the fact that it uses the sadly outdated [[Gamma Kyon Emitter]]s for its main defence against enemy capitals means it poses little threat to similar classed opponents. Its main advantageous features in combat are its shielding, small size, and near-impeccable missile and fighter defence. It can be killed by smaller ships using the indentation in its rear to pump as much firepower as possible into it.
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='editHelp'><a href="/index.php/Kha%27ak_Destroyer" title="Kha'ak Destroyer" id="mw-editform-cancel">Cancel</a> | <a target="helpwindow" href="/index.php/Help:Editing">Editing help</a> (opens in new window)</span>
</div><!-- editButtons -->
</div><!-- editOptions -->
...
<div class="mw-hiddenCategoriesExplanation"><p>This page is a member of 3 hidden categories:
</p></div><ul>
...
<div id="column-one">
	<div id="p-cactions" class="portlet">
		...
		<div class="pBody">
			<ul>
				 ...
				 <li id="ca-edit" class="selected"><a href="/index.php?title=Kha%27ak_Destroyer&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Kha%27ak_Destroyer&amp;returntoquery=action%3Dedit%26section%3D4" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
...
<script>if ( window.mediaWiki ) {
	mediaWiki.config.set({"wgCanonicalNamespace": "", "wgCanonicalSpecialPageName": false, "wgNamespaceNumber": 0, "wgPageName": "Kha\'ak_Destroyer", "wgTitle": "Kha\'ak Destroyer", "wgAction": "edit", "wgArticleId": 278, "wgIsArticle": false, "wgUserName": null, "wgUserGroups": ["*"], "wgCurRevisionId": 4132, "wgCategories": [], "wgBreakFrames": true, "wgRestrictionEdit": [], "wgRestrictionMove": []});
}
</script>
<script>if ( window.mediaWiki ) {
