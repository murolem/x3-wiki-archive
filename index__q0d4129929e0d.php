...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Trans-Orbital_Accelerator rootpage-Trans-Orbital_Accelerator skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Trans-Orbital Accelerator</h1>
...
<input type='hidden' value="20180102121708" name="wpStarttime" />
<input type='hidden' value="20140605061125" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="16272" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">The Trans-Orbital Accelerator, is the [[Terran]] equivalent of the [[jumpgate]] for use moving around the Solar System, as well as [[Aldrin]]. Rather than generating a warp tunnel between two points, it works by accelerating ships to high sublight speeds in a short distance and decelerating them at the complementary Trans-Orbital Accelerator. Trans-Orbital Accelerators are also used by the [[Argon]] in the Albion sectors.
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Trans-Orbital_Accelerator" title="Trans-Orbital Accelerator" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<li><a href="/index.php/Template:SectorTravel" title="Template:SectorTravel">Template:SectorTravel</a> (<a href="/index.php?title=Template:SectorTravel&amp;action=edit" title="Template:SectorTravel">edit</a>) </li></ul></div><div class="hiddencats"></div><div class="limitreport"></div><input type="hidden" value="1" name="wpUltimateParam"/>
</form>
...
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Trans-Orbital_Accelerator">http://www.x3wiki.com/index.php/Trans-Orbital_Accelerator</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Trans-Orbital_Accelerator&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Trans-Orbital+Accelerator&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Trans-Orbital+Accelerator&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
