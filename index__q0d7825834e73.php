...
<head>
<meta charset="UTF-8" /><title>Editing Flower Farm - X3 Wiki</title>
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Flower_Farm skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Flower Farm</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Flower_Farm&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20160818062700" name="wpStarttime" />
<input type='hidden' value="20150225191518" name="wpEdittime" />
...
{{Infobox factory
|faction=Teladi
|station=Flower Farm L
|hull=2,225,000
|shield=15
|generator=1500
|hangar=5
|cycle=00:01:00
|productnum=[[Sunrise Flowers]] (75)
|stationprice={{Priceblock|Teladi Majority Shareholder|899976}}
|reqresources=[[Energy Cells]] (75)&lt;br>
|optresources=[[Teladianium]]
}}
{{Infobox factory
|faction=Teladi
|station=Flower Farm M
|hull=900,000
|shield=10
|generator=1500
|hangar=5
|cycle=00:01:00
|productnum=[[Sunrise Flowers]] (30)
|stationprice={{Priceblock|Teladi Majority Shareholder|360004}}
|reqresources=[[Energy Cells]] (30)&lt;br>
|optresources=[[Teladianium]]
}}
{{Infobox close}}
==Overview==
Teladi Flower Farms produce [[Sunrise Flowers]], the primary component in Teladi foodstuffs, grown from energy provided by [[Energy Cells]].

NPC Stations accept [[Teladianium]] as a secondary resource.

===Encyclopedia Entry===
Teladi Flower Farms are large geodesic domes that contain a typical example of warm humid atmosphere and conditions of the Teladi Planet. Inside these domes Teladi farmers grow vast fields of white Teladi Sunrise Flowers whose heads are used to make a fine oil called Nostrop, and whose stems and leaves are used as a foodstuff.
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Flower_Farm" title="Flower Farm" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a href="http://x3wiki.com/index.php/Flower_Farm">http://x3wiki.com/index.php/Flower_Farm</a>"</div>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Flower_Farm&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Flower+Farm&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Flower+Farm&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
