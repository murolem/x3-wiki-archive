...
<head>
<meta charset="UTF-8"/>
<title>Editing Headquarters - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Headquarters","wgTitle":"Headquarters","wgCurRevisionId":16319,"wgRevisionId":0,"wgArticleId":2121,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Headquarters","wgRelevantArticleId":2121,"wgRequestId":"WXvGL1kfZokAAHt2baMAAAAY","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia","wgEditMessage":"editing"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Headquarters rootpage-Headquarters skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Headquarters</h1>
...
<input type='hidden' value="20170728231807" name="wpStarttime" />
<input type='hidden' value="20140715065044" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="16319" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{ Infobox Station
|Race=Any
|Type=Dock
|Capacity=500,000 units
|Hull=15,000,000
|Shield=15 x [[Shields#2_GJ|2 Gj]]
|Production=Adjustable Wares
|Docking=&lt;table class="wikitable sortable" style="width:400px;font-weight:normal;">&lt;tr>&lt;td>'''Port'''&lt;/td>&lt;td>'''Ship Class'''&lt;/td>&lt;td>'''Number of Docking Ports'''&lt;/td>&lt;/tr>&lt;tr>&lt;td>Hangar&lt;/td>&lt;td>Fighters&lt;/td>&lt;td>Unlimited&lt;/td>&lt;/tr>&lt;tr>&lt;td>Hook Dock&lt;/td>&lt;td>Corvettes&lt;/td>&lt;td>15 (3*5 hooks)&lt;/td>&lt;/tr>&lt;tr>&lt;td>Mega Dock&lt;/td>&lt;td>Capital Ships&lt;/td>&lt;td>10&lt;/td>&lt;/tr>&lt;/table>
}}

===Introduction===
The Headquarters is obtained by going through the [[HQ plot]].

This massive station enables the player to store a massive number of wares, ships and weapons. In fact, the station's storage hold is so large that it can store TL stations.

The headquarters also has the ability to Repair, Decompose and Construct ships. All of these actions, however, require time and materials.

===Production, Recycling and Reverse Engineering===


The Headquarters can act as a [[Shipyard]]. However, the cost is not in a direct currency. Instead, you must use direct materials. The ratio of these materials is:

{| class="wikitable" border=1 style="float:right;"
|+ Approx. Production Ratio (Fig 1.1)
|-
! Component 
! Value
|-
...
Definitions:
* Recycle - Convert a ship into raw materials.
* Production - Build a ship using raw materials.
* Reverse Engineering - Sacrifice a ship to gain the ability to create another of that type. (Blueprints)
...
Production will enable players with vast factory empires to build ships without having to trade their [[Wares]] for money. Some specific wares, such as [[Microchips]] and [[Quantum Tubes]] will be very difficult to get up the required numbers to build the ship making it very unbalanced.
...
The Headquarters will normally spawn with the ability to make a [[Buster]]. The payer must sacrifice ships in Reverse Engineering to add more blueprints so that more ship types can become Producable.

===Production Costs / Gains===
Credits: '''Carlo''' (X3 Forums)
*CR - Cloth Rimes
*RO - Rastar Oil
*SW - Silicon Wafers
*QT - Quantum Tubes
...
Click '''Expand''' to see data. This data includes every single ship in the game.
{| class="wikitable sortable mw-collapsible mw-collapsed" border="1"
! Race
! Ship
! Class
! data-sort-type="number" | Credits
! data-sort-type="time" | Build Time
! data-sort-type="number" | Energy
! data-sort-type="number" | Teladianium
! data-sort-type="number" | CR
! data-sort-type="number" | RO
! data-sort-type="number" | Ore
! data-sort-type="number" | SW
! data-sort-type="number" | Crystals
! data-sort-type="number" | QT
! data-sort-type="number" | Microchips
! data-sort-type="number" | CC
! data-sort-type="number" | NV
|-
| Argon
| Colossus
| M1
...
The Headquarters is probably one of the best stations to store all of your fleet in. With the ability to store unlimited fighters, 15 Corvettes/Freighters and 10 Capital ships, the Headquarters is probably one of the most fierce hard-points in the game. However, it is also one of the most difficult to obtain.

===Freight Storage===

The Headquarters also boasts the largest Freight capacity in the game. With the ability to hold '''500,000''' units of freight, it can help any player store their armaments or trade items with ease. The headquarters also has a built-in Ware management system that allows players to increase the types of wares possible in the headquarters. Unfortunately, there is no way to get rid of a ware once it has been added without modding.

===Terran Version===

The Terran version of the Player Headquarters is available in Albion Prelude as a reward at the end of the Terran and Aldrin gamestarts' plot (Loose Ends). It's not available to the other gamestarts, and is a general improvement over the Commonwealth version in several ways:

* Larger cargo bay: 700.000 units (40% more).
* 18 capital ship docking points.
* Unlimited docking for ships other than TL/M1/M2/M7.

The only other differences are that the starting blueprint is a Sabre instead of a Buster, the packed station takes up 30k cargo units instead of 25k, and the station itself is many times larger, as usual for the Terran.
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Headquarters" title="Headquarters" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<li><a href="/index.php/Template:Infobox_Station" title="Template:Infobox Station">Template:Infobox Station</a> (<a href="/index.php?title=Template:Infobox_Station&amp;action=edit" title="Template:Infobox Station">edit</a>) </li></ul></div><div class="hiddencats"></div><div class="limitreport"></div><input type="hidden" value="1" name="wpUltimateParam"/>
</form>
</div><div class="printfooter">
Retrieved from "<a dir="ltr" href="http://x3wiki.com/index.php/Headquarters">http://x3wiki.com/index.php/Headquarters</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Headquarters&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Headquarters&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Headquarters&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
