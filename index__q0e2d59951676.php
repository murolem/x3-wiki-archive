...
<head>
<title>Editing X-perimental Shuttle (section) - X3 Wiki</title>
...
<form id="editform" name="editform" method="post" action="/index.php?title=X-perimental_Shuttle&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="2" name="wpSection" />
<input type='hidden' value="20110104113401" name="wpStarttime" />
<input type='hidden' value="20110103234517" name="wpEdittime" />
...
Not much is known about the ship known as the Xperimental Shuttle. This ship was supposed to be able to cross vast distances without having to use jump gates, by generating its own wormhole. Argon Scientists are still trying to fix the ship and get its drive back into working order. When the ship was built it was considered to be the fastest ship of its class. It also attracted the attention of people when it landed at stations, as the ship is unique.

The X-perimental Shuttle, also know as the X-shuttle or X-craft, is a Terran ship reverse engineered from a damaged Xenon scoutship that arrived in the Solar System with a gateless jumpdrive. The prototype, equipped with the Terran version of this point-to-point jumpdrive, was intended to allow the Terrans to begin a second wave of expansion without relying on the Xenon-infested jumpgate network.
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='editHelp'><a href="/index.php/X-perimental_Shuttle" title="X-perimental Shuttle" id="mw-editform-cancel">Cancel</a> | <a target="helpwindow" href="/index.php/Help:Editing">Editing help</a> (opens in new window)</span>
</div><!-- editButtons -->
</div><!-- editOptions -->
...
<div class="mw-hiddenCategoriesExplanation"><p>This page is a member of 7 hidden categories:
</p></div><ul>
	...
	<div id="p-cactions" class="portlet">
		...
		<div class="pBody">
			<ul>
				 ...
				 <li id="ca-edit" class="selected"><a href="/index.php?title=X-perimental_Shuttle&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=X-perimental_Shuttle&amp;returntoquery=action%3Dedit%26section%3D2" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
