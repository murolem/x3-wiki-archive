...
<input type='hidden' value="20160504060040" name="wpStarttime" />
...
The Hyperion was first introduced as a prototype [[M7]] class yacht for the [[Paranid]] where it was significantly larger and more powerful. Its classification has changed over time to a cheaper and more compact [[M6+]], but remains a rather unique vessel, even after it started to be produced in larger numbers.
...
<div id="column-one">
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Hyperion&amp;returntoquery=action%3Dedit%26section%3D2&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Hyperion&amp;returntoquery=action%3Dedit%26section%3D2" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
