...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Main_Page rootpage-Main_Page skin-monobook action-edit">
...
</p><textarea readonly="" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{| width="100%" style="background: transparent;"
...
* [[Ore_asteroid_list|Ore asteroid list]] - Ore asteroid list.
* [[Silicon_asteroid_list|Silicon asteroid list]] - Silicon asteroid list.
* [[Ice_asteroid_list|Ice asteroid list]] - Ice asteroid list.
* [[Nividium_asteroid_list|Nividium asteroid list]] - Nividium asteroid list.
&lt;/center>
|}
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Main+Page&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
