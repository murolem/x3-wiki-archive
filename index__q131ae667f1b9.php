...
<head>
<meta charset="UTF-8"/>
<title>Editing Phantom - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Phantom","wgTitle":"Phantom","wgCurRevisionId":16185,"wgRevisionId":0,"wgArticleId":1816,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Phantom","wgRelevantArticleId":1816,"wgRequestId":"WlgaN1kfZokAAFFx1aQAAAAY","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia","wgEditMessage":"editing"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Phantom rootpage-Phantom skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Phantom</h1>
...
<p><strong>Warning:</strong> You are not logged in. Your IP address will be publicly visible if you make any edits. If you <strong><a class="external text" href="http://www.x3wiki.com/index.php?title=Special:UserLogin&amp;returnto=Phantom">log in</a></strong> or <strong><a class="external text" href="http://www.x3wiki.com/index.php?title=Special:CreateAccount&amp;returnto=Phantom">create an account</a></strong>, your edits will be attributed to your username, along with other benefits.
</p>
</div>
<div id="wikiPreview" class="ontop" style="display: none;"><div lang="en" dir="ltr" class="mw-content-ltr"></div></div><form id="editform" name="editform" method="post" action="/index.php?title=Phantom&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntispam">Anti-spam check.
...
{{Infobox close}}
==Overview==
In Terran Conflict, the Phantom is the fastest TP available for sale, mounts the heaviest shields, and has the most guns. It is ideal for players looking to make large amounts of money from passenger transport missions that frequently require a TP-class ship. However, it is not the fastest overall TP in the game; the Split [[Iguana|Iguana Vanguard]] takes the title by beating it at a mere 6 m/s. In Albion Prelude, the [[Mani]] and [[Ocelot]] are faster.

==Background==
The Phantom is the latest offering from the famous Omicron Lyrae Shipyards. Designed to compete in the same niche as the Hyperion, it combines luxurious interior suites with a reinforced hull and enhanced shield generators, making it the perfect vessel for use as a private yacht for the wealthy entrepreneur. The vessel has minimal defensive armament, but is capable of defending itself from the scattered pirate raiders which plague the universe. The current design still contains a number of minor faults, but has been deemed safe for sale to the mass market.
==Physical Characteristics==
== Combat ==
Contrary to the in-game description, this ship cannot match the [[Hyperion]] in combat capability. Its shields are strong and it is heavily armed for a TP, but it is still recommended to keep it out of harm's way.
== Equipment ==
== Availability ==
{| style="text-align:center;" cellpadding="3"
|+ '''Availability'''
|- style="{{Colour/Argon}}"
! Variant !! [[Legend's Home]] !!  [[Omicron Lyrae]] !! [[Cloudbase South East]]
|-
! Phantom || x || x || x ||
|-
|}
...
Passenger transport.
== See Also==
*[[Express|Argon Express]]
*[[Angel|Boron Angel]]
*[[Manta|Boron Manta]]
*[[Hermes|Paranid Hermes]]
*[[Iguana|Split Iguana]]
*[[Toucan|Teladi Toucan]]
*[[Scabbard|Terran Scabbard]]
*[[Geochen|Teladi Geochen]]
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Phantom" title="Phantom" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Phantom">http://www.x3wiki.com/index.php/Phantom</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Phantom&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Phantom&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Phantom&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
