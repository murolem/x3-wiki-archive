...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Notus_Hauler rootpage-Notus_Hauler skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Notus Hauler</h1>
...
<input type='hidden' value="20171001183020" name="wpStarttime" />
<input type='hidden' value="20140410062219" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="16194" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{Infobox open}}
{{Infobox variant
|Variant=Notus Hauler
|Faction=OTAS
|Class={{M3+class}}
|Priceblock={{Priceblock|Argon|Trusted Ally 5,534,600}}
|Minspeed=67.6
|Maxspeed=169
|Minaccel=12
|Maxaccel=31
...
{{Infobox close}}
==Overview==
The Notus is the most powerful [[Commonwealth]] fighter. It should not be underestimated, as its only drawback is a slightly paltry cargo capacity for its class.

==Background==
==Physical Characteristics==
== Combat ==
The Notus is arguably an improvement on the [[Venti]], as although it has one less weapon in total, it has improved generation to fire them and two are now turreted. It makes an exceptional dogfighter. With improved shielding over its predecessor, its survivability in battle has also increased.
...
|}
== Availability ==
The Notus is not available to buy in Vanilla, nor is it available as a plot reward. It must be [[capping|capped]], which is possible, as there are Argon Notus Haulers patrolling some Argon sectors. Can be found home-based to OWPs, like in Aladna Hill.  The Notus IS available at the OTAS shipyard in Albion Prelude.
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Notus_Hauler" title="Notus Hauler" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Notus_Hauler">http://www.x3wiki.com/index.php/Notus_Hauler</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Notus_Hauler&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Notus+Hauler&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Notus+Hauler&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
