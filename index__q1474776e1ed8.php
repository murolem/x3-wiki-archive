...
<head>
<title>Editing Simulation Modeling - X3 Wiki</title>
...
wgNamespaceNumber=0,
wgPageName="Simulation_Modeling",
wgTitle="Simulation Modeling",
wgAction="edit",
wgArticleId=1008,
wgIsArticle=false,
wgUserName=null,
...
<body class="mediawiki ltr ns-0 ns-subject page-Simulation_Modeling skin-monobook">
<div id="globalWrapper">
<div id="column-content"><div id="content" >
	<a id="top"></a>
	
	<h1 id="firstHeading" class="firstHeading">Simulation Modeling</h1>
	<div id="bodyContent">
...
<form id="editform" name="editform" method="post" action="/index.php?title=Simulation_Modeling&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="" name="wpSection" />
<input type='hidden' value="20110311111357" name="wpStarttime" />
<input type='hidden' value="20101220175447" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary" /><input type="hidden" value="0" name="oldid" /><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" name="wpTextbox1">X3 is a game that simulates a fictional universe comprised of sectors of space connected by gates, the [[X-universe]].
...
The difference in modeling causes some unexpected behavior in OOS mode, as the objects no longer have to obey physical constraints and as for further computational savings, time is evaluated in larger chunks. Furthermore, OOS events the player is not directly monitoring through the Trading Extension occur in larger time chunks than those that are being directly monitored.
...
|
===In-Sector===
*Combat is modeled in real-time, accounting for projectiles, collisions, and orientation.
*Movement takes into account obstacles and potential collisions, and ships must maneuver around obstacles.
|
===Out-of-Sector===
...
<div id="column-one">
	<div id="p-cactions" class="portlet">
		...
		<div class="pBody">
			<ul>
				 ...
				 <li id="ca-edit" class="selected"><a href="/index.php?title=Simulation_Modeling&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
				 <li id="ca-history"><a href="/index.php?title=Simulation_Modeling&amp;action=history" title="Past revisions of this page [h]" accesskey="h">History</a></li>
			</ul>
		</div>
	</div>
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Simulation_Modeling&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
	...
	<div class="portlet" id="p-tb">
		...
		<div class="pBody">
			<ul>
				<li id="t-whatlinkshere"><a href="/index.php/Special:WhatLinksHere/Simulation_Modeling" title="List of all wiki pages that link here [j]" accesskey="j">What links here</a></li>
