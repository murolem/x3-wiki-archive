...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Transport_Passengers rootpage-Transport_Passengers skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Transport Passengers</h1>
...
<input type='hidden' value="20171005192124" name="wpStarttime" />
<input type='hidden' value="20130809233751" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="13403" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">A [[Missions#Other Mission|Mission]] offered at [[stations]].

==Objective==
Same as [[Transport Passenger|taxi]] mission but with greater numbers of passengers.

==General Difficulty:==
Easy/Medium, depending on circumstance.

==What you will need: ==

* A fast ship with size M cargo or bigger, the requisite cargo capacity (6 per passenger), and [[Cargo Lifesupport System]].
* Docking Computer, to save time.

==What you will find: ==

* Anything up to 20 passengers to be transported across a couple of Sectors.

==Commentary and Strategy==
The passengers board automatically when you dock. Time is usually tight, so having and using a [[Docking Computer]] is a big, big help. A [[Jumpdrive]] will make this mission a cakewalk, but if you don't have one, you'll have to tear across space as fast as you can (something which the autopilot cannot do).

A [[TP]]-class ship is not a necessity, you simply need the requisite cargo space and the ability to get to the target in time.
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Transport_Passengers" title="Transport Passengers" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Transport_Passengers">http://www.x3wiki.com/index.php/Transport_Passengers</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Transport_Passengers&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Transport+Passengers&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Transport+Passengers&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
