...
<head>
<meta charset="UTF-8" /><title>Editing Uranus - X3 Wiki</title>
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Uranus skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Uranus</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Uranus&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20160522104235" name="wpStarttime" />
<input type='hidden' value="20140310144356" name="wpEdittime" />
...
|Race=Terran
|SecLevel=Core
|Population=55,711,517
|Planets=0
|SunLevel=150
|GateDist=100
|Gates={{Gateblock/Begin}}
{{Gateblock2|North|5500|	25000|	46500|[[Uranus 2]]}}
{{Gateblock2|East|41875|	0|	0|[[Saturn]]}}
{{Gateblock2|South|-22500|	-22000|	-50000|[[Uranus 3]]}}
{{Gateblock2|West|-37500|	0|	500|[[Neptune]]}}
{{Gateblock/End}}
}}
==Description==
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Uranus" title="Uranus" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Uranus&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Uranus&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Uranus&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
