...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Thuruk_s_Beard rootpage-Thuruk_s_Beard skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Thuruk's Beard</h1>
...
<input type='hidden' value="20170530224553" name="wpStarttime" />
<input type='hidden' value="20140306130420" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="15815" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{Infobox Sector
|Race=Split
|SecLevel=Border
|Population=66,534,325
|Planets=1
|SunLevel=150
|GateDist=140
...
{{Gateblock2|North|0|	0|	44310|[[Family Rhonkar]]}}
{{Gateblock2|South|0|	0|	-40810|[[Hatikvah's Faith]]}}
{{Gateblock2|West|-44310|	0|	0|[[Company Pride]]}}
&lt;/table>
}}
==Description==
On the fringes of civilized space, this deep space system is no stranger to raids by pirates and other hostile ships. Founded by the [[Split]] leader Thuruk as a prison colony for [[Boron]] captured during their wars, it has evolved into a thriving industrial outpost.
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Thuruk%27s_Beard" title="Thuruk's Beard" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<li><a href="/index.php/Template:Colour/Split" title="Template:Colour/Split">Template:Colour/Split</a> (<a href="/index.php?title=Template:Colour/Split&amp;action=edit" title="Template:Colour/Split">edit</a>) </li><li><a href="/index.php/Template:Gateblock2" title="Template:Gateblock2">Template:Gateblock2</a> (<a href="/index.php?title=Template:Gateblock2&amp;action=edit" title="Template:Gateblock2">edit</a>) </li><li><a href="/index.php/Template:Infobox_Sector" title="Template:Infobox Sector">Template:Infobox Sector</a> (<a href="/index.php?title=Template:Infobox_Sector&amp;action=edit" title="Template:Infobox Sector">edit</a>) </li><li><a href="/index.php/Template:Split_Navbox" title="Template:Split Navbox">Template:Split Navbox</a> (<a href="/index.php?title=Template:Split_Navbox&amp;action=edit" title="Template:Split Navbox">edit</a>) </li></ul></div><div class="hiddencats"></div><div class="limitreport"></div><input type="hidden" value="1" name="wpUltimateParam"/>
</form>
...
Retrieved from "<a dir="ltr" href="http://x3wiki.com/index.php/Thuruk%27s_Beard">http://x3wiki.com/index.php/Thuruk%27s_Beard</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Thuruk%27s_Beard&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Thuruk%27s+Beard&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Thuruk%27s+Beard&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
