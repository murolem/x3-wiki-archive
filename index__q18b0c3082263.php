...
<input type='hidden' value="20100605121755" name="wpStarttime" />

<input type='hidden' value="20100602020526" name="wpEdittime" />

<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />

<input name="wpAutoSummary" type="hidden" value="db4a97e464b64811ffe035ac8a68bfdf" />

<textarea name="wpTextbox1" id="wpTextbox1" cols="80" rows="25" tabindex="1" accesskey=",">==Overview==

The Osaka is the [[Terran|USC's]] fleet battleship, and along with the [[ATF]] [[Tyr]] provides the platforms on which Earth mounts its heavy guns.
...
<div class="editOptions"><span class="mw-summary" id="wpSummaryLabel"><label for="wpSummary">Summary:</label></span> <input name="wpSummary" size="60" value="/* Overview */ " id="wpSummary" maxlength="200" tabindex="1" /><br/>
	...
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Osaka" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
...
</script><!-- Served in 0.167 secs. --></body></html>
