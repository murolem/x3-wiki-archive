...
<head>
<meta charset="UTF-8"/>
<title>Editing Category:Capital Ships - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"Category","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":14,"wgPageName":"Category:Capital_Ships","wgTitle":"Capital Ships","wgCurRevisionId":13858,"wgRevisionId":0,"wgArticleId":165,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Category:Capital_Ships","wgRelevantArticleId":165,"wgRequestId":"WfZQTVkfZokAAEzuDYgAAAAA","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia","wgEditMessage":"editing"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<body class="mediawiki ltr sitedir-ltr ns-14 ns-subject page-Category_Capital_Ships rootpage-Category_Capital_Ships skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Category:Capital Ships</h1>
...
<input type='hidden' value="20171029220357" name="wpStarttime" />
<input type='hidden' value="20130910004233" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="13858" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{See also|Carrier}}
{{Shipcategory}}
==Overview==
...
Capital Ships can only be [[capping|captured]] by [[boarding]] them with [[marines]] (this is also true of [[M6|corvettes]], although the latter are not considered Capital Ships).

{| class="wikitable" style="text-align:right;"
! 
! scope="col" style="text-align:center;" bgcolor="WhiteSmoke" | Ship Class 
! scope="col" bgcolor="WhiteSmoke" | Typical length (m)
|-
! scope="row" rowspan="4" bgcolor="WhiteSmoke"|Capital Ship classes 
| {{M1class}} ||  1550 - 4500
|-
| {{M2class}}&lt;bR>{{M2+class}}  ||  1400 - 4700
|-
| {{M7class}}&lt;bR>{{M7Mclass}}&lt;bR>{{M7Cclass}} ||  800 - 2800
|-
| {{TLclass}} ||  1550 - 3600
|-
| colspan="3" | 
...
==Docking==
Capital Ships require their own class of docking clamps and hence the range of stations they can dock at is limited.&lt;bR>
Freight exchange with other stations must be conducted through intermediaries.

A list of docking stations and limits is available [[Docking#Capital Ship Docking Stations|Here]].
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Category:Capital_Ships" title="Category:Capital Ships" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<li><a href="/index.php/Template:M1class" title="Template:M1class">Template:M1class</a> (<a href="/index.php?title=Template:M1class&amp;action=edit" title="Template:M1class">edit</a>) </li><li><a href="/index.php/Template:M2%2Bclass" title="Template:M2+class">Template:M2+class</a> (<a href="/index.php?title=Template:M2%2Bclass&amp;action=edit" title="Template:M2+class">edit</a>) </li><li><a href="/index.php/Template:M2class" title="Template:M2class">Template:M2class</a> (<a href="/index.php?title=Template:M2class&amp;action=edit" title="Template:M2class">edit</a>) </li><li><a href="/index.php/Template:M7Cclass" title="Template:M7Cclass">Template:M7Cclass</a> (<a href="/index.php?title=Template:M7Cclass&amp;action=edit" title="Template:M7Cclass">edit</a>) </li><li><a href="/index.php/Template:M7Mclass" title="Template:M7Mclass">Template:M7Mclass</a> (<a href="/index.php?title=Template:M7Mclass&amp;action=edit" title="Template:M7Mclass">edit</a>) </li><li><a href="/index.php/Template:M7class" title="Template:M7class">Template:M7class</a> (<a href="/index.php?title=Template:M7class&amp;action=edit" title="Template:M7class">edit</a>) </li><li><a href="/index.php/Template:See_also" title="Template:See also">Template:See also</a> (<a href="/index.php?title=Template:See_also&amp;action=edit" title="Template:See also">edit</a>) </li><li><a href="/index.php/Template:Shipcategory" title="Template:Shipcategory">Template:Shipcategory</a> (<a href="/index.php?title=Template:Shipcategory&amp;action=edit" title="Template:Shipcategory">edit</a>) </li><li><a href="/index.php/Template:TLclass" title="Template:TLclass">Template:TLclass</a> (<a href="/index.php?title=Template:TLclass&amp;action=edit" title="Template:TLclass">edit</a>) </li></ul></div><div class="hiddencats"></div><div class="limitreport"></div><input type="hidden" value="1" name="wpUltimateParam"/>
</form>
...
Retrieved from "<a dir="ltr" href="http://x3wiki.com/index.php/Category:Capital_Ships">http://x3wiki.com/index.php/Category:Capital_Ships</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Category:Capital_Ships&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Category%3ACapital+Ships&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Category%3ACapital+Ships&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
