...
<head>
<meta charset="UTF-8" /><title>Editing Commercial Agent - X3 Wiki</title>
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Commercial_Agent skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Commercial Agent</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Commercial_Agent&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20160427232631" name="wpStarttime" />
<input type='hidden' value="20130810170049" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary" /><input type="hidden" value="0" name="oldid" /><input type="hidden" value="text/x-wiki" name="format" /><input type="hidden" value="wikitext" name="model" /><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{See also|Traders}}
{{Stub}}

'''Please note:''' This article is a stub. You may wish to consult the [[#See Also|See Also]] section for a list of more in-depth guides, or consider fleshing it out yourself.



"Commercial Agent" or "CAG" is a feature added by the [[Bonus Pack]] to [[X3: Reunion]], [[Terran Conflict]] and [[Albion Prelude]].

CAGs buy and sell goods for stations. You assign them by first assigning a homebase and then selecting "Start Commercial Representation" from the Trade menu while [[Navigation Command Software]] and [[Trade Command Software Mk 1]] and [[Trade Command Software Mk 2|Mk 2]] are installed.


== Usage ==
Equip a {{TSclass}} with the required software, assign a homebase, then select ''"Start Commercial Representation"''. 


== Pilot Levels ==

Pilots level up and gain new abilities as they do, which means taking training courses. Newly employed pilots are paid no wage. From Level 2 and up, they begin to draw a wage, varying from 20-40 credits per Mizura flown. Pilot levels are shared between CAG, [[Commodity Logistics Software|CLS MkI]], and [[Commodity Logistics Software|CLS MkII]] pilots, meaning that a CAG can be trained as a CLS pilot, or be switched to a CLS pilot without losing rank.
...
'''New Abilities:''' Can now sell station products, and trade with/from [[Trading Station]]s and [[Equipment Dock]]s.
...
'''New Abilities:''' Will repair ship if damaged, and will continue to search for the best deal even after departing the [[stations|station]].
...
*''Sell products:'' The threshold at which a CAG will sell a product, in percentage. E.g., given a station that can produce up to 32 [[Particle Accelerator Cannon|PACs]], 50% means the CAG will attempt to sell PACs upon 16 being completed.
...
== See Also ==
[{{linky}}forum.egosoft.com/viewtopic.php?t=275924 Official Egosoft Thread] (Includes description)


{{Trading}}
[[Category:Bonus Package]]
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Commercial_Agent" title="Commercial Agent" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<li><a href="/index.php/Template:Linky" title="Template:Linky">Template:Linky</a> (<a href="/index.php?title=Template:Linky&amp;action=edit" title="Template:Linky">edit</a>) </li><li><a href="/index.php/Template:See_also" title="Template:See also">Template:See also</a> (<a href="/index.php?title=Template:See_also&amp;action=edit" title="Template:See also">edit</a>) </li><li><a href="/index.php/Template:Stub" title="Template:Stub">Template:Stub</a> (<a href="/index.php?title=Template:Stub&amp;action=edit" title="Template:Stub">edit</a>) </li><li><a href="/index.php/Template:TSclass" title="Template:TSclass">Template:TSclass</a> (<a href="/index.php?title=Template:TSclass&amp;action=edit" title="Template:TSclass">edit</a>) </li><li><a href="/index.php/Template:Trading" title="Template:Trading">Template:Trading</a> (<a href="/index.php?title=Template:Trading&amp;action=edit" title="Template:Trading">edit</a>) </li></ul></div><div class="hiddencats"></div><div class="limitreport"></div>
</form>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Commercial_Agent&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Commercial+Agent&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Commercial+Agent&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
