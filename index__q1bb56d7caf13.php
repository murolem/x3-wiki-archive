...
<head>
<meta charset="UTF-8" /><title>Editing Talk:To do List (new section) - X3 Wiki</title>
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Talk:To do List (new section)</span></h1>
...
<input type='hidden' value="20140829164725" name="wpStarttime" />
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="istalk"><a href="/index.php?title=Talk:To_do_List&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
				<li id="ca-addsection" class="selected"><a href="/index.php?title=Talk:To_do_List&amp;action=edit&amp;section=new" title="Start a new section [+]" accesskey="+">+</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Talk%3ATo+do+List&amp;returntoquery=action%3Dedit%26section%3Dnew&amp;type=signup">Create account</a></li>
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Talk%3ATo+do+List&amp;returntoquery=action%3Dedit%26section%3Dnew" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
