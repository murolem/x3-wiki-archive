...
<head>
<meta charset="UTF-8" />
<title>Editing Heavy Hydra (section) - X3 Wiki</title>
...
<div id="column-content"><div id="content">
	...
	<h1 id="firstHeading" class="firstHeading">Editing Heavy Hydra (section)</h1>
	<div id="bodyContent">
...
<form id="editform" name="editform" method="post" action="/index.php?title=Heavy_Hydra&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="4" name="wpSection" />
<input type='hidden' value="20110905045821" name="wpStarttime" />
<input type='hidden' value="20110828120947" name="wpEdittime" />
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='editHelp'><a href="/index.php/Heavy_Hydra" title="Heavy Hydra" id="mw-editform-cancel">Cancel</a> | <a target="helpwindow" href="/index.php/Help:Editing">Editing help</a> (opens in new window)</span>
</div><!-- editButtons -->
</div><!-- editOptions -->
...
<div class="mw-hiddenCategoriesExplanation"><p>This page is a member of 11 hidden categories:
</p></div><ul>
...
<div id="column-one">
	...
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Heavy_Hydra&amp;returntoquery=action%3Dedit%26section%3D4" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
...
<script>if ( window.mediaWiki ) {
	mediaWiki.config.set({"wgCanonicalNamespace": "", "wgCanonicalSpecialPageName": false, "wgNamespaceNumber": 0, "wgPageName": "Heavy_Hydra", "wgTitle": "Heavy Hydra", "wgAction": "edit", "wgArticleId": 239, "wgIsArticle": false, "wgUserName": null, "wgUserGroups": ["*"], "wgCurRevisionId": 7123, "wgCategories": [], "wgBreakFrames": true, "wgRestrictionEdit": [], "wgRestrictionMove": []});
}
</script>
<script>if ( window.mediaWiki ) {
...
</script><!-- Served in 0.290 secs. --></body></html>