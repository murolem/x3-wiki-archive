...
100.00%    4.622      1 - -total
 76.42%    3.532      1 - Template:Missions
 21.14%    0.977      1 - Template:Linky
 18.02%    0.833      1 - Template:Plot_Missions
 17.83%    0.824      1 - Template:Other_Missions
 16.88%    0.780      1 - Template:Offers
-->

<!-- Saved in parser cache with key dailystunt_wiki:pcache:idhash:1033-0!*!0!!*!*!* and timestamp 20170608082739 and revision id 16453
 -->
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Balance+of+Power&amp;returntoquery=printable%3Dyes" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Balance+of+Power&amp;returntoquery=printable%3Dyes" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
...
<script type="text/javascript" src="//geoiplookup.wikimedia.org/"></script><script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgBackendResponseTime":110});});</script></body></html>
