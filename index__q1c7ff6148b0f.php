...
<head>
<title>Log in / create account - X3 Wiki</title>
<meta charset="UTF-8" />
...
<form name="userlogin2" id="userlogin2" method="post" action="/index.php?title=Special:UserLogin&amp;action=submitlogin&amp;type=signup&amp;returnto=Auster+Hauler">
	<h2>Create account</h2>
	<p id="userloginlink">Already have an account? <a href="/index.php?title=Special:UserLogin&amp;type=login&amp;returnto=Auster+Hauler">Log in</a>.</p>
	<div class='captcha'><p>To help protect against automated account creation, please select just the cat photos in the box below:
</p><script src="http://challenge.asirra.com/js/AsirraClientSide.js"></script><script>var asirra_js_failed = '"Please correctly identify the cats."';</script><noscript><b>Please enable JavaScript and resubmit the page.</b></noscript></div>
		<table>
		<tr>
		...
		<tr>
				...
				<td class="mw-input">
					<input class="loginText" id="wpEmail" tabindex="6" size="20" type="email" name="wpEmail" />					<div class="prefsectiontip">
						<p>Email address is optional, but is needed for password resets, should you forget your password.
</p><p>You can also choose to let others contact you by email through a link on your user or talk page.
...
<input type="hidden" name="wpCreateaccountToken" value="7859bf5edd7a4eed415aa71672355973" /></form>
</div>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="ca-nstab-special" class="selected"><a href="/index.php?title=Special:UserLogin&amp;returnto=Auster+Hauler&amp;type=signup" context="subject" title="This is a special page, you cannot edit the page itself">Special page</a></li>
			</ul>
		</div>
	</div>
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-createaccount" class="active"><a href="/index.php?title=Special:UserLogin&amp;returnto=Auster+Hauler&amp;returntoquery=type%3Dsignup&amp;type=signup">Create account</a></li>
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Auster+Hauler&amp;returntoquery=type%3Dsignup" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
...
<script>if(window.mw){
mw.loader.load(["mediawiki.special.userlogin.signup","ext.confirmEdit.asirra","mediawiki.user","mediawiki.page.ready","mediawiki.searchSuggest","mediawiki.hidpi"], null, true);
}</script>
