...
<head>
<meta charset="UTF-8" /><title>Editing Energy Cells (section) - X3 Wiki</title>
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Energy Cells (section)</span></h1>
...
<input type='hidden' value="20160513065049" name="wpStarttime" />
...
<div id="column-one">
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Energy+Cells&amp;returntoquery=action%3Dedit%26section%3D3&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Energy+Cells&amp;returntoquery=action%3Dedit%26section%3D3" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
