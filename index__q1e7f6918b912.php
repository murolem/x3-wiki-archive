...
<head>
<meta charset="UTF-8" />
<title>Revision history of "Capital Ships" - X3 Wiki</title>
...
<link rel="alternate" type="application/atom+xml" title="&quot;Capital Ships&quot; Atom feed" href="/index.php?title=Capital_Ships&amp;feed=atom&amp;action=history" />
...
<body class="mediawiki ltr ns-0 ns-subject page-Capital_Ships skin-monobook">
<div id="globalWrapper">
<div id="column-content"><div id="content">
	<a id="top"></a>
	
	<h1 id="firstHeading" class="firstHeading">Revision history of "Capital Ships"</h1>
	<div id="bodyContent">
		<div id="siteSub">From X3 Wiki</div>
		<div id="contentSub"><a href="/index.php?title=Special:Log&amp;page=Capital+Ships" title="Special:Log">View logs for this page</a></div>
		<div id="jump-to-nav">Jump to: <a href="#column-one">navigation</a>, <a href="#searchInput">search</a></div>
		<!-- start content -->
<form action="/index.php" method="get" id="mw-history-searchform"><fieldset id="mw-history-search">
<legend>Browse history</legend>
<input type="hidden" value="Capital_Ships" name="title" />
...
<li><span class="mw-history-histlinks">(cur | prev) </span> <a href="/index.php?title=Capital_Ships&amp;oldid=7362" title="Capital Ships">22:42, 17 September 2011</a> <span class='history-user'><a href="/index.php/User:StarSword" title="User:StarSword" class="mw-userlink">StarSword</a>  <span class="mw-usertoollinks">(<a href="/index.php?title=User_talk:StarSword&amp;action=edit&amp;redlink=1" class="new" title="User talk:StarSword (page does not exist)">Talk</a> | <a href="/index.php/Special:Contributions/StarSword" title="Special:Contributions/StarSword">contribs</a>)</span></span> <span class="history-size">(27 bytes)</span> <span class="comment">(moved <a href="/index.php/Capital_Ships" class="mw-redirect" title="Capital Ships">Capital Ships</a> to <a href="/index.php/Capital_ships" title="Capital ships">Capital ships</a>: &quot;Ships&quot; is not a proper noun)</span> </li>
</ul>
...
<div id="column-one">
	<div id="p-cactions" class="portlet">
		...
		<div class="pBody">
			<ul>
				 <li id="ca-nstab-main" class="selected"><a href="/index.php/Capital_Ships" title="View the content page [c]" accesskey="c">Page</a></li>
				 <li id="ca-talk"><a href="/index.php/Talk:Capital_Ships" title="Discussion about the content page [t]" accesskey="t">Discussion</a></li>
				 <li id="ca-edit"><a href="/index.php?title=Capital_Ships&amp;action=edit" title="You can edit this page. Please use the preview button before saving [e]" accesskey="e">Edit</a></li>
				 <li id="ca-history" class="selected"><a href="/index.php?title=Capital_Ships&amp;action=history" title="Past revisions of this page [h]" accesskey="h">History</a></li>
			</ul>
		</div>
	</div>
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Capital_Ships&amp;returntoquery=action%3Dhistory" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
	...
	<div class="portlet" id="p-tb">
		...
		<div class="pBody">
			<ul>
				<li id="t-whatlinkshere"><a href="/index.php/Special:WhatLinksHere/Capital_Ships" title="List of all wiki pages that link here [j]" accesskey="j">What links here</a></li>
			...
			<li id="feedlinks"><a id="feed-atom" href="/index.php?title=Capital_Ships&amp;feed=atom&amp;action=history" rel="alternate" type="application/atom+xml" class="feedlink" title="Atom feed for this page">Atom</a>&#160;
...
<script>if ( window.mediaWiki ) {
	mediaWiki.config.set({"wgCanonicalNamespace": "", "wgCanonicalSpecialPageName": false, "wgNamespaceNumber": 0, "wgPageName": "Capital_Ships", "wgTitle": "Capital Ships", "wgAction": "history", "wgArticleId": 1715, "wgIsArticle": false, "wgUserName": null, "wgUserGroups": ["*"], "wgCurRevisionId": 7362, "wgCategories": [], "wgBreakFrames": false, "wgRestrictionEdit": [], "wgRestrictionMove": []});
}
</script>
<script>if ( window.mediaWiki ) {
