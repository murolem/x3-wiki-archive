...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing M0</h1>
...
<input type='hidden' value="20170802201313" name="wpStarttime" />
<input type='hidden' value="20130120235948" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="11528" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">'''M0 Mothership'''

M0 are the heaviest ship class and, prior to the Terran Conflict, were used only by [[Xenon]] and [[Kha'ak]].
...
The Xenon M0 appeared in X: Beyond the Frontier.
In X3, its remains can be found in [[Xenon Sector 101]].

The Kha'ak M0 appeared in X2 in the battle for Omicron Lyrae.

In Albion Prelude, the [[Valhalla|ATF Valhalla]] is, canonically, an M0 Mothership, combining the firepower of a M2+ destroyer with the force projection of a massive carrier.
...
<li><a href="/index.php/Template:M0category" title="Template:M0category">Template:M0category</a> (<a href="/index.php?title=Template:M0category&amp;action=edit" title="Template:M0category">edit</a>) </li></ul></div><div class="hiddencats"></div><div class="limitreport"></div><input type="hidden" value="1" name="wpUltimateParam"/>
</form>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=M0&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=M0&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
