...
<head>
<meta charset="UTF-8" /><title>Editing Talk:Missiles - X3 Wiki</title>
...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"Talk","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":1,"wgPageName":"Talk:Missiles","wgTitle":"Missiles","wgCurRevisionId":3923,"wgRevisionId":0,"wgArticleId":65,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Talk:Missiles","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia"});
...
<body class="mediawiki ltr sitedir-ltr ns-1 ns-talk page-Talk_Missiles skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Talk:Missiles</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Talk:Missiles&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20140718001914" name="wpStarttime" />
<input type='hidden' value="20101101184243" name="wpEdittime" />
...
recommend setting torpedoclass as "Torpedo"

so firestorm torpedo would be 
&lt;pre>
...
[[User:Madned|Madned]] 19:27, 25 June 2010 (UTC)

please refer to missile page writeup on how to fill in the fields.
Submunitions is the incorrect term and actually refers to number of warheads launch of each missile spawns, which could only be one, the missile itself. [[User:Madned|Madned]] 14:37, 7 October 2010 (CDT)

----
from the faq, http://www.egosoft.com/support/faq/faq_answer_en.php?answer=1721&amp;version=9&amp;sid=93885ee3971de23179e95efa0b6dea17
...
Swarm Missiles: This missile type divides into 5 sub-missiles after being launched. Every sub-missile offers the full level of explosive energy of its mother rocket which makes them really powerful tools of destruction. Once launched and split, the sub-missiles approach the target in circling movements which makes it hard for a missile defence system to defend against all of them and it’s almost certain that at least one or two missiles reach the target. 
...
[[User:Madned|Madned]] 01:00, 5 August 2010 (UTC)


----------------------
The Shadow missile stats look wrong; I doubt a single missile does 6GJ of damage. I think 755,000 is the damage done by all eight warheads. Can someone double-check please? [[User:Spychotic|Spychotic]] 09:34, 1 November 2010 (CDT)

from http://forum.egosoft.com/viewtopic.php?t=252320,&lt;bR> 755,000 is per warhead,&lt;br> http://eng.x3tc.ru/x3_tc_weapons/x3-weapon.php?c=MTY1MzAwMDM agrees. hmm. appears to be compatible with only one ship. skirnir. [[User:Madned|Madned]] 13:42, 1 November 2010 (CDT)
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Talk:Missiles" title="Talk:Missiles" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected istalk"><a href="/index.php?title=Talk:Missiles&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Talk%3AMissiles&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Talk%3AMissiles&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
