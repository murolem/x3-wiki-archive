...
<head>
<meta charset="UTF-8"/>
<title>Station Hack - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Station_Hack","wgTitle":"Station Hack","wgCurRevisionId":13412,"wgRevisionId":13412,"wgArticleId":461,"wgIsArticle":true,"wgIsRedirect":false,"wgAction":"view","wgUserName":null,"wgUserGroups":["*"],"wgCategories":["Missions"],"wgBreakFrames":false,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Station_Hack","wgRelevantArticleId":461,"wgRequestId":"WMyr91kfZokAAC7zGZkAAAAR","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Station_Hack rootpage-Station_Hack skin-monobook action-view">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Station Hack</h1>
				
				<div id="bodyContent" class="mw-body-content">
					<div id="siteSub">From X3 Wiki</div>
					<div id="contentSub"><div id="mw-revision-info">Revision as of 00:43, 10 August 2013 by <a href="/index.php/User:Korlus" title="User:Korlus" class="mw-userlink">Korlus</a> <span class="mw-usertoollinks">(<a href="/index.php?title=User_talk:Korlus&amp;action=edit&amp;redlink=1" class="new" title="User talk:Korlus (page does not exist)">talk</a> | <a href="/index.php/Special:Contributions/Korlus" title="Special:Contributions/Korlus">contribs</a>)</span> <span class="comment">(Missions)</span></div><br />
				<div id="mw-revision-nav">(<a href="/index.php?title=Station_Hack&amp;diff=prev&amp;oldid=13412" title="Station Hack">diff</a>) <a href="/index.php?title=Station_Hack&amp;direction=prev&amp;oldid=13412" title="Station Hack">← Older revision</a> | Latest revision (diff) | Newer revision → (diff)</div></div>
										<div id="jump-to-nav" class="mw-jump">Jump to: <a href="#column-one">navigation</a>, <a href="#searchInput">search</a></div>

					<!-- start content -->
					<div id="mw-content-text" lang="en" dir="ltr" class="mw-content-ltr"><p>Station hacks are <a href="/index.php/Missions#Offers" title="Missions">offered</a> at random Pirate Bases to provide a service to you, hacking a hostile station within a limited amount of sectors to become neutral. They are recognizable by the white light bulb sign over a station. No reputation loss for doing this, but it is rather expensive for beginners. 
</p>
<ul><li> Offered at Teladi Stations as well, and very rarely other race stations (for example, near Duke's Haven, since there are no Teladi or Pirate bases nearby).</li>
<li> You need to be within 3 sectors of the hostile station to be able to hack it.</li></ul>
<p><br />
</p>
...
100.00%    3.040      1 - Template:Missions
100.00%    3.040      1 - -total
 23.88%    0.726      1 - Template:Other_Missions
 22.01%    0.669      1 - Template:Plot_Missions
 21.77%    0.662      1 - Template:Offers
-->

<!-- Saved in parser cache with key dailystunt_wiki:pcache:idhash:461-0!*!0!*!*!*!* and timestamp 20170318033935 and revision id 13412
 -->
</div><div class="printfooter">
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php?title=Station_Hack&amp;oldid=13412">http://www.x3wiki.com/index.php?title=Station_Hack&amp;oldid=13412</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-history"><a href="/index.php?title=Station_Hack&amp;action=history" title="Past revisions of this page [h]" accesskey="h">History</a></li>
				</ul>
							</div>
		</div>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Station+Hack&amp;returntoquery=oldid%3D13412" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Station+Hack&amp;returntoquery=oldid%3D13412" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
		...
		<div class='pBody'>
			...
			<div class="pBody">
				<ul>
											...
											<li id="t-print"><a href="/index.php?title=Station_Hack&amp;oldid=13412&amp;printable=yes" rel="alternate" title="Printable version of this page [p]" accesskey="p">Printable version</a></li>
											<li id="t-permalink"><a href="/index.php?title=Station_Hack&amp;oldid=13412" title="Permanent link to this revision of the page">Permanent link</a></li>
		...
		<div class="visualClear"></div>
					...
					<ul id="f-list">
									<li id="lastmod"> This page was last modified on 10 August 2013, at 00:43.</li>
