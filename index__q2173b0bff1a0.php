...
<head>
<meta charset="UTF-8" /><title>Editing Rastar Oil - X3 Wiki</title>
...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Rastar_Oil","wgTitle":"Rastar Oil","wgCurRevisionId":15575,"wgRevisionId":0,"wgArticleId":1053,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Rastar_Oil","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia"});
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Rastar_Oil skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Rastar Oil</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Rastar_Oil&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20141017091211" name="wpStarttime" />
<input type='hidden' value="20140304130710" name="wpEdittime" />
...
{{Infobox close}}
==Overview==
Rastar is an oil produced from the animal fat of the Chelt, A farmed Sea bound animal of the Split. This oil, once refined, is very fine and is used by most races to lubricate engines and other moving mechanical parts. It is refined in Rastar Refineries, and sold in large barrels known as Gretts.
==Commentary==
This is a product of the [[Rastar Refinery]]
==Trading information==
{|
...
*Split [[Chip Plant]]
*Split [[Cluster Flak Array Forge]]
*Split [[Computer Plant]]
*Split [[Concussion Impulse Generator Forge]]
*Split [[Crystal Fab]]
...
*Split [[Heavy Shield Production Complex]]
*Split [[Heavy Weapons Complex]]
*Split [[High Energy Plasma Thrower Forge]]
*Split [[High Yield Production Complex]]
*Split [[Image Recognition Production Complex]]
*Split [[Impulse Ray Emitter Forge]]
*[[Ion Shard Railgun Forge]]
*Split [[Lasertower Factory]]
*Split [[Light Shield Production Complex]]
*Split [[Low-yield Sidearms Fab]]
*Split [[Mass Driver Forge]]
*Split [[Medium Weapons Complex]]
*Split [[Mobile Drilling System Factory]]
*Split [[Particle Accelerator Cannon Forge]]
*Split [[Phased Repeater Gun Forge]]
*Split [[Photon Pulse Cannon Forge]]
*Split [[Quantum Tube Fab]]
*[[Rehabilitation Facility]]
*Split [[Satellite Factory]]
*Split [[Shield Production Facility 1MJ]]
*Split [[SQUASH Mine Factory]]
*Split [[Swarm Missile Production Complex]]
*Split [[Tomahawk Missile Manufacturing Plant]]
*Split [[Tracker Mine Factory]]
|
*[[Space Jewellery]]
|
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Rastar_Oil" title="Rastar Oil" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a href="http://www.x3wiki.com/index.php/Rastar_Oil">http://www.x3wiki.com/index.php/Rastar_Oil</a>"</div>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Rastar_Oil&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Rastar+Oil&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Rastar+Oil&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
