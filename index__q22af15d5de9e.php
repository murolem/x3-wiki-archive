...
<head>
<meta charset="UTF-8" /><title>Editing Heavy Dragon - X3 Wiki</title>
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Heavy_Dragon skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Heavy Dragon</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Heavy_Dragon&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20140910113421" name="wpStarttime" />
<input type='hidden' value="20140311092217" name="wpEdittime" />
...
{{Infobox variant
|Variant=Heavy Dragon
|Faction=Split
|Class={{M6+class}}
|Priceblock={{Priceblock|Family Protector| 15772536}}
|Minspeed=84.7
|Maxspeed=160.9
|Minaccel=6
|Maxaccel=12
...
|-
! style="text-align:left;" | Heavy Dragon || - || - || - || - || - || x || - || x || x
|}
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Heavy_Dragon" title="Heavy Dragon" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a href="http://x3wiki.com/index.php/Heavy_Dragon">http://x3wiki.com/index.php/Heavy_Dragon</a>"</div>
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Heavy_Dragon&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Heavy+Dragon&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Heavy+Dragon&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
