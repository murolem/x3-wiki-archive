...
<head>
<meta charset="UTF-8" />
<title>Editing Medusa Prototype - X3 Wiki</title>
...
<div id="column-content"><div id="content">
	...
	<h1 id="firstHeading" class="firstHeading">Editing Medusa Prototype</h1>
	<div id="bodyContent">
...
<form id="editform" name="editform" method="post" action="/index.php?title=Medusa_Prototype&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="" name="wpSection" />
<input type='hidden' value="20110818062303" name="wpStarttime" />
<input type='hidden' value="20110807185803" name="wpEdittime" />
...
{{Infobox close}}
==Overview==
Barely improved statistically over the standard [[Medusa]], the Prototype craft has one marked advantage, shared by no other fighter in that it can utilise the heavy missiles reserved for the [[M6|Corvette]] class such as the massively powerful [[Firestorm Torpedo]] and versatile [[Typhoon Missile]]. It also has a slight speed and generator advantage over the standard Medusa, but this is very small.  
==Background==
...
*[[Typhoon Missile]]
== Availability ==
This ship is unpurchasable, only available through the Duke's Buccaneers corporation missions or the Unholy Traitor gamestart, neither of which are easy.

There is a small chance of finding high-tech traders flying this ship who can be forced to bail, leaving you their ship, but this is very unlikely.

if you ever get one bring it to the hq and dissasmbale it and have hevy misle asembaleey to make a small wing of them to serve as bombers with a tm beter splt to have speed an strong wing
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='editHelp'><a href="/index.php/Medusa_Prototype" title="Medusa Prototype" id="mw-editform-cancel">Cancel</a> | <a target="helpwindow" href="/index.php/Help:Editing">Editing help</a> (opens in new window)</span>
</div><!-- editButtons -->
</div><!-- editOptions -->
...
<li><a href="/index.php/Template:Colour/Paranid" title="Template:Colour/Paranid">Template:Colour/Paranid</a> (<a href="/index.php?title=Template:Colour/Paranid&amp;action=edit" title="Template:Colour/Paranid">edit</a>) </li><li><a href="/index.php/Template:Gunicon/0" title="Template:Gunicon/0">Template:Gunicon/0</a> (<a href="/index.php?title=Template:Gunicon/0&amp;action=edit" title="Template:Gunicon/0">view source</a>) (semi-protected)</li><li><a href="/index.php/Template:Gunslot" title="Template:Gunslot">Template:Gunslot</a> (<a href="/index.php?title=Template:Gunslot&amp;action=edit" title="Template:Gunslot">view source</a>) (semi-protected)</li><li><a href="/index.php/Template:Infobox_close" title="Template:Infobox close">Template:Infobox close</a> (<a href="/index.php?title=Template:Infobox_close&amp;action=edit" title="Template:Infobox close">view source</a>) (semi-protected)</li><li><a href="/index.php/Template:Infobox_open" title="Template:Infobox open">Template:Infobox open</a> (<a href="/index.php?title=Template:Infobox_open&amp;action=edit" title="Template:Infobox open">view source</a>) (semi-protected)</li><li><a href="/index.php/Template:Infobox_variant" title="Template:Infobox variant">Template:Infobox variant</a> (<a href="/index.php?title=Template:Infobox_variant&amp;action=edit" title="Template:Infobox variant">view source</a>) (semi-protected)</li><li><a href="/index.php/Template:M3%2Bclass" title="Template:M3+class">Template:M3+class</a> (<a href="/index.php?title=Template:M3%2Bclass&amp;action=edit" title="Template:M3+class">edit</a>) </li><li><a href="/index.php/Template:Priceblock" title="Template:Priceblock">Template:Priceblock</a> (<a href="/index.php?title=Template:Priceblock&amp;action=edit" title="Template:Priceblock">edit</a>) </li></ul>
</div>
	...
	<div id="p-cactions" class="portlet">
		...
		<div class="pBody">
			<ul>
				 ...
				 <li id="ca-edit" class="selected"><a href="/index.php?title=Medusa_Prototype&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Medusa_Prototype&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
...
<script>if ( window.mediaWiki ) {
	mediaWiki.config.set({"wgCanonicalNamespace": "", "wgCanonicalSpecialPageName": false, "wgNamespaceNumber": 0, "wgPageName": "Medusa_Prototype", "wgTitle": "Medusa Prototype", "wgAction": "edit", "wgArticleId": 91, "wgIsArticle": false, "wgUserName": null, "wgUserGroups": ["*"], "wgCurRevisionId": 6809, "wgCategories": [], "wgBreakFrames": true, "wgRestrictionEdit": [], "wgRestrictionMove": []});
}
</script>
<script>if ( window.mediaWiki ) {
...
</script><!-- Served in 0.338 secs. --></body></html>