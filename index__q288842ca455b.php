...
<head>
<meta charset="UTF-8" /><title>Editing Ammunition Factory (section) - X3 Wiki</title>
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Ammunition Factory (section)</span></h1>
...
<input type='hidden' value="20140830042506" name="wpStarttime" />
<input type='hidden' value="20140315191702" name="wpEdittime" />
...
This factory complements a [[Mass Driver Forge]] by creating and distributing [[Mass Driver Ammunition|ammunition]] for the [[Mass Driver]] weapon. It sells the ammunition in cases of 200 rounds each.

The products are created from [[Ore]] with the requisite addition of [[Energy Cells]] and the Argon or Split foodstuffs, as appropriate.
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Ammunition+Factory&amp;returntoquery=action%3Dedit%26section%3D1&amp;type=signup">Create account</a></li>
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Ammunition+Factory&amp;returntoquery=action%3Dedit%26section%3D1" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
