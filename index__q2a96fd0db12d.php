...
<head>
<meta charset="UTF-8" /><title>Editing Matter/Anti-Matter Launcher - X3 Wiki</title>
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Matter_Anti-Matter_Launcher skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Matter/Anti-Matter Launcher</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Matter/Anti-Matter_Launcher&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20160523030045" name="wpStarttime" />
<input type='hidden' value="20121211191029" name="wpEdittime" />
...
{{Infobox weapon
|weapon=Matter/Anti-Matter Launcher
|hulldam=3700
|shielddam=10000
|range=3.62
|rof= 72
...
{{Infobox close}}
==Overview==
The Matter/Anti-Matter Launcher, or MAML, is a [[Terran]] [[M6|corvette]] and [[M7|frigate]] weapon used against medium and heavy targets. It uses [[Matter/Anti-Matter Warhead]] Ammunition.
...
==Commentary==
The MAML does a large amount of hull damage, but is not as potent against shields. Nevertheless it is still a very powerful weapon, if somewhat limited in accuracy due to the tardy velocity of the warheads. Ammo boxes for this weapon last a long time. Their negligible energy drain and low RoF give [[Terran]]/[[ATF]] corvettes a great capacity for sustained firepower. As far as weapons for taking care heavier ships go, the MAML is the only real option for intermediate Terran ships, as their corvettes and frigates can only chose from these and [[Starburst Shockwave Cannon]]s as ideal main weapons for their class, and the shockwave cannons are only truly efficient in the anti-fighter role.
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Matter/Anti-Matter_Launcher" title="Matter/Anti-Matter Launcher" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Matter/Anti-Matter_Launcher&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Matter%2FAnti-Matter+Launcher&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Matter%2FAnti-Matter+Launcher&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
