...
<head>
<meta charset="UTF-8" /><title>Editing Shield Prod. Facility 25 MJ (section) - X3 Wiki</title>
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Shield_Prod_Facility_25_MJ skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Shield Prod. Facility 25 MJ (section)</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Shield_Prod._Facility_25_MJ&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20140830091350" name="wpStarttime" />
<input type='hidden' value="20140315025752" name="wpEdittime" />
...
| [[Paranid]] || [[Soja Husk]] || ||{{Priceblock|Friend of Priest King|3999312}}
|- style="{{attrColour/Split}}"
| [[Split]] || [[Rastar Oil]] || ||{{Priceblock|Distinguished Associate|3427980}}
|}
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Shield_Prod._Facility_25_MJ" title="Shield Prod. Facility 25 MJ" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a href="http://x3wiki.com/index.php/Shield_Prod._Facility_25_MJ">http://x3wiki.com/index.php/Shield_Prod._Facility_25_MJ</a>"</div>
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Shield_Prod._Facility_25_MJ&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Shield+Prod.+Facility+25+MJ&amp;returntoquery=action%3Dedit%26section%3D3&amp;type=signup">Create account</a></li>
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Shield+Prod.+Facility+25+MJ&amp;returntoquery=action%3Dedit%26section%3D3" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
