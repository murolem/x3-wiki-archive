...
<head>
<meta charset="UTF-8" /><title>Editing Spitfyre - X3 Wiki</title>
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Spitfyre skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Spitfyre</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Spitfyre&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20160501092950" name="wpStarttime" />
<input type='hidden' value="20131230165524" name="wpEdittime" />
...
|Faction=Terran
|Class={{M3class}}
|Priceblock={{Priceblock|Marshall of Mars| 2909601}}
|Minspeed=113.0
|Maxspeed=452.0
|Minaccel=22
|Maxaccel=88
...
It is so fast, that it can even chase down and often completely outrun [[M5]]s. Its only actual weakness, if there is one, is that the EEMPCs it mounts are slightly inferior to the regular [[EMPC]], which are still some of the best fighter weapons available. The energy recharge rates are so high that it can easily keep up a a continuous barrage of fire and can even eliminate [[M6]]s easily if it simply sits in their blind spots while firing at them.

Since it can also mount the [[M6|corvette]]-class [[PMAML]], this ship can also be equipped as a heavy hitter against larger targets.
...
== Availability ==
The Spitfyre is available at either of the two [[Aldrin Ship Production Base]]s in Aldrin orbit.
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Spitfyre" title="Spitfyre" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Spitfyre&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Spitfyre&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Spitfyre&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
