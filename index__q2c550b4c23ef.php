...
<h3> <span class="mw-headline" id="Chokaro">Chokaro</span></h3>
<p>The standard by which the Advanced Chokaro is measured.
</p>
<h3> <span class="mw-headline" id="Advanced_Chokaro">Advanced Chokaro</span></h3>
...
<div id="column-one">
	...
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Chokaro&amp;returntoquery=printable%3Dyes" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
...
<div id="footer">
	...
	<ul id="f-list">
		...
		<li id="viewcount">This page has been accessed 6,204 times.</li>
...
<script type="text/javascript" src="//geoiplookup.wikimedia.org/"></script><!-- Served in 0.565 secs. --></body></html>