...
<head>
<meta charset="UTF-8" /><title>Editing Thuruk's Pride - X3 Wiki</title>
...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Thuruk's_Pride","wgTitle":"Thuruk's Pride","wgCurRevisionId":15800,"wgRevisionId":0,"wgArticleId":796,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Thuruk's_Pride","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia"});
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Thuruk_s_Pride skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Thuruk's Pride</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Thuruk%27s_Pride&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20140717120622" name="wpStarttime" />
<input type='hidden' value="20140306130003" name="wpEdittime" />
...
|Race=Split
|SecLevel=Core
|Population=8,754,315
|Planets=3
|SunLevel=150
|GateDist=90
|Gates={{Gateblock/Begin}}
{{Gateblock2|North|0|	0|	45360|[[Family Zein]]}}
{{Gateblock2|East|45360|	0|	0|[[Family Pride]]}}
{{Gateblock2|South|0|	0|	-45360|[[Rhonkar's Fire]]}}
{{Gateblock/End}}
}}
==Description==
Thuruk's Pride produces a lot of the complex computers and hardware required by Split warships. Plentiful and cheap energy, and a variety of natural raw materials make this system a lucrative high-tech manufacturing center. [[Split]] and [[Paranid]] technology are combined in this sector to produce efficient and powerful beam weapons.
==Default [[Stations]]==
*[[Split Trading Port]]
...
{{Asteroid/Begin}}
{{Asteroid/Item|Silicon|10|10871|-6123|6365}}
{{Asteroid/End}}
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Thuruk%27s_Pride" title="Thuruk's Pride" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Thuruk%27s_Pride&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Thuruk%27s+Pride&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Thuruk%27s+Pride&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
