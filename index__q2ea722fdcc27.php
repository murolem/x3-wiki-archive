...
<head>
<meta charset="UTF-8" /><title>Editing Talk:Weapons - X3 Wiki</title>
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Talk:Weapons</span></h1>
...
<input type='hidden' value="20140717130621" name="wpStarttime" />
...
==Broken Page Codes==
I don't know if it's just weapons but all of the pages have broken code at the top.[[User:Sadron|Sadron]] 23:32, 22 January 2012 (CST)

== Missiles? ==
I know they are currently not on the page, but since they are also weapons, should there at least be a mention of them? Since it's clearly out of character for the current page, I thought I would ask here before making the change myself.
[[User:Korlus|&lt;font color="red">'''Korlus'''&lt;/font>]] - [[User talk:Korlus|&lt;sup>(talk)&lt;/sup>]] [[Special:contributions/Korlus|&lt;sub>(contribs)&lt;/sub>]] 10:46, 2 April 2013 (CDT)


== Extra Column? ==

I'm wondering about adding an extra column to the chart that lists what kind of weapon each weapon is (Beam, Bolt, Shockwave, Flak).
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Talk%3AWeapons&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Talk%3AWeapons&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
