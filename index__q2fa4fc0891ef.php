...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Cutlass&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="7" name="wpSection" />
<input type='hidden' value="20120823062212" name="wpStarttime" />
...
The Cutlass is a [[M1|carrier]] fighter par excellence. Its survivability and attack power mean it can defeat most foes, so if enough EMPCs can be gathered for a Cutlass wing, it makes for one of the top choices for AI controlled fighter, and among the most expensive.
...
<div id="column-one">
	...
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Cutlass&amp;returntoquery=action%3Dedit%26section%3D7" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
