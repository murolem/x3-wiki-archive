...
<head>
<meta charset="UTF-8" /><title>Editing Shark - X3 Wiki</title>
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Shark skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Shark</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Shark&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20160501065006" name="wpStarttime" />
<input type='hidden' value="20130930134954" name="wpEdittime" />
...
|Faction=Boron
|Class={{M1class}}
|Priceblock={{Priceblock|King's Knight| 61790791}}
|Minspeed=54.7
|Maxspeed=93
|Minaccel=5.47
|Maxaccel=9.3
...
&lt;/table>
|Dockbay={{Dockbay|45 [[M3+]]-[[M5]]}}
}}
{{Infobox close}}
==Overview==
The [[Boron]] [[M1]] is quite fast, with average shielding and firepower for its class. It is outclassed in most ways by the Argon [[Colossus]], which has a hangar of 60 ships with only a slight speed penalty.
==Background==
The Shark was developed to complement the [[Colossus|Argon Colossus]]. Both ships use similar technology, despite their aesthetic differences.

==Physical Characteristics==
Its hull design is extremely similar to the [[Ray]], but is slightly shorter. Its hangar is respectable but not outstanding, at around 45 ships. Like most [[Boron]] ships, the Shark has rather pleasing aesthetics compared to the capitals of other races which tend to be blocky, with the exception of the [[Paranid]] battleships, however each player has their own visual preferences.

== Combat ==
Its good all-round capabilities make it a capable battleship in its own right, though it cannot combat destroyers without a fighter wing. An [[Ion Cannon]] compatibility makes it able to rip through capital ship shielding like a hot knife through butter, though it still requires the [[Photon Pulse Cannon]] for finishing off the hull of the enemy ship.
...
Just about any Boron shipyard will sell the Shark.

== Suggested Roles==
Sharks are not usually considered the best in their class, and are not frequently used.
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Shark" title="Shark" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Shark&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Shark&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Shark&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
