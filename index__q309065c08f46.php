...
<head>
<meta charset="UTF-8"/>
<title>Editing Drone Production Facility - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Drone_Production_Facility","wgTitle":"Drone Production Facility","wgCurRevisionId":10310,"wgRevisionId":0,"wgArticleId":1493,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Drone_Production_Facility","wgRelevantArticleId":1493,"wgRequestId":"WYyltFkfZokAAGmN1UQAAAAL","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia","wgEditMessage":"editing"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Drone_Production_Facility rootpage-Drone_Production_Facility skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Drone Production Facility</h1>
...
<input type='hidden' value="20170810182804" name="wpStarttime" />
<input type='hidden' value="20121007234740" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="10310" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">__NOTOC__
{{Infobox open}}
{{Infobox factory
|faction=
|station=Drone Production Facility
|hull=
|shield=
|generator=
|hangar=
|cycle=00:00:00
|productnum=[[Fighter Drone]] ()&lt;bR>Second Product by Race
|stationprice=
|reqresources=[[Energy Cells]] ()&lt;br>[[Massom Powder]] ()&lt;br>[[Silicon Wafers]] ()
...
|- style="{{Colour/Argon}}"
| [[Argon]] || [[Fighter Drone MKII]] ()||{{Priceblock|Trusted Ally|2 898 204}}
|- style="{{Colour/Split}}"
| [[Split]] || [[Fighter Drone MKII]] () ||{{Priceblock|Distinguished Associate|3 035 320}}
|- style="{{Colour/Teladi}}"
| [[Teladi]] || [[Freight Drone]] () ||{{Priceblock|Majority Shareholder|2 617 732}}
|}
==Availability==
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Drone_Production_Facility" title="Drone Production Facility" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Drone_Production_Facility">http://www.x3wiki.com/index.php/Drone_Production_Facility</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Drone_Production_Facility&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Drone+Production+Facility&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Drone+Production+Facility&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
