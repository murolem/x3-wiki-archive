...
<form id="editform" name="editform" method="post" action="/index.php?title=Heavy_Hydra&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="1" name="wpSection" />
<input type='hidden' value="20110905045815" name="wpStarttime" />
...
The heavy Hydra is greatly improved over its predecessor, with massively superior generators which are on par with the Terran corvette ones. It has very good turret coverage, along with good speed and weapon compatibility, though poor manouverability and merely sufficient cargo space. The high cost - 25 million credits, almost twice as much as other heavy M6 craft - make this more a trophy piece than a practical combat ship.
...
<div id="column-one">
	...
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Heavy_Hydra&amp;returntoquery=action%3Dedit%26section%3D1" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
