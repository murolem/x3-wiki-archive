...
<form id="editform" name="editform" method="post" action="/index.php?title=Kraken&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="4" name="wpSection" />
<input type='hidden' value="20110104115833" name="wpStarttime" />
...
The Kraken fights from across the sector; like all [[M7M]]s it has relatively weak shielding and won't last too long if an enemy [[capital ship]] gets close to it. However, getting close to any M7M is a difficult proposition for any ship.
	...
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Kraken&amp;returntoquery=action%3Dedit%26section%3D4" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
...
<!-- Served in 0.263 secs. --><script type="text/javascript">
