...
<head>
<meta charset="UTF-8" />
<title>Editing Kha'ak Fighter (section) - X3 Wiki</title>
...
<div id="column-content"><div id="content">
	...
	<h1 id="firstHeading" class="firstHeading">Editing Kha'ak Fighter (section)</h1>
	<div id="bodyContent">
...
<form id="editform" name="editform" method="post" action="/index.php?title=Kha%27ak_Fighter&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="1" name="wpSection" />
<input type='hidden' value="20111016094754" name="wpStarttime" />
<input type='hidden' value="20110808040200" name="wpEdittime" />
...
A fearsome craft in previous games, the Khaak fighter is now little more than an unusual foe. Unless it appears in swarms, this ship's three beam weapons do not deal enough damage to be of use outside of its swarms. In swarms, such as a decoupled Kha'ak Cluster, these craft provide a deadly centrepoint for the swarm. It is of average to good speed, with typical shielding and poor cargo capacity. Its main danger (or attraction, if you can capture one) is that it rarely, if ever, misses. Inexperienced players can be killed quickly without being given a chance by this ship's accuracy. Alone, a low threat. In a group, deadly.
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='editHelp'><a href="/index.php/Kha%27ak_Fighter" title="Kha'ak Fighter" id="mw-editform-cancel">Cancel</a> | <a target="helpwindow" href="/index.php/Help:Editing">Editing help</a> (opens in new window)</span>
</div><!-- editButtons -->
</div><!-- editOptions -->
...
<div id="column-one">
	...
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Kha%27ak_Fighter&amp;returntoquery=action%3Dedit%26section%3D1" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
...
<script>if ( window.mediaWiki ) {
	mediaWiki.config.set({"wgCanonicalNamespace": "", "wgCanonicalSpecialPageName": false, "wgNamespaceNumber": 0, "wgPageName": "Kha\'ak_Fighter", "wgTitle": "Kha\'ak Fighter", "wgAction": "edit", "wgArticleId": 290, "wgIsArticle": false, "wgUserName": null, "wgUserGroups": ["*"], "wgCurRevisionId": 6854, "wgCategories": [], "wgBreakFrames": true, "wgRestrictionEdit": [], "wgRestrictionMove": []});
}
</script>
<script>if ( window.mediaWiki ) {
