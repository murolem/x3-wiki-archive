...
<head>
<meta charset="UTF-8" /><title>Editing Ion Cannon - X3 Wiki</title>
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Ion_Cannon skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Ion Cannon</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Ion_Cannon&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20160514130300" name="wpStarttime" />
<input type='hidden' value="20140903005805" name="wpEdittime" />
...
{{Infobox close}}
==Overview==
The Ion Cannon, sometimes abbreviated to IC, is a [[Boron]] capital ship weapon that does minimal hull damage but massive damage to shields and causes many other side-effects.

==Encyclopedia Entry==
A deadly weapon found on frigates, destroyers and carriers. Upscaling IPG technology and taking advantage of the massive energy available to capital ships, the Ion Cannon is the pinnacle of Boron ion weaponry. A huge amount of ion energy is concentrated into a single projectile and can disrupt a target ship's systems, such as engines and weapons, in addition to causing a large reduction in shield energy.

==Commentary==
An unusual capital weapon with the highest shield damage rate in the game, the Ion Cannon deals a large variety of hidden effects, such as energy draining, high chance of equipment damage, speed reduction and suchlike. Its effectiveness against hulls is poor, leading it to be used in conjunction with the [[Gauss Cannon]] to cause massive damage on both sides of enemy defence.
...
*[[Thresher]] (M7, Boron)
*[[Phoenix]] (M2, Teladi)
*[[Boreas]] (M2, OTAS/Argon)
*[[Truelight Seeker]] (M6, Gon/Argon)
*[[Megalodon]] (M2, Boron)
*[[Brigantine]] (M2, Pirates)
*[[Akuma]] (M2, Yaki)

==Available at Known Docks==
Boron Equipment Dock - Queens Retribution
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Ion_Cannon" title="Ion Cannon" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a href="http://x3wiki.com/index.php/Ion_Cannon">http://x3wiki.com/index.php/Ion_Cannon</a>"</div>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Ion_Cannon&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Ion+Cannon&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Ion+Cannon&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
