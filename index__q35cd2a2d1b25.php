...
<head>
<title>Editing Panther (section) - X3 Wiki</title>
<meta charset="UTF-8" />
...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Panther","wgTitle":"Panther","wgCurRevisionId":9515,"wgArticleId":663,"wgIsArticle":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgRelevantPageName":"Panther","wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia"});
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Panther skin-monobook action-edit">
<div id="fb-root"></div>
...
//]]>--></script>
	...
	<h1 id="firstHeading" class="firstHeading"><span dir="auto">Editing Panther (section)</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Panther&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="2" name="wpSection" />
<input type='hidden' value="20120812045045" name="wpStarttime" />
<input type='hidden' value="20120725183736" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d22c56ad5cf0a57cfc284ad6d0184961" name="wpAutoSummary" /><input type="hidden" value="0" name="oldid" /><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">==Background==
...
Split engineers recognized a huge gap in the tactical doctrine of all the other races, where {{M7class}}s were designed as pocket destroyers used to support the main battleships and carriers, or lead {{M6class}}s.  With this they would have strong yet limited solo patrol capabilities. The [[Argon]], [[Paranid]] and [[Teladi]] included small fighter wings but did not push this theory any further other than a compromise in design. 

However with typical Split thinking of ''"strike first, strike fast, strike hard and don't get hit,"'' they embarked on one of the most successful M7 designs of the modern time:  they built a ship which filled every possible spare hull space with weapons, shields, generators and a huge hanger bay for 32 [[:Category:Fighters|Fighter class]] ships (20 in AP), about five times as many as most other M7s. All other non-combat functions, especially crew and pilot quarters, mess hall, medical bay, etc. were sacrificed. With the ability to mass-produce pocket carriers capable of jumping an overwhelming force of fighters to any target, and combined with its impressive fighter-less sister design, the Tiger, the Split are the dominant player in M7 class combat.       
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='editHelp'><a href="/index.php/Panther" title="Panther" id="mw-editform-cancel">Cancel</a> | <a target="helpwindow" href="/index.php/Help:Editing">Editing help</a> (opens in new window)</span>
</div><!-- editButtons -->
</div><!-- editOptions -->
...
Retrieved from "<a href="http://www.x3wiki.com/index.php/Panther">http://www.x3wiki.com/index.php/Panther</a>"</div>
...
<div id="column-one">
	<div id="p-cactions" class="portlet">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Panther&amp;action=edit" primary="1" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Panther&amp;returntoquery=action%3Dedit%26section%3D2" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
