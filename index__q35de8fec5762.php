...
<head>
<meta charset="UTF-8" /><title>Editing Geochen - X3 Wiki</title>
...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Geochen","wgTitle":"Geochen","wgCurRevisionId":15624,"wgRevisionId":0,"wgArticleId":1788,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Geochen","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia"});
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Geochen skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Geochen</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Geochen&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20160514073302" name="wpStarttime" />
<input type='hidden' value="20140304180056" name="wpEdittime" />
...
|Faction=Teladi
|Class={{TPclass}}
|Priceblock={{Priceblock|Company Manager|1460659}}
|Minspeed=74
|Maxspeed=148
|Minaccel=4
|Maxaccel=8
...
{{Infobox close}}
==Overview==
The Geochen is a Teladi TP ship introduced in Albion Prelude.

==Background==
The Geochen is an unusual ship; a luxury liner designed by a race with very little sense for aesthetics or luxury in general. The design and controls were modified for non-Teladi pilots, as even the manufacturers of the Geochen realized that the ship would have little marketability among the Teladi themselves. Even so, the ship is still built on the tried and tested basic Teladi principles of high shielding and relatively low speed. The huge cargo bay is another bonus, allowing it to hold months' worth of provisions for solitary exile voyages.

==Physical Characteristics==
The Geochen looks like a scaled-down Albatross. Like other Teladi ships, it looks like it was cobbled together from spare parts.
== Combat ==
The Geochen is surprisingly dangerous for a TP.  Though its laser generator is weak, it is capable of mounting the energy-efficient [[Energy Bolt Chaingun]] in three of its slots, and can use the deadly [[Plasma Burst Generator]] in its main cannon.
== Equipment ==
'''Built-In Equipment'''
...
|-
! style="text-align:left;" |Geochen || x || || || || ||
|}

== Suggested Roles==
[[Marine]] storage or Passenger Transport missions.
== See Also==
{{TP}}
{{TPcategory}}
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Geochen" title="Geochen" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Geochen&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Geochen&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Geochen&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
