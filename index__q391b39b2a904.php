...
<head>
<meta charset="UTF-8" /><title>Editing Talk:Weapons (section) - X3 Wiki</title>
...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"Talk","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":1,"wgPageName":"Talk:Weapons","wgTitle":"Weapons","wgCurRevisionId":12898,"wgRevisionId":0,"wgArticleId":173,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Talk:Weapons","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia"});
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Talk:Weapons (section)</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Talk:Weapons&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20140829193607" name="wpStarttime" />
<input type='hidden' value="20130628180607" name="wpEdittime" />
...
&lt;/pre>
[[User:Madned|Madned]] 21:31, 24 June 2010 (UTC)
----
from faq: {{linky}}www.egosoft.com/support/faq/faq_answer_en.php?answer=932&amp;version=9&amp;sid=93885ee3971de23179e95efa0b6dea17

The following weapons require ammunition:
Energy Bolt Chaingun	- Energy Bolt Chaingun Ammunition	(1S cargo per unit)

Gauss Cannon	- Gauss Cannon Ammunition	(25L cargo per unit)

(Prototype) Matter/Anti-Matter Launcher	- Matter/Anti-matter Warhead	(4S cargo per unit)

Mass Driver	- Mass Driver Ammunition	(1S cargo per unit)

One unit of ammunition provides 200 rounds, and is automatically removed from your cargo bay when your guns need loading.

Note that if you have multiple guns firing then ammunition will be used up more quickly, e.g. if you have 8 Gauss Cannons firing together they will get 25 shots each from a single unit of ammunition.
[[User:Madned|Madned]] 01:02, 5 August 2010 (UTC)
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Talk:Weapons" title="Talk:Weapons" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected istalk"><a href="/index.php?title=Talk:Weapons&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Talk%3AWeapons&amp;returntoquery=action%3Dedit%26section%3D1&amp;type=signup">Create account</a></li>
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Talk%3AWeapons&amp;returntoquery=action%3Dedit%26section%3D1" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
