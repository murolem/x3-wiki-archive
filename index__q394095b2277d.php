...
<input name="wpCreateaccountToken" type="hidden" value="fbb886f3f9f8fca48010916900aed25159a950f1+\"/>
...
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Special:CreateAccount">http://www.x3wiki.com/index.php/Special:CreateAccount</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				<ul>
				<li id="ca-nstab-special" class="selected"><a href="/index.php?title=Special:CreateAccount&amp;returnto=%C2%AE%C2%AE%C2%AE%C2%AE%C2%AEUSA+1,866,866,1752;;;;;;;;Sbcglobal+email+Customer+support+number." title="This is a special page, and it cannot be edited">Special page</a></li>
				</ul>
							</div>
		</div>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount" class="active"><a href="/index.php?title=Special:CreateAccount&amp;returnto=%C2%AE%C2%AE%C2%AE%C2%AE%C2%AEUSA+1%2C866%2C866%2C1752%3B%3B%3B%3B%3B%3B%3B%3BSbcglobal+email+Customer+support+number." title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=%C2%AE%C2%AE%C2%AE%C2%AE%C2%AEUSA+1%2C866%2C866%2C1752%3B%3B%3B%3B%3B%3B%3B%3BSbcglobal+email+Customer+support+number." title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
		...
		<div class='pBody'>
			...
			<div class="pBody">
				<ul>
											...
											<li id="t-print"><a href="/index.php?title=Special:CreateAccount&amp;returnto=%C2%AE%C2%AE%C2%AE%C2%AE%C2%AEUSA+1%2C866%2C866%2C1752%3B%3B%3B%3B%3B%3B%3B%3BSbcglobal+email+Customer+support+number.&amp;printable=yes" rel="alternate" title="Printable version of this page [p]" accesskey="p">Printable version</a></li>
									</ul>
							</div>
		</div>
