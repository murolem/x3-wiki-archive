...
<head>
<meta charset="UTF-8"/>
<title>Editing Wares - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Wares","wgTitle":"Wares","wgCurRevisionId":15512,"wgRevisionId":0,"wgArticleId":209,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Wares","wgRelevantArticleId":209,"wgRequestId":"WS31D1kfZokAAFuUBAcAAAAF","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia","wgEditMessage":"editing"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Wares rootpage-Wares skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Wares</h1>
...
<p><strong>Warning:</strong> You are not logged in. Your IP address will be publicly visible if you make any edits. If you <strong><a class="external text" href="http://www.x3wiki.com/index.php?title=Special:UserLogin&amp;returnto=Wares">log in</a></strong> or <strong><a class="external text" href="http://www.x3wiki.com/index.php?title=Special:CreateAccount&amp;returnto=Wares">create an account</a></strong>, your edits will be attributed to your username, along with other benefits.
</p>
</div>
<div id="wikiPreview" class="ontop" style="display: none;"><div lang="en" dir="ltr" class="mw-content-ltr"></div></div><form id="editform" name="editform" method="post" action="/index.php?title=Wares&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntispam">Anti-spam check.
...
<input type='hidden' value="20170530224119" name="wpStarttime" />
<input type='hidden' value="20140303211449" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="15512" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">Wares are the raw and manufactured goods of the X universe.

Everything in space is a ware and generally occupies space.&lt;br>
There are two properties of cargo:
* [[Cargo Class]]: which describes general dimensions limiting carriage on certain transports. 
* Volume: a numerical description of space limiting carriage to vessels which have enough total free space.

==Types of Wares==
===Ship Equipment===
====Tactical Equipment====
The following wares are offensive and defensive shipboard equipment and have their cargo information listed with their technical specs:
*[[Missiles]]
*[[Weapons]]
*[[Shields]]

====Other Equipment====
The following wares are shipboard equipment that have special functions aboard ship:
*[[Bioscanner]]
...
====Software====
There are also several software upgrades available which do not take up cargo space, but have unique functions aboard ship:
*[[Best Buys Locator]]
...
====Police Licenses====
The [[Commonwealth]] governments offer [[police license]]s, which award bounties against faction enemies.  Factions with whom the player is so licensed are noted with an &lt;nowiki>[L]&lt;/nowiki> marking next to their [[Reputation|notoriety]] listing in the "Pilot Status" dialog. Additionally, you may scan ships in that races sector legally. (It’s not considered an aggressive act. This will turn the ships to enemy red if you find illegal goods aboard which can be destroyed with no reputation loss.)

For reasons unknown, the [[Terran]]s do not offer a similar license.

===Ship Upgrades===
These upgrades increase a ship's general performance.
*[[Engine Tuning]]
*[[Cargo Bay Extension]]
*[[Rudder Optimisation]]

===Other Wares===
These wares are simply trade goods.
...
|
=====[[List of Miscellaneous Wares|Natural]]=====
*Cartography Chips
*Cleaning Robots
*Container 
*Debris
...
*[[Warheads]]
=====Ammunition=====
*[[Energy Bolt Chaingun Ammunition]]
*[[Gauss Cannon Ammunition]]
*[[Mass Driver Ammunition]]
*[[Matter/Anti-Matter Warhead]]
|-
| colspan="6"|

=====Special Objects=====
Special Objects exist independently in space, many of them are sold aboard stations, some (like Jumpgates and Trans-Orbital Accelerators) exist only in space.
...
==Illegal Wares==
{{See also|Illegal Wares by Faction}}

Depending on whose space you're in, different wares are illegal and will cause authorities to attempt to confiscate them. Refusal to eject the illegal ware will result in weapons fire.
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Wares" title="Wares" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<li><a href="/index.php/Illegal_Wares_by_Faction" title="Illegal Wares by Faction">Illegal Wares by Faction</a> (<a href="/index.php?title=Illegal_Wares_by_Faction&amp;action=edit" title="Illegal Wares by Faction">edit</a>) </li><li><a href="/index.php/Template:See_also" title="Template:See also">Template:See also</a> (<a href="/index.php?title=Template:See_also&amp;action=edit" title="Template:See also">edit</a>) </li><li><a href="/index.php/Template:Trading" title="Template:Trading">Template:Trading</a> (<a href="/index.php?title=Template:Trading&amp;action=edit" title="Template:Trading">edit</a>) </li></ul></div><div class="hiddencats"></div><div class="limitreport"></div><input type="hidden" value="1" name="wpUltimateParam"/>
</form>
</div><div class="printfooter">
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Wares">http://www.x3wiki.com/index.php/Wares</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Wares&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Wares&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Wares&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
