...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Sun_Oil_Refinery rootpage-Sun_Oil_Refinery skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Sun Oil Refinery</h1>
...
<input type='hidden' value="20171005192037" name="wpStarttime" />
<input type='hidden' value="20150304165207" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="16656" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">__NOTOC__
{{Infobox open}}
{{Infobox factory
|faction=Teladi
|station=Sun Oil Refinery L
|hull=2,000,000
|shield=15
|generator=1500
|hangar=10
|cycle=00:01:00
|productnum=[[Nostrop Oil]] (50)
|stationprice={{Priceblock|Teladi Majority Shareholder|2125024}}
|reqresources=[[Energy Cells]] (75)&lt;br>[[Sunrise Flowers]] (75)&lt;br>
|optresources=[[Stott Spices]]&lt;br>[[Swamp Plant]]
}}
{{Infobox factory
|faction=Teladi
|station=Sun Oil Refinery M
|hull=800,000
|shield=10
|generator=1500
|hangar=5
|cycle=00:01:00
|productnum=[[Nostrop Oil]] (20)
|stationprice={{Priceblock|Teladi Majority Shareholder|849984}}
|reqresources=[[Energy Cells]] (30)&lt;br>[[Sunrise Flowers]] (30)&lt;br>
|optresources=[[Stott Spices]]&lt;br>[[Swamp Plant]]
}}
{{Infobox close}}
==Overview==
Sun Oil Refineries are Teladi factories that produce [[Nostrop Oil]] from [[Energy Cells]] and [[Sunrise Flowers]]. 

NPC stations will buy [[Stott Spices]] and [[Swamp Plant]] as secondary resources.

===Encyclopedia Entry===
A Teladian Sun Oil Refinery is the place where the flower heads of the Teladian Sunrise Flower are pressed and then process to produce the crude oil known as Nostrop. 

In addition to requiring a constant supply of Teladian Sunrise Flowers these refineries also require BoGas every now and then.
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Sun_Oil_Refinery" title="Sun Oil Refinery" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Sun_Oil_Refinery">http://www.x3wiki.com/index.php/Sun_Oil_Refinery</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Sun_Oil_Refinery&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Sun+Oil+Refinery&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Sun+Oil+Refinery&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
