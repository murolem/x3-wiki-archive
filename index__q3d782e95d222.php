...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Albatross&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="7" name="wpSection" />
<input type='hidden' value="20120823061701" name="wpStarttime" />
...
Because of its massive size and relitivley low defensive capabilities, the Albatross should never be brought into a battle. However, its large hanger bay and cargo space can support a small to medium sized fleet outside sector limits. It can also be used as a mobile supply depot, allowing entrepenurs to transport and store ships, goods and equipment.
...
<div id="column-one">
	...
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Albatross&amp;returntoquery=action%3Dedit%26section%3D7" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
