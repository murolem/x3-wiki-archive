...
<head>
<meta charset="UTF-8"/>
<title>Editing N - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"N","wgTitle":"N","wgCurRevisionId":11913,"wgRevisionId":0,"wgArticleId":595,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"N","wgRelevantArticleId":595,"wgRequestId":"WPKWnlkfZokAABQKlvQAAAAS","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia","wgEditMessage":"editing"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-N rootpage-N skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing N</h1>
...
<p><strong>Warning:</strong> You are not logged in. Your IP address will be publicly visible if you make any edits. If you <strong><a class="external text" href="http://x3wiki.com/index.php?title=Special:UserLogin&amp;returnto=N">log in</a></strong> or <strong><a class="external text" href="http://x3wiki.com/index.php?title=Special:CreateAccount&amp;returnto=N">create an account</a></strong>, your edits will be attributed to your username, along with other benefits.
</p>
</div>
<div id="wikiPreview" class="ontop" style="display: none;"><div lang="en" dir="ltr" class="mw-content-ltr"></div></div><form id="editform" name="editform" method="post" action="/index.php?title=N&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntispam">Anti-spam check.
...
<input type='hidden' value="20170415215438" name="wpStarttime" />
<input type='hidden' value="20130407043648" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="11913" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{Infobox open}}
{{Infobox variant
|Variant=N
|Faction=Xenon
|Class={{M5class}}
...
{{Infobox close}}
==Overview==
A dangerous M5 to combat due to its tendency to appear in swarms with other [[Xenon]] craft. It packs [[Particle Accelerator Cannon]]s, which are a powerful weapon against most foes.

==Background==
The N is considered to be a short-range scout ship of the Xenon. It is only lightly armed but very fast. A forerunner of this ship fought in the Xenon conflict, but its participation was not considered to be great.

==Physical Characteristics==
== Combat ==
As M5s go the N packs a punch. However, turn the gun on it and you also find that it gets vaporised by a clip round the ear. Not an effective combat vessel on its own, and serves little more than to distract patrol ships from the real threats in [[Xenon]] task forces. Certain missiles like the [[Rapier Missile|Rapier]], [[Wasp Missile|Wasp]], [[Disruptor Missile|Disruptor]], and the [[Hurricane Missile|Hurricane]] can make short work of an N in no time.
...
|}
== Availability ==
As with all [[Xenon]] ships, the N must be [[capping|capped]] to be used.
...
! Ware !! Amount
|- valign="top"
|[[Energy Cells]]||{{formatnum:32}}
|-
|[[Teladianium]]||{{formatnum:1}}
|-
|[[Cloth Rimes]]||0
|-
|[[Rastar Oil]]||0
...
|[[Ore]]||{{formatnum:1}}
|-
|[[Silicon|Silicon Wafers]]||{{formatnum:1}}
|-
|[[Crystals]]||1
|-
|[[Quantum Tubes]]||0
...
|-
|Shipwright Fee ([[Credits]])|| {{formatnum:9609}}
|-
|Build Time (game time)&lt;bR>(hh:mm:ss)||	00:02:53
|}
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/N" title="N" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://x3wiki.com/index.php/N">http://x3wiki.com/index.php/N</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=N&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=N&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=N&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
