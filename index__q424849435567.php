...
<head>
<meta charset="UTF-8" /><title>Editing Teladi - X3 Wiki</title>
...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Teladi","wgTitle":"Teladi","wgCurRevisionId":16778,"wgRevisionId":0,"wgArticleId":189,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Teladi","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia"});
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Teladi skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Teladi</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Teladi&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20160428052227" name="wpStarttime" />
<input type='hidden' value="20151207010644" name="wpEdittime" />
...
|Ranks= {{Rank List|Company Director
|Venture Capitalist
|Venture Profiteer
|Company Owner
|Company Manager
...
===Ships===
The Teladi are far more interested in trade than in developing new technologies. For that reason, their ships and stations use the outdated technologies that they've traded with the other races for. Because of their preference for trading, their ships often feature large cargo bays for their class. The [[Kestrel]] is perhaps the only Teladi ship with any sort of extraordinary capability, with its high speed. Teladi capital ships make extensive use of [[Gauss Cannon]]s, which is their principal capital-to-capital weapon. Overall, Teladi ships are below average to poor performance-wise, notable for having low speeds and poor firepower, although they have rather good shielding. They are often more expensive than average (though not so much, and there are a few exceptions) for ships in their class as well. For these reasons, Teladi ships are not popular with players. They do have a niche application that does not make them wholly ineffective in combat, however: their larger-than-normal cargo bays make them excellent for [[Missiles|missile]] barrages, and it is not uncommon for certain ships like the [[Falcon|Falcon Hauler]] and the [[Shrike]] to be stuffed with huge numbers of missiles, such as the [[Tornado Missile|Tornado]] and the [[Typhoon Missile|Typhoon]], two of the most effective missiles to strengthen the Teladi arsenal.

*[[Condor|M1 Teladi Condor]]
*[[Phoenix|M2 Teladi Phoenix]]
*[[Falcon|M3 Teladi Falcon]]
*[[Kea|M3+ Teladi Kea]]
*[[Buzzard|M4 Teladi Buzzard]]
*[[Kite|M4+ Teladi Kite]]
*[[Harrier|M5 Teladi Harrier]]
*[[Kestrel|M5 Teladi Kestrel]]
*[[Osprey|M6 Teladi Osprey]]
*[[Heavy_Osprey|M6+ Teladi Heavy Osprey]]
*[[Shrike|M7 Teladi Shrike]]
*[[Gannet|M7M Teladi Gannet]]
*[[Peregrine|M8 Teladi Peregrine]]
*[[Albatross|TL Teladi Albatross]]
*[[Vulture|TS Teladi Vulture]]
*[[Toucan|TP Teladi Toucan]]
*[[Pelican|TM Teladi Pelican]]
Albion Prelude Ships
*[[Cormorant|M7C Teladi Cormorant]]
*[[Tern|TS+ Teladi Tern]]
*[[Geochen|TP Teladi Geochen]]

===Stations===
====Shipyards====
Teladi Shipyards are known as [[Teladi Shipyard]]s and are known to exist in the following sectors:
*[[Seizewell]]
*[[Ceo's Sprite]] (super)
*[[PTNI Headquarters]]
*[[Ianamus Zura]]
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Teladi" title="Teladi" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Teladi&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Teladi&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Teladi&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
