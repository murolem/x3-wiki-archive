...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Rolk_s_Drift rootpage-Rolk_s_Drift skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Rolk's Drift</h1>
...
<input type='hidden' value="20170424234234" name="wpStarttime" />
<input type='hidden' value="20140306093458" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="15703" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{Infobox Sector
|Race=Boron
|SecLevel=Core
|Population=88,000,041
|Planets= 3
|SunLevel=150
|GateDist= 50
...
{{Gateblock2|East|24740|	0|	0|[[Queen's Space]]}}
{{Gateblock2|West|-29740|	0|	-1000|[[Kingdom End]]}}
&lt;/table>
}}
==Description==
The Boron produce high quality electronics and semi-organic computer systems as well as more conventional goods in this large and crowded sector. The supporting factories produce a wealth of raw materials for the local and export markets.
==Default [[Stations]]==
==[[Asteroids]]==

{{Asteroid/Begin}}
{{Asteroid/Item|Ore|8|-21983|7417|-4621}}
{{Asteroid/Item|Ore|8|-16191|4364|-9109}}
{{Asteroid/Item|Ore|10|-25714|5677|6663}}
{{Asteroid/Item|Ore|5|-24116|-3618|-13378}}
{{Asteroid/Item|Ore|4|-19544|3167|3696}}
{{Asteroid/End}}
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Rolk%27s_Drift" title="Rolk's Drift" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://x3wiki.com/index.php/Rolk%27s_Drift">http://x3wiki.com/index.php/Rolk%27s_Drift</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Rolk%27s_Drift&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Rolk%27s+Drift&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Rolk%27s+Drift&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
