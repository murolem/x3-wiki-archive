...
<head>
<meta charset="UTF-8"/>
<title>Editing Mobile Mining - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Mobile_Mining","wgTitle":"Mobile Mining","wgCurRevisionId":13441,"wgRevisionId":0,"wgArticleId":1112,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Mobile_Mining","wgRelevantArticleId":1112,"wgRequestId":"WXPjeFkfZokAAGoFuvoAAAAA","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia","wgEditMessage":"editing"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Mobile_Mining rootpage-Mobile_Mining skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Mobile Mining</h1>
...
<input type='hidden' value="20170722234456" name="wpStarttime" />
<input type='hidden' value="20130810012056" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="13441" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">Mobile Mining is the process of reducing a mineral bearing asteroid to small pieces and collecting them with a ship. 
...
Smaller asteroids can be broken down using standard ship lasers. Weapons with wide areas of effect are very efficient for this task, [[PSG]]s will shatter a large swathe of rocks, it will however occasionally vaporize pebbles caught in the area of effect. Customarily, a [[Mobile Drilling System]] is used to break up asteroids into collectible pebbles.

When breaking up super-asteroids, a heavy weapon must be used; [[Hornet Missile]]s were once very popular for this application, otherwise a Mobile Drilling System may also be used.
...
Having reduced a field to pebbles, ships equipped with Ore Collectors may collect them and store them in their cargo bay as [[Ore]], [[Silicon|Silicon Wafers]], [[Ice]], and [[Nividium]].
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Mobile_Mining" title="Mobile Mining" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<li><a href="/index.php/Template:Trading" title="Template:Trading">Template:Trading</a> (<a href="/index.php?title=Template:Trading&amp;action=edit" title="Template:Trading">edit</a>) </li></ul></div><div class="hiddencats"></div><div class="limitreport"></div><input type="hidden" value="1" name="wpUltimateParam"/>
</form>
...
Retrieved from "<a dir="ltr" href="http://x3wiki.com/index.php/Mobile_Mining">http://x3wiki.com/index.php/Mobile_Mining</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Mobile_Mining&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Mobile+Mining&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Mobile+Mining&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
