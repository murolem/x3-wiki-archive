...
<head>
<meta charset="UTF-8"/>
<title>Editing Missiles (section) - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Missiles","wgTitle":"Missiles","wgCurRevisionId":14668,"wgRevisionId":0,"wgArticleId":25,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Missiles","wgRelevantArticleId":25,"wgRequestId":"WXYNalkfZokAABpZ92UAAAAP","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia","wgEditMessage":"editingsection"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Missiles rootpage-Missiles skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Missiles (section)</h1>
...
<p><strong>Warning:</strong> You are not logged in. Your IP address will be publicly visible if you make any edits. If you <strong><a class="external text" href="http://x3wiki.com/index.php?title=Special:UserLogin&amp;returnto=Missiles">log in</a></strong> or <strong><a class="external text" href="http://x3wiki.com/index.php?title=Special:CreateAccount&amp;returnto=Missiles">create an account</a></strong>, your edits will be attributed to your username, along with other benefits.
</p>
</div>
<div id="wikiPreview" class="ontop" style="display: none;"><div lang="en" dir="ltr" class="mw-content-ltr"></div></div><form id="editform" name="editform" method="post" action="/index.php?title=Missiles&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntispam">Anti-spam check.
...
<input type='hidden' value="20170724150826" name="wpStarttime" />
<input type='hidden' value="20140225101928" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="db4a97e464b64811ffe035ac8a68bfdf" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="14668" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">==Overview==
...
This means missiles have a large role in [[Combat#Combat_strategy|combat strategy]], as it gives weaker ships a chance to kill stronger ships, if they are willing to sacrifice money or rare loot, or simply have the [[Stations|missile complexes]] to buy victory.

[[Boarding pods]] are a "missile" which delivers marines from the firing ship to the target.

Attack missiles have a variety of properties.&lt;bR>
'''Damage yield''' is the amount of damage inflicted on targets within the '''Area of Effect'''.&lt;br>
'''Range''' describes how far the missile can travel, generally you want to launch at targets well within range to compensate for target movement.&lt;br>
'''Speed''' describes how quickly it moves towards a target.&lt;br>
'''Cooldown''' describes how much time the launcher takes between firings to prepare the next launch.&lt;br>
'''Seeker''' determines how the missile acquires targets and when it may be fired: '''Targetted''', requiring a target prior to launch or '''Autonomous''' which relies on the missile's onboard systems.&lt;br>
'''Swarming''' refers simply to missiles which release multiple warheads. There are always eight '''warheads''' released. Note: warhead behavior is detailed in other columns such as dumbfire, heat-seeking, etc.&lt;br>
'''Guidance''' determines how a missile tracks and follows targets: '''Heat seeking''' missiles will attempt to attack the nearest warm target, '''Image Recognition''' or '''Standard Guidance''' will follow a specific target primarily based on its appearance, '''Dumb-fire''' have no guidance at all and will travel in direction of launch without maneuvering relying on the pilot's intuition of target movement.&lt;br>
'''Fusing''' controls detonation, most missiles detonate when they '''impact''' a target. '''Proximity fusing''' will detonate when the missiles gets close enough to the target, generally once it's already missed impact and is getting farther away. A few missiles may be '''Manually Triggered''' to detonate remotely, also known as '''synaptic triggering'''.&lt;br>
Some missiles have extremely powerful detonations which affect large areas the size of this influence is noted by '''Area of Effect'''.&lt;br>
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Missiles" title="Missiles" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://x3wiki.com/index.php/Missiles">http://x3wiki.com/index.php/Missiles</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Missiles&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Missiles&amp;returntoquery=action%3Dedit%26section%3D1" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Missiles&amp;returntoquery=action%3Dedit%26section%3D1" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
