...
<head>
<meta charset="UTF-8" /><title>Editing Shuri - X3 Wiki</title>
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Shuri skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Shuri</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Shuri&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20160501133707" name="wpStarttime" />
<input type='hidden' value="20140318143821" name="wpEdittime" />
...
{{Infobox close}}
==Overview==
No one knows how the Yaki obtained plans for the [[Colossus|Argon Colossus]], but the Shuri appears to be an identical copy of that Argon warship.

==Background==
===Encyclopedia Entry===
Using the Shuri as a command center and base of operations, the Yaki are now in a postion to project their burgeoning power well beyond their frontiers.

==Physical Characteristics==
The Shuri is visually identical to the Colossus, with the same vaguely cuboid features.

== Combat ==
Like all [[M1]]s, the Shuri can defend itself reasonably, but not against [[M2]]. The Shuri can hold its own against aggressive [[M7]]s thanks to its 12 capital-level weapon slots on its side and rear turrets, but it should rely on its fighter wing for protection.
...
|}
== Availability ==
The Shuri is not available for purchase, but one can often be found patrolling [[Weaver's Tempest]] in Albion Prelude.
== Suggested Roles==
As with the Colossus, the Shuri is an excellent flagship for any fleet, offering good speed, good shielding, a large docking port and plenty of cargo space to resupply its fighters.
== See Also==
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Shuri" title="Shuri" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Shuri&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Shuri&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Shuri&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
