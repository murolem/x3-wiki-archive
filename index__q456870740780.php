...
<head>
<meta charset="UTF-8"/>
<title>Editing PX - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"PX","wgTitle":"PX","wgCurRevisionId":16356,"wgRevisionId":0,"wgArticleId":1850,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"PX","wgRelevantArticleId":1850,"wgRequestId":"Wi0FiFkfZokAAG7i7KgAAAAI","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia","wgEditMessage":"editing"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-PX rootpage-PX skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing PX</h1>
...
<p><strong>Warning:</strong> You are not logged in. Your IP address will be publicly visible if you make any edits. If you <strong><a class="external text" href="http://www.x3wiki.com/index.php?title=Special:UserLogin&amp;returnto=PX">log in</a></strong> or <strong><a class="external text" href="http://www.x3wiki.com/index.php?title=Special:CreateAccount&amp;returnto=PX">create an account</a></strong>, your edits will be attributed to your username, along with other benefits.
</p>
</div>
<div id="wikiPreview" class="ontop" style="display: none;"><div lang="en" dir="ltr" class="mw-content-ltr"></div></div><form id="editform" name="editform" method="post" action="/index.php?title=PX&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntispam">Anti-spam check.
...
<input type='hidden' value="20171210095936" name="wpStarttime" />
<input type='hidden' value="20140726215347" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="16356" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{Infobox open}}
{{Infobox variant
|Variant=PX
|Faction=Xenon
|Class={{M6+class}}
...
{{Infobox close}}
==Overview==
One of the most dangerous ships in its class, the PX is quick, tough and powerful. It has a large laser generator, one more weapon slot in its main than the [[Argon]] [[Heavy Centaur]] and [[Boron]] [[Heavy Hydra]], and boasts [[Pulsed Beam Emitter]] capable turrets with enviable coverage. Its appearance is similar to the [[Xenon P]], but it has more engines and a slightly larger hull. Its huge agility advantage is lost however, and it is more in line with its fellow [[M6+]]es. Like the Xenon J and K, is very quick/cheap to manufacture for its class, being an M6+ costing the same as the M6 Xenon P.

==Background==
Recently spotted on incursions from Xenon sectors, this heavily modified variant of the P represents a considerable step forward in Xenon manufacturing capability.

==Physical Characteristics==

The PX looks very similar to the P except the frame is a bit more boxy and it has two more engines mounted at the top of the craft.

== Combat ==
A dangerous foe, the PX is rarely encountered alone, generally found at the head of scouting parties or protecting [[Xenon]] capital craft. It should be avoided by light and medium fighters, and combated with extreme caution by heavy fighters and other corvettes. Its PBE turrets will shred anything trying to find a blindspot and its lethal main array will obliterate anything in front of it. Best fought at either long range or, in the case of other corvettes, very close range assuming the pilot is confident they can remain behind it. 
...
If you are lucky enough to capture one, they are useful in escort or player ship roles, as the AI should never be left unescorted.

== Equipment ==
One of the few [[M6]] ships that can effectively use the mid-level weapons like the [[Ion Shard Railgun]] due to its good laser generator. Uses 4x200Mj shields. Often used with [[PBE]]s in the turrets and a mix of PBE/[[HEPT]] in the main. Occasionally even used with [[EMPC]] in the main, being curiously able to mount this highly efficient Terran alternative to the [[PAC]]/HEPT and achieve greater sustained firepower.
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/PX" title="PX" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/PX">http://www.x3wiki.com/index.php/PX</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=PX&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=PX&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=PX&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
