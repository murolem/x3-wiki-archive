...
<head>
<meta charset="UTF-8"/>
<title>Editing Plasma Burst Generator - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Plasma_Burst_Generator","wgTitle":"Plasma Burst Generator","wgCurRevisionId":14369,"wgRevisionId":0,"wgArticleId":324,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Plasma_Burst_Generator","wgRelevantArticleId":324,"wgRequestId":"WMUOg1kfZokAAAbS7IQAAAAE","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia","wgEditMessage":"editing"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Plasma_Burst_Generator rootpage-Plasma_Burst_Generator skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Plasma Burst Generator</h1>
...
<input type='hidden' value="20170312090155" name="wpStarttime" />
<input type='hidden' value="20140219193609" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="14369" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{Infobox open}}
{{Infobox weapon
|weapon=Plasma Burst Generator
|hulldam=109
|shielddam=427
|range=0.787
|rof= 54
...
{{Infobox close}}
==Overview==
The Plasma Burst Generator or PBG is a [[Pirate]] weapon that is often found equipped on Pirate ships. It resembles a large flame thrower and can be equipped on many [[Commonwealth]] ships of the fighter and corvette classes. Not to be confused with the [[Pulsed Beam Emitter|PBE]], [[Phased Repeater Gun|PRG]] or [[Phased Shockwave Generator|PSG]].
...
There are [[Plasma Burst Generator Forge]]s in the Unknown Sector east of PTNI Headquarters, in LooManckStrat's Legacy, in Danna's Chance and in Maelstrom.
However, they are hostile towards all players at the start, which means that they don't sell their Plasma Burst Generators to the player. A [[Station Hack]] will solve this problem. 

With a lot of luck some [[bail]]ed out or [[boarding|boarded]] pirate ships may still have some PBGs equipped.
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Plasma_Burst_Generator" title="Plasma Burst Generator" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://x3wiki.com/index.php/Plasma_Burst_Generator">http://x3wiki.com/index.php/Plasma_Burst_Generator</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Plasma_Burst_Generator&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Plasma+Burst+Generator&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Plasma+Burst+Generator&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
