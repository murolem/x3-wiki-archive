...
<head>
<meta charset="UTF-8" /><title>Editing Matter/Anti-Matter Warhead Production Fab - X3 Wiki</title>
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Matter_Anti-Matter_Warhead_Production_Fab skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Matter/Anti-Matter Warhead Production Fab</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Matter/Anti-Matter_Warhead_Production_Fab&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20140717171841" name="wpStarttime" />
<input type='hidden' value="20130823142949" name="wpEdittime" />
...
{{Infobox factory
|faction=Terran
|station=M/A-M Warhead Production Fab
|hull=2000000
|shield=15
|generator=1500
|hangar=10
|cycle=00:01:35
|productnum=[[Matter/Anti-Matter Warhead]] (6)
|stationprice={{priceblock||3129332}}
|reqresources=[[Energy Cells]] (54)&lt;br>[[Terran MRE]] (9)&lt;br>[[Ore]] (9)
|optresources=[[Hull Plating]]
}}
{{Infobox close}}
==Overview==
Makes [[Matter/Anti-Matter_Launcher|MAML]] ammo.

===Encyclopedia Entry===
This production fab manufactures Matter/Anti-Matter Warheads.
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Matter/Anti-Matter_Warhead_Production_Fab" title="Matter/Anti-Matter Warhead Production Fab" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Matter/Anti-Matter_Warhead_Production_Fab&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Matter%2FAnti-Matter+Warhead+Production+Fab&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Matter%2FAnti-Matter+Warhead+Production+Fab&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
