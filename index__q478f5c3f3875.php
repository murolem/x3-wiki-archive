...
<head>
<title>Editing Fenrir (section) - X3 Wiki</title>
<meta charset="UTF-8" />
...
//]]>--></script>
	...
	<h1 id="firstHeading" class="firstHeading"><span dir="auto">Editing Fenrir (section)</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Fenrir&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="4" name="wpSection" />
<input type='hidden' value="20120804233553" name="wpStarttime" />
<input type='hidden' value="20120430220658" name="wpEdittime" />
...
The Fenrir is not only fast enough to dogfight, its shields are almost unbreakable even for other heavy fighters and it requires a concerted attack to destroy. With two turrets, it is a problem for any enemy ship nearby, and with 8+2 highly efficient forward weapons it is a particularly lethal problem for the target it has locked in its sights.

If this ship can be obtained in large numbers it essentially obsoletes all other ships as a carrier fighter: its defences and - if the EMPCs for a meaningful number of them can be acquired - firepower are unmatchable, and its common stats such as speed and agility are very high too. The high energy efficiency of EMPCs give it a remarkable capability for sustained firepower.
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='editHelp'><a href="/index.php/Fenrir" title="Fenrir" id="mw-editform-cancel">Cancel</a> | <a target="helpwindow" href="/index.php/Help:Editing">Editing help</a> (opens in new window)</span>
</div><!-- editButtons -->
</div><!-- editOptions -->
...
<div id="column-one">
	<div id="p-cactions" class="portlet">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Fenrir&amp;action=edit" primary="1" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Fenrir&amp;returntoquery=action%3Dedit%26section%3D4" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
