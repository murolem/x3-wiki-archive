...
<div id="mw-content-text"><div class="mw-ui-container">
		...
		<form name="userlogin2" id="userlogin2" class="mw-ui-vform" method="post" action="/index.php?title=Special:UserLogin&amp;action=submitlogin&amp;type=signup&amp;returnto=Goner+Plot">
...
If you choose to provide it, this will be used for giving you attribution for your work.
				...
				<input class="mw-ui-button mw-ui-big mw-ui-block mw-ui-primary" id="wpCreateaccount" tabindex="10" type="submit" value="Create your account" name="wpCreateaccount" />			</div>
						<input type="hidden" name="wpCreateaccountToken" value="1f9495edf52d2a15df857070f2d66a1c" />		</form>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="ca-nstab-special" class="selected"><a href="/index.php?title=Special:UserLogin&amp;returnto=Goner+Plot&amp;type=signup" title="This is a special page, you cannot edit the page itself">Special page</a></li>
			</ul>
		</div>
	</div>
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-createaccount" class="active"><a href="/index.php?title=Special:UserLogin&amp;returnto=Goner+Plot&amp;returntoquery=type%3Dsignup&amp;type=signup">Create account</a></li>
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Goner+Plot&amp;returntoquery=type%3Dsignup" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
	...
	<div class="portlet" id="p-tb" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="t-print"><a href="/index.php?title=Special:UserLogin&amp;returnto=Goner+Plot&amp;type=signup&amp;printable=yes" rel="alternate" title="Printable version of this page [p]" accesskey="p">Printable version</a></li>
			</ul>
		</div>
	</div>
