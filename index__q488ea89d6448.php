...
<head>
<meta charset="UTF-8" /><title>Editing Vulture (section) - X3 Wiki</title>
...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Vulture","wgTitle":"Vulture","wgCurRevisionId":16776,"wgRevisionId":0,"wgArticleId":243,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Vulture","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia"});
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Vulture skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Vulture (section)</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Vulture&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20160708025431" name="wpStarttime" />
<input type='hidden' value="20150714202000" name="wpEdittime" />
...
===Vulture===
The Vulture is the standard against which the other variants is compared. It has average speed and a small cargo bay relative to the others.
===Vulture Hauler===
The Vulture Hauler doubles the standard Vulture's cargo space and mounts an additional shield, but is 16 m/s slower.
===Vulture Miner===
The Vulture Miner is faster and has a slightly larger cargo bay than the standard Vulture, but cannot mount any weaponry other than those that go in the [[Utility Slot]].
===Vulture Prototype===
Like other Prototype variants, the Vulture Prototype improves on the standard variant in most respects: it has more shielding, larger cargo and is significantly faster.
===Vulture Super Freighter===
The Super Freighter variant is heavily shielded, but is slower and has a smaller cargo bay than the Vulture Hauler.
===Vulture Super Freighter XL===
The Vulture Super Freighter XL is atrociously slow at 57.5 m/s, but boasts the largest cargo bay of any Vulture variant.
===Vulture Tanker===
The Vulture Tanker is available at different shipyards, but is functionally identical to the standard Vulture.
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Vulture" title="Vulture" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Vulture&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Vulture&amp;returntoquery=action%3Dedit%26section%3D4&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Vulture&amp;returntoquery=action%3Dedit%26section%3D4" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
