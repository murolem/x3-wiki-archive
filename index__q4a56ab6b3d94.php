...
<head>
<meta charset="UTF-8"/>
<title>Editing Complex - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Complex","wgTitle":"Complex","wgCurRevisionId":16920,"wgRevisionId":0,"wgArticleId":1899,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Complex","wgRelevantArticleId":1899,"wgRequestId":"WW5AWVkfZokAAGKOqeAAAAAH","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia","wgEditMessage":"editing"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Complex rootpage-Complex skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Complex</h1>
...
<p><strong>Warning:</strong> You are not logged in. Your IP address will be publicly visible if you make any edits. If you <strong><a class="external text" href="http://www.x3wiki.com/index.php?title=Special:UserLogin&amp;returnto=Complex">log in</a></strong> or <strong><a class="external text" href="http://www.x3wiki.com/index.php?title=Special:CreateAccount&amp;returnto=Complex">create an account</a></strong>, your edits will be attributed to your username, along with other benefits.
</p>
</div>
<div id="wikiPreview" class="ontop" style="display: none;"><div lang="en" dir="ltr" class="mw-content-ltr"></div></div><form id="editform" name="editform" method="post" action="/index.php?title=Complex&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntispam">Anti-spam check.
...
<input type='hidden' value="20170718170737" name="wpStarttime" />
<input type='hidden' value="20170325182342" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="16920" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{| style=" margin-bottom: .5em; float: left; padding: .5em 1.4em .8em 0; background: none ;" class="toclimit-1"
| __TOC__
|}
=The “how to” Station &amp; Complex guide=
==Overview==
&lt;nowiki>*This Guide is currently under construction, check back every week for more updates and edits!*&lt;/nowiki>
...
So you want to own a space station?&lt;br/>
...
{| style="float:right;margin:1em;text-align:center;" border="1" cellspacing="0"
...
Optimistic Break Even Time = (Station Cost)/(Net Profit/Time)&lt;br>
Optimistic Net Profit = (Max Unit Val * Batch Size) - (Material Costs per Batch)

{| style="text-align:center;" class="pretty sortable"
!Station!!Race!!Cost!!Max Unit Val!! Batch Size !! Cycle (s) !! Max Gross !! Mat. Cost/Batch !! Max Net !! Break Even Time
{{EcnStnLn|Teladianium Foundry M|Teladi|325008|255|4|60|1020|360|660|29547s}}
{{EcnStnLn|Teladianium Foundry L|Teladi|811548|255|10|60|2550|900|1650|29511s}}
{{EcnStnLn|Solar Power Plant XL|Teladi|18594200|20|5530|215|110600|57280|53320|74977}}
{{EcnStnLn|Solar Power Plant XL|Boron|17607360|20|5530|215|110600|57280|53320|70998}}
|}
...
{| style="float:left;position:relative;top:4em;border:solid;"
|+'''Legend'''
|-
|{{ffcolor/0}}|Neutral
|-
...
|-
! Argon 
{{friendfoe|1|1|0|0|0|0|2|2|2|2}}
|-
! Boron 
{{friendfoe|1|1|0|0|0|0|2|2|2|2}}
|-
! Paranid 
{{friendfoe|0|0|1|1|0|0|2|2|2|2}}
|-
! Split 
{{friendfoe|0|0|1|1|0|0|2|2|2|2}}
|-
! Teladi 
{{friendfoe|0|0|0|0|1|0|2|0|0|2}}
|-
! Terran 
{{friendfoe|0|0|0|0|0|1|2|2|2|2}}
|-
! Xenon 
{{friendfoe|2|2|2|2|2|2|1|2|2|2}}
|-
! Yaki 
{{friendfoe|2|2|2|2|2|2|2|1|2|2}}
|-
! Pirate 
{{friendfoe|2|2|2|2|2|2|2|2|1|2}}
|-
! Kha'ak
{{friendfoe|2|2|2|2|2|2|2|2|2|1}}
|}
...
#	How will the station get resources? (Are there nearby SPPs and raw materials?)
# How do I sell the product?
##	Do you see lots of trade ships in the area? (The more traffic the more your product is likely to get bought!) 
##	Is their competition for the same products I’m selling in that sector or nearby sectors? 
##	Is the station I’m buying producing an in demand good/ware that won’t saturate the local economy?
# How secure are the sectors nearby? Do I have to worry about ships getting destroyed trying to buy resources?

Jumpdrive [[UT]]s can suppress local demand by providing access to distant sources of goods.
...
{|
|- valign="top"
| style="padding:0 1em 0 0; width:14em;"|
'''Pros''' &lt;br/>
...
==Example of a self-sustaining Complex==

Just as a quick example of a simple complex to create that produces something from nothing:

Silicon Mine L (might need several of these: calculations assume yield 26)
Cattle Ranch L 
Cahoona Bakery L
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Complex" title="Complex" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<li><a href="/index.php/Template:Colour/Boron" title="Template:Colour/Boron">Template:Colour/Boron</a> (<a href="/index.php?title=Template:Colour/Boron&amp;action=edit" title="Template:Colour/Boron">edit</a>) </li><li><a href="/index.php/Template:Colour/Teladi" title="Template:Colour/Teladi">Template:Colour/Teladi</a> (<a href="/index.php?title=Template:Colour/Teladi&amp;action=edit" title="Template:Colour/Teladi">edit</a>) </li><li><a href="/index.php/Template:EcnStnLn" title="Template:EcnStnLn">Template:EcnStnLn</a> (<a href="/index.php?title=Template:EcnStnLn&amp;action=edit" title="Template:EcnStnLn">edit</a>) </li><li><a href="/index.php/Template:Ffcolor/0" title="Template:Ffcolor/0">Template:Ffcolor/0</a> (<a href="/index.php?title=Template:Ffcolor/0&amp;action=edit" title="Template:Ffcolor/0">edit</a>) </li><li><a href="/index.php/Template:Ffcolor/1" title="Template:Ffcolor/1">Template:Ffcolor/1</a> (<a href="/index.php?title=Template:Ffcolor/1&amp;action=edit" title="Template:Ffcolor/1">edit</a>) </li><li><a href="/index.php/Template:Ffcolor/2" title="Template:Ffcolor/2">Template:Ffcolor/2</a> (<a href="/index.php?title=Template:Ffcolor/2&amp;action=edit" title="Template:Ffcolor/2">edit</a>) </li><li><a href="/index.php/Template:Friendfoe" title="Template:Friendfoe">Template:Friendfoe</a> (<a href="/index.php?title=Template:Friendfoe&amp;action=edit" title="Template:Friendfoe">edit</a>) </li><li><a href="/index.php/Template:Trading" title="Template:Trading">Template:Trading</a> (<a href="/index.php?title=Template:Trading&amp;action=edit" title="Template:Trading">edit</a>) </li></ul></div><div class="hiddencats"></div><div class="limitreport"></div><input type="hidden" value="1" name="wpUltimateParam"/>
</form>
</div><div class="printfooter">
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Complex">http://www.x3wiki.com/index.php/Complex</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Complex&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Complex&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Complex&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
