...
<head>
<meta charset="UTF-8"/>
<title>Editing Auster Hauler - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Auster_Hauler","wgTitle":"Auster Hauler","wgCurRevisionId":13266,"wgRevisionId":0,"wgArticleId":614,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Auster_Hauler","wgRelevantArticleId":614,"wgRequestId":"Wmh36FkfZokAAB6dD5QAAAAA","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia","wgEditMessage":"editing"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Auster_Hauler rootpage-Auster_Hauler skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Auster Hauler</h1>
...
<input type='hidden' value="20180124121120" name="wpStarttime" />
<input type='hidden' value="20130731151745" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="13266" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{Infobox open}}
{{Infobox variant
|Variant=Auster Hauler
|Faction=OTAS
|Class={{M8class}}
|Priceblock={{Priceblock|Federation Guardian| 5,699,751}}
|Minspeed=52
|Maxspeed=104.9
|Minaccel=4
|Maxaccel=9
...
{{Infobox close}}
==Overview==
In theory the best bomber in the game. In practice, it is nonexistent in Vanilla but available for purchase in Albion Prelude. Uses a model similar to the [[Gladiator]] and has stats like the basic [[Argon]] [[Centaur]], its only difference is the missile weaponry in place of a main array of guns. With the single largest cargo bay in the [[M8]] class, the Auster Hauler therefore can carry more missiles than any other bomber, with the possible exception of the [[Claymore]], which uses [[Phantom Missile]]s of volume 1 (no longer true as of Albion Prelude - Phantom missiles have volume 6 there) as opposed to the 2 units of the [[Tomahawk Heavy Missile]]. The Auster boasts considerably larger shields than all other bombers, giving it some more survivability against fighter attack, usually the bane of the M8.
...
== Availability ==
The Auster Hauler is available for purchase only in Albion Prelude.
{| style="text-align:center;" cellpadding="3"
|- style="background-color:lightblue;"
! Variant !! [[Legend's Home]]
|-
! Auster Hauler || x ||
|}
== Suggested Roles==
Long range anti-capital or anti-station bombing.
== See Also==
{{M8}}
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Auster_Hauler" title="Auster Hauler" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://x3wiki.com/index.php/Auster_Hauler">http://x3wiki.com/index.php/Auster_Hauler</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Auster_Hauler&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Auster+Hauler&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Auster+Hauler&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
