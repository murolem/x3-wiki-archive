...
<head>
<meta charset="UTF-8" />
<title>Editing Talk:Fight Command Software - X3 Wiki</title>
...
<body class="mediawiki ltr ns-1 ns-talk page-Talk_Fight_Command_Software skin-monobook">
<div id="globalWrapper">
<div id="column-content"><div id="content">
	<a id="top"></a>
	
	<h1 id="firstHeading" class="firstHeading">Editing Talk:Fight Command Software</h1>
	<div id="bodyContent">
...
<form id="editform" name="editform" method="post" action="/index.php?title=Talk:Fight_Command_Software&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="" name="wpSection" />
<input type='hidden' value="20111124040730" name="wpStarttime" />
<input type='hidden' value="20111124040730" name="wpEdittime" />
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='editHelp'><a href="/index.php/Talk:Fight_Command_Software" title="Talk:Fight Command Software" id="mw-editform-cancel">Cancel</a> | <a target="helpwindow" href="/index.php/Help:Editing">Editing help</a> (opens in new window)</span>
</div><!-- editButtons -->
</div><!-- editOptions -->
...
Retrieved from "<a href="http://www.x3wiki.com/index.php/Talk:Fight_Command_Software">http://www.x3wiki.com/index.php/Talk:Fight_Command_Software</a>"</div>
...
<div id="column-one">
	<div id="p-cactions" class="portlet">
		...
		<div class="pBody">
			<ul>
				 ...
				 <li id="ca-talk" class="selected new"><a href="/index.php?title=Talk:Fight_Command_Software&amp;action=edit&amp;redlink=1" title="Discussion about the content page [t]" accesskey="t">Discussion</a></li>
				 <li id="ca-edit" class="selected istalk"><a href="/index.php?title=Talk:Fight_Command_Software&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Create</a></li>
	...
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Talk:Fight_Command_Software&amp;returntoquery=action%3Dedit%26redlink%3D1" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
	...
	<div class="portlet" id="p-tb">
		...
		<div class="pBody">
			<ul>
				<li id="t-whatlinkshere"><a href="/index.php/Special:WhatLinksHere/Talk:Fight_Command_Software" title="List of all wiki pages that link here [j]" accesskey="j">What links here</a></li>
...
<script>if ( window.mediaWiki ) {
	mediaWiki.config.set({"wgCanonicalNamespace": "Talk", "wgCanonicalSpecialPageName": false, "wgNamespaceNumber": 1, "wgPageName": "Talk:Fight_Command_Software", "wgTitle": "Fight Command Software", "wgAction": "edit", "wgArticleId": 0, "wgIsArticle": false, "wgUserName": null, "wgUserGroups": ["*"], "wgCurRevisionId": 0, "wgCategories": [], "wgBreakFrames": true, "wgRestrictionCreate": []});
}
</script>
<script>if ( window.mediaWiki ) {
