...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Asteroids","wgTitle":"Asteroids","wgCurRevisionId":8709,"wgArticleId":12,"wgIsArticle":true,"wgAction":"view","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":false,"wgPageContentLanguage":"en","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgRelevantPageName":"Asteroids","wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia"});
...
//]]>--></script>
	...
	<h1 id="firstHeading" class="firstHeading"><span dir="auto">Asteroids</span></h1>
	<div id="bodyContent" class="mw-body">
		<div id="siteSub">From X3 Wiki</div>
		<div id="contentSub"><div id="mw-revision-info">Revision as of 16:32, 22 February 2012 by <a href="/index.php/User:Madned" title="User:Madned" class="mw-userlink">Madned</a>  <span class="mw-usertoollinks">(<a href="/index.php/User_talk:Madned" title="User talk:Madned">Talk</a> | <a href="/index.php/Special:Contributions/Madned" title="Special:Contributions/Madned">contribs</a>)</span></div><br />
				<div id="mw-revision-nav">(<a href="/index.php?title=Asteroids&amp;diff=prev&amp;oldid=8709" title="Asteroids">diff</a>) <a href="/index.php?title=Asteroids&amp;direction=prev&amp;oldid=8709" title="Asteroids">← Older revision</a> | Latest revision (diff) | Newer revision → (diff)</div></div>
...
</p><p>Certain large varieties are immune to standard ship weapons fire and require certain heavy weapons or a mining laser to shatter.
These asteroids may have mining facilities placed on them to extract resources vital to space-borne industries.
</p><p>In the X universe, asteroids are classified by 4 types of minerals.
</p>
<ul><li> <a href="/index.php/Ore" title="Ore">Ore</a> (<a href="/index.php/Ore_asteroid_list" title="Ore asteroid list">Ore asteroid list</a>)
</li><li> <a href="/index.php/Silicon" title="Silicon" class="mw-redirect">Silicon</a> (<a href="/index.php/Silicon_asteroid_list" title="Silicon asteroid list">Silicon asteroid list</a>)
</li><li> <a href="/index.php/Ice" title="Ice">Ice</a> (<a href="/index.php/Ice_asteroid_list" title="Ice asteroid list">Ice asteroid list</a>)
</li><li> <a href="/index.php/Nividium" title="Nividium">Nividium</a> (<a href="/index.php/Nividium_asteroid_list" title="Nividium asteroid list">Nividium asteroid list</a>)
</li></ul>
...
<!-- Saved in parser cache with key dailystunt_wiki:pcache:idhash:12-0!*!0!*!*!*!* and timestamp 20130307164814 -->
</div><div class="printfooter">
Retrieved from "<a href="http://x3wiki.com/index.php?title=Asteroids&amp;oldid=8709">http://x3wiki.com/index.php?title=Asteroids&amp;oldid=8709</a>"</div>
...
<div id="column-one">
	<div id="p-cactions" class="portlet">
		...
		<div class="pBody">
			<ul>
				<li id="ca-nstab-main" class="selected"><a href="/index.php/Asteroids" primary="1" context="subject" title="View the content page [c]" accesskey="c">Page</a></li>
				<li id="ca-talk"><a href="/index.php/Talk:Asteroids" primary="1" context="talk" title="Discussion about the content page [t]" accesskey="t">Discussion</a></li>
				<li id="ca-edit"><a href="/index.php?title=Asteroids&amp;action=edit" primary="1" title="You can edit this page. Please use the preview button before saving [e]" accesskey="e">Edit</a></li>
	...
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Asteroids&amp;returntoquery=oldid%3D8709" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
	...
	<div class="portlet" id="p-tb">
		...
		<div class="pBody">
			<ul>
				...
				<li><a href="/index.php?title=Asteroids&amp;oldid=8709&amp;printable=yes" rel="alternate">Printable version</a></li>
				<li id="t-permalink"><a href="/index.php?title=Asteroids&amp;oldid=8709" title="Permanent link to this revision of the page">Permanent link</a></li>
			</ul>
		</div>
	</div>
...
<div id="footer">
	...
	<ul id="f-list">
		<li id="lastmod"> This page was last modified on 22 February 2012, at 16:32.</li>
		<li id="viewcount">This page has been accessed 31,337 times.</li>
