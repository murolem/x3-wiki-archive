...
<head>
<title>Editing Bail (section) - X3 Wiki</title>
...
<form id="editform" name="editform" method="post" action="/index.php?title=Bail&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="1" name="wpSection" />
<input type='hidden' value="20110104032755" name="wpStarttime" />
<input type='hidden' value="20101123232622" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="6f5d91a5b08abda07569e6d9408ecc22" name="wpAutoSummary" /><input type="hidden" value="0" name="oldid" /><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" name="wpTextbox1">==Mechanics==
...
It is often advantageous to use a low hull damage high shield damage weapon like the [[Pulsed Beam Emitter]], since that will preserve the hull through several [[capping]] attempts. However, many players believe that a heavily damaging the hull most negatively affects morale and in any event permits players to most rapidly process a large number of candidate ships with the least attention. Both strategies attempt to increase the number of bail checks for a given amount of time.
...
<span class="mw-summary" id="wpSummaryLabel"><label for="wpSummary">Summary:</label></span> <input class="mw-summary" id="wpSummary" maxlength="200" tabindex="1" size="60" value="/* Mechanics */ " name="wpSummary" /><div class='editCheckboxes'>
</div>
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='editHelp'><a href="/index.php/Bail" title="Bail" id="mw-editform-cancel">Cancel</a> | <a target="helpwindow" href="/index.php/Help:Editing">Editing help</a> (opens in new window)</span>
</div><!-- editButtons -->
</div><!-- editOptions -->
...
<div id="column-one">
	...
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Bail&amp;returntoquery=action%3Dedit%26section%3D1" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
