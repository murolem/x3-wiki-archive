...
<head>
<meta charset="UTF-8"/>
<title>Editing Docking - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Docking","wgTitle":"Docking","wgCurRevisionId":16876,"wgRevisionId":0,"wgArticleId":108,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Docking","wgRelevantArticleId":108,"wgRequestId":"WbNhMVkfZokAACHcM@UAAAAQ","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia","wgEditMessage":"editing"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Docking rootpage-Docking skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Docking</h1>
...
<p><strong>Warning:</strong> You are not logged in. Your IP address will be publicly visible if you make any edits. If you <strong><a class="external text" href="http://www.x3wiki.com/index.php?title=Special:UserLogin&amp;returnto=Docking">log in</a></strong> or <strong><a class="external text" href="http://www.x3wiki.com/index.php?title=Special:CreateAccount&amp;returnto=Docking">create an account</a></strong>, your edits will be attributed to your username, along with other benefits.
</p>
</div>
<div id="wikiPreview" class="ontop" style="display: none;"><div lang="en" dir="ltr" class="mw-content-ltr"></div></div><form id="editform" name="editform" method="post" action="/index.php?title=Docking&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntispam">Anti-spam check.
...
<input type='hidden' value="20170909033409" name="wpStarttime" />
<input type='hidden' value="20170221011844" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="16876" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">Transfer of [[wares]] usually occurs when vessels dock.

[[Stations]] feature both internal docking bays and external docking clamps. External docking clamps are limited in number (usually 5), whereas internal bays are functionally unlimited. Docking listings on station pages will usually reference external clamps.&lt;br>
External docking clamps can usually handle all non-capital ship types.&lt;br>
Internal bays can usually only handle smaller craft like [[:Category:Fighters|fighters]].

[[:Category:Capital Ships|Capital Ships]] may only externally dock at certain stations and usually only 2 at a time.&lt;br>
The [[Aran]] class ship is an exception which may dock all types of vessels including other capital ships.

Some ships may also dock smaller craft, usually fighter craft and sometimes limited to small {{M5class}} class vessels.

At a [[reputation|race rank]] of -1 you may dock with a race's stations in border sectors and at a rank of 0 in core sectors.
...
This is the slowest method of docking, and it is also well-noted that this form of docking is very inefficient and unreliable for larger ships such as [[:Category:Capital Ships|capital ships]], especially with regard to the new super shipyard's model.
...
Approach angle and speed are unimportant when using a docking computer. This is the best docking strategy used with larger ships such as [[:Category:Capital Ships|capital ships]], and noticeably safer for all classes of ships.


===Available docking ports===
Fighters are defined as {{M3+class}} to {{M5class}}.

Super Shipyards also permit unlimited hangar docking for {{M6+class}}, {{M6class}}, {{TPclass}}, and  {{TSclass}} ships.
...
==Hangar Docking Stations==
From [{{linky}}forum.egosoft.com/viewtopic.php?t=287694 forum]:
...
|-
| [[Headquarters | Personal HQ]] || Unlimited
|-
| [[Complex Hub]] || 25
|-
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Docking" title="Docking" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<li><a href="/index.php/Template:Linky" title="Template:Linky">Template:Linky</a> (<a href="/index.php?title=Template:Linky&amp;action=edit" title="Template:Linky">edit</a>) </li><li><a href="/index.php/Template:M3%2Bclass" title="Template:M3+class">Template:M3+class</a> (<a href="/index.php?title=Template:M3%2Bclass&amp;action=edit" title="Template:M3+class">edit</a>) </li><li><a href="/index.php/Template:M5class" title="Template:M5class">Template:M5class</a> (<a href="/index.php?title=Template:M5class&amp;action=edit" title="Template:M5class">edit</a>) </li><li><a href="/index.php/Template:M6%2Bclass" title="Template:M6+class">Template:M6+class</a> (<a href="/index.php?title=Template:M6%2Bclass&amp;action=edit" title="Template:M6+class">edit</a>) </li><li><a href="/index.php/Template:M6class" title="Template:M6class">Template:M6class</a> (<a href="/index.php?title=Template:M6class&amp;action=edit" title="Template:M6class">edit</a>) </li><li><a href="/index.php/Template:TPclass" title="Template:TPclass">Template:TPclass</a> (<a href="/index.php?title=Template:TPclass&amp;action=edit" title="Template:TPclass">edit</a>) </li><li><a href="/index.php/Template:TSclass" title="Template:TSclass">Template:TSclass</a> (<a href="/index.php?title=Template:TSclass&amp;action=edit" title="Template:TSclass">edit</a>) </li></ul></div><div class="hiddencats"></div><div class="limitreport"></div><input type="hidden" value="1" name="wpUltimateParam"/>
</form>
</div><div class="printfooter">
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Docking">http://www.x3wiki.com/index.php/Docking</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-talk"><a href="/index.php/Talk:Docking" rel="discussion" title="Discussion about the content page [t]" accesskey="t">Discussion</a></li>
				<li id="ca-edit" class="selected"><a href="/index.php?title=Docking&amp;action=edit" title="Edit this page">Edit</a></li>
				<li id="ca-history"><a href="/index.php?title=Docking&amp;action=history" title="Past revisions of this page [h]" accesskey="h">History</a></li>
				</ul>
							</div>
		</div>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Docking&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Docking&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
		...
		<div class='pBody'>
			...
			<div class="pBody">
				<ul>
											...
											<li id="t-info"><a href="/index.php?title=Docking&amp;action=info" title="More information about this page">Page information</a></li>
									</ul>
							</div>
		</div>
