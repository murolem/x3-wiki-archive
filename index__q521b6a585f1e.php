...
<head>
<meta charset="UTF-8" /><title>Editing Xenon Conflict - X3 Wiki</title>
<meta name="generator" content="MediaWiki 1.22.6" />
<meta name="robots" content="noindex,nofollow" />
<link rel="alternate" type="application/x-wiki" title="Edit" href="/index.php?title=Xenon_Conflict&amp;action=edit" />
<link rel="edit" title="Edit" href="/index.php?title=Xenon_Conflict&amp;action=edit" />
...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Xenon_Conflict","wgTitle":"Xenon Conflict","wgCurRevisionId":9112,"wgRevisionId":0,"wgArticleId":1355,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Xenon_Conflict","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia"});
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Xenon_Conflict skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Xenon Conflict</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Xenon_Conflict&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20140910144836" name="wpStarttime" />
<input type='hidden' value="20120425151502" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary" /><input type="hidden" value="0" name="oldid" /><input type="hidden" value="text/x-wiki" name="format" /><input type="hidden" value="wikitext" name="model" /><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">The Xenon Conflict, a war fought between the [[Argon|Argon Federation]] and the [[Xenon]], was a defining era in the history of the X-Universe.

Beginning in the year 160, reports began to emerge of ships in the outer reaches of Argon space that did not belong to their allies, the [[Paranid|Paranid Empire]]. In 210, as the Argon Federation continued to grow, ships began going missing in the far reaches of Argon space. By 214, it was widely accepted that these unidentified ships were of [[Terraformer]] origin, and the Argon federal government was preparing for war.

Events came to a head with the destruction of the Antigone in 215, the largest Argon space station constructed to that date, by a Xenon strike force. The Argon Federation Fleet fully mobilised and skirmishes between Argon and Xenon forces increased in frequency.

In the year 230, the [[Paranid]] chose to forgo joining the Argon in their struggle, which was going increasingly badly. Relations between the former allies soured and never recovered. Xenon forces were slowly overrunning Argon space, destroying Argon ships and stations.

The Federation was unable to provide an answer until 255, when the Argon fleet regained the initiative and landed a number of defeats on Xenon fleets. The Xenon were driven back out of the territories they had conquered and by the year 290, the Argon Federation was back in control of all its previous domains. The Xenon forces disappeared, completely ceasing their attacks on the Argon, and a programme of reconnaisance was begun by the Argon fleet to locate the Xenon home sectors.

The Argon Federation enjoyed a period of peace and stability despite the now hostile border it shared with the Paranid Empire. This state of affairs continued until the year 324 with the beginning of the [[Boron Campaign]].
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Xenon_Conflict" title="Xenon Conflict" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a href="http://x3wiki.com/index.php/Xenon_Conflict">http://x3wiki.com/index.php/Xenon_Conflict</a>"</div>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="ca-nstab-main" class="selected"><a href="/index.php/Xenon_Conflict" title="View the content page [c]" accesskey="c">Page</a></li>
				<li id="ca-talk" class="new"><a href="/index.php?title=Talk:Xenon_Conflict&amp;action=edit&amp;redlink=1" title="Discussion about the content page [t]" accesskey="t">Discussion</a></li>
				<li id="ca-edit" class="selected"><a href="/index.php?title=Xenon_Conflict&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
				<li id="ca-history"><a href="/index.php?title=Xenon_Conflict&amp;action=history" rel="archives" title="Past revisions of this page [h]" accesskey="h">History</a></li>
			</ul>
		</div>
	</div>
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Xenon+Conflict&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Xenon+Conflict&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
...
<a href="/index.php/Main_Page" style="background-image: url(http://www.x3wiki.com/x3.jpg);" title="Visit the main page"></a>
	...
	<div class="portlet" id="p-tb" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="t-whatlinkshere"><a href="/index.php/Special:WhatLinksHere/Xenon_Conflict" title="A list of all wiki pages that link here [j]" accesskey="j">What links here</a></li>
				<li id="t-recentchangeslinked"><a href="/index.php/Special:RecentChangesLinked/Xenon_Conflict" title="Recent changes in pages linked from this page [k]" accesskey="k">Related changes</a></li>
				<li id="t-specialpages"><a href="/index.php/Special:SpecialPages" title="A list of all special pages [q]" accesskey="q">Special pages</a></li>
				<li id="t-info"><a href="/index.php?title=Xenon_Conflict&amp;action=info">Page information</a></li>
			</ul>
		</div>
	</div>
