...
<head>
<meta charset="UTF-8" /><title>Editing Dolphin - X3 Wiki</title>
<meta name="generator" content="MediaWiki 1.22.6" />
<meta name="robots" content="noindex,nofollow" />
<link rel="alternate" type="application/x-wiki" title="Edit" href="/index.php?title=Dolphin&amp;action=edit" />
<link rel="edit" title="Edit" href="/index.php?title=Dolphin&amp;action=edit" />
...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Dolphin","wgTitle":"Dolphin","wgCurRevisionId":13927,"wgRevisionId":0,"wgArticleId":116,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Dolphin","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia"});
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Dolphin skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Dolphin</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Dolphin&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20160914211356" name="wpStarttime" />
<input type='hidden' value="20130930135552" name="wpEdittime" />
...
{{Infobox variant
|Variant=Dolphin Hauler
|Faction=Boron
|Class={{TSclass}}
|Priceblock={{Priceblock|| 1029447}}
|Minspeed=33.3
|Maxspeed=59.9
|Minaccel=1
|Maxaccel=2
...
{{Infobox variant
|Variant=Dolphin Super Freighter
|Faction=Boron
|Class={{TSclass}}
|Priceblock={{Priceblock|| 1115147}}
|Minspeed=32.0
|Maxspeed=57.7
|Minaccel=1
|Maxaccel=2
...
{{Infobox variant
|Variant=Dolphin Super Freighter XL
|Faction=Boron
|Class={{TSclass}}
|Priceblock={{Priceblock|| 2167186}}
|Minspeed=29.9
|Maxspeed=53.9
|Minaccel=1
|Maxaccel=3
...
{{Infobox variant
|Variant=Dolphin Tanker
|Faction=Boron
|Class={{TSclass}}
|Priceblock={{Priceblock|| 510514}}
|Minspeed=41.6
|Maxspeed=74.9
|Minaccel=1
|Maxaccel=3
...
{{Infobox close}}
==Overview==
The Boron Dolphin is the slowest of the TS class ships. However, it has a larger cargobay than all but the [[Mistral|OTAS Mistral]] [[TS]].
...
== Combat ==
The Dolphin has average shielding for a TS, but is completely unarmed. It may carry certain light missiles for defense, but it should not stray anywhere it is likely to be attacked.  If you must send a Dolphin into potentially hostile space, make sure it carries [[Fighter Drone]]s.
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Dolphin" title="Dolphin" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="ca-nstab-main" class="selected"><a href="/index.php/Dolphin" title="View the content page [c]" accesskey="c">Page</a></li>
				<li id="ca-talk" class="new"><a href="/index.php?title=Talk:Dolphin&amp;action=edit&amp;redlink=1" title="Discussion about the content page [t]" accesskey="t">Discussion</a></li>
				<li id="ca-edit" class="selected"><a href="/index.php?title=Dolphin&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
				<li id="ca-history"><a href="/index.php?title=Dolphin&amp;action=history" rel="archives" title="Past revisions of this page [h]" accesskey="h">History</a></li>
			</ul>
		</div>
	</div>
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Dolphin&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Dolphin&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
...
<a href="/index.php/Main_Page" style="background-image: url(http://www.x3wiki.com/x3.jpg);" title="Visit the main page"></a>
	...
	<div class="portlet" id="p-tb" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="t-whatlinkshere"><a href="/index.php/Special:WhatLinksHere/Dolphin" title="A list of all wiki pages that link here [j]" accesskey="j">What links here</a></li>
				<li id="t-recentchangeslinked"><a href="/index.php/Special:RecentChangesLinked/Dolphin" title="Recent changes in pages linked from this page [k]" accesskey="k">Related changes</a></li>
				<li id="t-specialpages"><a href="/index.php/Special:SpecialPages" title="A list of all special pages [q]" accesskey="q">Special pages</a></li>
				<li id="t-info"><a href="/index.php?title=Dolphin&amp;action=info">Page information</a></li>
			</ul>
		</div>
	</div>
