...
<head>
<meta charset="UTF-8" /><title>Editing Water Purification Plant - X3 Wiki</title>
...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Water_Purification_Plant","wgTitle":"Water Purification Plant","wgCurRevisionId":16665,"wgRevisionId":0,"wgArticleId":2006,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Water_Purification_Plant","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia"});
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Water_Purification_Plant skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Water Purification Plant</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Water_Purification_Plant&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20150425014255" name="wpStarttime" />
<input type='hidden' value="20150304172703" name="wpEdittime" />
...
{{Infobox factory
|faction=Terran
|station=Water Purification Plant L
|hull=2250000
|shield=15
|generator=1500
|hangar=10
|cycle=00:01:12
|productnum=[[Water]] (120)
|stationprice=
|reqresources=[[Energy Cells]] (90)&lt;br>[[Ice]] (15)
|optresources=None
}}

{{Infobox factory
|faction=Terran
|station=Water Purification Plant M
|hull=300000
|shield=8
|generator=1500
|hangar=10
...
|productnum=[[Water]] (24)
|stationprice=
|reqresources=[[Energy Cells]] (18)&lt;br>[[Ice]] (3)
|optresources=None
}}
{{Infobox close}}

==Overview==
Water Purification Plants are Terran factories that produce [[Water]] from [[Energy Cells]] and [[Ice]].
===Encyclopedia Entry===
[[Water]], in the form of [[ice]], is harvested from asteroids and then treated by Water Purification Plants to be made safe for human consumption.
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Water_Purification_Plant" title="Water Purification Plant" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Water_Purification_Plant&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Water+Purification+Plant&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Water+Purification+Plant&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
