...
<head>
<meta charset="UTF-8"/>
<title>Editing Heretic's End - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Heretic's_End","wgTitle":"Heretic's End","wgCurRevisionId":15896,"wgRevisionId":0,"wgArticleId":780,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Heretic's_End","wgRelevantArticleId":780,"wgRequestId":"WK4JVVkfZokAAElWRKwAAAAo","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia","wgEditMessage":"editing"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Heretic_s_End rootpage-Heretic_s_End skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Heretic's End</h1>
...
<input type='hidden' value="20170222215741" name="wpStarttime" />
<input type='hidden' value="20140309102354" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="15896" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{Infobox Sector
|Race=Terran
|SecLevel=Border
...
{{Gateblock2|North|-750|	0|	29550|[[Asteroid Belt]]}}
{{Gateblock2|South|0|	0|	-25725|[[Circle Of Labour]]}}
{{Gateblock/End}}
}}
==Description==
===History===
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Heretic%27s_End" title="Heretic's End" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<li><a href="/index.php/Template:Colour/Terran" title="Template:Colour/Terran">Template:Colour/Terran</a> (<a href="/index.php?title=Template:Colour/Terran&amp;action=edit" title="Template:Colour/Terran">edit</a>) </li><li><a href="/index.php/Template:Gateblock/Begin" title="Template:Gateblock/Begin">Template:Gateblock/Begin</a> (<a href="/index.php?title=Template:Gateblock/Begin&amp;action=edit" title="Template:Gateblock/Begin">edit</a>) </li><li><a href="/index.php/Template:Gateblock/End" title="Template:Gateblock/End">Template:Gateblock/End</a> (<a href="/index.php?title=Template:Gateblock/End&amp;action=edit" title="Template:Gateblock/End">edit</a>) </li><li><a href="/index.php/Template:Gateblock2" title="Template:Gateblock2">Template:Gateblock2</a> (<a href="/index.php?title=Template:Gateblock2&amp;action=edit" title="Template:Gateblock2">edit</a>) </li><li><a href="/index.php/Template:Infobox_Sector" title="Template:Infobox Sector">Template:Infobox Sector</a> (<a href="/index.php?title=Template:Infobox_Sector&amp;action=edit" title="Template:Infobox Sector">edit</a>) </li><li><a href="/index.php/Template:Terran_Navbox" title="Template:Terran Navbox">Template:Terran Navbox</a> (<a href="/index.php?title=Template:Terran_Navbox&amp;action=edit" title="Template:Terran Navbox">edit</a>) </li></ul></div><div class="hiddencats"></div><div class="limitreport"></div><input type="hidden" value="1" name="wpUltimateParam"/>
</form>
</div><div class="printfooter">
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Heretic%27s_End">http://www.x3wiki.com/index.php/Heretic%27s_End</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-talk" class="new"><a href="/index.php?title=Talk:Heretic%27s_End&amp;action=edit&amp;redlink=1" rel="discussion" title="Discussion about the content page [t]" accesskey="t">Discussion</a></li>
				<li id="ca-edit" class="selected"><a href="/index.php?title=Heretic%27s_End&amp;action=edit" title="Edit this page">Edit</a></li>
				<li id="ca-history"><a href="/index.php?title=Heretic%27s_End&amp;action=history" title="Past revisions of this page [h]" accesskey="h">History</a></li>
				</ul>
							</div>
		</div>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Heretic%27s+End&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Heretic%27s+End&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
		...
		<div class='pBody'>
			...
			<div class="pBody">
				<ul>
											...
											<li id="t-info"><a href="/index.php?title=Heretic%27s_End&amp;action=info" title="More information about this page">Page information</a></li>
									</ul>
							</div>
		</div>
