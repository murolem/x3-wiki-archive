...
<head>
<meta charset="UTF-8"/>
<title>Editing Hatikvah's Faith - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Hatikvah's_Faith","wgTitle":"Hatikvah's Faith","wgCurRevisionId":15457,"wgRevisionId":0,"wgArticleId":913,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Hatikvah's_Faith","wgRelevantArticleId":913,"wgRequestId":"WS215VkfZokAAF6QCgMAAAAB","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia","wgEditMessage":"editing"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Hatikvah_s_Faith rootpage-Hatikvah_s_Faith skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Hatikvah's Faith</h1>
...
<input type='hidden' value="20170530181149" name="wpStarttime" />
<input type='hidden' value="20140303134804" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="15457" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{Infobox Sector
|Race=Pirate
|SecLevel=Border
|Population=4,142,839
|Planets=3
|SunLevel=150
|GateDist=70
...
{{Gateblock2|North|0|	0|	35280|[[Thuruk's Beard]]}}
{{Gateblock2|East|35280|	0|	0|[[Aladna Hill]]}}
{{Gateblock2|South|0|	0|	-35000|[[Clarity's End]]}}
{{Gateblock2|West|-35280|	0|	0|[[Nopileos' Memorial]]}}
&lt;/table>
}}
==Description==
After the [[Xenon Conflict]], this system was abandoned. When retreating [[Xenon]] completely destroyed a neighboring system by forcing its twin suns to go nova, the colonies and factories of this system were eradicated. It is the home to many refugees of the last Xenon war and the other minor wars that came before it. The people here begin to build new lives and homes while they mourn their past and hope for their future.
==Commentary==
Hatikvah's Faith is a very busy sector for traders and, despite its pirate allegiance, is actually very safe. Due to the large numbers of escorted freighters and a military patrol typically stationed near one or more gates, aggressive pirates don't last very long in this sector. Even better, those military patrols happen to turn a blind eye to aggressive players, giving you an excellent opportunity to personally fill in the piracy gap. Better yet, there are at least three ''friendly'' [[Shipyards]] and [[Equipment Dock|Equipment Docks]] (four, if you consider the Xenon friendly) within three jumps, giving you plenty of variety for where to fence your newly acquired [[capping|ships]] and cargo. There are even a pair of [[ownerless ships|freebies]] nearby, in case you needed some help setting up shop.

Though, be aware. There is a Xenon sector nearby.
==Default [[Stations]]==
==[[Asteroids]]==

{{Asteroid/Begin}}
{{Asteroid/Item|Ore|44|8376|1308|4304}}
{{Asteroid/Item|Ore|32|-13118|1270|-7502}}
{{Asteroid/Item|Ore|25|-13435|-5897|19065}}
{{Asteroid/Item|Ore|21|-15659|-1873|5042}}
{{Asteroid/Item|Ore|20|5631|-870|21497}}
{{Asteroid/Item|Ore|20|5631|-870|21497}}
{{Asteroid/Item|Ore|20|295|-3214|4275}}
{{Asteroid/Item|Ore|20|295|-3214|4275}}
{{Asteroid/Item|Ore|18|-17149|7135|11809}}
{{Asteroid/Item|Ore|13|-5688|-3028|0}}
{{Asteroid/Item|Ore|11|-16993|6950|-2460}}
{{Asteroid/Item|Ore|7|-8455|-2722|8364}}
{{Asteroid/Item|Silicon|26|-2112|6614|-16511}}
{{Asteroid/Item|Silicon|26|-411|-2733|-19559}}
{{Asteroid/Item|Silicon|13|7743|6453|-13532}}
{{Asteroid/Item|Silicon|13|6479|1784|-19559}}
{{Asteroid/Item|Silicon|6|6479|-3286|-9716}}
{{Asteroid/Item|Silicon|6|8088|-5997|-17127}}
{{Asteroid/End}}
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Hatikvah%27s_Faith" title="Hatikvah's Faith" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://x3wiki.com/index.php/Hatikvah%27s_Faith">http://x3wiki.com/index.php/Hatikvah%27s_Faith</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Hatikvah%27s_Faith&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Hatikvah%27s+Faith&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Hatikvah%27s+Faith&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
