...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Rhonkar_s_Fire rootpage-Rhonkar_s_Fire skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Rhonkar's Fire</h1>
...
<input type='hidden' value="20170530230357" name="wpStarttime" />
<input type='hidden' value="20140306130236" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="15810" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{Infobox Sector
|Race=Split
|SecLevel=Border
|Population=59,569,205
|Planets=5
|SunLevel=150
|GateDist=70
...
{{Gateblock2|North|0|	0|	35280|[[Thuruk's Pride]]}}
{{Gateblock2|East|35280|	0|	0|[[Rhonkar's Clouds]]}}
{{Gateblock2|South|0|	0|	-35280|[[Family Rhonkar]]}}
&lt;/table>
}}
==Description==
The powerful Rhonkar Family runs this large [[Split]] weapons outpost. It is a heavily industrialized system with a lack of warmth and lays emphasis on functionality that is common to all Split space installations. Rhonkar Family warriors patrol their property efficiently and deal with unwanted guests with little courtesy.
...
{{Asteroid/Begin}}
{{Asteroid/Item|Ore|9|-7588|5430|-15096}}
{{Asteroid/Item|Ore|7|8100|4780|3065}}
{{Asteroid/Item|Ore|4|-16993|-1940|-3989}}
{{Asteroid/Item|Ore|2|-12406|-2263|7120}}
{{Asteroid/Item|Ore|2|-949|-1070|6482}}
{{Asteroid/End}}
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Rhonkar%27s_Fire" title="Rhonkar's Fire" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://x3wiki.com/index.php/Rhonkar%27s_Fire">http://x3wiki.com/index.php/Rhonkar%27s_Fire</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Rhonkar%27s_Fire&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Rhonkar%27s+Fire&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Rhonkar%27s+Fire&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
