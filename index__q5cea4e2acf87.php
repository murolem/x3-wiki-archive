...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<div id="bodyContent" class="mw-body-content">
					...
					<!-- start content -->
					<div id="mw-content-text"><div class="mw-ui-container"><div id="userloginprompt"></div><div id="userloginForm"><form action="/index.php?title=Special:UserLogin&amp;returnto=Teladi+Stock+Exchange" method="post" name="userlogin" class="mw-ui-vform mw-ui-container visualClear"><div>
...
<input name="wpLoginToken" type="hidden" value="579cb0591920602bfc9e6e4bd02517a65969b9aa+\"/>
<div class="mw-ui-vform-field mw-form-related-link-container"><a href="/index.php/Special:PasswordReset" title="Special:PasswordReset">Forgot your password?</a></div><div id="mw-createaccount-cta" class="mw-ui-vform-field">Don&#039;t have an account?<a id="mw-createaccount-join" href="/index.php?title=Special:CreateAccount&amp;returnto=Teladi+Stock+Exchange" class="mw-ui-button" tabindex="100">Join X3 Wiki</a></div></form></div></div></div><div class="printfooter">
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Special:UserLogin">http://www.x3wiki.com/index.php/Special:UserLogin</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				<ul>
				<li id="ca-nstab-special" class="selected"><a href="/index.php?title=Special:UserLogin&amp;returnto=Teladi+Stock+Exchange" title="This is a special page, and it cannot be edited">Special page</a></li>
				</ul>
							</div>
		</div>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Teladi+Stock+Exchange" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login" class="active"><a href="/index.php?title=Special:UserLogin&amp;returnto=Teladi+Stock+Exchange" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
		...
		<div class='pBody'>
			...
			<div class="pBody">
				<ul>
											...
											<li id="t-print"><a href="/index.php?title=Special:UserLogin&amp;returnto=Teladi+Stock+Exchange&amp;printable=yes" rel="alternate" title="Printable version of this page [p]" accesskey="p">Printable version</a></li>
									</ul>
							</div>
		</div>
