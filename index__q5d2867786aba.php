...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Hydra&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="7" name="wpSection" />
<input type='hidden' value="20120827075040" name="wpStarttime" />
...
With a large cargobay and high speed, the Hydra is an effective armed freighter, as well as being an effective platform for deploying large amounts of ordnance such as missiles, drones, lasertowers and mines.
...
<div id="column-one">
	...
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Hydra&amp;returntoquery=action%3Dedit%26section%3D7" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
