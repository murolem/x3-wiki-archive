...
<head>
<meta charset="UTF-8"/>
<title>Editing L - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"L","wgTitle":"L","wgCurRevisionId":14200,"wgRevisionId":0,"wgArticleId":593,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"L","wgRelevantArticleId":593,"wgRequestId":"Wlgb4FkfZokAAFicGCUAAAAJ","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia","wgEditMessage":"editing"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-L rootpage-L skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing L</h1>
...
<p><strong>Warning:</strong> You are not logged in. Your IP address will be publicly visible if you make any edits. If you <strong><a class="external text" href="http://www.x3wiki.com/index.php?title=Special:UserLogin&amp;returnto=L">log in</a></strong> or <strong><a class="external text" href="http://www.x3wiki.com/index.php?title=Special:CreateAccount&amp;returnto=L">create an account</a></strong>, your edits will be attributed to your username, along with other benefits.
</p>
</div>
<div id="wikiPreview" class="ontop" style="display: none;"><div lang="en" dir="ltr" class="mw-content-ltr"></div></div><form id="editform" name="editform" method="post" action="/index.php?title=L&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntispam">Anti-spam check.
...
<input type='hidden' value="20180112022224" name="wpStarttime" />
<input type='hidden' value="20140115034801" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="14200" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{Infobox open}}
{{Infobox variant
|Variant=L
|Faction=Xenon
|Class={{M3class}}
...
{{Infobox close}}
==Overview==
The L is most commonly found equipped with the powerful [[Pulsed Beam Emitter]]. However, it does not have the generator power to feed more than two of these weapons. When encountered, this ship can deal a serious amount of damage in a very short time, but will quickly run out of puff so isn't the most serious of threats. Also, it does not have any turrets, so players can exploit this weakness by launching missiles before it gets into firing range.

==Background==
Until recently the L was the most powerful Xenon fighter developed; it is armed with multiple lasers, and powerful shields. These ships are often seen attacking passing ships trying to take shortcuts through their sectors. Like other Xenon ships, the L has been updated in the last few years.
==Physical Characteristics==
== Combat ==
Dogfighting in the L requires careful management of weapons energy, but otherwise, standard tactics of point and shoot make this fighter effective enough to compete respectably in a battle.

The L is slow, but like all [[Xenon]] designs, it has versatile loadout options.
...
Like all Xenon craft below M6s, the L must be capped in order to be acquired for personal use.

== Suggested Roles==

The L is not a remarkable fighter to use due to its middling energy capacity and recharge rate, and the existence of the far superior [[LX]] makes the L obsolete in any role.
...
! Ware !! Amount
|- valign="top"
|[[Energy Cells]]||{{formatnum:784}}
|-
|[[Teladianium]]||{{formatnum:24}}
|-
|[[Cloth Rimes]]||8
|-
|[[Rastar Oil]]||16
...
|[[Ore]]||{{formatnum:32}}
|-
|[[Silicon|Silicon Wafers]]||{{formatnum:24}}
|-
|[[Crystals]]||8
|-
|[[Quantum Tubes]]||8
...
|-
|Shipwright Fee ([[Credits]])|| {{formatnum:231280}}
|-
|Build Time (game time)&lt;bR>(hh:mm:ss)||	00:41:44
|}
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/L" title="L" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/L">http://www.x3wiki.com/index.php/L</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=L&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=L&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=L&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
