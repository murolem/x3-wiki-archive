...
<head>
<meta charset="UTF-8" /><title>Editing A New Home spoilers - X3 Wiki</title>
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing A New Home spoilers</span></h1>
...
<input type='hidden' value="20160424010447" name="wpStarttime" />
<input type='hidden' value="20120518052640" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary" /><input type="hidden" value="0" name="oldid" /><input type="hidden" value="text/x-wiki" name="format" /><input type="hidden" value="wikitext" name="model" /><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">The ANH plot gives the reward of a Sector, which can be chosen by the player. There is a cost incurred of a third of a billion Credits for access to the Sector.

See http://forum.egosoft.com/viewtopic.php?t=287107

==Possible Personal Sector Names==
*[[Guiding Star]]
*[[CEO's Wellspring]]
*[[Cathedral of Xaar]]
*[[Spires of Elusion]]
...
<div id="column-one">
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=A+New+Home+spoilers&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=A+New+Home+spoilers&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
