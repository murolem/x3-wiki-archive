...
<head>
<meta charset="UTF-8" /><title>Editing Orca - X3 Wiki</title>
...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Orca","wgTitle":"Orca","wgCurRevisionId":13923,"wgRevisionId":0,"wgArticleId":238,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Orca","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia"});
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Orca skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Orca</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Orca&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20160915014700" name="wpStarttime" />
<input type='hidden' value="20130930135453" name="wpEdittime" />
...
|Faction=Boron
|Class={{TLclass}}
|Priceblock={{Priceblock||22.344.668}}
|Minspeed=73.90
|Maxspeed=110.80
|Minaccel=4
|Maxaccel=6
...
{{Infobox close}}
==Overview==
The Boron TL is considered a faster version of the Argon Mammoth in usage, with a respectable cargo capacity and similar pricing.  

As with all TL class ships, it is terribly undershielded, and liable to explode upon exiting a gate when anything larger than a corvette is ahead of it. Of course, the Orca's large size even when compared to other TLs exacerbates this problem.

A common issue with the Orca is its width in the rear area; it is actually wider than it appears when piloting it, so caution must be taken to steer clearly of other ships, gates, and stations, in order to avoid collisions.

==Background==
The Boron Orca is a heavy-duty transporter craft, fractionally bigger than the Argon Mammoth. It cannot dock directly at a space station and has to rely on a relay of smaller ships to ferry cargo backwards and forwards to it. Despite looking cumbersome the Orca is maneuverable and is slightly faster than the Argon Mammoth. Many of these ships are privately owned and it is possible to hire them - for a price.

==Physical Characteristics==
It has a similar shape to other Boron big ships such as the Shark, although its rear section is slightly wider than that of the others.
== Combat ==
Like all TLs the Orca can defend itself when attacked by [[:Category:fighters|fighters]], but not larger ships.

== Equipment ==
== Availability ==

=== For Sale at Known Shipyards ===
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Orca" title="Orca" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a href="http://x3wiki.com/index.php/Orca">http://x3wiki.com/index.php/Orca</a>"</div>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Orca&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
				<li id="ca-history"><a href="/index.php?title=Orca&amp;action=history" rel="archives" title="Past revisions of this page [h]" accesskey="h">History</a></li>
			</ul>
		</div>
	</div>
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Orca&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Orca&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
	...
	<div class="portlet" id="p-tb" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="t-info"><a href="/index.php?title=Orca&amp;action=info">Page information</a></li>
			</ul>
		</div>
	</div>
