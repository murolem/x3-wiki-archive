...
<head>
<meta charset="UTF-8" /><title>Editing Tri-Beam Cannon - X3 Wiki</title>
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Tri-Beam_Cannon skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Tri-Beam Cannon</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Tri-Beam_Cannon&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20160909165423" name="wpStarttime" />
<input type='hidden' value="20131119054755" name="wpEdittime" />
...
==Commentary==
The Tri-Beam Cannon is one of the semi-implemented experimental beam weapons, and has the worst compatibility of the lot: only the Goner Truelight Seeker is compatible, and probably only because it got a mostly blanket compatibility anyway.
It has few redeeming features if scripted in, with damage, range and suchlike being quite similar to the [[Plasma Beam Cannon]], though the PBC has vanilla applications in the form of lasertowers, and better non-vanilla prospects than the TBC due to wider compatiblity.
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Tri-Beam_Cannon" title="Tri-Beam Cannon" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a href="http://www.x3wiki.com/index.php/Tri-Beam_Cannon">http://www.x3wiki.com/index.php/Tri-Beam_Cannon</a>"</div>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Tri-Beam_Cannon&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Tri-Beam+Cannon&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Tri-Beam+Cannon&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
