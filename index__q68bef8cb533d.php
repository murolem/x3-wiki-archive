...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Traders rootpage-Traders skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Traders</h1>
...
<p><strong>Warning:</strong> You are not logged in. Your IP address will be publicly visible if you make any edits. If you <strong><a class="external text" href="http://x3wiki.com/index.php?title=Special:UserLogin&amp;returnto=Traders">log in</a></strong> or <strong><a class="external text" href="http://x3wiki.com/index.php?title=Special:CreateAccount&amp;returnto=Traders">create an account</a></strong>, your edits will be attributed to your username, along with other benefits.
</p>
</div>
<div id="wikiPreview" class="ontop" style="display: none;"><div lang="en" dir="ltr" class="mw-content-ltr"></div></div><form id="editform" name="editform" method="post" action="/index.php?title=Traders&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntispam">Anti-spam check.
...
<input type='hidden' value="20170525113817" name="wpStarttime" />
<input type='hidden' value="20140718203558" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="16332" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{See also|Universe Traders Guide}}

By default, the game only includes two kinds of Trader - the Sector Trader, and the Universe Trader. Following the installation of the [[Bonus Pack]], two more are available to the player - the [[Commercial Agent|CAG]] (Commercial Agent) and the [[Commodity Logistics Software|CLS Trader]]. This page primarily refers to those native to the game. Please consult the relative pages for more information regarding the other types of trader, and their advantages and disadvantages Vs. Sector and Universe Traders.


By installing the [[Trade Command Software|Trade Command Software mk 3]] in an XL-capable ship, the '''Sector Trader''' and '''Universe Trader''' commands become available. Both these commands allow autonomous trading to be conducted.
...
|-
|11	||	Chief Paymaster			||	3			||	
|-
|12	||	Trade Negotiator		||	4			||	
|-
...
|17	||	Major Trader			||	5			||	
|-
|18	||	International Trader		||	8			||	
|-
|19	||	Dealer				||	8			||	
|-
|20	||	Major Dealer			||	10			||	Sector Trader will stop gaining levels at 20
|-
|21	||	International Dealer		||	10			||	
|-
|22	||	Production Assistant		||	10			||	
|-
|23	||	Production Expert		||	10			||	
|-
|24	||	Production Manager		||	10			||	
|-
|25	||	Production Director		||	10			||	
|}

== Other Traders ==
The other two types of trader, the [[Commercial Agent]] and the [[Commodity Logistics Software|CLS Trader]] both fulfil very different roles to the two traders mentioned above.

=== CAG ===
{{Main|Commercial Agent}}
...
==See Also==
*[{{linky}}downloads.thexuniverse.us/symtec/trader/datasheet_en.pdf PDF datasheet]
*[{{linky}}forum.egosoft.com/viewtopic.php?t=334255 Tim's CLS2 Guide]
*[{{linky}}forum.egosoft.com/viewtopic.php?t=121043 Old Guide for Reunion] (Still somewhat relevant)
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Traders" title="Traders" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<li><a href="/index.php/Template:Linky" title="Template:Linky">Template:Linky</a> (<a href="/index.php?title=Template:Linky&amp;action=edit" title="Template:Linky">edit</a>) </li><li><a href="/index.php/Template:Main" title="Template:Main">Template:Main</a> (<a href="/index.php?title=Template:Main&amp;action=edit" title="Template:Main">edit</a>) </li><li><a href="/index.php/Template:See_also" title="Template:See also">Template:See also</a> (<a href="/index.php?title=Template:See_also&amp;action=edit" title="Template:See also">edit</a>) </li><li><a href="/index.php/Template:Trading" title="Template:Trading">Template:Trading</a> (<a href="/index.php?title=Template:Trading&amp;action=edit" title="Template:Trading">edit</a>) </li></ul></div><div class="hiddencats"></div><div class="limitreport"></div><input type="hidden" value="1" name="wpUltimateParam"/>
</form>
...
Retrieved from "<a dir="ltr" href="http://x3wiki.com/index.php/Traders">http://x3wiki.com/index.php/Traders</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Traders&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Traders&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Traders&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
