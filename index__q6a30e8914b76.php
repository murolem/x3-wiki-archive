...
<form id="editform" name="editform" method="post" action="/index.php?title=Pleco&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="7" name="wpSection" />
<input type='hidden' value="20101230011722" name="wpStarttime" />
...
The Pleco is not an ideal TM for use as a fighter tender, but does well in the armoured freighter and [[traders|trader]] roles.
...
<div id="column-one">
	...
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Pleco&amp;returntoquery=action%3Dedit%26section%3D7" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
...
<!-- Served in 0.304 secs. --><script type="text/javascript">
