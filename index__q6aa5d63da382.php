...
<form id="editform" name="editform" method="post" action="/index.php?title=Aegir&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="4" name="wpSection" />
<input type='hidden' value="20110910031921" name="wpStarttime" />
...
The Aegir is unable to deal enough damage to another [[capital ship]] using only its guns - which are really only heavy corvette-grade weapons - to be effective in that respect. However, it does not need to use its guns as it equips the tremendously powerful [[Wraith Missile]]. An Aegir equipped with [[Starburst Shockwave Cannon]]s and Wraiths is essentially unbeatable by any ship in any number save an [[M7M]] class missile frigate.
...
<div id="column-one">
	...
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Aegir&amp;returntoquery=action%3Dedit%26section%3D4" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
...
</script><!-- Served in 0.271 secs. --></body></html>