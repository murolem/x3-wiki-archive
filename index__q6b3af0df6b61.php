...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Solano rootpage-Solano skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Solano</h1>
...
<p><strong>Warning:</strong> You are not logged in. Your IP address will be publicly visible if you make any edits. If you <strong><a class="external text" href="http://www.x3wiki.com/index.php?title=Special:UserLogin&amp;returnto=Solano">log in</a></strong> or <strong><a class="external text" href="http://www.x3wiki.com/index.php?title=Special:CreateAccount&amp;returnto=Solano">create an account</a></strong>, your edits will be attributed to your username, along with other benefits.
</p>
</div>
<div id="wikiPreview" class="ontop" style="display: none;"><div lang="en" dir="ltr" class="mw-content-ltr"></div></div><form id="editform" name="editform" method="post" action="/index.php?title=Solano&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntispam">Anti-spam check.
...
<input type='hidden' value="20170720175153" name="wpStarttime" />
<input type='hidden' value="20161016124520" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="16807" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{Infobox open}}
{{Infobox variant
|Variant=Solano
|Faction=OTAS
|Class={{M4+class}}
|Priceblock={{Priceblock|Confirmed Friend| 1261300}}
|Minspeed= 75 
|Maxspeed= 210 
|Minaccel= 23.4 
|Maxaccel= 65.52 
...
{{Infobox close}}
==Overview==
The Solano is an extremely deadly ship for its size. Boasting all the speed and manoeuvrability of an average interceptor, its shields outclass some heavy fighters. Do not underestimate this [[OTAS]] fighter.

==Background==
===Encyclopedia Entry===
The Solano is an advanced interceptor, optimised for rapid closure on hostile intruders. It has the ability to destroy similar-sized ships or hold larger ones until reinforcements arrive.
==Physical Characteristics==
== Combat ==
Due to its heavy shielding, the Solano is even more difficult to kill than it is to catch. With its ability to mount both [[PAC]] and [[PRG]], the latter an exceptional dogfighting weapon and the former a great all-rounder, it can be tuned to a variety of tasks.

It resembles a more heavily shielded, scaled down [[Mamba]] with lighter weapons and weaker weapons recharge.
...
|}
== Availability ==
The Solano can be bought at the OTAS shipyard in [[Legend's Home]].
...
! Ware !! Amount
|- valign="top"
|[[Energy Cells]]||{{formatnum:368}}
|-
|[[Teladianium]]||{{formatnum:11}}
|-
|[[Cloth Rimes]]||3
|-
|[[Rastar Oil]]||7
...
|[[Ore]]||{{formatnum:15}}
|-
|[[Silicon|Silicon Wafers]]||{{formatnum:11}}
|-
|[[Crystals]]||3
|-
|[[Quantum Tubes]]||3
...
|-
|Shipwright Fee ([[Credits]])|| {{formatnum:108812}}
|-
|Build Time (game time)&lt;bR>(hh:mm:ss)||	00:26:09
|}

== Suggested Roles==

The Solano is a player favorite for use as a cheap carrier fighter - good survivability, speed and firepower, along with [[Mass Driver]] compatibility, make it extremely dangerous to face in large numbers.

The ship is poor against Corvette and Capital ships, however if used correctly, it can dodge most of the incoming fire from Anti-fighter cannons, with the exceptions of flak artillery and Kyon weaponry. The ship should therefore primarily be deployed against enemy fighters and bombers, while other craft target heavier vessels.
== See Also==
*[[Eurus|OTAS Eurus]]
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Solano" title="Solano" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Solano">http://www.x3wiki.com/index.php/Solano</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Solano&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Solano&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Solano&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
