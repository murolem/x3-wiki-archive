...
<head>
<meta charset="UTF-8" /><title>Editing Aldrin 2 - X3 Wiki</title>
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Aldrin_2 skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Aldrin 2</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Aldrin_2&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20160903175020" name="wpStarttime" />
<input type='hidden' value="20140227161519" name="wpEdittime" />
...
{{Gateblock|East|6000|-3000|-10000}}
{{Gateblock|South|-11000|-38000|-21000}}
{{Gateblock|West|-24000|-16000|-5000}}
&lt;/table>
}}
...
==Default [[Stations]]==
[[USC Orbital Support Station|USC Orbital Supply Base]] &lt;br />
Aldrin Energy Production Base XL alpha &lt;br />
Aldrin Mixed Food Production Base M alpha &lt;br />
Aldrin Experimental [[Electro-Magnetic Plasma Cannon Forge|EMPC Forge]] M alpha &lt;br />
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Aldrin_2" title="Aldrin 2" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a href="http://www.x3wiki.com/index.php/Aldrin_2">http://www.x3wiki.com/index.php/Aldrin_2</a>"</div>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Aldrin_2&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Aldrin+2&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Aldrin+2&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
