...
<head>
<meta charset="UTF-8" /><title>Editing Xenon Sector 101 - X3 Wiki</title>
...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Xenon_Sector_101","wgTitle":"Xenon Sector 101","wgCurRevisionId":13560,"wgRevisionId":0,"wgArticleId":966,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Xenon_Sector_101","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia"});
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Xenon_Sector_101 skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Xenon Sector 101</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Xenon_Sector_101&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20160818050629" name="wpStarttime" />
<input type='hidden' value="20130821010007" name="wpEdittime" />
...
{{Gateblock2|North|0|	0|	34650|[[Nopileos' Memorial]]}}
&lt;/table>
}}
==Description==
After the battle in the sector known today as [[Nopileos' Memorial]], the [[Xenon]] have used this sector as a junkyard, storing and recycling ships here. The coordinates for this gate were lost, but a recent survey by Argon Expeditionary forces have since rediscovered the gate's location.

In Terran Conflict, there is an [[Ownerless ships|unowned]] [[Scorpion|Scorpion Raider]] in this sector.
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Xenon_Sector_101" title="Xenon Sector 101" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<li><a href="/index.php/Template:Colour/Xenon" title="Template:Colour/Xenon">Template:Colour/Xenon</a> (<a href="/index.php?title=Template:Colour/Xenon&amp;action=edit" title="Template:Colour/Xenon">edit</a>) </li><li><a href="/index.php/Template:Gateblock2" title="Template:Gateblock2">Template:Gateblock2</a> (<a href="/index.php?title=Template:Gateblock2&amp;action=edit" title="Template:Gateblock2">edit</a>) </li><li><a href="/index.php/Template:Infobox_Sector" title="Template:Infobox Sector">Template:Infobox Sector</a> (<a href="/index.php?title=Template:Infobox_Sector&amp;action=edit" title="Template:Infobox Sector">edit</a>) </li></ul></div><div class="hiddencats"></div><div class="limitreport"></div>
</form>
</div><div class="printfooter">
Retrieved from "<a href="http://x3wiki.com/index.php/Xenon_Sector_101">http://x3wiki.com/index.php/Xenon_Sector_101</a>"</div>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Xenon_Sector_101&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Xenon+Sector+101&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Xenon+Sector+101&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
