...
<head>
<meta charset="UTF-8"/>
<title>Editing Venti - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Venti","wgTitle":"Venti","wgCurRevisionId":19186,"wgRevisionId":0,"wgArticleId":280,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Venti","wgRelevantArticleId":280,"wgRequestId":"Wdzgn1kfZokAABOpYosAAAAK","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia","wgEditMessage":"editing"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Venti rootpage-Venti skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Venti</h1>
...
<p><strong>Warning:</strong> You are not logged in. Your IP address will be publicly visible if you make any edits. If you <strong><a class="external text" href="http://www.x3wiki.com/index.php?title=Special:UserLogin&amp;returnto=Venti">log in</a></strong> or <strong><a class="external text" href="http://www.x3wiki.com/index.php?title=Special:CreateAccount&amp;returnto=Venti">create an account</a></strong>, your edits will be attributed to your username, along with other benefits.
</p>
</div>
<div id="wikiPreview" class="ontop" style="display: none;"><div lang="en" dir="ltr" class="mw-content-ltr"></div></div><form id="editform" name="editform" method="post" action="/index.php?title=Venti&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntispam">Anti-spam check.
...
<input type='hidden' value="20171010150047" name="wpStarttime" />
<input type='hidden' value="20170826013031" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="19186" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{Infobox open}}
{{Infobox variant
|Variant=Venti
|Faction=OTAS
|Class={{M3class}}
|Priceblock={{Priceblock|Argon|Accepted Advisor 3,314,764}}
|Minspeed=78
|Maxspeed=195
|Minaccel=16.49
|Maxaccel=41.23
...
{{Infobox close}}
==Overview==
An extremely dangerous fighter, the Venti is fast, well-shielded and has a massive frontal weapons array with 10 hardpoints. Its small laser generator can be bypassed by using the [[Energy Bolt Chaingun]] or the low-consumption [[Plasma Burst Generator]], which makes the Venti obscenely dangerous. A very powerful asset.

The only drawback of the Venti is the rather cramped cargo bay, which cannot compete with other M3s/M3+s, so don't over-compensate with your choice of weapons.

==Background==
Like all ships designed and built by OTAS, it is extremely well made and some say this is one of the most advanced class of M3s in the modern age. Many believe this is still a prototype design as its rarely seen in space and not available to be bought. 
 
==Physical Characteristics==
Unique to all ship designs - the Venti has a dual mini-gun set up (aka 'Gatling gun'). This gives the impression it can deliver a huge amount of firepower, something backed up by the actual delivery of a fully armed 10 frontal weapons array. Arguably the coolest fighter in the game, though its paintwork could do with some spiffing up - it looks rusty!

== Combat ==
Swift, agile, well fortified and packing a serious wallop, the Venti is an exceptional dogfighter. It will run out of energy quite quickly if it is filled with heavy energy-draining weapons such as the [[High Energy Plasma Thrower|HEPT]] but even then can still eke out enough energy to support continuous fire from at least one weapon. Be wary of its physical ammo consumption as well - when equipped with many [[Energy Bolt Chaingun]]s, it can run out of ammunition quickly and will need to be resupplied often.
...
|}
== Availability ==
This ship is only available as a reward for completing a high level OTAS mission. So in theory the player can only ever own one Venti. In practice, it can be reverse engineered and constructed at the player headquarters, or several of them can be obtained during the OTAS plot chain using an exploit.
Can be purchased at OTAS shipyard in Albion Prelude.

== Suggested Roles==

The Venti makes for an excellent carrier-worthy fighter, once reverse-engineered in the player HQ. In numbers, they can easily shred any fighter and capital ship within minutes to seconds.
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Venti" title="Venti" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Venti">http://www.x3wiki.com/index.php/Venti</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Venti&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Venti&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Venti&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
