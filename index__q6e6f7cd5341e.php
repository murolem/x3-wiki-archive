...
Do <b>NOT</b> fill this in!</label><input type="text" name="wpAntispam" id="wpAntispam" value="" /></div><input type='hidden' value="16" name="wpSection" />
<input type='hidden' value="20160708062912" name="wpStarttime" />
...
The Vulture often suffers in comparison to the Boron Dolphin. It features a minor improvement in speed and price at the cost of a smaller cargo bay and weaker shields.  They can however fill the same roles.
*Station Trader
*Manual Trader

Like most TS class ships, the relatively weak shields and low speeds mean they should be kept away from combat.
...
<div id="column-one">
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Vulture&amp;returntoquery=action%3Dedit%26section%3D16&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Vulture&amp;returntoquery=action%3Dedit%26section%3D16" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
