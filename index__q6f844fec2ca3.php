...
wgNamespaceNumber=0,
wgPageName="Heavy_shield_Production_Complex",
wgTitle="Heavy shield Production Complex",
wgAction="edit",
wgArticleId=0,
wgIsArticle=false,
wgUserName=null,
...
<body class="mediawiki ltr ns-0 ns-subject page-Heavy_shield_Production_Complex skin-monobook">
<div id="globalWrapper">
<div id="column-content"><div id="content" >
	<a id="top"></a>
	
	<h1 id="firstHeading" class="firstHeading">Heavy shield Production Complex</h1>
	<div id="bodyContent">
...
<form id="editform" name="editform" method="post" action="/index.php?title=Heavy_shield_Production_Complex&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="" name="wpSection" />
<input type='hidden' value="20110104093839" name="wpStarttime" />
<input type='hidden' value="20110104093840" name="wpEdittime" />
...
<div id="column-one">
	...
	<div class="portlet" id="p-tb">
		...
		<div class="pBody">
			<ul>
				<li id="t-whatlinkshere"><a href="/index.php/Special:WhatLinksHere/Heavy_shield_Production_Complex" title="List of all wiki pages that link here [j]" accesskey="j">What links here</a></li>
...
<!-- Served in 0.288 secs. --><script type="text/javascript">
