...
<head>
<meta charset="UTF-8"/>
<title>Editing Acinonyx Prototype - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Acinonyx_Prototype","wgTitle":"Acinonyx Prototype","wgCurRevisionId":16870,"wgRevisionId":0,"wgArticleId":2117,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Acinonyx_Prototype","wgRelevantArticleId":2117,"wgRequestId":"WdzfKVkfZokAAA0V4IoAAAAI","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia","wgEditMessage":"editing"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Acinonyx_Prototype rootpage-Acinonyx_Prototype skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Acinonyx Prototype</h1>
...
<input type='hidden' value="20171010145433" name="wpStarttime" />
<input type='hidden' value="20170218142228" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="16870" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{Infobox open}}
{{Infobox variant
|Variant=Acinonyx Prototype
|Faction=Split
|Class={{M6+class}}
|Priceblock={{Priceblock|Honoured Strong Arm of Rhonkar| 24m}}
|Minspeed=100
|Maxspeed=190
|Minaccel=7
|Maxaccel=13.3
...
==Overview==
The Acinonyx Prototype is the newest [[M6+]] introduced in Albion Prelude 3.0. It has formidable speed, strong laser recharge and massive frontal firepower. It is the only ship other than [[M7M]]s able to fire [[Boarding Pods|boarding pods]].

==Background==
===Encyclopedia Entry===
This unique ship was custom built to act as a testbed for newly developed technologies. It was designed completely from scratch to incorporate Ho t'Sh't's prototype Matter/Antimatter engine. Equipped with expanded laser generators for weapons testing and missile systems, which have been modified to launch boarding pods, the Acinonyx Prototype is a force to be reckoned with.
==Physical Characteristics==
The Acinonyx resembles a Terran ship, except with typical Split modifications. It is essentially a catamaran, with two symmetrical hulls joined together by the cockpit. The main guns are located immediately in front of the cockpit, and spin like a minigun when fired. The ship is the typical Split rust-red color with yellow lighting.
==Combat==
The Acinonyx features twelve forward batteries able to fire the high-damage [[Concussion Impulse Generator]] or [[Ion Shard Railgun]], with a large energy reserve and powerful generator. Notably, it can fire [[Hammer Heavy Torpedo]]es, an extremely powerful tool for dealing with large targets, though the ship cannot fire them in barrages like [[M7M]]s can.

Though dangerous from the front, the Acinonyx has only average shielding for its class, and its defensive turrets do not mount any heavy weaponry. However, it can easily outrun any target it cannot outgun.
...
==Availability==
This ship is only available as a reward for completing the Shady Business plot. Like the X-Shuttle, it can't be reverse-engineered in a PHQ.
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Acinonyx_Prototype" title="Acinonyx Prototype" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Acinonyx_Prototype">http://www.x3wiki.com/index.php/Acinonyx_Prototype</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-talk" class="new"><a href="/index.php?title=Talk:Acinonyx_Prototype&amp;action=edit&amp;redlink=1" rel="discussion" title="Discussion about the content page [t]" accesskey="t">Discussion</a></li>
				<li id="ca-edit" class="selected"><a href="/index.php?title=Acinonyx_Prototype&amp;action=edit" title="Edit this page">Edit</a></li>
				<li id="ca-history"><a href="/index.php?title=Acinonyx_Prototype&amp;action=history" title="Past revisions of this page [h]" accesskey="h">History</a></li>
				</ul>
							</div>
		</div>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Acinonyx+Prototype&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Acinonyx+Prototype&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
		...
		<div class='pBody'>
			...
			<div class="pBody">
				<ul>
											...
											<li id="t-info"><a href="/index.php?title=Acinonyx_Prototype&amp;action=info" title="More information about this page">Page information</a></li>
									</ul>
							</div>
		</div>
