...
<head>
<title>Editing Unknown Sector (8,8) (section) - X3 Wiki</title>
<meta charset="UTF-8" />
...
//]]>--></script>
	...
	<h1 id="firstHeading" class="firstHeading"><span dir="auto">Editing Unknown Sector (8,8) (section)</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Unknown_Sector_(8,8)&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="3" name="wpSection" />
<input type='hidden' value="20120801034910" name="wpStarttime" />
<input type='hidden' value="20101018191118" name="wpEdittime" />
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='editHelp'><a href="/index.php/Unknown_Sector_(8,8)" title="Unknown Sector (8,8)" id="mw-editform-cancel">Cancel</a> | <a target="helpwindow" href="/index.php/Help:Editing">Editing help</a> (opens in new window)</span>
</div><!-- editButtons -->
</div><!-- editOptions -->
	...
	<div id="p-cactions" class="portlet">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Unknown_Sector_(8,8)&amp;action=edit" primary="1" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Unknown+Sector+%288%2C8%29&amp;returntoquery=action%3Dedit%26section%3D3" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
