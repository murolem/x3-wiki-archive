...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Octopus rootpage-Octopus skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Octopus</h1>
...
<p><strong>Warning:</strong> You are not logged in. Your IP address will be publicly visible if you make any edits. If you <strong><a class="external text" href="http://x3wiki.com/index.php?title=Special:UserLogin&amp;returnto=Octopus">log in</a></strong> or <strong><a class="external text" href="http://x3wiki.com/index.php?title=Special:CreateAccount&amp;returnto=Octopus">create an account</a></strong>, your edits will be attributed to your username, along with other benefits.
</p>
</div>
<div id="wikiPreview" class="ontop" style="display: none;"><div lang="en" dir="ltr" class="mw-content-ltr"></div></div><form id="editform" name="editform" method="post" action="/index.php?title=Octopus&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntispam">Anti-spam check.
...
<input type='hidden' value="20170724150831" name="wpStarttime" />
<input type='hidden' value="20130930135359" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="13919" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{Infobox open}}
{{Infobox variant
|Variant=Octopus
|Faction=Boron
|Class={{M5class}}
|Priceblock={{Priceblock|Trusted Courtier|73732}}
|Minspeed=142.6
|Maxspeed=427.8
|Minaccel=67
|Maxaccel=202
...
|Slot=Main
|Guncount=4
|ire=1|pac=0|hept=0|cig=0|ppc=0|md=0|us=0|prg=0
|cfaa=0|pbc=0|id=0|ipg=0|ic=0|fbl=0|psg=0|tbc=0
|ebc=0|faa=0|gc=0|pbe=0|isr=0|palc=0|pbg=0|ibl=0
|empc=0|maml=0|ssc=0|psp=0|fbc=0|ake=0|bke=0
|gke=0|eempc=0|pmaml=0|pssc=0|eempc=0
}}
&lt;/table>
|Dockbay=
}}
{{Infobox variant
|Variant=Octopus Raider
|Faction=Boron
|Class={{M5class}}
|Priceblock={{Priceblock|Trusted Courtier|108914}}
|Minspeed=181.1
|Maxspeed=543.4
|Minaccel=85
|Maxaccel=257
...
{{Infobox variant
|Variant=Octopus Sentinel
|Faction=Boron
|Class={{M5class}}
|Priceblock={{Priceblock|Trusted Courtier|106543}}
|Minspeed=116.9
|Maxspeed=350.8
|Minaccel=55
|Maxaccel=166
...
{{Infobox variant
|Variant=Octopus Vanguard
|Faction=Boron
|Class={{M5class}}
|Priceblock={{Priceblock|Trusted Courtier|81325}}
|Minspeed=156.8
|Maxspeed=470.6
|Minaccel=74
|Maxaccel=223
...
! Variant !! [[Kingdom End]] !! [[Ocean of Fantasy]] !! [[Lucky Planets]] !! [[Depths Of Silence]] !! [[Great Reef]] !! [[Queen's Retribution]]
|-
! Octopus || x ||  || || || x || x
|-
! Octopus Raider ||  ||  || ||  ||  || x
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Octopus" title="Octopus" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://x3wiki.com/index.php/Octopus">http://x3wiki.com/index.php/Octopus</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Octopus&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Octopus&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Octopus&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
