...
<!-- Saved in parser cache with key dailystunt_wiki:pcache:idhash:596-0!*!0!!en!*!edit=0 and timestamp 20110827204741 -->
	...
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Xenon_P&amp;returntoquery=printable%3Dyes" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
...
<li id="t-specialpages"><a href="/index.php/Special:SpecialPages" title="List of all special pages [q]" accesskey="q">Special pages</a></li>
				<li id="t-permalink"><a href="/index.php?title=Xenon_P&amp;oldid=6864" title="Permanent link to this revision of the page">Permanent link</a></li>			</ul>
		</div>
	</div>
...
<div id="footer">
	...
	<ul id="f-list">
		<li id="lastmod"> This page was last modified on 8 August 2011, at 21:18.</li>
		<li id="viewcount">This page has been accessed 2,254 times.</li>
...
<script>if ( window.mediaWiki ) {
	mediaWiki.config.set({"wgCanonicalNamespace": "", "wgCanonicalSpecialPageName": false, "wgNamespaceNumber": 0, "wgPageName": "Xenon_P", "wgTitle": "Xenon P", "wgAction": "view", "wgArticleId": 596, "wgIsArticle": true, "wgUserName": null, "wgUserGroups": ["*"], "wgCurRevisionId": 6864, "wgCategories": ["Impulse Ray Emitter", "Particle Accelerator Cannon", "High Energy Plasma Thrower", "Utility Slot", "Phased Repeater Gun", "Fragmentation Bomb Launcher", "Ion Shard Railgun", "Electro-Magnetic Plasma Cannon", "Pulsed Beam Emitter", "M6", "Board to Capture", "Boarding Ship"], "wgBreakFrames": false, "wgRestrictionEdit": [], "wgRestrictionMove": []});
}
</script>
<script>if ( window.mediaWiki ) {
...
</script><!-- Served in 0.283 secs. --></body></html>