...
<head>
<meta charset="UTF-8"/>
<title>Editing Heavy Centaur - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Heavy_Centaur","wgTitle":"Heavy Centaur","wgCurRevisionId":16363,"wgRevisionId":0,"wgArticleId":234,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Heavy_Centaur","wgRelevantArticleId":234,"wgRequestId":"WkipOFkfZokAAC4sRKMAAAAC","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia","wgEditMessage":"editing"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Heavy_Centaur rootpage-Heavy_Centaur skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Heavy Centaur</h1>
...
<input type='hidden' value="20171231090912" name="wpStarttime" />
<input type='hidden' value="20140727142305" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="16363" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{Infobox open}}
{{Infobox variant
|Variant=Heavy Centaur 
|Faction=Argon
|Class={{M6+class}}
|Priceblock={{Priceblock|Federation Guardian| 14377642}}
|Minspeed= 57.5 
|Maxspeed= 115
|Minaccel=4
|Maxaccel=8
|Minsteer= 1.6
|Maxsteer= 3.3
|Hull= 67000 / 268000 (AP)
|Maxshield=200 MJ
|Shieldslots=4
|Maxshieldstrength= 800
|Shieldreactor= 2800
|Cargoclass=XL
|Mincargo= 500 
|Maxcargo= 975
...
{{Infobox variant
|Variant=Heavy Centaur Prototype
|Faction=Argon
|Class={{M6+class}}
|Priceblock=
|Minspeed= 77 
...
{{Infobox close}}
==Overview==
A vastly improved version of the basic centaur design, improving on almost everything apart from turning, speed and cargo space. A much appreciated design improvement is its increased range of weapon choices and its impressive angle of turret coverage. 
   
==Background==
Argon naval draughtsmen spent months asking themselves how to improve the [[Centaur]]. With better shields, weapons and engines and absolutely no frills, the new 'Heavy' Centaur is their response.

==Variants==
===Heavy Centaur===
The basic heavy centaur is much like the regular centaur, but with better firepower and protection. It has an extra 200MJ shield slot, but, more importantly, it has a largely improved energy reserve and recharge rates, giving it much better damage potential. In terms of speed it is slightly slower. While the standard version packs a nasty punch for its size it does suffer from low top speed which is comparable to many [[M7]] class craft. If it enters a heavy firefight it does not lend itself well to conventional escape; it must rely on its Jumpdrive.

===Heavy Centaur Prototype===
Built for testing before full production, this design proved to be far too expensive and sacrifices were made to its engines, shield and laser batteries to reduce production costs. Some examples can still be seen flying in space, but are operated by the Argon military and are not for sale. It eliminates the major flaw of the standard design; instead of being relatively slow for an [[M6]] it is one of the fastest. This version is favored by players because of its speed and versatility, however its cargo space is even more limited.

==Physical Characteristics==
Apart from having similar lines, the design team threw out the original hull and started anew. Its main characteristics is its vastly increased engine/thruster design, rotating radar/Ldar scanner array and moving twin barrelled turrets on both port/starboard and aft behind the conning tower. Note the bridge/pilot is situated on the front of the conning tower and not on the front prow (unlike the original centaur).

== Combat ==
The ship's most major flaw is a blindspot directly below its undercarriage which its turrets cannot bear on. Using the roll thrusters is a quick and effective way around this problem, and when used to good effect, the Heavy Centaur will have the upper hand against most ships in its class and all ships it outclasses. Much like the [[Centaur]], the ability to fit [[Plasma Burst Generator|Plasma Burst Generators]] can often provide fearsome offensive potential well in excess of most M6/M6+ vessels. As an improvement over the [[Centaur]], the Heavy variant can fit them on '''every''' turret, making the ship incredibly lethal to frigates, and over time, just as lethal to capitals that outclass it. The only trade-off is a loss of 2 frontal turrets, compared with the Centaur. However, this is counterbalanced by the fact that now, when passing a ship or strafing by it, the pilot can continue raining down plasma fire. A Heavy Centaur fitted with nothing but PBGs can destroy a Xenon Q in short order, and many other capitals that have blind spots or otherwise easily dodged weaponry.
...
|}
== Availability ==
Heavy Centaur basic variant can be purchased from the [[Argon Federal Shipyard]] in [[Legend's Home]].

The Prototype variant of the Heavy Centaur is a reward for reaching rank 10 with either [[Plutarch]] or [[Jonferco]].

== Suggested Roles==
Because of its impressive range of weapons choice and turret coverage, it can be made as a pure anti corvette or a pure anti fighter class of M6. With specific fittings, it can take on some capital vessels as well (see above section: Combat)

'''''Excels as:'''''

Anti-Fighter Vessel

Anti-Corvette Vessel
...
Anti Capital ship vessel (with exceptions, see above section: Combat)

Lone Vessel

Refueling ship

Jump-Drive ship (Due to the low cargo capacity, although its capacity still allows a moderate amount of jumping around/turbo-boosting before refueling is needed)

Missile frigate

== See Also==
*[[Centaur|Argon Centaur]]
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Heavy_Centaur" title="Heavy Centaur" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Heavy_Centaur">http://www.x3wiki.com/index.php/Heavy_Centaur</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Heavy_Centaur&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Heavy+Centaur&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Heavy+Centaur&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
