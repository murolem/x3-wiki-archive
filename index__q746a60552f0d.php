...
<input type='hidden' value="20160708000712" name="wpStarttime" />
...
This sector contains one of the most varied selections of products in the known universe.  Equipment, raw materials, ship upgrades, and installations of many types can be traded here in a relatively secure environment.  This is the [[Boron]] home world and a place of quiet contemplation and study.
...
<div id="column-one">
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Kingdom+End&amp;returntoquery=action%3Dedit%26section%3D1&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Kingdom+End&amp;returntoquery=action%3Dedit%26section%3D1" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
...
<script type="text/javascript" src="//geoiplookup.wikimedia.org/"></script><!-- Served in 0.575 secs. --></body></html>