...
<head>
<meta charset="UTF-8"/>
<title>Editing Heavy Nemesis - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Heavy_Nemesis","wgTitle":"Heavy Nemesis","wgCurRevisionId":14721,"wgRevisionId":0,"wgArticleId":96,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Heavy_Nemesis","wgRelevantArticleId":96,"wgRequestId":"WkMc3FkfZokAACYMsJ4AAAAW","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia","wgEditMessage":"editing"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Heavy_Nemesis rootpage-Heavy_Nemesis skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Heavy Nemesis</h1>
...
<input type='hidden' value="20171227040900" name="wpStarttime" />
<input type='hidden' value="20140225135155" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="14721" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{Infobox open}}
{{Infobox variant
|Variant=Heavy Nemesis
|Faction=Paranid
|Class={{M6+class}}
|Priceblock={{Priceblock|Priest Protectorate| 14377642 }}
|Minspeed=62.2
|Maxspeed=124.5
|Minaccel=4
|Maxaccel=8
...
==Overview==
The [[Paranid]] '''Heavy Nemesis''' is one of the most stylish ships in ''[[X3: Terran Conflict]]'', so it would make a good personal yacht for players if not for its tiny cargo bay.  Like the original [[Nemesis]] it is a highly effective patrol craft.

==Background==
This militarized "Heavy" version of the Paranid Nemesis is a no-frills, gritty and very potent corvette.  With ramped-up performance in almost every aspect of the ship, it is the nemesis of almost every opponent.

==Physical Characteristics==
The Heavy Nemesis addresses the turret problem in the original, with three dual turrets providing almost perfect anti-fighter defense. Its generator is improved, at average level for the heavy corvettes, and it has respectable speed while retaining a low profile, allowing it to easily evade attacks by strafing when player-controlled.

== Combat ==
Like its predecessor, the Heavy Nemesis can mount the [[Ion Shard Railgun]], but still has insufficient power to justify the weapon's use.  It can still severely lower the energy available to some battleships or [[TL]]s.

== Equipment ==
Like many [[M6+]] craft, the Heavy Nemesis mounts [[Shields#200 MJ|4x200MJ]] shields, making it quite difficult to destroy using low-key weapons.  It can use a wide variety of weapons, usually [[High Energy Plasma Thrower]]s, [[Ion Shard Railgun]]s or [[Concussion Impulse Generator]]s on its fixed mounts, and assorted light armaments in the turrets, such as the [[Particle Accelerator Cannon]] or [[Pulsed Beam Emitter]].
...
== Availability ==
The Heavy Nemesis is available at two [[Paranid Shipyard]]s for around 14 million credits, which is about average for this type of ship. If purchase is not an option, they are often found escorting Paranid warships or in patrol groups and can be boarded.  It rarely goes unescorted.
...
== Suggested Roles==
A highly versatile craft in combat, the Heavy Nemesis can lead sector patrols with a fighter escort.  It is also fast enough to keep up with almost all frigates and other battleships, so is effective as an escort.  However, its cramped cargo bay prevents it from being useful as a player ship.

== See Also==
*[[Nemesis|Paranid Nemesis]]
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Heavy_Nemesis" title="Heavy Nemesis" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Heavy_Nemesis">http://www.x3wiki.com/index.php/Heavy_Nemesis</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Heavy_Nemesis&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Heavy+Nemesis&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Heavy+Nemesis&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
