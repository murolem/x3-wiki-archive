...
<head>
<meta charset="UTF-8" /><title>Editing Engine Tuning (section) - X3 Wiki</title>
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Engine Tuning (section)</span></h1>
...
<input type='hidden' value="20160925124014" name="wpStarttime" />
...
<div id="column-one">
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Engine+Tuning&amp;returntoquery=action%3Dedit%26section%3D1&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Engine+Tuning&amp;returntoquery=action%3Dedit%26section%3D1" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
