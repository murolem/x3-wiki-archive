...
<head>
<meta charset="UTF-8"/>
<title>Editing Tormented Teladi plot (section) - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Tormented_Teladi_plot","wgTitle":"Tormented Teladi plot","wgCurRevisionId":12341,"wgRevisionId":0,"wgArticleId":2196,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Tormented_Teladi_plot","wgRelevantArticleId":2196,"wgRequestId":"WRt5Y1kfZokAABAYPugAAAAB","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia","wgEditMessage":"editingsection"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Tormented_Teladi_plot rootpage-Tormented_Teladi_plot skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Tormented Teladi plot (section)</h1>
...
<input type='hidden' value="20170516221251" name="wpStarttime" />
<input type='hidden' value="20130601210400" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="facefd1d934face8e8035404f17dd75e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="12341" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">==Part 1==

As you should be aware, you now have only 12 hours to raise the required 2,250,000Cr to pay the fines that you have been issued. contact me at Teladi Trading Station in Tears of Greed when you have acquired the necessary funds and the rather impressive ship we confiscated will be released back to you. Failure to do so will result in your ship being scrapped immediately. Good profit Joranas; you will need it.


# Raise 2,250,000Cr in 12 game hours
# Pay "Minisessas Towisaris Yoyunis V", Teladi Profit Guild in the Comms Channel of the Teladi [[Trading Station]]

'''Reward''':
# [[Enhanced Kea]] (2x [[High Energy Plasma Thrower]], 2x [[Fragmentation Bomb Launcher]])
</textarea><div class='editOptions'>
<span class="mw-summary" id="wpSummaryLabel"><label for="wpSummary">Summary:</label></span> <input class="mw-summary" id="wpSummary" maxlength="200" tabindex="1" size="60" spellcheck="true" title="Enter a short summary [b]" accesskey="b" value="/* Part 1 */ " name="wpSummary"/><div class='editCheckboxes'>
</div>
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Tormented_Teladi_plot" title="Tormented Teladi plot" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://x3wiki.com/index.php/Tormented_Teladi_plot">http://x3wiki.com/index.php/Tormented_Teladi_plot</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Tormented_Teladi_plot&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Tormented+Teladi+plot&amp;returntoquery=action%3Dedit%26section%3D2" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Tormented+Teladi+plot&amp;returntoquery=action%3Dedit%26section%3D2" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
