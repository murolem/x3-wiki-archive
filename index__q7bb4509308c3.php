...
<head>
<meta charset="UTF-8"/>
<title>Buy Used Ship - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Buy_Used_Ship","wgTitle":"Buy Used Ship","wgCurRevisionId":13415,"wgRevisionId":13415,"wgArticleId":464,"wgIsArticle":true,"wgIsRedirect":false,"wgAction":"view","wgUserName":null,"wgUserGroups":["*"],"wgCategories":["Missions"],"wgBreakFrames":false,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Buy_Used_Ship","wgRelevantArticleId":464,"wgRequestId":"WO8pj1kfZokAAFZbIh4AAAAM","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Buy_Used_Ship rootpage-Buy_Used_Ship skin-monobook action-view">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Buy Used Ship</h1>
				
				<div id="bodyContent" class="mw-body-content">
					<div id="siteSub">From X3 Wiki</div>
					<div id="contentSub"><div id="mw-revision-info">Revision as of 01:43, 10 August 2013 by <a href="/index.php/User:Korlus" title="User:Korlus" class="mw-userlink">Korlus</a> <span class="mw-usertoollinks">(<a href="/index.php?title=User_talk:Korlus&amp;action=edit&amp;redlink=1" class="new" title="User talk:Korlus (page does not exist)">talk</a> | <a href="/index.php/Special:Contributions/Korlus" title="Special:Contributions/Korlus">contribs</a>)</span> <span class="comment">(Missions)</span></div><br />
				<div id="mw-revision-nav">(<a href="/index.php?title=Buy_Used_Ship&amp;diff=prev&amp;oldid=13415" title="Buy Used Ship">diff</a>) <a href="/index.php?title=Buy_Used_Ship&amp;direction=prev&amp;oldid=13415" title="Buy Used Ship">← Older revision</a> | Latest revision (diff) | Newer revision → (diff)</div></div>
										<div id="jump-to-nav" class="mw-jump">Jump to: <a href="#column-one">navigation</a>, <a href="#searchInput">search</a></div>

					<!-- start content -->
					<div id="mw-content-text" lang="en" dir="ltr" class="mw-content-ltr"><p>A free standing <a href="/index.php/Missions#Offers" title="Missions">Offer</a> in space.
</p><p>Buy ship for specified money. Ship will be listed as&#160;% of hull left intact and money you need to pay for it. Keep an eye out for rare ships such as the <a href="/index.php/Hyperion" title="Hyperion">Hyperion</a> that are selling these and you might find yourself a bargain.  
</p><p>In some cases, you can find a 100% ship that you can sell for a profit at a nearby shipyard. Instant profit! (Emphasis on SOME...)
</p><p>NB: at least in version 3.0, 100% ships are usually VASTLY OVERPRICED, so you do not make a profit when you try to sell them at a shipyard.  On the other hand, the price drop from damaged ships is enormous, so if you get offered a 80% ship, and sell it on a shipyard (without repairing it), you can make around 100% profit.  Still, even the 100% offers might be useful if your race rank prohibits you from buying that ship in a regular shipyard of that race.  Also, this is a good way to buy a TS cheaply to get your trading career started.  These offers only pop up if you have a decent race rank in the sector though.
</p><p><br />
</p>
...
100.00%    4.260      1 - Template:Missions
100.00%    4.260      1 - -total
 25.78%    1.098      1 - Template:Plot_Missions
 23.66%    1.008      1 - Template:Other_Missions
 20.07%    0.855      1 - Template:Offers
-->

<!-- Saved in parser cache with key dailystunt_wiki:pcache:idhash:464-0!*!0!*!*!*!* and timestamp 20170412120823 and revision id 13415
 -->
</div><div class="printfooter">
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php?title=Buy_Used_Ship&amp;oldid=13415">http://www.x3wiki.com/index.php?title=Buy_Used_Ship&amp;oldid=13415</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-history"><a href="/index.php?title=Buy_Used_Ship&amp;action=history" title="Past revisions of this page [h]" accesskey="h">History</a></li>
				</ul>
							</div>
		</div>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Buy+Used+Ship&amp;returntoquery=oldid%3D13415" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Buy+Used+Ship&amp;returntoquery=oldid%3D13415" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
		...
		<div class='pBody'>
			...
			<div class="pBody">
				<ul>
											...
											<li id="t-print"><a href="/index.php?title=Buy_Used_Ship&amp;oldid=13415&amp;printable=yes" rel="alternate" title="Printable version of this page [p]" accesskey="p">Printable version</a></li>
											<li id="t-permalink"><a href="/index.php?title=Buy_Used_Ship&amp;oldid=13415" title="Permanent link to this revision of the page">Permanent link</a></li>
		...
		<div class="visualClear"></div>
					...
					<ul id="f-list">
									<li id="lastmod"> This page was last modified on 10 August 2013, at 01:43.</li>
