...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<div id="bodyContent" class="mw-body-content">
					...
					<!-- start content -->
					<div id="mw-content-text"><div class="mw-ui-container"><div id="userloginForm"><form action="/index.php?title=Special:CreateAccount&amp;returnto=Phased+Repeater+Gun" method="post" id="userlogin2" name="userlogin2" class="mw-ui-vform mw-ui-container visualClear"><div id="mw-createacct-status-area"></div><div>
...
<input name="wpCreateaccountToken" type="hidden" value="491352ddc31b14a9b4d257468b3378f05a5f0511+\"/>
</form></div><div class="mw-createacct-benefits-container"><h2>X3 Wiki is made by people like you.</h2><div class="mw-createacct-benefits-list"><div class="mw-number-text icon-edits"><h3>23,740</h3><p>edits</p></div><div class="mw-number-text icon-pages"><h3>1,043</h3><p>pages</p></div><div class="mw-number-text icon-contributors"><h3>1</h3><p>recent contributor</p></div></div></div></div></div><div class="printfooter">
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Special:CreateAccount">http://www.x3wiki.com/index.php/Special:CreateAccount</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				<ul>
				<li id="ca-nstab-special" class="selected"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Phased+Repeater+Gun" title="This is a special page, and it cannot be edited">Special page</a></li>
				</ul>
							</div>
		</div>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount" class="active"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Phased+Repeater+Gun" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Phased+Repeater+Gun" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
		...
		<div class='pBody'>
			...
			<div class="pBody">
				<ul>
											...
											<li id="t-print"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Phased+Repeater+Gun&amp;printable=yes" rel="alternate" title="Printable version of this page [p]" accesskey="p">Printable version</a></li>
									</ul>
							</div>
		</div>
