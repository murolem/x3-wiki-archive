...
<head>
<meta charset="UTF-8" /><title>Editing Galleon - X3 Wiki</title>
...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Galleon","wgTitle":"Galleon","wgCurRevisionId":13504,"wgRevisionId":0,"wgArticleId":170,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Galleon","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia"});
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Galleon skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Galleon</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Galleon&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20160501133719" name="wpStarttime" />
<input type='hidden' value="20130814105710" name="wpEdittime" />
...
==Overview==
The Galleon is the [[Pirates|Pirate]] faction {{M1class}}. It represents a major advancement in offensive capabilities for the Pirates, but is still no match for a [[Commonwealth]] task force unless covered by other pirate ships. It is tied with the [[Kha'ak Carrier]] for the lowest number of fighter bays out of any [[M1]] (though the Kha'ak Carrier itself has a bugged hangar bay, which effectively reduces its number to zero), and probably is the least effective of its class; this makes it unpopular as a command ship.

==Background==
===Encyclopedia Entry===
The Galleon carrier represents many years of secluded development and reverse-engineering by a cooperative of Pirate shipbuilders. Pirates can now project a fighter capability where it is most needed.

==Physical Characteristics==
== Combat ==
The Galleon's weapons array packs a punch compared to mainstream [[M1]] class ships and has above average speed to boot for its class, however, it suffers from a serious lack of shielding which gives it even less survivability against aggressive [[:Category:Capital Ships|capital ships]] than usual for a carrier. The quite small hangar capacity (bested even by the M7 Split Panther) severely limits its role as a conventional M1.

== Equipment ==
== Availability ==
This ship is not available at any [[shipyard]]s, and must be [[boarding|captured]] in order to be used.

== Suggested Roles==
Backwater patrols/trophy ship: being inferior in every meaningful aspect to a Yaki Hoshi or a Split Raptor, its use is not recommended.
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Galleon" title="Galleon" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a href="http://x3wiki.com/index.php/Galleon">http://x3wiki.com/index.php/Galleon</a>"</div>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Galleon&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Galleon&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Galleon&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
