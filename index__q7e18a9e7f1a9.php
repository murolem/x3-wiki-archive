...
<head>
<meta charset="UTF-8" /><title>Editing Heavy Osprey - X3 Wiki</title>
...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Heavy_Osprey","wgTitle":"Heavy Osprey","wgCurRevisionId":15944,"wgRevisionId":0,"wgArticleId":699,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Heavy_Osprey","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia"});
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Heavy_Osprey skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Heavy Osprey</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Heavy_Osprey&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20150227043059" name="wpStarttime" />
<input type='hidden' value="20140311090210" name="wpEdittime" />
...
{{Infobox variant
|Variant=Heavy Osprey
|Faction=Teladi
|Class={{M6+class}}
|Priceblock={{Priceblock|| 16517250}}
|Minspeed=41.8
|Maxspeed=92
|Minaccel=3
|Maxaccel=6
...
{{Infobox close}}
==Overview==
The Heavy Osprey is very heavily fortified and has excellent turret coverage, but is too slow to be used in an offensive role. Works well as a sentinel in a defensive role, where it can draw fire off the target and destroy the aggressors on its own terms.

==Background==
==Physical Characteristics==
== Combat ==
Combat in the Heavy Osprey against lighter ships tends to be to hold steady and let the turrets do their work whilst the shields absorb the damage. Against heavier ships extraordinary care has to be taken as should the ship get in too deep, it is too slow to get out again.
...
|-
! style="text-align:left;" | Heavy Osprey || x || - || - || - || - || -
|}

== Suggested Roles==
High shields and large number of anticorvette weapons make for a very effective OOS patrol ship.  As a fleet ship, it's too slow for assaults but fares better than most other corvettes against capital targets due to its ability to operate at range.  Not a great player ship as it's kind of a sitting duck regardless of who the pilot is.

== See Also==
*[[Osprey|Teladi Osprey]]
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Heavy_Osprey" title="Heavy Osprey" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Heavy_Osprey&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Heavy+Osprey&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Heavy+Osprey&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
