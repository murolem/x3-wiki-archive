...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Phantom_Missile_Fabrication_Facility rootpage-Phantom_Missile_Fabrication_Facility skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Phantom Missile Fabrication Facility</h1>
...
<input type='hidden' value="20170111235708" name="wpStarttime" />
<input type='hidden' value="20150305152352" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="16706" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">__NOTOC__
{{Infobox open}}
{{Infobox factory
|faction=Terran
|station=Phantom Missile Fabrication Facility
|hull=1000000
|shield=9
|generator=2000
|hangar=10
|cycle=00:20:00
|productnum=[[Phantom Missile]] (3)
|stationprice={{Priceblock|Terran Warrior of Io|2889112}}
|reqresources=[[Energy Cells]] (300)&lt;br>[[Ore]] (50)&lt;br>[[Terran MRE]] (50)
...
===Encyclopedia Entry===
This facility produces the [[Phantom Missile]].
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Phantom_Missile_Fabrication_Facility" title="Phantom Missile Fabrication Facility" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://x3wiki.com/index.php/Phantom_Missile_Fabrication_Facility">http://x3wiki.com/index.php/Phantom_Missile_Fabrication_Facility</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Phantom_Missile_Fabrication_Facility&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Phantom+Missile+Fabrication+Facility&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Phantom+Missile+Fabrication+Facility&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
