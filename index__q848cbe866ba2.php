...
<input type='hidden' value="20100605120823" name="wpStarttime" />

<input type='hidden' value="20100602020526" name="wpEdittime" />

<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />

<input name="wpAutoSummary" type="hidden" value="99e7f39055015702ec3e00bb5d946b10" />

<textarea name="wpTextbox1" id="wpTextbox1" cols="80" rows="25" tabindex="1" accesskey=",">==Suggested roles==

For any OOS combat role the Osaka is unmatched, but it particularly excells at anti-Q patrols in sectors bordering Xenon space.
...
<div class="editOptions"><span class="mw-summary" id="wpSummaryLabel"><label for="wpSummary">Summary:</label></span> <input name="wpSummary" size="60" value="/* Suggested roles */ " id="wpSummary" maxlength="200" tabindex="1" /><br/>
