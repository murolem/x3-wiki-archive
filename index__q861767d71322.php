...
<head>
<meta charset="UTF-8" /><title>Editing Talk:Boarding - X3 Wiki</title>
<meta name="generator" content="MediaWiki 1.22.6" />
<meta name="robots" content="noindex,nofollow" />
<link rel="alternate" type="application/x-wiki" title="Edit" href="/index.php?title=Talk:Boarding&amp;action=edit" />
<link rel="edit" title="Edit" href="/index.php?title=Talk:Boarding&amp;action=edit" />
...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"Talk","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":1,"wgPageName":"Talk:Boarding","wgTitle":"Boarding","wgCurRevisionId":7451,"wgRevisionId":0,"wgArticleId":493,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Talk:Boarding","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia"});
...
<body class="mediawiki ltr sitedir-ltr ns-1 ns-talk page-Talk_Boarding skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Talk:Boarding</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Talk:Boarding&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20140910163144" name="wpStarttime" />
<input type='hidden' value="20110921190613" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary" /><input type="hidden" value="0" name="oldid" /><input type="hidden" value="text/x-wiki" name="format" /><input type="hidden" value="wikitext" name="model" /><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">the egosoft faq on boarding
First of all it is necessary to know which ships can be boarded. See this FAQ article.

There are 2 alternative methods of boarding, irrespective of the target which you want to board: 

1) Boarding by dropping your marines into outer space by using the command console:

The following equipment is required: 
A TP, M6 or M7M class ship.
...
Position your own ship such that your own marines can reach the hostile ship’s hull (marines can fly 28m/s), and keep down the shields.

Drop the marines by using the command console ('Board Ship' in the Piracy menu, or 'Launch All Marines' in Additional Commands).

When the marines reach the ship the boarding process will start automatically. Until your Marines have breached the hull you have to keep the shields down.

After breaking through your marines will try to take over the ship (for further details please refer to the game manual).


2) Boarding by using boarding pods

The following equipment is required:
An M7M class ship (exceptions: Otas Aquilo and ATF Skirnir), or an Otas Sirokos.
...
ATTENTION: Boarding pods are missiles, and they can be targeted and destroyed by hostile turrets like every other missile in the game.
[[User:Madned|Madned]] 13:51, 27 September 2010 (CDT)

==Vandals not idiots==
178.137.171.102 is a vandal, not an idiot. That IP appears on the stop spam lists.

also given the other defacements on the boarding page, I can only assume they like the appropriateness of the article topic.

Anyone else think there has been a odd drop in the number of spammer account creation listings? calm before or the stillness following a storm? [[User:Madned|Madned]] 01:19, 16 March 2011 (CDT)


Looks like 91.207.6.174 is one heck of an on-the-ball spambot. Anything anyone can do?

Couldn't the page just be locked from non-user edits?

: possibly, but requires an administrator type [[User:Madned|Madned]] 00:44, 27 August 2011 (CDT)


Hey all. I've made a duplicate page called 'Bigship Boarding'. Provided the spambots can't read, we could abandon this page and just change all the new links to the new one.
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Talk:Boarding" title="Talk:Boarding" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a href="http://x3wiki.com/index.php/Talk:Boarding">http://x3wiki.com/index.php/Talk:Boarding</a>"</div>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="ca-nstab-main"><a href="/index.php/Boarding" title="View the content page [c]" accesskey="c">Page</a></li>
				<li id="ca-talk" class="selected"><a href="/index.php/Talk:Boarding" title="Discussion about the content page [t]" accesskey="t">Discussion</a></li>
				<li id="ca-edit" class="selected istalk"><a href="/index.php?title=Talk:Boarding&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
				<li id="ca-addsection"><a href="/index.php?title=Talk:Boarding&amp;action=edit&amp;section=new" title="Start a new section [+]" accesskey="+">+</a></li>
				<li id="ca-history"><a href="/index.php?title=Talk:Boarding&amp;action=history" rel="archives" title="Past revisions of this page [h]" accesskey="h">History</a></li>
			</ul>
		</div>
	</div>
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Talk%3ABoarding&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Talk%3ABoarding&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
...
<a href="/index.php/Main_Page" style="background-image: url(http://www.x3wiki.com/x3.jpg);" title="Visit the main page"></a>
	...
	<div class="portlet" id="p-tb" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="t-whatlinkshere"><a href="/index.php/Special:WhatLinksHere/Talk:Boarding" title="A list of all wiki pages that link here [j]" accesskey="j">What links here</a></li>
				<li id="t-recentchangeslinked"><a href="/index.php/Special:RecentChangesLinked/Talk:Boarding" title="Recent changes in pages linked from this page [k]" accesskey="k">Related changes</a></li>
				<li id="t-specialpages"><a href="/index.php/Special:SpecialPages" title="A list of all special pages [q]" accesskey="q">Special pages</a></li>
				<li id="t-info"><a href="/index.php?title=Talk:Boarding&amp;action=info">Page information</a></li>
			</ul>
		</div>
	</div>
