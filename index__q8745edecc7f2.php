...
<head>
<meta charset="UTF-8" /><title>Editing Gladiator - X3 Wiki</title>
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Gladiator skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Gladiator</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Gladiator&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20160514065925" name="wpStarttime" />
<input type='hidden' value="20140726214632" name="wpEdittime" />
...
|Faction=Argon
|Class={{M8class}}
|Priceblock={{Priceblock|Federation Guardian| 5409482}}
|Minspeed=62.5 
|Maxspeed=125
|Minaccel=8
|Maxaccel=16
...
{{Infobox close}}
==Overview==
The Gladiator is the [[Argon]] [[M8|bomber]] craft. It is one of the few bombers not crippled by a serious weakness that is easy to exploit, and is a popular ship in its class; however, it is pretty roundly beaten by the preferred [[Paranid]] [[Hades]].

==Background==
==Physical Characteristics==
Roughly twice the size of a [[Nova]], with a few more parts assembled in different areas of its frame.
== Combat ==
The Gladiator fights with [[Tomahawk Heavy Missile|Tomahawk]] missiles, and can launch up to 8 of them at once. This is enough to devastate any target, however the slow speed of Tomahawks means that the Gladiator struggles against fighters, particularly of the [[M4]] class. A point defence turret does allow it some protection against aggressors.

== Equipment ==
The Gladiator fires the [[Tomahawk Heavy Missile]].

== Availability ==
{| style="text-align:center;" cellpadding="3"
|- style="background-color:lightblue;"
! Variant !! [[Cloudbase South East]] !! [[Legend's Home]]
|-
! Gladiator || x || x ||
|}

It may also be [[bail|captured]] from [[Argon]] patrols or [[Pirates|pirate]] forces typically spawned by [[Defend_Station|station defense]] missions.

== Suggested Roles==
As a [[M8|bomber]], the Gladiator serves as a missile launching platform from relatively long range to destroy [[:Category:Capital Ships|capital ships]] and stations.
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Gladiator" title="Gladiator" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Gladiator&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Gladiator&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Gladiator&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
