...
<head>
<meta charset="UTF-8" /><title>Editing Mammoth - X3 Wiki</title>
...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Mammoth","wgTitle":"Mammoth","wgCurRevisionId":13986,"wgRevisionId":0,"wgArticleId":227,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Mammoth","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia"});
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Mammoth skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Mammoth</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Mammoth&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20160514090542" name="wpStarttime" />
<input type='hidden' value="20131103221012" name="wpEdittime" />
...
|Faction=Argon
|Class={{TLclass}}
|Priceblock={{Priceblock|Trusted Ally| 28506608 }}
|Minspeed=58.3
|Maxspeed=87.5 
|Minaccel=2
|Maxaccel=4
...
{{Infobox close}}
==Overview==
One of the better [[TL]]s in the game, the Mammoth is tied with the [[Mobile Mining Base Ship]] for the largest cargobay of any buyable ship, at 60,000 units. This means it is useful as both a mobile storage unit and a station deployer. It is somewhat slower than most other TLs, though its large freight space makes up for this. Like all of its class, the Mammoth is terribly undershielded for its size, with protection befitting an [[M6]] and poor weaponry. Though it can mount some battleship weaponry such as the [[Flak Artillery Array]] and [[Incendiary Bomb Launcher]], it lacks the generator to run full slots of either for extended periods of time.

==Background==
The Argon Mammoth is a Heavy Transporter ship, usually found in Argon Federation territory. It is so large that it cannot dock at any space station, instead it is loaded and unloaded by docking some distance from the station, having its freight ferried back and forwards by fleets of smaller transporters. These ships are owned by successful private entrepreneur pilots who have made a great investment in order to purchase them - therefore they are more than keen to hire out their services.

==Physical Characteristics==
Similar looking to both the Colossus and Titan.

== Combat ==
The Mammoth is not a warship, although it is quite capable of defending itself from small squads of fighters. Its large size more than its low shielding are what penalises it in survivability; it won't last long against any warmongering [[:Category:Capital Ships|capital ship]], and because it is slow and clumsy, it can be threatened and destroyed by [[M6]] class ships as well.
...
*Storage
*Fleet resupply
*Mobile mining ship/fleet buffer
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Mammoth" title="Mammoth" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a href="http://x3wiki.com/index.php/Mammoth">http://x3wiki.com/index.php/Mammoth</a>"</div>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Mammoth&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Mammoth&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Mammoth&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
