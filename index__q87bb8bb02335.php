...
<head>
<title>Fighter Drone - X3 Wiki</title>
<meta charset="UTF-8" />
...
<script>if(window.mw){
	mw.config.set({"wgCanonicalNamespace": "", "wgCanonicalSpecialPageName": false, "wgNamespaceNumber": 0, "wgPageName": "Fighter_Drone", "wgTitle": "Fighter Drone", "wgCurRevisionId": 7993, "wgArticleId": 1266, "wgIsArticle": true, "wgAction": "view", "wgUserName": null, "wgUserGroups": ["*"], "wgCategories": ["Impulse Ray Emitter", "Wares"], "wgBreakFrames": false, "wgRestrictionEdit": [], "wgRestrictionMove": [], "Geo": {"city": "", "country": ""}, "wgNoticeProject": "wikipedia"});
}
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Fighter_Drone action-view skin-monobook">
...
<div id="column-content"><div id="content">
	...
	<h1 id="firstHeading" class="firstHeading">Fighter Drone</h1>
	<div id="bodyContent">
		<div id="siteSub">From X3 Wiki</div>
		<div id="contentSub">
				<div id="mw-revision-info">Revision as of 01:28, 2 December 2011 by <a href="/index.php/User:Madned" title="User:Madned" class="mw-userlink">Madned</a>  <span class="mw-usertoollinks">(<a href="/index.php/User_talk:Madned" title="User talk:Madned">Talk</a> | <a href="/index.php/Special:Contributions/Madned" title="Special:Contributions/Madned">contribs</a>)</span></div>

				<div id="mw-revision-nav">(<a href="/index.php?title=Fighter_Drone&amp;diff=prev&amp;oldid=7993" title="Fighter Drone">diff</a>) <a href="/index.php?title=Fighter_Drone&amp;direction=prev&amp;oldid=7993" title="Fighter Drone">← Older revision</a> | Latest revision (diff) | Newer revision → (diff)</div>
			</div>
...
<h2><span class="editsection">[<a href="/index.php?title=Fighter_Drone&amp;action=edit&amp;section=1" title="Edit section: Overview">edit</a>]</span> <span class="mw-headline" id="Overview">Overview</span></h2>
<h3><span class="editsection">[<a href="/index.php?title=Fighter_Drone&amp;action=edit&amp;section=2" title="Edit section: Encyclopedia Entry">edit</a>]</span> <span class="mw-headline" id="Encyclopedia_Entry">Encyclopedia Entry</span></h3>
<p>A fighting drone can be launched a great distance against an enemy ship and attacks targets autonomously.
</p>
<h2><span class="editsection">[<a href="/index.php?title=Fighter_Drone&amp;action=edit&amp;section=3" title="Edit section: Commentary">edit</a>]</span> <span class="mw-headline" id="Commentary">Commentary</span></h2>
...
</p><p>For <a href="/index.php/OOS" title="OOS" class="mw-redirect">OOS</a> combat, the combination of a <a href="/index.php/TM" title="TM">TM</a> and fighter drones makes for a cheap alternative to a M5 carrier. As drones are easier to replace, attrition losses are less of a logistical problem, essentially commoditizing fighter power. In this role the superior speed of fighter drones (compared to <a href="/index.php/Fighter_Drone_MKII" title="Fighter Drone MKII">Fighter Drone MKII</a> or <a href="/index.php/Keris" title="Keris">Keris</a>) makes them more attractive for projecting power as it permits them to reach firing range faster.
</p><p>For <a href="/index.php/IS" title="IS" class="mw-redirect">IS</a> combat, the weak power of the IRE and limitations on number of platforms that may attack at once severely limits drone effectiveness and MKII or heavier drones may prove more effective.
</p>
<h2><span class="editsection">[<a href="/index.php?title=Fighter_Drone&amp;action=edit&amp;section=4" title="Edit section: Trading information">edit</a>]</span> <span class="mw-headline" id="Trading_information">Trading information</span></h2>
<table>
<tr>
<th> Sold by; </th>
...
<tr valign="top">
<td>
<ul><li>Race Factory where this ware is sold
</li></ul>
</td>
<td>
...
<h2><span class="editsection">[<a href="/index.php?title=Fighter_Drone&amp;action=edit&amp;section=5" title="Edit section: See Also">edit</a>]</span> <span class="mw-headline" id="See_Also">See Also</span></h2>
<p><a href="/index.php/Fighter_Drone_MKII" title="Fighter Drone MKII">Fighter Drone MKII</a>
</p>
<!-- 
NewPP limit report
Preprocessor node count: 485/1000000
Post-expand include size: 21946/2097152 bytes
Template argument size: 8404/2097152 bytes
Expensive parser function count: 0/100
-->

<!-- Saved in parser cache with key dailystunt_wiki:pcache:idhash:1266-0!*!0!!en!*!* and timestamp 20120509214946 -->
</div><div class="printfooter">
Retrieved from "<a href="http://www.x3wiki.com/index.php?title=Fighter_Drone&amp;oldid=7993">http://www.x3wiki.com/index.php?title=Fighter_Drone&amp;oldid=7993</a>"</div>
		<div id='catlinks' class='catlinks'><div id="mw-normal-catlinks"><a href="/index.php/Special:Categories" title="Special:Categories">Category</a>: <ul><li><a href="/index.php/Category:Wares" title="Category:Wares">Wares</a></li></ul></div><div id="mw-hidden-catlinks" class="mw-hidden-cats-hidden">Hidden category: <ul><li><a href="/index.php/Category:Impulse_Ray_Emitter" title="Category:Impulse Ray Emitter">Impulse Ray Emitter</a></li></ul></div></div>		<!-- end content -->
...
<div id="column-one">
	<div id="p-cactions" class="portlet">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-history"><a href="/index.php?title=Fighter_Drone&amp;action=history" title="Past revisions of this page [h]" accesskey="h">History</a></li>
			</ul>
		</div>
	</div>
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Fighter_Drone&amp;returntoquery=oldid%3D7993" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
	...
	<div class="portlet" id="p-tb">
		...
		<div class="pBody">
			<ul>
				...
				<li><a href="/index.php?title=Fighter_Drone&amp;oldid=7993&amp;printable=yes" rel="alternate">Printable version</a></li>
				<li id="t-permalink"><a href="/index.php?title=Fighter_Drone&amp;oldid=7993" title="Permanent link to this revision of the page">Permanent link</a></li>
			</ul>
		</div>
	</div>
...
</script><script type="text/javascript" src="//geoiplookup.wikimedia.org/"></script><!-- Served in 10.714 secs. --></body></html>