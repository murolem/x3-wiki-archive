...
<input type='hidden' value="20160503234509" name="wpStarttime" />
...
The Hyperion cannot be bought and must be [[Bigship Boarding|boarded]]. It can be found patrolling some Paranid sectors, sometimes unescorted.

When choosing the starting game scenario "Poisoned Paranid" you get an "overtuned" Hyperion upon paying the ransom for it. This Hyperion is special in that it can (by chance) reach very high speed levels, reportedly up to 250.2 m/s. [{{linky}}forum.egosoft.com/viewtopic.php?t=289489 See details.]
...
<div id="column-one">
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Hyperion&amp;returntoquery=action%3Dedit%26section%3D6&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Hyperion&amp;returntoquery=action%3Dedit%26section%3D6" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
