...
<head>
<meta charset="UTF-8"/>
<title>Editing Aran - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Aran","wgTitle":"Aran","wgCurRevisionId":14292,"wgRevisionId":0,"wgArticleId":262,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Aran","wgRelevantArticleId":262,"wgRequestId":"Wln3OVkfZokAADzoRnsAAAAB","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia","wgEditMessage":"editing"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Aran rootpage-Aran skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Aran</h1>
...
<p><strong>Warning:</strong> You are not logged in. Your IP address will be publicly visible if you make any edits. If you <strong><a class="external text" href="http://www.x3wiki.com/index.php?title=Special:UserLogin&amp;returnto=Aran">log in</a></strong> or <strong><a class="external text" href="http://www.x3wiki.com/index.php?title=Special:CreateAccount&amp;returnto=Aran">create an account</a></strong>, your edits will be attributed to your username, along with other benefits.
</p>
</div>
<div id="wikiPreview" class="ontop" style="display: none;"><div lang="en" dir="ltr" class="mw-content-ltr"></div></div><form id="editform" name="editform" method="post" action="/index.php?title=Aran&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntispam">Anti-spam check.
...
<input type='hidden' value="20180113121033" name="wpStarttime" />
<input type='hidden' value="20140202142731" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="14292" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{Infobox open}}
{{Infobox variant
|Variant=Aran
|Faction=Goner
|Class={{M1class}}
...
|Laserrecharge=577
|Gunbay=
|Dockbay={{Dockbay|30 [[M6]]-[[M5]]&lt;br>1 [[:Category:Capital Ships|capital ship]]}}
}}
{{Infobox close}}
==Overview==
The Goner '''Aran''' [[M1]] is a very rare and unique ship. It is essentially a gigantic mobile storage facility, boasting a cargo bay double that of the [[Atmospheric Lifter|largest TL]]. The ship can move, albeit at a snail's pace. It is best utilized where ships can come to it rather than the other way around.

Unique among Carriers, it can dock [[M6]] ships in its hold in addition to the normal [[M3]], [[M4]] and [[M5]]s.

It is also the only ship in the game that has a Capital-class docking port, allowing it to dock a single [[:Category:Capital Ships|capital ship]]. This makes is a good craft for resupplying capital ships in the field, rather than forcing depleted ships to return to Equipment docks or your Headquarters for supplies.
...
(Source: [{{linky}}www.thexuniverse.com/showwiki/Aran| X Universe])
...
== Combat ==
The Aran is unarmed, and although heavily shielded, the fact that it is abominably slow and impossible to miss means that a [[M2|destroyer]] will make short work of it given the chance. The Aran's combat strategy is simple; jump away as quickly as possible.

Alternatively, use the massive docking bays to jump in an entire fleet.  Theoretically, one could dock a single [[M2]] along with 29 [[Hyperion]]s, which could have 2 [[Spitfyre]]s each.  One M2, 29 [[M6+]], 58 [[M3+]], and a virtually unlimited supply of ammunition.

For a more cost-effective solution, provide the Aran with a large supply of [[Fighter Drone]]s, as cargo space is not usually a concern.
== Equipment ==
The Aran cannot mount any weapons. It does feature 3 turrets (forward, back and top), but possesses no gun slots for them. It may not fire any missiles, not even defensive [[Mosquito Missile]]s.

== Availability ==
The Aran is only found in [[Unknown Sector (Randomly Created UFJD Sector)|Unknown Sectors]] accessed with the [[Unfocussed Jumpdrive]].  The Aran has a random chance to spawn in any given randomly-generated sector.

===Capturing the Aran===
The Aran must be [[boarding|boarded]] to capture. Because the player can only take one ship with them to UFJD sectors, they must bring all necessary supplies with them at once. An [[M7M]] is best for the job, as their [[Boarding Pod]]s will make the job significantly easier. Make sure your ship has Boarding Pods, Marines, extra [[Energy Cells]], and preferably, [[Video Enhancement Goggles]]  The Marines need not have high Fighting skill, as the Aran does not have defenders, but their skills should be high, especially Engineering - the Aran is always heavily damaged when found, and damage the marines cause must be minimized.
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Aran" title="Aran" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<li><a href="/index.php/Template:Colour/Goner" title="Template:Colour/Goner">Template:Colour/Goner</a> (<a href="/index.php?title=Template:Colour/Goner&amp;action=edit" title="Template:Colour/Goner">edit</a>) </li><li><a href="/index.php/Template:Dockbay" title="Template:Dockbay">Template:Dockbay</a> (<a href="/index.php?title=Template:Dockbay&amp;action=edit" title="Template:Dockbay">edit</a>) </li><li><a href="/index.php/Template:Factionshipcat/" title="Template:Factionshipcat/">Template:Factionshipcat/</a> (<a href="/index.php?title=Template:Factionshipcat/&amp;action=edit" title="Template:Factionshipcat/">edit</a>) </li><li><a href="/index.php/Template:Infobox_close" title="Template:Infobox close">Template:Infobox close</a> (<a href="/index.php?title=Template:Infobox_close&amp;action=edit" title="Template:Infobox close">view source</a>) (semi-protected)</li><li><a href="/index.php/Template:Infobox_open" title="Template:Infobox open">Template:Infobox open</a> (<a href="/index.php?title=Template:Infobox_open&amp;action=edit" title="Template:Infobox open">view source</a>) (semi-protected)</li><li><a href="/index.php/Template:Infobox_variant" title="Template:Infobox variant">Template:Infobox variant</a> (<a href="/index.php?title=Template:Infobox_variant&amp;action=edit" title="Template:Infobox variant">view source</a>) (semi-protected)</li><li><a href="/index.php/Template:Linky" title="Template:Linky">Template:Linky</a> (<a href="/index.php?title=Template:Linky&amp;action=edit" title="Template:Linky">edit</a>) </li><li><a href="/index.php/Template:M1" title="Template:M1">Template:M1</a> (<a href="/index.php?title=Template:M1&amp;action=edit" title="Template:M1">edit</a>) </li><li><a href="/index.php/Template:M1Table" title="Template:M1Table">Template:M1Table</a> (<a href="/index.php?title=Template:M1Table&amp;action=edit" title="Template:M1Table">edit</a>) </li><li><a href="/index.php/Template:M1category" title="Template:M1category">Template:M1category</a> (<a href="/index.php?title=Template:M1category&amp;action=edit" title="Template:M1category">edit</a>) </li><li><a href="/index.php/Template:M1class" title="Template:M1class">Template:M1class</a> (<a href="/index.php?title=Template:M1class&amp;action=edit" title="Template:M1class">edit</a>) </li><li><a href="/index.php/Template:Shipbox" title="Template:Shipbox">Template:Shipbox</a> (<a href="/index.php?title=Template:Shipbox&amp;action=edit" title="Template:Shipbox">edit</a>) </li><li><a href="/index.php/Template:Shipclassbox" title="Template:Shipclassbox">Template:Shipclassbox</a> (<a href="/index.php?title=Template:Shipclassbox&amp;action=edit" title="Template:Shipclassbox">edit</a>) </li></ul></div><div class="hiddencats"></div><div class="limitreport"></div><input type="hidden" value="1" name="wpUltimateParam"/>
</form>
</div><div class="printfooter">
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Aran">http://www.x3wiki.com/index.php/Aran</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Aran&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Aran&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Aran&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
