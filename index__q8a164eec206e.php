...
<form id="editform" name="editform" method="post" action="/index.php?title=Atreus&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="11" name="wpSection" />
<input type='hidden' value="20110719145310" name="wpStarttime" />
<input type='hidden' value="20100802174710" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="b5970fad006d4df770cfef7da553c1d9" name="wpAutoSummary" /><input type="hidden" value="0" name="oldid" /><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" name="wpTextbox1">==Core Worlds==
#
...
<div id="column-one">
	...
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Atreus&amp;returntoquery=action%3Dedit%26section%3D11" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
