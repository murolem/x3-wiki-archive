...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Energy_Bolt_Chaingun rootpage-Energy_Bolt_Chaingun skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Energy Bolt Chaingun</h1>
...
<input type='hidden' value="20170720143111" name="wpStarttime" />
<input type='hidden' value="20140812051843" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="16394" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{Infobox open}}
{{Infobox weapon
|weapon=Energy Bolt Chaingun
|hulldam= 1400
|shielddam= 8900
|range= 2.81 
|rof= 394 
...
{{Infobox close}}
==Overview==
The ammunition based Energy Bolt Chaingun, or [[Abbreviations|EBC]], is roughly equivalent on terms of damage potential to the [[High Energy Plasma Thrower|HEPT]], and plays the similar heavy fighter/medium corvette weapon role.

==Encyclopedia Entry==
This laser is used in larger weapon systems and by many small to medium fighters. The Energy Bolt Chaingun was designed by the Teladi as an ammo-based alternative to the energy-hungry HEPT and [[PBE]]. It fires "bolts" of stored energy designed to damage enemy ships as effectively as any energy or plasma based weapon, while putting less strain on the ship's generator. This weapon requires special [[Weapons#Ammunition Based Weapons|ammunition]].
==Commentary==
Despite dealing slightly less damage per second than the ubiquitous [[High Energy Plasma Thrower|HEPT]] it boasts slightly higher accuracy due to its better shot speed and frequency, more than making up for slightly inferior damage, and can even result in the EBC dealing more dps to a moving target. &lt;br/>
...
Like most ammo based weapons the EBC is [[Teladi]]an in origin. Also like any ammo-based weapon it is emphatically not recommended for OOS duty; a [[PAC]]/[[HEPT]]/[[IPG]] loadout would make a much better choice, especially in turrets. one round of OOS combat depletes an entire ammo crate as a rule.
...
[[Light Weapons Complex|Teladi Light Weapons Complex]]

[[Energy Bolt Chaingun Forge]] available to purchase by players in some [[Teladi Shipyard| Teladi Shipyards]].
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Energy_Bolt_Chaingun" title="Energy Bolt Chaingun" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://x3wiki.com/index.php/Energy_Bolt_Chaingun">http://x3wiki.com/index.php/Energy_Bolt_Chaingun</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Energy_Bolt_Chaingun&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Energy+Bolt+Chaingun&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Energy+Bolt+Chaingun&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
