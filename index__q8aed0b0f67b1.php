...
<head>
<meta charset="UTF-8" /><title>Editing Spectre Missile Production Facility - X3 Wiki</title>
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Spectre_Missile_Production_Facility skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Spectre Missile Production Facility</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Spectre_Missile_Production_Facility&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20160818003100" name="wpStarttime" />
<input type='hidden' value="20150225173722" name="wpEdittime" />
...
{{Infobox factory
|faction=Terran
|station=Spectre Missile Production Facility
|hull=1000000
|shield=9
|generator=2000
|hangar=10
|cycle=00:14:00
|productnum=[[Spectre Missile]] (1)
|stationprice=
|reqresources=[[Energy Cells]] (210)&lt;br>[[Ore]] (35)&lt;br>[[Terran MRE]] (35)
...
===Encyclopedia Entry===
This facility produces the Spectre Missile.

==Availability==
This factory is the only [[Terran]] weapons facility that is not for sale at [[Terran Unknown Sector 1]].
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Spectre_Missile_Production_Facility" title="Spectre Missile Production Facility" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Spectre_Missile_Production_Facility&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Spectre+Missile+Production+Facility&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Spectre+Missile+Production+Facility&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
