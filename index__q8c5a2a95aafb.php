...
<head>
<title>Editing Kraken (section) - X3 Wiki</title>
...
<form id="editform" name="editform" method="post" action="/index.php?title=Kraken&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="1" name="wpSection" />
<input type='hidden' value="20110104093302" name="wpStarttime" />
<input type='hidden' value="20101126152112" name="wpEdittime" />
...
The [[Boron]] [[M7M]] is one of the two favourites in its class, along with the [[Split]] [[Cobra]] due to its good speed and huge cargobay which extend its endurance on the battlefield, while retaining some mobility (unlike the [[Teladi]] [[Gannet]] which is slower than most destroyers and turns like a brick).&lt;br>
All [[M7M|Missile Frigates]] are considered very overpowered due to their armament: long range anti-capital torpedoes which can be fired in barrages of 8 at a time, and fast swarming anti fighter missiles. In conjunction with a [[TL]] resupply craft with spare missiles, an M7m can clear a sector and the Kraken is no exception, though it can go for longer than most without restocking. Its shield generator is on par with those of destroyers, despite its low shielding of only 3Gj.
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='editHelp'><a href="/index.php/Kraken" title="Kraken" id="mw-editform-cancel">Cancel</a> | <a target="helpwindow" href="/index.php/Help:Editing">Editing help</a> (opens in new window)</span>
</div><!-- editButtons -->
</div><!-- editOptions -->
...
<div id="column-one">
	<div id="p-cactions" class="portlet">
		...
		<div class="pBody">
			<ul>
				 ...
				 <li id="ca-edit" class="selected"><a href="/index.php?title=Kraken&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Kraken&amp;returntoquery=action%3Dedit%26section%3D1" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
...
<!-- Served in 0.210 secs. --><script type="text/javascript">
