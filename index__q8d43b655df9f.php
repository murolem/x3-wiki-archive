...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Albion_Gamma rootpage-Albion_Gamma skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Albion Gamma</h1>
...
<input type='hidden' value="20180112000951" name="wpStarttime" />
<input type='hidden' value="20130909151913" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="13681" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{Infobox Sector
|Race= Argon
|SecLevel= Border
|Population= 100,567
|Planets= 1
...
{{Gateblock2|East|-47500|0|0|[[Albion Beta]]}}
{{Gateblock2|South|0|0|-33100|[[Belt of Aguilar]]}}
&lt;/table>
}}
==Overview==
...
==Default [[Stations]]==
#[[Jonferco]] [[Military Outpost|Defence Outpost]]
#[[Jonferco]] [[Trading Station]]
#[[High Yield Production Complex]] beta
#[[Marine Training Barracks M]] beta

==[[Asteroids]]==
14 Known

==[[Missions]]==
[[X3ap:2_Jonferco_Eavesdrop | Albion Prelude: Jonferco_Eavesdrop]]
{{Argon Navbox}}
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Albion_Gamma" title="Albion Gamma" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Albion_Gamma">http://www.x3wiki.com/index.php/Albion_Gamma</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Albion_Gamma&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Albion+Gamma&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Albion+Gamma&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
