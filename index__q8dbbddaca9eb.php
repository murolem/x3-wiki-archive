...
<body class="mediawiki ltr ns-0 ns-subject page-Thor skin-monobook">
	...
	<div id="content">
		<a name="top" id="top"></a>
				<h1 id="firstHeading" class="firstHeading">Editing Thor</h1>
		<div id="bodyContent">
...
<form id="editform" name="editform" method="post" action="/index.php?title=Thor&amp;action=submit" enctype="multipart/form-data">
<input type='hidden' value="" name="wpSection" />
<input type='hidden' value="20100606064516" name="wpStarttime" />

<input type='hidden' value="20100606064516" name="wpEdittime" />
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='editHelp'><a href="/index.php/Thor" title="Thor">Cancel</a>&#32;|&#32;<a target="helpwindow" href="/index.php/Help:Editing">Editing help</a> (opens in new window)</span>
</div><!-- editButtons -->
</div><!-- editOptions -->
	...
	<div id="p-cactions" class="portlet">
		...
		<div class="pBody">
			<ul>
				 ...
				 <li id="ca-nstab-main" class="selected new"><a href="/index.php?title=Thor&amp;action=edit&amp;redlink=1" title="View the content page [c]" accesskey="c">Page</a></li>
				 ...
				 <li id="ca-edit" class="selected"><a href="/index.php?title=Thor&amp;action=edit" title="You can edit this page.&#10;Please use the preview button before saving">Create</a></li>			</ul>
		</div>
	</div>
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Thor" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
