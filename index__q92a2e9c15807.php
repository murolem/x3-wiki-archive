...
<form id="editform" name="editform" method="post" action="/index.php?title=Ray&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="2" name="wpSection" />
<input type='hidden' value="20110910032050" name="wpStarttime" />
...
<div id="column-one">
	...
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Ray&amp;returntoquery=action%3Dedit%26section%3D2" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
...
</script><!-- Served in 0.262 secs. --></body></html>