...
<head>
<meta charset="UTF-8"/>
<title>Editing Stations - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Stations","wgTitle":"Stations","wgCurRevisionId":16792,"wgRevisionId":0,"wgArticleId":6,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Stations","wgRelevantArticleId":6,"wgRequestId":"Wdyof1kfZokAAGZEj48AAAAL","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia","wgEditMessage":"editing"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Stations rootpage-Stations skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Stations</h1>
...
<p><strong>Warning:</strong> You are not logged in. Your IP address will be publicly visible if you make any edits. If you <strong><a class="external text" href="http://www.x3wiki.com/index.php?title=Special:UserLogin&amp;returnto=Stations">log in</a></strong> or <strong><a class="external text" href="http://www.x3wiki.com/index.php?title=Special:CreateAccount&amp;returnto=Stations">create an account</a></strong>, your edits will be attributed to your username, along with other benefits.
</p>
</div>
<div id="wikiPreview" class="ontop" style="display: none;"><div lang="en" dir="ltr" class="mw-content-ltr"></div></div><form id="editform" name="editform" method="post" action="/index.php?title=Stations&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntispam">Anti-spam check.
...
<input type='hidden' value="20171010110119" name="wpStarttime" />
<input type='hidden' value="20161007234332" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="16792" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{See also|Economy}}


Space stations are the hub of all space-borne activity.

All races meet and conduct transactions aboard space stations.

Frequently, stations are the host to [[missions|missions or offers]].

== Quirks ==
{{See also|Complex}}
Most stations primarily exist to manufacture and sell goods which may be traded to generate profits. It should be noted that NPC stations frequently have different resource requirements to an equivalent player-owned factory. Infobox data on these pages will issue the stats for player-owned factories, with NPC fab requirements in the article text. Stations can also be connected together to create a [[Complex]] using Complex Construction kits.
A list of stations follows.

== Station Types ==
{| style="clear:both;"
|- valign="top"
| style="width:36%;padding-right:5em;" |
===Economic stations===
These stations produce organic and technological goods that can be traded for profit and often supply raw materials to other factories;
...
| style="width:55%;padding-right:5em;" |

===Military Stations===
These stations produce military hardware for ships&lt;br>
(which can also be traded for profit);
{|
! Durable Goods !! Expendable Munitions Factories
|- valign="top"
|
*[[Advanced Drone Factory]]
*[[Advanced Satellite Factory]]
*[[Aldrin Weapon Production Base]]
*[[Cluster Flak Array Forge]]
...
*[[Phantom Missile Production Facility]]
*[[Poltergeist Missile Production Facility]]
*[[Seeker Missile Production Complex]]
*[[Shadow Missile Construction Facility]]
*[[Silkworm Missile Factory]]
*[[Spectre Missile Production Facility]]
*[[SQUASH Mine Factory]]
...
{|
|- valign="top"
| style="width:45%;padding-right:5em;" |
===Shipyards===
'''[[Shipyard]]s''' are the source for all stations and ships, each race has a few.  Shipyards can repair docked ships.
...
*[[Equipment Dock]]
*[[Military Outpost]], [[Military Base]] (Terran)
*[[Pirate Base]]
*[[Trading Station]]
*[[Headquarters]] (Player-owned)
|}

==Sortable Lists==

*[[List of Argon Factories:XTC]]
*[[List of Boron Factories:XTC]]
*[[List of Paranid Factories:XTC]]
*[[List of Split Factories:XTC]]
*[[List of Teladi Factories:XTC]]
*[[List of Terran Factories:XTC]]
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Stations" title="Stations" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<li><a href="/index.php/Template:See_also" title="Template:See also">Template:See also</a> (<a href="/index.php?title=Template:See_also&amp;action=edit" title="Template:See also">edit</a>) </li><li><a href="/index.php/Template:Trading" title="Template:Trading">Template:Trading</a> (<a href="/index.php?title=Template:Trading&amp;action=edit" title="Template:Trading">edit</a>) </li></ul></div><div class="hiddencats"></div><div class="limitreport"></div><input type="hidden" value="1" name="wpUltimateParam"/>
</form>
</div><div class="printfooter">
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Stations">http://www.x3wiki.com/index.php/Stations</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Stations&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Stations&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Stations&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
