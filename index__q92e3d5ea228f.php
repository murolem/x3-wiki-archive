...
<head>
<meta charset="UTF-8" /><title>Editing Jonferco - X3 Wiki</title>
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Jonferco skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Jonferco</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Jonferco&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20160903102238" name="wpStarttime" />
<input type='hidden' value="20140313153244" name="wpEdittime" />
...
|Faction=Jonferson Space Dynamics Division
|Speciestype=Argon
|Homeworld=[[Belt of Aguilar]]
|Systems=
|Population=
|Government=Corporate
|Ranks={{Rank List|Hero of Jonferson
|Jonferson Crusader
|JSDD Shareholder
|JSDD Protector
|JSDD Specialist
...
==General==
Jonferson Space Dynamics Division, known popularly as Jonferco and founded by Ser Alman Jonferson, an ambitious civilian outfit specializing in engineering and installation design.

==Science and Technology==
===Ships===
Reward the player of these ships when reach specific ranks
*Rank 4 (JSDD Professional): [[Mercury (ship)|Enhanced Mercury]] (TS) 
*Rank 7 (JSDD Protector): [[Enhanced Elite]] (M4+) 
*Rank 10 (Hero of Jonferson): [[Heavy Centaur Prototype]] (M6+)

===Stations===
*Headquarter located in [[Belt of Aguilar]]
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Jonferco" title="Jonferco" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Jonferco&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Jonferco&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Jonferco&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
