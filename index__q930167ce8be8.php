...
<head>
<meta charset="UTF-8"/>
<title>Editing Aquilo - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Aquilo","wgTitle":"Aquilo","wgCurRevisionId":16846,"wgRevisionId":0,"wgArticleId":612,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Aquilo","wgRelevantArticleId":612,"wgRequestId":"WZ1IoFkfZokAABuJt6cAAAAF","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia","wgEditMessage":"editing"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Aquilo rootpage-Aquilo skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Aquilo</h1>
...
<p><strong>Warning:</strong> You are not logged in. Your IP address will be publicly visible if you make any edits. If you <strong><a class="external text" href="http://www.x3wiki.com/index.php?title=Special:UserLogin&amp;returnto=Aquilo">log in</a></strong> or <strong><a class="external text" href="http://www.x3wiki.com/index.php?title=Special:CreateAccount&amp;returnto=Aquilo">create an account</a></strong>, your edits will be attributed to your username, along with other benefits.
</p>
</div>
<div id="wikiPreview" class="ontop" style="display: none;"><div lang="en" dir="ltr" class="mw-content-ltr"></div></div><form id="editform" name="editform" method="post" action="/index.php?title=Aquilo&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntispam">Anti-spam check.
...
<input type='hidden' value="20170823091928" name="wpStarttime" />
<input type='hidden' value="20170128115344" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="16846" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{Infobox open}}
{{Infobox variant
|Variant=Aquilo
|Faction=OTAS
|Class={{M7Mclass}}
|Priceblock={{Priceblock|Argon|Federation Marshal 38206712}}
|Minspeed=54
|Maxspeed=91.8
|Minaccel=7
|Maxaccel=13
...
{{Infobox close}}
==Overview==
The original [[M7M|M7M Missile Frigate]], the Aquilo is intended for one purpose; leaving nothing standing in its wake.

==Background==
The Aquilo was an experiment by [[OTAS]] to produce an artillery platform capable of taking down any target from long range. The solution was a Frigate-sized ship armed with multiple missile launchers to bombard the target with specialist ordnance from a safe distance. It was so tremendously potent that, by necessity for their survival against this new [[M7M]] class of ship, it was quickly copied by every other power in the X-Universe as no existing vessel could provide an answer to it. As more design and development time has been spent on the Aquilo, it remains the most powerful warship south of [[Heretic's End]].

==Physical Characteristics==
== Combat ==
Matching the shields of the [[Gannet]] and with increased speed and a second point defence turret, the Aquilo holds the accolade of being the most powerful [[Commonwealth]] ship, and the second most powerful ship in the game after the [[Skirnir]].

== Equipment ==
The Aquilo is cheap for a Missile Frigate, this is probably because it is one of the only ones not compatible with [[boarding pods]].

For boarding, OTAS has its specialized boarding missile frigate the [[Sirokos]].
...
== Availability ==
*[[OTAS Shipyard]] in [[Legend's Home]]
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Aquilo" title="Aquilo" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Aquilo">http://www.x3wiki.com/index.php/Aquilo</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Aquilo&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Aquilo&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Aquilo&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
