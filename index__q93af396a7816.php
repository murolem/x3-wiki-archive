...
<head>
<meta charset="UTF-8" /><title>Editing Plasma Burst Generator Forge - X3 Wiki</title>
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Plasma_Burst_Generator_Forge skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Plasma Burst Generator Forge</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Plasma_Burst_Generator_Forge&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20160818052325" name="wpStarttime" />
<input type='hidden' value="20150305175715" name="wpEdittime" />
...
{{Infobox factory
|faction=Pirate
|station=Plasma Burst Generator Forge
|hull=1000000
|shield=9
|generator=2000
|hangar=5
|cycle=00:42:00
|productnum=[[Plasma Burst Generator]] (1)
|stationprice=
|reqresources=[[Energy Cells]] (630)&lt;br>[[Ore]] (105)&lt;br>[[Space Fuel]]
|optresources=[[Crystals]]&lt;br>[[Space Weed]]
}}
{{Infobox close}}
==Overview==
...
However, they are hostile towards all players at the start, which means that they don't sell their [[Plasma Burst Generator|Plasma Burst Generators]] to the player. A [[Station Hack]] will solve this problem.
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Plasma_Burst_Generator_Forge" title="Plasma Burst Generator Forge" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a href="http://x3wiki.com/index.php/Plasma_Burst_Generator_Forge">http://x3wiki.com/index.php/Plasma_Burst_Generator_Forge</a>"</div>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Plasma_Burst_Generator_Forge&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Plasma+Burst+Generator+Forge&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Plasma+Burst+Generator+Forge&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
