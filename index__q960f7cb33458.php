...
<form id="editform" name="editform" method="post" action="/index.php?title=X-perimental_Shuttle&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="7" name="wpSection" />
<input type='hidden' value="20110104093501" name="wpStarttime" />
...
The X-Shuttle is only available as a plot reward for the [[Treasure Hunt]] plot.
	...
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=X-perimental_Shuttle&amp;returntoquery=action%3Dedit%26section%3D7" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
...
<!-- Served in 0.308 secs. --><script type="text/javascript">
