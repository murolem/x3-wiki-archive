...
<head>
<meta charset="UTF-8"/>
<title>Information for "Pulsed Beam Emitter" - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Pulsed_Beam_Emitter","wgTitle":"Pulsed Beam Emitter","wgCurRevisionId":11349,"wgRevisionId":0,"wgArticleId":228,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"info","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Pulsed_Beam_Emitter","wgRelevantArticleId":228,"wgRequestId":"WN6qOlkfZokAACqHq6cAAAAh","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Pulsed_Beam_Emitter rootpage-Pulsed_Beam_Emitter skin-monobook action-info">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Information for "Pulsed Beam Emitter"</h1>
...
<tr id="mw-pageinfo-display-title"><td style="vertical-align: top;">Display title</td><td>Pulsed Beam Emitter</td></tr>
<tr id="mw-pageinfo-default-sort"><td style="vertical-align: top;">Default sort key</td><td>Pulsed Beam Emitter</td></tr>
<tr id="mw-pageinfo-length"><td style="vertical-align: top;">Page length (in bytes)</td><td>3,289</td></tr>
<tr id="mw-pageinfo-article-id"><td style="vertical-align: top;">Page ID</td><td>228</td></tr>
<tr><td style="vertical-align: top;">Page content language</td><td>English (en)</td></tr>
<tr id="mw-pageinfo-content-model"><td style="vertical-align: top;">Page content model</td><td>wikitext</td></tr>
<tr id="mw-pageinfo-robot-policy"><td style="vertical-align: top;">Indexing by robots</td><td>Allowed</td></tr>
<tr><td style="vertical-align: top;"><a href="/index.php?title=Special:WhatLinksHere/Pulsed_Beam_Emitter&amp;hidelinks=1&amp;hidetrans=1" title="Special:WhatLinksHere/Pulsed Beam Emitter">Number of redirects to this page</a></td><td>1</td></tr>
...
<tr id="mw-pageinfo-firsttime"><td style="vertical-align: top;">Date of page creation</td><td><a href="/index.php?title=Pulsed_Beam_Emitter&amp;oldid=656" title="Pulsed Beam Emitter">23:57, 1 July 2010</a></td></tr>
...
<tr id="mw-pageinfo-lasttime"><td style="vertical-align: top;">Date of latest edit</td><td><a href="/index.php?title=Pulsed_Beam_Emitter&amp;oldid=11349" title="Pulsed Beam Emitter">20:36, 11 December 2012</a></td></tr>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Pulsed+Beam+Emitter&amp;returntoquery=action%3Dinfo" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Pulsed+Beam+Emitter&amp;returntoquery=action%3Dinfo" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
