...
<head>
<meta charset="UTF-8" /><title>Editing User:Korlus - X3 Wiki</title>
...
<body class="mediawiki ltr sitedir-ltr ns-2 ns-subject page-User_Korlus skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing User:Korlus</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=User:Korlus&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20150425050634" name="wpStarttime" />
<input type='hidden' value="20140324151451" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary" /><input type="hidden" value="0" name="oldid" /><input type="hidden" value="text/x-wiki" name="format" /><input type="hidden" value="wikitext" name="model" /><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">This page is mostly for my own use, but as I don't visit here all that often any more, please feel free to butt in on any of the pages mentioned below. If you do, leaving a message on my discussion page would be appreciated, but of course is not necessary.

I'm largely responsible for the initial Racial Navboxes, but other people (notably [[User:Knighster35|Knighster35]]) have also done plenty of work on them.
...
==Sandboxes:==
*[[User:Korlus/sandbox|Link to sandbox]]
*[[User:Korlus/sandbox2|Link to sandbox 2]]
*[[User:Korlus/templatesandbox|Template Sandbox]]
...
Useful Links:
*CAG/CLS: {{linky}}forum.egosoft.com/viewtopic.php?p=2346651
*Autopilot: {{linky}}roguey.co.uk/forum/viewtopic.php?id=490&amp;p=2
...
*[[Template:Terran Navbox]]
*[[Template:Boron Navbox]]

=== Needs Testing: ===
I'm trialling a different look here. Could do with input.

*[[Template:Argon Navbox]]


=== Mostly Done: ===
*[[Template:Races]]
*[[Races]]
*[[Template:Racial Navbox]]
*[[Template:ATF Navbox]]

=== Not Done: ===
*[[Template:Paranid Navbox]] done
*[[Template:Split Navbox]]   done
*[[Template:Teladi Navbox]]  done
*[[Template:Xenon Navbox]]
*[[Template:Goner Navbox]]
*[[Template:OTAS Navbox]]
*[[Template:Aldrin Navbox]]
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/User:Korlus" title="User:Korlus" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=User:Korlus&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=User%3AKorlus&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=User%3AKorlus&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
