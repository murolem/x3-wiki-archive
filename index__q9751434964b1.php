...
<head>
<meta charset="UTF-8"/>
<title>Editing Ice Harvesting Facility - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Ice_Harvesting_Facility","wgTitle":"Ice Harvesting Facility","wgCurRevisionId":16625,"wgRevisionId":0,"wgArticleId":2007,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Ice_Harvesting_Facility","wgRelevantArticleId":2007,"wgRequestId":"WldytVkfZokAAFdzXcwAAAAN","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia","wgEditMessage":"editing"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Ice_Harvesting_Facility rootpage-Ice_Harvesting_Facility skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Ice Harvesting Facility</h1>
...
<input type='hidden' value="20180111142037" name="wpStarttime" />
<input type='hidden' value="20150225193042" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="16625" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{Infobox open}}
{{Infobox factory
|faction=Terran
|station=Ice Harvesting Facility L
|hull=750000
|shield=9
|generator=1500
|hangar=10
...
|optresources=[[Terran MRE]]
}}
{{Infobox factory
|faction=Terran
|station=Ice Harvesting Facility M
|hull=150000
|shield=4
|generator=1500
|hangar=10
...
|productnum=[[Ice]] (4)
|stationprice=
|reqresources=[[Energy Cells]] (24)
|optresources=[[Terran MRE]]
}}
{{Infobox close}}

==Overview==
Ice Harvesting Facility are Terran factories that produce [[Ice]] from [[Energy Cells]]. 

NPC stations will buy [[Terran MRE]] as a secondary resource.
===Encyclopedia Entry===
This facility is used to harvest [[ice]] located deep within asteroids. The ice is then transported to a purification facility to be melted and separated from impurities.

==Availability==
This factory is unique to the Terran and can be randomly found in the cargo of a [[Boarding|captured]] [[Atmospheric Lifter]].
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Ice_Harvesting_Facility" title="Ice Harvesting Facility" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Ice_Harvesting_Facility">http://www.x3wiki.com/index.php/Ice_Harvesting_Facility</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Ice_Harvesting_Facility&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Ice+Harvesting+Facility&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Ice+Harvesting+Facility&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
