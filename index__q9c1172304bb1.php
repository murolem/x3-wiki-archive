...
<head>
<meta charset="UTF-8" /><title>Editing Mistral Super Freighter - X3 Wiki</title>
<meta name="generator" content="MediaWiki 1.22.6" />
<meta name="robots" content="noindex,nofollow" />
<link rel="alternate" type="application/x-wiki" title="Edit" href="/index.php?title=Mistral_Super_Freighter&amp;action=edit" />
<link rel="edit" title="Edit" href="/index.php?title=Mistral_Super_Freighter&amp;action=edit" />
...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Mistral_Super_Freighter","wgTitle":"Mistral Super Freighter","wgCurRevisionId":16230,"wgRevisionId":0,"wgArticleId":616,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Mistral_Super_Freighter","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia"});
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Mistral_Super_Freighter skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Mistral Super Freighter</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Mistral_Super_Freighter&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20151117023807" name="wpStarttime" />
<input type='hidden' value="20140501032750" name="wpEdittime" />
...
{{Infobox variant
|Variant=Mistral Super Freighter
|Faction=OTAS
|Class={{TS+class}}
|Priceblock={{Priceblock|| 1,509,303}}
|Minspeed=39 
|Maxspeed=78
|Minaccel=4
|Maxaccel=9
...
The Mistral Super Freighter has an average maximum cargo bay size and speed among [[TS+]] transports, and the worst shielding in its class, making it an unusually weak entry by [[OTAS]]. It's fairly inexpensive, though, not least thanks to the large stock cargo bay.

Compared to the [[Mistral]], the Mistral Super Freighter sacrifices speed and turrets for 2 extra 25 MJ shields. As such, it is poorly suited to combat and is reliant on its shields to allow it to escape with a jumpdrive.
...
|}
== Availability ==
The Mistral Super Freighter is available from the OTAS shipyard in [[Legend's Home]]

== Suggested Roles==
Mistral Super Freighters are a lackluster choice for [[Traders|Universe Traders]].  With the weakest shields and fewest guns of any TS+ and only average cargo and speed, the MSF might not be the best choice for this role.  Its biggest claim to fame is the simplicity of supplying a freshly purchased Mistral with a [[jumpdrive]], as they are available right there at the shipyard.

With its large stock cargo bay of 10,000, it can be commissioned more cheaply for hauling bulk cargo than the other TS+, thanks to not requiring as many progressively more expensive [[Cargo Bay Extension|Cargo Bay Extensions]]. This makes the MSF an attractive choice in a CAG role.
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Mistral_Super_Freighter" title="Mistral Super Freighter" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a href="http://www.x3wiki.com/index.php/Mistral_Super_Freighter">http://www.x3wiki.com/index.php/Mistral_Super_Freighter</a>"</div>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="ca-nstab-main" class="selected"><a href="/index.php/Mistral_Super_Freighter" title="View the content page [c]" accesskey="c">Page</a></li>
				<li id="ca-talk"><a href="/index.php/Talk:Mistral_Super_Freighter" title="Discussion about the content page [t]" accesskey="t">Discussion</a></li>
				<li id="ca-edit" class="selected"><a href="/index.php?title=Mistral_Super_Freighter&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
				<li id="ca-history"><a href="/index.php?title=Mistral_Super_Freighter&amp;action=history" rel="archives" title="Past revisions of this page [h]" accesskey="h">History</a></li>
			</ul>
		</div>
	</div>
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Mistral+Super+Freighter&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Mistral+Super+Freighter&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
...
<a href="/index.php/Main_Page" style="background-image: url(http://www.x3wiki.com/x3.jpg);" title="Visit the main page"></a>
	...
	<div class="portlet" id="p-tb" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="t-whatlinkshere"><a href="/index.php/Special:WhatLinksHere/Mistral_Super_Freighter" title="A list of all wiki pages that link here [j]" accesskey="j">What links here</a></li>
				<li id="t-recentchangeslinked"><a href="/index.php/Special:RecentChangesLinked/Mistral_Super_Freighter" title="Recent changes in pages linked from this page [k]" accesskey="k">Related changes</a></li>
				<li id="t-specialpages"><a href="/index.php/Special:SpecialPages" title="A list of all special pages [q]" accesskey="q">Special pages</a></li>
				<li id="t-info"><a href="/index.php?title=Mistral_Super_Freighter&amp;action=info">Page information</a></li>
			</ul>
		</div>
	</div>
