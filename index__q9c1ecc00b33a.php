...
<script>if(window.mw){
	mw.config.set({"wgCanonicalNamespace": "", "wgCanonicalSpecialPageName": false, "wgNamespaceNumber": 0, "wgPageName": "Trading_Station", "wgTitle": "Trading Station", "wgCurRevisionId": 0, "wgArticleId": 0, "wgIsArticle": false, "wgAction": "edit", "wgUserName": null, "wgUserGroups": ["*"], "wgCategories": [], "wgBreakFrames": true, "wgRestrictionCreate": [], "Geo": {"city": "", "country": ""}, "wgNoticeProject": "wikipedia"});
}
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Trading_Station action-edit skin-monobook">
...
<div id="column-content"><div id="content">
	...
	<h1 id="firstHeading" class="firstHeading">Editing Trading Station</h1>
	<div id="bodyContent">
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Trading_Station&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="" name="wpSection" />
<input type='hidden' value="20120109071055" name="wpStarttime" />
<input type='hidden' value="20120109071055" name="wpEdittime" />
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='editHelp'><a href="/index.php/Trading_Station" title="Trading Station" id="mw-editform-cancel">Cancel</a> | <a target="helpwindow" href="/index.php/Help:Editing">Editing help</a> (opens in new window)</span>
</div><!-- editButtons -->
</div><!-- editOptions -->
...
Retrieved from "<a href="http://www.x3wiki.com/index.php/Trading_Station">http://www.x3wiki.com/index.php/Trading_Station</a>"</div>
...
<div id="column-one">
	<div id="p-cactions" class="portlet">
		...
		<div class="pBody">
			<ul>
				<li id="ca-nstab-main" class="selected new"><a href="/index.php?title=Trading_Station&amp;action=edit&amp;redlink=1" title="View the content page [c]" accesskey="c">Page</a></li>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Trading_Station&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Create</a></li>
			</ul>
		</div>
	</div>
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Trading_Station&amp;returntoquery=action%3Dedit%26redlink%3D1" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
