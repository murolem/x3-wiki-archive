...
<head>
<meta charset="UTF-8"/>
<title>Editing Player Sector - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Player_Sector","wgTitle":"Player Sector","wgCurRevisionId":12941,"wgRevisionId":0,"wgArticleId":2239,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Player_Sector","wgRelevantArticleId":2239,"wgRequestId":"WPcalVkfZokAAEMOA9sAAAAc","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia","wgEditMessage":"editing"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Player_Sector rootpage-Player_Sector skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Player Sector</h1>
...
<input type='hidden' value="20170419080645" name="wpStarttime" />
<input type='hidden' value="20130629194418" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="12941" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{Infobox Sector
|Race=Player
|SecLevel=
|Population=
|Planets=1
...
{{Gateblock2|South|0     |	0|	-60000|[[Void of Opportunity]]}}
&lt;/table>
}}
==Description==

The Player Sector (galactic coordinates 12,4) is a sector awarded to the player after completing the Breaking Grounds plot (AP 3.0). It's actual name depends on player choice.

==Default [[Stations]]==

None, although upon acquiring the sector, the player will be given the option of moving their [[Headquarters|Player HQ]] and/or Corporate HQ there, even if previously deployed elsewhere.

==[[Asteroids]]==

Several asteroids, including [[Nividium]].
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Player_Sector" title="Player Sector" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<li><a href="/index.php/Template:Colour/Player" title="Template:Colour/Player">Template:Colour/Player</a> (<a href="/index.php?title=Template:Colour/Player&amp;action=edit" title="Template:Colour/Player">edit</a>) </li><li><a href="/index.php/Template:Gateblock2" title="Template:Gateblock2">Template:Gateblock2</a> (<a href="/index.php?title=Template:Gateblock2&amp;action=edit" title="Template:Gateblock2">edit</a>) </li><li><a href="/index.php/Template:Infobox_Sector" title="Template:Infobox Sector">Template:Infobox Sector</a> (<a href="/index.php?title=Template:Infobox_Sector&amp;action=edit" title="Template:Infobox Sector">edit</a>) </li></ul></div><div class="hiddencats"></div><div class="limitreport"></div><input type="hidden" value="1" name="wpUltimateParam"/>
</form>
...
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Player_Sector">http://www.x3wiki.com/index.php/Player_Sector</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Player_Sector&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Player+Sector&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Player+Sector&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
