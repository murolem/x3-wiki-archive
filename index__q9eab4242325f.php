...
<head>
<meta charset="UTF-8" />
<title>Revision history of "Ice Miner" - X3 Wiki</title>
<meta name="generator" content="MediaWiki 1.17.0" />
<meta name="robots" content="noindex,nofollow" />
<link rel="alternate" type="application/x-wiki" title="Edit" href="/index.php?title=Ice_Miner&amp;action=edit" />
<link rel="edit" title="Edit" href="/index.php?title=Ice_Miner&amp;action=edit" />
...
<link rel="alternate" type="application/atom+xml" title="&quot;Ice Miner&quot; Atom feed" href="/index.php?title=Ice_Miner&amp;feed=atom&amp;action=history" />
...
<body class="mediawiki ltr ns-0 ns-subject page-Ice_Miner skin-monobook">
<div id="globalWrapper">
<div id="column-content"><div id="content">
	<a id="top"></a>
	
	<h1 id="firstHeading" class="firstHeading">Revision history of "Ice Miner"</h1>
	<div id="bodyContent">
		<div id="siteSub">From X3 Wiki</div>
		<div id="contentSub"><a href="/index.php?title=Special:Log&amp;page=Ice+Miner" title="Special:Log">View logs for this page</a></div>
		<div id="jump-to-nav">Jump to: <a href="#column-one">navigation</a>, <a href="#searchInput">search</a></div>
		<!-- start content -->
<form action="/index.php" method="get" id="mw-history-searchform"><fieldset id="mw-history-search">
<legend>Browse history</legend>
<input type="hidden" value="Ice_Miner" name="title" />
...
<li><span class="mw-history-histlinks">(cur | prev) </span> <a href="/index.php?title=Ice_Miner&amp;oldid=6566" title="Ice Miner">04:56, 13 July 2011</a> <span class='history-user'><a href="/index.php/Special:Contributions/67.2.40.158" title="Special:Contributions/67.2.40.158" class="mw-userlink">67.2.40.158</a>  <span class="mw-usertoollinks">(<a href="/index.php?title=User_talk:67.2.40.158&amp;action=edit&amp;redlink=1" class="new" title="User talk:67.2.40.158 (page does not exist)">Talk</a>)</span></span> <span class="history-size">(131 bytes)</span> <span class="comment">(Created page with &quot;TL class ship that can be found in Terran space.  Can be captured to obtain Ice Mining L Facility if it happens to be carrying one.&quot;)</span> </li>
</ul>
</form><div class="printfooter">
Retrieved from "<a href="http://www.x3wiki.com/index.php/Ice_Miner">http://www.x3wiki.com/index.php/Ice_Miner</a>"</div>
...
<div id="column-one">
	<div id="p-cactions" class="portlet">
		...
		<div class="pBody">
			<ul>
				 <li id="ca-nstab-main" class="selected"><a href="/index.php/Ice_Miner" title="View the content page [c]" accesskey="c">Page</a></li>
				 <li id="ca-talk" class="new"><a href="/index.php?title=Talk:Ice_Miner&amp;action=edit&amp;redlink=1" title="Discussion about the content page [t]" accesskey="t">Discussion</a></li>
				 <li id="ca-edit"><a href="/index.php?title=Ice_Miner&amp;action=edit" title="You can edit this page. Please use the preview button before saving [e]" accesskey="e">Edit</a></li>
				 <li id="ca-history" class="selected"><a href="/index.php?title=Ice_Miner&amp;action=history" title="Past revisions of this page [h]" accesskey="h">History</a></li>
			</ul>
		</div>
	</div>
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Ice_Miner&amp;returntoquery=action%3Dhistory" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
	...
	<div class="portlet" id="p-tb">
		...
		<div class="pBody">
			<ul>
				<li id="t-whatlinkshere"><a href="/index.php/Special:WhatLinksHere/Ice_Miner" title="List of all wiki pages that link here [j]" accesskey="j">What links here</a></li>
				<li id="t-recentchangeslinked"><a href="/index.php/Special:RecentChangesLinked/Ice_Miner" title="Recent changes in pages linked from this page [k]" accesskey="k">Related changes</a></li>
			<li id="feedlinks"><a id="feed-atom" href="/index.php?title=Ice_Miner&amp;feed=atom&amp;action=history" rel="alternate" type="application/atom+xml" class="feedlink" title="Atom feed for this page">Atom</a>&#160;
...
<script>if ( window.mediaWiki ) {
	mediaWiki.config.set({"wgCanonicalNamespace": "", "wgCanonicalSpecialPageName": false, "wgNamespaceNumber": 0, "wgPageName": "Ice_Miner", "wgTitle": "Ice Miner", "wgAction": "history", "wgArticleId": 1627, "wgIsArticle": false, "wgUserName": null, "wgUserGroups": ["*"], "wgCurRevisionId": 6566, "wgCategories": [], "wgBreakFrames": false, "wgRestrictionEdit": [], "wgRestrictionMove": []});
}
</script>
<script>if ( window.mediaWiki ) {
