...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Home_of_Light rootpage-Home_of_Light skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Home of Light</h1>
...
<input type='hidden' value="20170531082536" name="wpStarttime" />
<input type='hidden' value="20140228104422" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="15249" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{Infobox Sector
|Race=Argon
|SecLevel=Core
...
{{Gateblock2|North| 312 | 1,250 | 21,913|[[Argon Prime]]}}
{{Gateblock2|East| 13,788 | -4,062| -4,375|[[President's End]]}}
{{Gateblock2|South|-7,500| -4,687|-25,975|[[Ore Belt]]}}
{{Gateblock2|West|-26,913| 4,687 |-7,187|[[Red Light]]}}
&lt;/table>
}}
==Description==
===Encyclopedia Entry===
...
*[[Ammunition Factory]]
*[[Cahoona Bakery L]] alpha
*[[Cahoona Bakery M]] beta
*[[Crystal Fab M]] alpha
*[[Crystal Fab M]] beta
*[[Marine Training Barracks M]] alpha
*[[Quantum Tube Fab]] alpha
*[[Quantum Tube Fab]] beta
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Home_of_Light" title="Home of Light" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Home_of_Light">http://www.x3wiki.com/index.php/Home_of_Light</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Home_of_Light&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Home+of+Light&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Home+of+Light&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
