...
<head>
<meta charset="UTF-8" /><title>Editing Guiding Star - X3 Wiki</title>
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Guiding Star</span></h1>
...
<input type='hidden' value="20150424231432" name="wpStarttime" />
...
==Sun/s==
As with all other possible sector choices, Guiding Star contains 300% sun. (2 separate suns)
...
Retrieved from "<a href="http://x3wiki.com/index.php/Guiding_Star">http://x3wiki.com/index.php/Guiding_Star</a>"</div>
...
<div id="column-one">
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Guiding+Star&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Guiding+Star&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
