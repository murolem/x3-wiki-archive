...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Panther&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="1" name="wpSection" />
<input type='hidden' value="20120812045301" name="wpStarttime" />
...
The [[Split]] '''Panther''' is known as a pocket carrier, almost equal to the far larger and more expensive {{M1class}}s. What makes this ship so impressive is that its fighter wing capacity far exceeds any other {{M7class}}. In fact, the hangar capacity exceeds all non-M1 ships, and even some of the smaller M1s. On top of that, its wide weapon selection, gun turret coverage, top speed, turning, versatility and aesthetically pleasing design makes it a very popular player ship.
...
<div id="column-one">
	...
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Panther&amp;returntoquery=action%3Dedit%26section%3D1" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
