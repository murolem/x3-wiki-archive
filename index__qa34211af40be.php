...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Economy rootpage-Economy skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Economy</h1>
...
<p><strong>Warning:</strong> You are not logged in. Your IP address will be publicly visible if you make any edits. If you <strong><a class="external text" href="http://x3wiki.com/index.php?title=Special:UserLogin&amp;returnto=Economy">log in</a></strong> or <strong><a class="external text" href="http://x3wiki.com/index.php?title=Special:CreateAccount&amp;returnto=Economy">create an account</a></strong>, your edits will be attributed to your username, along with other benefits.
</p>
</div>
<div id="wikiPreview" class="ontop" style="display: none;"><div lang="en" dir="ltr" class="mw-content-ltr"></div></div><form id="editform" name="editform" method="post" action="/index.php?title=Economy&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntispam">Anti-spam check.
...
<input type='hidden' value="20170121112105" name="wpStarttime" />
<input type='hidden' value="20140102110040" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="14119" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">''Note: This article is about understanding the inherent economy of the X-Universe. If you are more interested in learning how to profit from it, you may find one of the [[#See Also|Links at the bottom of the page]] more useful.''
...
The X-Economy is tiered; less complicated goods get "used" by factories to make more complicated goods, and the items on the highest tier are Ship's [[Wares#Ship Equipment|Equipment]].

On the bottom tier is [[Energy Cells]], and in between sit "Bio", "Minerals", "Food", "Natural" and "Tech" tiers, before finally getting to Ship Equipment and Special Objects. That might sounds complicated, but please take a look at the [[#Tiering Example|Tiering Example]] below if you can't quite get your head around what it means.


=== Tiering Example ===
A [[High Energy Plasma Thrower]] ("[[Abbreviations|HEPT]]") is made by a [[High Energy Plasma Thrower Forge]] using [[Energy Cells]], [[Ore]] and a type of [[Wares#Food|Food]] that varies by race.
...
So you can see, it all comes down to '''Energy Cells'''; and they are a special case - ''Energy Cells'' are made by [[Solar Power Plant]]s, and NPC-owned plants do not require resources to function. As such, the X-Universe will never fall apart (Player-owned Solar Power Plants require [[Crystals]] to operate).
...
==== Solar Power Plants ====
{{main|Solar Power Plant}}
Solar Power Plants are also unique enough to warrant specific mention. NPC Solar Power Plants use up Crystals as a [[#Secondary Resources|Secondary Resource]] and output Energy Cells, whereas the player power plants require Crystals as a [[#Primary Resources|Primary Resource]]. Unlike most other factories, which output on a 1:1 Resource:Product basis, Solar Power Plants (even those owned by the player) use very few crystals for the amount of Energy Cells they produce.
...
==== Bio and Mineral ====
The "Bio" and "Mineral" tiers are the lowest after Energy Cells, as they only need Energy Cells to produce their products. "Bio" introduces the first racial oddity here, as each [[races|race]] has approximately two Racial Bio stuffs (e.g. Argnu Beef and [[Delexian Wheat]] for the [[Argon]], or [[BoGas]] and [[Plankton]] for the [[Boron]]), whereas all races use the same Minerals (Primarily [[Ore]] and [[Silicon]], although also [[Ice]] for the [[Terran]]s).
...
Complexes are used to easily automate goods transport between stations, simplifying logistics, and minimizing the number of supporting traders required to supply them. They benefit heavily from having the [[Bonus Pack]] installed, and using the [[Commercial Agent|CAG]] scripts.
...
*[[Factories]]
*[[Complex]]es
*[{{linky}}theengineeringguild.co.uk/node/115 X3 Economy Guide]
*[{{linky}}theengineeringguild.co.uk/node/120 X3 Trading Networks]
{{Trading}}
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Economy" title="Economy" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<li><a href="/index.php/Template:Linky" title="Template:Linky">Template:Linky</a> (<a href="/index.php?title=Template:Linky&amp;action=edit" title="Template:Linky">edit</a>) </li><li><a href="/index.php/Template:Main" title="Template:Main">Template:Main</a> (<a href="/index.php?title=Template:Main&amp;action=edit" title="Template:Main">edit</a>) </li><li><a href="/index.php/Template:Sectstub" title="Template:Sectstub">Template:Sectstub</a> (<a href="/index.php?title=Template:Sectstub&amp;action=edit" title="Template:Sectstub">edit</a>) </li><li><a href="/index.php/Template:See_also" title="Template:See also">Template:See also</a> (<a href="/index.php?title=Template:See_also&amp;action=edit" title="Template:See also">edit</a>) </li><li><a href="/index.php/Template:Trading" title="Template:Trading">Template:Trading</a> (<a href="/index.php?title=Template:Trading&amp;action=edit" title="Template:Trading">edit</a>) </li></ul></div><div class="hiddencats"></div><div class="limitreport"></div><input type="hidden" value="1" name="wpUltimateParam"/>
</form>
</div><div class="printfooter">
Retrieved from "<a dir="ltr" href="http://x3wiki.com/index.php/Economy">http://x3wiki.com/index.php/Economy</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Economy&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Economy&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Economy&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
