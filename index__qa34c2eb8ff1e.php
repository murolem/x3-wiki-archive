...
<input type='hidden' value="20170724151212" name="wpStarttime" />
<input type='hidden' value="20140225101928" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="2bb47a071972ca5ede4322294d3b48f2" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="14668" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">==Table of Missiles==
...
|-
| [[Hornet Missile]] ||200,000||31.2 ||186 ||no ||yes || standard ||impact||[[Commonwealth]]||[[M1]]-[[M2]] [[M6]]-[[M7]]&lt;sup>1&lt;/sup>
|-
| [[Thorn]] ||15,000||17.777 ||158 ||no ||yes || standard ||proximity||[[Kha'ak]]||[[M1]]-[[M3]] [[M6]]||none
|-
| [[Typhoon Missile]] ||240,000||74.8 ||195 ||yes ||yes || standard ||impact||All||[[M1]]-[[M2]] [[M6]]-[[M7]]&lt;sup>1&lt;/sup>
|-
| [[Firestorm Torpedo]] ||1,000,000||99.0 ||165 ||no || || standard ||impact||All||[[M1]]-[[M2]] [[M6]]-[[M7]]&lt;sup>1&lt;/sup>
|-
...
|}
Note 1: The [[Medusa|Medusa Prototype]] [[M3]]-class fighter can also launch these Corvette-class missiles.
</textarea><div class='editOptions'>
<span class="mw-summary" id="wpSummaryLabel"><label for="wpSummary">Summary:</label></span> <input class="mw-summary" id="wpSummary" maxlength="200" tabindex="1" size="60" spellcheck="true" title="Enter a short summary [b]" accesskey="b" value="/* Table of Missiles */ " name="wpSummary"/><div class='editCheckboxes'>
</div>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Missiles&amp;returntoquery=action%3Dedit%26section%3D2" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Missiles&amp;returntoquery=action%3Dedit%26section%3D2" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
