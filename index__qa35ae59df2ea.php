...
<head>
<title>Editing Truelight Seeker (section) - X3 Wiki</title>
...
<form id="editform" name="editform" method="post" action="/index.php?title=Truelight_Seeker&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="4" name="wpSection" />
<input type='hidden' value="20110107034004" name="wpStarttime" />
<input type='hidden' value="20101128143835" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="07697354b42b5996fa5bb9899abcd59b" name="wpAutoSummary" /><input type="hidden" value="0" name="oldid" /><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" name="wpTextbox1">== Combat ==
...
Against M6 or lesser vehicles, a tactic available to the Truelight Seeker is to utilize the greater range afforded by the heavy guns and try to cripple enemies before they can get close enough to fight back, then retreating to a standoff position to finish them off.
...
Against a swarm of M5 ships the Truelight Seeker may employ the PSG, which is capable of covering a broad cone in front of the ship.
...
<span class="mw-summary" id="wpSummaryLabel"><label for="wpSummary">Summary:</label></span> <input class="mw-summary" id="wpSummary" maxlength="200" tabindex="1" size="60" value="/* Combat */ " name="wpSummary" /><div class='editCheckboxes'>
</div>
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='editHelp'><a href="/index.php/Truelight_Seeker" title="Truelight Seeker" id="mw-editform-cancel">Cancel</a> | <a target="helpwindow" href="/index.php/Help:Editing">Editing help</a> (opens in new window)</span>
</div><!-- editButtons -->
</div><!-- editOptions -->
...
<div class="mw-hiddenCategoriesExplanation"><p>This page is a member of 27 hidden categories:
</p></div><ul>
	...
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Truelight_Seeker&amp;returntoquery=action%3Dedit%26section%3D4" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
...
<!-- Served in 0.241 secs. --><script type="text/javascript">
