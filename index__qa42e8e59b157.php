...
<head>
<meta charset="UTF-8" /><title>Editing CEO's Wellspring - X3 Wiki</title>
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing CEO's Wellspring</span></h1>
...
<input type='hidden' value="20140717142903" name="wpStarttime" />
<input type='hidden' value="20120518052935" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary" /><input type="hidden" value="0" name="oldid" /><input type="hidden" value="text/x-wiki" name="format" /><input type="hidden" value="wikitext" name="model" /><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">

==Overview==
One of the five possible sector names a player gets to choose from at the end of the [[A New Home]] [[missions]]. It is located north of the [[Unknown Sector (20,5)]] east of [[Zyarth's Dominion]].
...
==Sun/s==
As with all other possible sector choices, CEO's Wellspring contains 300% sun. (2 separate suns)
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=CEO%27s+Wellspring&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=CEO%27s+Wellspring&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
