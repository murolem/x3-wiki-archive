...
<input type='hidden' value="20160506045831" name="wpStarttime" />
...
<div id="column-one">
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Raptor&amp;returntoquery=action%3Dedit%26section%3D7&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Raptor&amp;returntoquery=action%3Dedit%26section%3D7" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
