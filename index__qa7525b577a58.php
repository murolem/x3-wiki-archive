...
<!-- Saved in parser cache with key dailystunt_wiki:pcache:idhash:1987-0!*!0!!en!*!* and timestamp 20120816103152 -->
...
<div id="column-one">
	...
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Ariadne&amp;returntoquery=printable%3Dyes" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
...
<div id="footer">
	...
	<ul id="f-list">
		...
		<li id="viewcount">This page has been accessed 347 times.</li>
