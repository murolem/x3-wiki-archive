...
<head>
<meta charset="UTF-8" /><title>Editing Orbital Defence Station - X3 Wiki</title>
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Orbital_Defence_Station skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Orbital Defence Station</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Orbital_Defence_Station&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20150425004206" name="wpStarttime" />
<input type='hidden' value="20130823123908" name="wpEdittime" />
...
==Encyclopedia Entry==
===Text===
This station is designed for the sole purpose of providing maximum protection and security to the sector it is in.
===Voice Over===
This station is designed for the sole purpose of providing maximum protection and security to the sector it is in.
...
|-
|-
|[[Shields#1 GJ|1 GJ Shield]]
|77
|XL
|2
|-
|-
|[[Shields#1 MJ|1 MJ Shield]]
|1
|S
|124
|-
|-
|[[Shields#200 MJ|200 MJ Shield]]
|25
|L
|4
|-
|-
|[[Shields#25 MJ|25 MJ Shield]]
|10
|M
|6
|-
|-
|[[Shields#5 MJ|5 MJ Shield]]
|3
|S
|30
|-
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Orbital_Defence_Station" title="Orbital Defence Station" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Orbital_Defence_Station&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Orbital+Defence+Station&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Orbital+Defence+Station&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
