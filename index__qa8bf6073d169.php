...
<form id="editform" name="editform" method="post" action="/index.php?title=Viper&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="1" name="wpSection" />
<input type='hidden' value="20110830163115" name="wpStarttime" />
...
The Viper is the [[Split]] [[M8|bomber]] ship. It is the fastest in its class and its shields are not as ridiculously lacking as most Split ships are. However, it has the smallest cargo capacity of the [[M8|bomber]] class, meaning it cannot carry as much ordinance as its counterparts.
	...
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Viper&amp;returntoquery=action%3Dedit%26section%3D1" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
