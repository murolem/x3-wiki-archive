...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Photon_Pulse_Cannon rootpage-Photon_Pulse_Cannon skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Photon Pulse Cannon</h1>
...
<input type='hidden' value="20180109091318" name="wpStarttime" />
<input type='hidden' value="20140310163722" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="15940" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{Infobox open}}
{{Infobox weapon
|weapon=Photon Pulse Cannon
|hulldam=8200
|shielddam=46500
|range=6.62
|rof= 43
...
{{Infobox close}}
==Overview==
The Photon Pulse Cannon or PPC is the premier [[Commonwealth]] [[:Category:Capital Ships|capital ship]] weapon.

==Encyclopedia Entry==
A deadly weapon found on [[M7|frigates]], [[M2|destroyers]] and [[M1|carriers]].
...
==Commentary==
The PPC does the job that the [[High Energy Plasma Thrower|HEPT]] once did; a weapon that capital ships use to slug it out with other capital ships. It is the most all-round of the capital weapons that include the [[Point Singularity Projector|PSP]], [[Ion Cannon]], [[Gauss Cannon]] and [[Incendiary Bomb Launcher|IBL]]. Whilst it can be charged for extra damage, the PPC deals enough that it isn't necessary. [[M2|Destroyers]] are usually equipped with full arrays of them; but they set the owner back a pretty penny, as together a full loadout of PPCs is almost as costly as some of the destroyer hulls that mount them.

==Known Compatible Ships==
Almost all M1 and M2 class ships can use this weapon.&lt;br>
The [[Thresher|Boron Thresher]] and the [[Q|Xenon Q]] are the only M7 class ships which can mount the PPC.&lt;br>
Similarly, the Goner [[Truelight Seeker]] is the only known M6 which can mount the PPC.

==Available at Known Docks==

Produced in the [[Photon Pulse Cannon Forge]] available in some [[Federal Argon Shipyard|Argon Shipyard]] and [[Paranid Shipyard]].&lt;br>
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Photon_Pulse_Cannon" title="Photon Pulse Cannon" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Photon_Pulse_Cannon">http://www.x3wiki.com/index.php/Photon_Pulse_Cannon</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Photon_Pulse_Cannon&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Photon+Pulse+Cannon&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Photon+Pulse+Cannon&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
