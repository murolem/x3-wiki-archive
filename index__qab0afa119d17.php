...
<head>
<meta charset="UTF-8"/>
<title>Editing Tern - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Tern","wgTitle":"Tern","wgCurRevisionId":15626,"wgRevisionId":0,"wgArticleId":1787,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Tern","wgRelevantArticleId":1787,"wgRequestId":"Wi0IvVkfZokAAH4sYqYAAAAR","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia","wgEditMessage":"editing"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Tern rootpage-Tern skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Tern</h1>
...
<p><strong>Warning:</strong> You are not logged in. Your IP address will be publicly visible if you make any edits. If you <strong><a class="external text" href="http://www.x3wiki.com/index.php?title=Special:UserLogin&amp;returnto=Tern">log in</a></strong> or <strong><a class="external text" href="http://www.x3wiki.com/index.php?title=Special:CreateAccount&amp;returnto=Tern">create an account</a></strong>, your edits will be attributed to your username, along with other benefits.
</p>
</div>
<div id="wikiPreview" class="ontop" style="display: none;"><div lang="en" dir="ltr" class="mw-content-ltr"></div></div><form id="editform" name="editform" method="post" action="/index.php?title=Tern&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntispam">Anti-spam check.
...
<input type='hidden' value="20171210101317" name="wpStarttime" />
<input type='hidden' value="20140304181431" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="15626" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{Infobox open}}
{{Infobox variant
|Variant=Tern
|Faction=Teladi
|Class={{TS+class}}
|Priceblock={{Priceblock|| 1708856}}
|Minspeed= 38.1
|Maxspeed= 60.9
|Minaccel=1
|Maxaccel=2
...
{{Infobox close}}
==Overview==
The Teladi introduced this new [[TS]]+ ship in time for the events of Albion Prelude. It boasts the toughest shielding of any Commonwealth TS (tied with the [[Hayabusa|Terran Hayabusa]] for toughest shields on any TS), but otherwise is a fairly weak entry in the category. Like other Teladi ships, it is the slowest in its class, and while it has one of the largest cargo bays of any TS, it is simply outshone by its competitors. It is still an excellent investment for a complex Commercial Agent, where the ability to move large amounts of cargo is most important.

==Background==
Sensing the need for a new transporter for risky, high-profit situations, the Teladi designed the Tern. Marked as a long-term investment, the Tern was built with an unusually high degree of redundancy for a Teladi vessel. A single Tern is estimated to be able to outperform any three regular transporters, ensuring that the extra credits spent on each ship would repay themselves in a relatively short amount of time. As the Tern was primarily intended to ferry large high-tech cargoes, it soon became a firm favourite of smugglers and black-market ware dealers.
==Physical Characteristics==
The Tern is surprisingly graceful in appearance for a Teladi ship. While its bow features the usual metal spikes, the rest of the ship's hull plating is relatively smooth.  However, the Teladi still do not see fit to paint it.
== Combat ==
The Tern can mount the [[Plasma Burst Generator]], allowing it to eradicate any fighter that gets too close, but is vulnerable if hunted from longer ranges.
...
|-
! style="text-align:left;" |Tern || x || || || || ||
|}

== Suggested Roles==
The Tern is not as effective a Universe Trader as other TS+ ships, but makes a good Commercial Agent.
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Tern" title="Tern" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<li><a href="/index.php/Template:Colour/Teladi" title="Template:Colour/Teladi">Template:Colour/Teladi</a> (<a href="/index.php?title=Template:Colour/Teladi&amp;action=edit" title="Template:Colour/Teladi">edit</a>) </li><li><a href="/index.php/Template:Factionshipcat/" title="Template:Factionshipcat/">Template:Factionshipcat/</a> (<a href="/index.php?title=Template:Factionshipcat/&amp;action=edit" title="Template:Factionshipcat/">edit</a>) </li><li><a href="/index.php/Template:Gunicon/0" title="Template:Gunicon/0">Template:Gunicon/0</a> (<a href="/index.php?title=Template:Gunicon/0&amp;action=edit" title="Template:Gunicon/0">view source</a>) (semi-protected)</li><li><a href="/index.php/Template:Gunicon/1" title="Template:Gunicon/1">Template:Gunicon/1</a> (<a href="/index.php?title=Template:Gunicon/1&amp;action=edit" title="Template:Gunicon/1">view source</a>) (semi-protected)</li><li><a href="/index.php/Template:Gunslot" title="Template:Gunslot">Template:Gunslot</a> (<a href="/index.php?title=Template:Gunslot&amp;action=edit" title="Template:Gunslot">view source</a>) (semi-protected)</li><li><a href="/index.php/Template:Infobox_close" title="Template:Infobox close">Template:Infobox close</a> (<a href="/index.php?title=Template:Infobox_close&amp;action=edit" title="Template:Infobox close">view source</a>) (semi-protected)</li><li><a href="/index.php/Template:Infobox_open" title="Template:Infobox open">Template:Infobox open</a> (<a href="/index.php?title=Template:Infobox_open&amp;action=edit" title="Template:Infobox open">view source</a>) (semi-protected)</li><li><a href="/index.php/Template:Infobox_variant" title="Template:Infobox variant">Template:Infobox variant</a> (<a href="/index.php?title=Template:Infobox_variant&amp;action=edit" title="Template:Infobox variant">view source</a>) (semi-protected)</li><li><a href="/index.php/Template:Priceblock" title="Template:Priceblock">Template:Priceblock</a> (<a href="/index.php?title=Template:Priceblock&amp;action=edit" title="Template:Priceblock">edit</a>) </li><li><a href="/index.php/Template:Shipbox" title="Template:Shipbox">Template:Shipbox</a> (<a href="/index.php?title=Template:Shipbox&amp;action=edit" title="Template:Shipbox">edit</a>) </li><li><a href="/index.php/Template:Shipclassbox" title="Template:Shipclassbox">Template:Shipclassbox</a> (<a href="/index.php?title=Template:Shipclassbox&amp;action=edit" title="Template:Shipclassbox">edit</a>) </li><li><a href="/index.php/Template:TS%2B" title="Template:TS+">Template:TS+</a> (<a href="/index.php?title=Template:TS%2B&amp;action=edit" title="Template:TS+">edit</a>) </li><li><a href="/index.php/Template:TS%2BTable" title="Template:TS+Table">Template:TS+Table</a> (<a href="/index.php?title=Template:TS%2BTable&amp;action=edit" title="Template:TS+Table">edit</a>) </li><li><a href="/index.php/Template:TS%2Bcategory" title="Template:TS+category">Template:TS+category</a> (<a href="/index.php?title=Template:TS%2Bcategory&amp;action=edit" title="Template:TS+category">edit</a>) </li><li><a href="/index.php/Template:TS%2Bclass" title="Template:TS+class">Template:TS+class</a> (<a href="/index.php?title=Template:TS%2Bclass&amp;action=edit" title="Template:TS+class">edit</a>) </li><li><a href="/index.php/Template:Teladi_Navbox" title="Template:Teladi Navbox">Template:Teladi Navbox</a> (<a href="/index.php?title=Template:Teladi_Navbox&amp;action=edit" title="Template:Teladi Navbox">edit</a>) </li></ul></div><div class="hiddencats"><div class="mw-hiddenCategoriesExplanation"><p>This page is a member of 2 hidden categories:
</p></div><ul>
...
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Tern">http://www.x3wiki.com/index.php/Tern</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				<ul>
				<li id="ca-nstab-main" class="selected"><a href="/index.php/Tern" title="View the content page [c]" accesskey="c">Page</a></li>
				<li id="ca-talk" class="new"><a href="/index.php?title=Talk:Tern&amp;action=edit&amp;redlink=1" rel="discussion" title="Discussion about the content page [t]" accesskey="t">Discussion</a></li>
				<li id="ca-edit" class="selected"><a href="/index.php?title=Tern&amp;action=edit" title="Edit this page">Edit</a></li>
				<li id="ca-history"><a href="/index.php?title=Tern&amp;action=history" title="Past revisions of this page [h]" accesskey="h">History</a></li>
				</ul>
							</div>
		</div>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Tern&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Tern&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
		...
		<div class='pBody'>
			...
			<div class="pBody">
				<ul>
											...
											<li id="t-info"><a href="/index.php?title=Tern&amp;action=info" title="More information about this page">Page information</a></li>
									</ul>
							</div>
		</div>
