...
<head>
<meta charset="UTF-8"/>
<title>Editing Category:Carrier - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"Category","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":14,"wgPageName":"Category:Carrier","wgTitle":"Carrier","wgCurRevisionId":13540,"wgRevisionId":0,"wgArticleId":2375,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Category:Carrier","wgRelevantArticleId":2375,"wgRequestId":"WfK7tVkfZokAAH@VAB8AAAAR","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia","wgEditMessage":"editing"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<body class="mediawiki ltr sitedir-ltr ns-14 ns-subject page-Category_Carrier rootpage-Category_Carrier skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Category:Carrier</h1>
...
<input type='hidden' value="20171027045309" name="wpStarttime" />
<input type='hidden' value="20130814111823" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="13540" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{See also|Capital Ships}}

== Overview ==
Carriers vary in size, from your humble {{TMclass}}, up to the massive {{M1class}}, with a fair few ships between.
...
Equipping 40+ {{M3class}} ships with weapons is often more than the X-Universe can handle in one go, so often requires [[complex|special infrastructure]] in order to equip so many ships in a short space of time.


== Docking ==
As all carrier ships, by their definition, can be docked with, it means the player can swap to and from ships landed (default key: "x" when another internal ship is selected). When the player swaps into a ship inside the carrier, the ship will immediately launch.
...
=== Docking Non-Fighter Ships ===
A few, very special ships can dock non-fighter ships (e.g. ships not [[M3+]] - [[M5]]), such as the Paranid [[Ariadne]] and Boron [[Guppy]] being able to dock a single {{TSclass}} or {{TPclass}} ship. This is very rare, and only a select few ships may do this.

The Goner [[Aran]] is unique in that it can dock other capital-class ships.

=== Docking at Stations ===
As many carriers are capital ships, docking at stations can be difficult. For freight transfer with player-owned stations, [[Freight Drone]]s are often useful. Otherwise, using the ships carried inside to ferry goods and purchase items from a station is common. Players often use a Jumpdrive equipped TS combined with a transporter to fill a Carrier's cargohold.
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Category:Carrier" title="Category:Carrier" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<li><a href="/index.php/Template:M1class" title="Template:M1class">Template:M1class</a> (<a href="/index.php?title=Template:M1class&amp;action=edit" title="Template:M1class">edit</a>) </li><li><a href="/index.php/Template:M3class" title="Template:M3class">Template:M3class</a> (<a href="/index.php?title=Template:M3class&amp;action=edit" title="Template:M3class">edit</a>) </li><li><a href="/index.php/Template:See_also" title="Template:See also">Template:See also</a> (<a href="/index.php?title=Template:See_also&amp;action=edit" title="Template:See also">edit</a>) </li><li><a href="/index.php/Template:TMclass" title="Template:TMclass">Template:TMclass</a> (<a href="/index.php?title=Template:TMclass&amp;action=edit" title="Template:TMclass">edit</a>) </li><li><a href="/index.php/Template:TPclass" title="Template:TPclass">Template:TPclass</a> (<a href="/index.php?title=Template:TPclass&amp;action=edit" title="Template:TPclass">edit</a>) </li><li><a href="/index.php/Template:TSclass" title="Template:TSclass">Template:TSclass</a> (<a href="/index.php?title=Template:TSclass&amp;action=edit" title="Template:TSclass">edit</a>) </li></ul></div><div class="hiddencats"></div><div class="limitreport"></div><input type="hidden" value="1" name="wpUltimateParam"/>
</form>
</div><div class="printfooter">
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Category:Carrier">http://www.x3wiki.com/index.php/Category:Carrier</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Category:Carrier&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Category%3ACarrier&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Category%3ACarrier&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
