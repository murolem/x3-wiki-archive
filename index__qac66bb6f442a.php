...
<head>
<meta charset="UTF-8"/>
<title>Editing Plankton Farm - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Plankton_Farm","wgTitle":"Plankton Farm","wgCurRevisionId":16628,"wgRevisionId":0,"wgArticleId":1452,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Plankton_Farm","wgRelevantArticleId":1452,"wgRequestId":"WHiMW1kfZokAADjTt-gAAAAC","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia","wgEditMessage":"editing"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Plankton_Farm rootpage-Plankton_Farm skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Plankton Farm</h1>
...
<input type='hidden' value="20170113081419" name="wpStarttime" />
<input type='hidden' value="20150225193929" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="16628" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">__NOTOC__
{{Infobox open}}
{{Infobox factory
|faction=Boron
|station=Plankton Farm L
|hull=2250000
|shield=15
|generator=1500
|hangar=5
|cycle=00:01:00
|productnum=[[Plankton]] (75)
|stationprice={{Priceblock|Boron Queen's Guard|799992}}
|reqresources=[[Energy Cells]] (75)&lt;br>
|optresources=[[Delexian Wheat]]
}}
{{Infobox factory
|faction=Boron
|station=Plankton Farm M
|hull=900000
|shield=10
|generator=1500
|hangar=5
|cycle=00:01:00
|productnum=[[Plankton]] (30)
|stationprice={{Priceblock|Boron Queen's Guard|320008}}
|reqresources=[[Energy Cells]] (30)&lt;br>
|optresources=[[Delexian Wheat]]
}}
{{Infobox close}}
==Overview==
Plankton Farms are Boron factories that produce [[Plankton]] from [[Energy Cells]]. 

NPC stations will buy [[Delexian Wheat]] as a secondary resource.

===Encyclopedia Entry===
Despite Boron Plankton being formed naturally on the Boron Home Planet, such is the popularity of Boron Spices that the Boron have established a large number of specialised Plankton farms to meet the demand. 

These farms are large geodesic domes that create the unique chemical soup that is the atmosphere of the Planet Boron. Once produced the Plankton is then transported to a nearby Space Stott Mixery where it is processed into the many different Boron Spices. These factories also add the growing Plankton to Delexian Wheat, Meatsteak Cahoonas and Soja Husk in experiments to produce different varieties of foodstuff.
==Availability==
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Plankton_Farm" title="Plankton Farm" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Plankton_Farm">http://www.x3wiki.com/index.php/Plankton_Farm</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-talk" class="new"><a href="/index.php?title=Talk:Plankton_Farm&amp;action=edit&amp;redlink=1" rel="discussion" title="Discussion about the content page [t]" accesskey="t">Discussion</a></li>
				<li id="ca-edit" class="selected"><a href="/index.php?title=Plankton_Farm&amp;action=edit" title="Edit this page">Edit</a></li>
				<li id="ca-history"><a href="/index.php?title=Plankton_Farm&amp;action=history" title="Past revisions of this page [h]" accesskey="h">History</a></li>
				</ul>
							</div>
		</div>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Plankton+Farm&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Plankton+Farm&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
		...
		<div class='pBody'>
			...
			<div class="pBody">
				<ul>
											...
											<li id="t-info"><a href="/index.php?title=Plankton_Farm&amp;action=info" title="More information about this page">Page information</a></li>
									</ul>
							</div>
		</div>
