...
<input type='hidden' value="20170425135536" name="wpStarttime" />
<input type='hidden' value="20170201144338" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="ee65a043fd4342c449cd521fe8b396bb" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="16855" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">== Bugs ==
''For a more in-depth look at fixing bugs, please take a look through several of the links provided at [[#See Also|the bottom of the page]].''

Common problems include:
=== Trader Not Doing Anything ===
'''Cause:''' It depends. It can come under one of two guises:
*''Standby:'' No profitable trades found.
*''Idle:'' means there is an issue that ought to resolve itself soon - e.g. enemies present, or missing pre-requisite. It also covers generic problems which you (the player) may have to fix. Be careful of this one, as it could be the trading bay is full of an item it can't sell, and will need to be manually emptied, or you might need to restart trading from a different sector. If you notice Traders often end up in falling to "Idle" in one sector, consider adding that sector to your Mk III Trader Blacklist via the in-game "Additional Commands" accessible on any ship with [[Trade Command Software#Trade Command Software Mk3|Mk III Trading Software]] installed.
...
<span class="mw-summary" id="wpSummaryLabel"><label for="wpSummary">Summary:</label></span> <input class="mw-summary" id="wpSummary" maxlength="200" tabindex="1" size="60" spellcheck="true" title="Enter a short summary [b]" accesskey="b" value="/* Bugs */ " name="wpSummary"/><div class='editCheckboxes'>
</div>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Universe+Traders+Guide&amp;returntoquery=action%3Dedit%26section%3D12" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Universe+Traders+Guide&amp;returntoquery=action%3Dedit%26section%3D12" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
