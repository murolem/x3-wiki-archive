...
<head>
<meta charset="UTF-8"/>
<title>Editing Not Purchasable - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Not_Purchasable","wgTitle":"Not Purchasable","wgCurRevisionId":14242,"wgRevisionId":0,"wgArticleId":2405,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Not_Purchasable","wgRelevantArticleId":2405,"wgRequestId":"WH9CnVkfZokAAB5cekIAAAAC","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia","wgEditMessage":"editing"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Not_Purchasable rootpage-Not_Purchasable skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Not Purchasable</h1>
...
<input type='hidden' value="20170118102533" name="wpStarttime" />
<input type='hidden' value="20140123114358" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="14242" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{stub}}

"Not Purchasable" usually refers to one of several kinds of items in the game:

== Unavailable Items ==
Items that are unavailable - e.g. items that are included in the data files, but simply are not available in the (unmodified) game, but are still present in the game files, so can be [[mod]]ded/hacked/[[script]]ed in.

Examples include the [[Tri-Beam Cannon]] or the [[Mobile Repair Ship]].

== Unpurchasable Items ==
These are items that are available in the game, but may not be bought. Prominent examples include:
* Many [[Missiles]] (e.g. the [[Remote Guided Warhead]]).
* Many [[Ships]] (e.g. the [[Aran]]).
* Many [[Weapons]] (e.g. the [[Repair Laser]]).
* Several [[Wares]] (e.g. the [[Jump Beacon]]).

Many ships listed as unpurchasable may be [[boarding|boarded]]
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Not_Purchasable" title="Not Purchasable" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<li><a href="/index.php/Template:Stub" title="Template:Stub">Template:Stub</a> (<a href="/index.php?title=Template:Stub&amp;action=edit" title="Template:Stub">edit</a>) </li></ul></div><div class="hiddencats"></div><div class="limitreport"></div><input type="hidden" value="1" name="wpUltimateParam"/>
</form>
</div><div class="printfooter">
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Not_Purchasable">http://www.x3wiki.com/index.php/Not_Purchasable</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-talk" class="new"><a href="/index.php?title=Talk:Not_Purchasable&amp;action=edit&amp;redlink=1" rel="discussion" title="Discussion about the content page [t]" accesskey="t">Discussion</a></li>
				<li id="ca-edit" class="selected"><a href="/index.php?title=Not_Purchasable&amp;action=edit" title="Edit this page">Edit</a></li>
				<li id="ca-history"><a href="/index.php?title=Not_Purchasable&amp;action=history" title="Past revisions of this page [h]" accesskey="h">History</a></li>
				</ul>
							</div>
		</div>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Not+Purchasable&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Not+Purchasable&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
		...
		<div class='pBody'>
			...
			<div class="pBody">
				<ul>
											...
											<li id="t-info"><a href="/index.php?title=Not_Purchasable&amp;action=info" title="More information about this page">Page information</a></li>
									</ul>
							</div>
		</div>
