...
<head>
<meta charset="UTF-8" />
<title>View source - X3 Wiki</title>
...
<body class="mediawiki ltr ns-8 ns-subject page-MediaWiki_Vector-view-history skin-monobook">
...
<div id="column-content"><div id="content">
	...
	<div id="bodyContent">
		...
		<div id="contentSub">for <a href="/index.php/MediaWiki:Vector-view-history" title="MediaWiki:Vector-view-history">MediaWiki:Vector-view-history</a></div>
...
</p><textarea id="wpTextbox1" name="wpTextbox1" cols="80" rows="25" readonly="">View history</textarea><div class='templatesUsed'>

</div>
<div class="printfooter">
Retrieved from "<a href="http://x3wiki.com/index.php/MediaWiki:Vector-view-history">http://x3wiki.com/index.php/MediaWiki:Vector-view-history</a>"</div>
...
<div id="column-one">
	<div id="p-cactions" class="portlet">
		...
		<div class="pBody">
			<ul>
				 <li id="ca-nstab-mediawiki" class="selected"><a href="/index.php/MediaWiki:Vector-view-history" title="View the system message [c]" accesskey="c">Message</a></li>
				 <li id="ca-talk" class="new"><a href="/index.php?title=MediaWiki_talk:Vector-view-history&amp;action=edit&amp;redlink=1" title="Discussion about the content page [t]" accesskey="t">Discussion</a></li>
				 <li id="ca-viewsource" class="selected"><a href="/index.php?title=MediaWiki:Vector-view-history&amp;action=edit" title="This page is protected.&#10;You can view its source [e]" accesskey="e">View source</a></li>
			</ul>
		</div>
	</div>
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=MediaWiki:Vector-view-history&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
	...
	<div class="portlet" id="p-tb">
		...
		<div class="pBody">
			<ul>
				<li id="t-whatlinkshere"><a href="/index.php/Special:WhatLinksHere/MediaWiki:Vector-view-history" title="List of all wiki pages that link here [j]" accesskey="j">What links here</a></li>
...
<script>if ( window.mediaWiki ) {
	mediaWiki.config.set({"wgCanonicalNamespace": "MediaWiki", "wgCanonicalSpecialPageName": false, "wgNamespaceNumber": 8, "wgPageName": "MediaWiki:Vector-view-history", "wgTitle": "Vector-view-history", "wgAction": "edit", "wgArticleId": 0, "wgIsArticle": false, "wgUserName": null, "wgUserGroups": ["*"], "wgCurRevisionId": 0, "wgCategories": [], "wgBreakFrames": true, "wgRestrictionCreate": []});
}
</script>
<script>if ( window.mediaWiki ) {
