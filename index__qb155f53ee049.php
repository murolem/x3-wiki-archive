...
<head>
<meta charset="UTF-8" /><title>Editing Boron Campaign - X3 Wiki</title>
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Boron_Campaign skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Boron Campaign</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Boron_Campaign&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20160909183937" name="wpStarttime" />
<input type='hidden' value="20160614221834" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary" /><input type="hidden" value="0" name="oldid" /><input type="hidden" value="text/x-wiki" name="format" /><input type="hidden" value="wikitext" name="model" /><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">The Boron Campaign was the first large-scale war that involved all members of the [[Commonwealth]]. It was fought between the [[Paranid]]/[[Split]] alliance against the [[Boron]]/[[Argon]] alliance a few decades after the end of the [[Xenon Conflict]].

The Boron Kingdom had grown continually since discovering the secrets of space travel and the gate network, and as of the year 2255 had expanded through a huge tract of space to the east of their home Sector of [[Kingdom End]]. Unfortunately for the Boron, the [[Split]] had occupied this region of space since discovering space travel themselves 150 years earlier, and due to their warlike nature soon found glee in attacking the new far-flung Boron colonies.
...
The Argon Federation desperately needed a new ally, and found it in the Boron in 2323. In the year 2324, a combined Split/Paranid fleet attacked another Argon deep-space mining fleet. The Argon Federation responded by formally declaring war on the Split and Paranid, officially beginning the Boron Campaign.
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Boron_Campaign" title="Boron Campaign" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a href="http://www.x3wiki.com/index.php/Boron_Campaign">http://www.x3wiki.com/index.php/Boron_Campaign</a>"</div>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Boron_Campaign&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Boron+Campaign&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Boron+Campaign&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
