...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Ion_Pulse_Generator rootpage-Ion_Pulse_Generator skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Ion Pulse Generator</h1>
...
<input type='hidden' value="20171215105344" name="wpStarttime" />
<input type='hidden' value="20140920130723" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="16480" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{Infobox open}}
{{Infobox weapon
|weapon=Ion Pulse Generator
|hulldam=544
|shielddam=13000
|range=3.88
|rof= 62
...
{{Infobox close}}
==Overview==
The Ion Pulse Generator, or IPG, is a [[Boron]] weapon compatible with [[M6|corvette]]s and heavier ships.
...
|- valign="top"
|
*[[Astraeus Hauler]] (M7, Argon/OTAS)
*[[Boreas]] (M2, Argon/OTAS)
*[[Centaur]] (M6, Argon)
*[[Cerberus]] (M7, Argon)
*[[Colossus]] (M1, Argon)
*[[Griffon Sentinel]] (M7C, Argon)
*[[Heavy Centaur]] (M6+, Argon)
*[[Heavy Centaur Prototype]] (M6+, Argon)
*[[Mammoth]] (TL, Argon)
*[[Pirate Centaur]] (M6, Argon)
*[[Skiron]] (M6, Argon/OTAS)
*[[Titan]] (M2, Argon)
|
*[[Guppy]] (M7C, Boron)
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Ion_Pulse_Generator" title="Ion Pulse Generator" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Ion_Pulse_Generator">http://www.x3wiki.com/index.php/Ion_Pulse_Generator</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Ion_Pulse_Generator&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Ion+Pulse+Generator&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Ion+Pulse+Generator&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
