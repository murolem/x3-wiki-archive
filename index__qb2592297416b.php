...
<head>
<meta charset="UTF-8" /><title>Editing Blue Profit - X3 Wiki</title>
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Blue_Profit skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Blue Profit</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Blue_Profit&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20140717144143" name="wpStarttime" />
<input type='hidden' value="20140306124836" name="wpEdittime" />
...
{{Gateblock2|North|0|	9375|	35160|[[Greater Profit]]}}
{{Gateblock2|South|-7500|	0|	-35160|[[Ceo's Sprite]]}}
&lt;/table>
}}
==Description==
A busy and lucrative system with an economy dependent on high-quality electronics. Blue Profit is most famous as the source of the distinctive style of music devised by Teladi factory workers. Combining Teladi reed-whistles and Boron toneshells with Argon and Teladi percussion instruments, 'Teladi Blues' is appreciated by many sentient species.
==Default [[Stations]]==
==[[Asteroids]]==
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Blue_Profit" title="Blue Profit" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Blue_Profit&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Blue+Profit&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Blue+Profit&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
