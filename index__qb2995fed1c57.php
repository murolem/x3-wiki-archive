...
<form id="editform" name="editform" method="post" action="/index.php?title=Kha%27ak_Fighter&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="4" name="wpSection" />
<input type='hidden' value="20111016064808" name="wpStarttime" />
...
Rarely found alone. If you are fighting the Khaak, always start with the most powerful ships and work downwards. For example, if a cluster decouples, the Fighter will be your most powerful foe. Kill it, and the Scouts can be picked off in less discomfort.
...
<div id="column-one">
	...
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Kha%27ak_Fighter&amp;returntoquery=action%3Dedit%26section%3D4" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
