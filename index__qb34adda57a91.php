...
<head>
<meta charset="UTF-8" /><title>Editing Meatsteak Cahoonas - X3 Wiki</title>
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Meatsteak_Cahoonas skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Meatsteak Cahoonas</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Meatsteak_Cahoonas&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20160514141841" name="wpStarttime" />
<input type='hidden' value="20130909134252" name="wpEdittime" />
...
Argon meatsteaks are traded throughout the universe. They provide a nutritious meat based food suitable for most types of races. Some races prefer to use Argon meatsteaks in conjuncture with different Boron spices. It is traded in blocks known as Cahoonas.

== Commentary ==
This product is produced at the Argon [[Cahoona Bakery M]] and [[Cahoona Bakery L]]
Cahoonas are the [[Argon]]'s main food product. because of this they are required by many Argon factories as a primary resource.

==Trading information==
{| border="1" cellspacing="0" cellpadding="2"
|- valign="top"
! scope="row"| Produced by; 
|
*[[Cahoona Bakery M]]
*[[Cahoona Bakery L]]

|- valign="top"
! scope="row"|Primary Resource at 
|
{|
|+'''Argon Factories'''
|- valign="top"
...
*[[Shield Prod. Fac. 200 MJ]]
*[[Shield Prod. Facility 2 GJ]]
...
|- valign="top"
! scope="row"|Secondary Resource at 
|
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Meatsteak_Cahoonas" title="Meatsteak Cahoonas" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Meatsteak_Cahoonas&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Meatsteak+Cahoonas&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Meatsteak+Cahoonas&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
