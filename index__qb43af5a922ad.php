...
<head>
<meta charset="UTF-8" /><title>Editing Shield reactor - X3 Wiki</title>
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Shield reactor</span></h1>
...
<input type='hidden' value="20160501072812" name="wpStarttime" />
...
A shield reactor charges the [[shields]] of [[ships]] in X3, are not upgradeable or interchangeable and have a fixed value for the lifetime of the ships or [[stations]] they are installed in.
...
==Application==
This means that two similar class ships, both with the same shield load out (e.g. 2 x [[Shields#25MJ|25MJ Shields]]), may have different performance in maintaining shields in combat if one has a more powerful shield reactor.
...
<div id="column-one">
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Shield+reactor&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Shield+reactor&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
