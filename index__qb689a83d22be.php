...
<head>
<title>Editing Equipment Dock - X3 Wiki</title>
<meta charset="UTF-8" />
...
<script>if(window.mw){
	mw.config.set({"wgCanonicalNamespace": "", "wgCanonicalSpecialPageName": false, "wgNamespaceNumber": 0, "wgPageName": "Equipment_Dock", "wgTitle": "Equipment Dock", "wgCurRevisionId": 0, "wgArticleId": 0, "wgIsArticle": false, "wgAction": "edit", "wgUserName": null, "wgUserGroups": ["*"], "wgCategories": [], "wgBreakFrames": true, "wgRestrictionCreate": [], "Geo": {"city": "", "country": ""}, "wgNoticeProject": "wikipedia"});
}
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Equipment_Dock action-edit skin-monobook">
...
<div id="column-content"><div id="content">
	...
	<h1 id="firstHeading" class="firstHeading">Editing Equipment Dock</h1>
	<div id="bodyContent">
...
<li class="mw-logline-delete">12:22, 11 May 2011 <a href="/index.php/User:Spychotic" title="User:Spychotic" class="mw-userlink">Spychotic</a> <span class="mw-usertoollinks">(<a href="/index.php/User_talk:Spychotic" title="User talk:Spychotic">Talk</a> | <a href="/index.php/Special:Contributions/Spychotic" title="Special:Contributions/Spychotic">contribs</a>)</span> deleted &quot;<a href="/index.php?title=Equipment_Dock&amp;action=edit&amp;redlink=1" class="new" title="Equipment Dock (page does not exist)">Equipment Dock</a>&quot; ‎ <span class="comment">(content was: &quot;Wow! That&#039;s a relaly neat answer!&quot; (and the only contributor was &quot;<a href="/index.php/Special:Contributions/64.71.138.95" title="Special:Contributions/64.71.138.95">64.71.138.95</a>&quot;))</span>  </li>
</ul>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Equipment_Dock&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="" name="wpSection" />
<input type='hidden' value="20120109065647" name="wpStarttime" />
<input type='hidden' value="20120109065647" name="wpEdittime" />
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='editHelp'><a href="/index.php/Equipment_Dock" title="Equipment Dock" id="mw-editform-cancel">Cancel</a> | <a target="helpwindow" href="/index.php/Help:Editing">Editing help</a> (opens in new window)</span>
</div><!-- editButtons -->
</div><!-- editOptions -->
...
<div id="column-one">
	<div id="p-cactions" class="portlet">
		...
		<div class="pBody">
			<ul>
				<li id="ca-nstab-main" class="selected new"><a href="/index.php?title=Equipment_Dock&amp;action=edit&amp;redlink=1" title="View the content page [c]" accesskey="c">Page</a></li>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Equipment_Dock&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Create</a></li>
			</ul>
		</div>
	</div>
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Equipment_Dock&amp;returntoquery=action%3Dedit%26redlink%3D1" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
