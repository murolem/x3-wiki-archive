...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Brigantine rootpage-Brigantine skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Brigantine</h1>
...
<p><strong>Warning:</strong> You are not logged in. Your IP address will be publicly visible if you make any edits. If you <strong><a class="external text" href="http://www.x3wiki.com/index.php?title=Special:UserLogin&amp;returnto=Brigantine">log in</a></strong> or <strong><a class="external text" href="http://www.x3wiki.com/index.php?title=Special:CreateAccount&amp;returnto=Brigantine">create an account</a></strong>, your edits will be attributed to your username, along with other benefits.
</p>
</div>
<div id="wikiPreview" class="ontop" style="display: none;"><div lang="en" dir="ltr" class="mw-content-ltr"></div></div><form id="editform" name="editform" method="post" action="/index.php?title=Brigantine&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntispam">Anti-spam check.
...
<input type='hidden' value="20171010210138" name="wpStarttime" />
<input type='hidden' value="20140303124221" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="15444" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{Infobox open}}
{{Infobox variant
|Variant= Brigantine
|Faction=Pirate
|Class={{M2class}}
...
{{Infobox close}}
==Overview==
The Brigantine equips a good range of weapons but is handicapped by its limited forward weapon power and poor defensive shielding; thus, it is the weakest of M2s for players. Nevertheless it is a popular ship, often used as [[boarding]] practice.

==Background==
The worst fears of shipping and trading companies were recently realised when the existence of a pirate destroyer was confirmed. Military forces have increased their vigilance in the face of this new threat.
==Physical Characteristics==
== Combat ==
The Brigantine can mount several flak cannons, making it particularly lethal against fighters. However it is weak against other capital ships due to its poor shielding and less than ideal anti-capital turret arcs. It has average speed for a destroyer so it cannot easily retreat from a fight, but with a competent pilot it is a force to be reckoned with.
...
|}
== Availability ==
The Brigantine cannot be bought at any shipyard and must be [[boarding|captured]] in order to be used.

== Suggested Roles==
Light patrol duty; the ship cannot defend itself out of sector from enemy M7s or greater.
== See Also==
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Brigantine" title="Brigantine" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Brigantine">http://www.x3wiki.com/index.php/Brigantine</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Brigantine&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Brigantine&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Brigantine&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
