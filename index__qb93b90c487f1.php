...
Do <b>NOT</b> fill this in!</label><input type="text" name="wpAntispam" id="wpAntispam" value="" /></div><input type='hidden' value="15" name="wpSection" />
<input type='hidden' value="20160708052725" name="wpStarttime" />
...
All Vultures come equipped with [[Trade Command Software|Trade Command Software MK1]], and Vulture Miners also come pre-equipped with:
*[[Mineral Scanner]]
*[[Ore Collector]]
...
|- style="{{Colour/Teladi}}"
! width="180px" | Variant !! [[Ceo's Sprite]] !! [[Grand Exchange]] !! [[Ianamus Zura]] !! [[Ministry of Finance]] !! [[PTNI Headquarters]] !! [[Seizewell]]
|-
! style="text-align:left;" | Vulture || x ||   || || ||   || x
|-
! style="text-align:left;" | Vulture Hauler || x ||  || || ||  || x
|-
! style="text-align:left;" | Vulture Miner || x ||  || x ||  ||   ||
|-
! style="text-align:left;" | Vulture Super Freighter || x || x || || || || 
|-
! style="text-align:left;" | Vulture Super Freighter XL|| x || x || || x ||  ||
|-
! style="text-align:left;" | Vulture Tanker || x || x ||  || || x ||
|}

The Vulture Prototype cannot be bought, and must be [[Bail|captured]]. It is awarded by [[NMMC]] upon reaching [[Reputation#NMMC|rank 4]]. Some Teladi Mineral Transporters are Vulture Prototypes (check ship stats to determine if it is a prototype or standard variant).
...
<div id="column-one">
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Vulture&amp;returntoquery=action%3Dedit%26section%3D15&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Vulture&amp;returntoquery=action%3Dedit%26section%3D15" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
