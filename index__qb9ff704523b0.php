...
<form id="editform" name="editform" method="post" action="/index.php?title=Orca&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="6" name="wpSection" />
<input type='hidden' value="20101230223953" name="wpStarttime" />
...
<div id="column-one">
	...
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Orca&amp;returntoquery=action%3Dedit%26section%3D6" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
