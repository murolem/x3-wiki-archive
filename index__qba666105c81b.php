...
<head>
<meta charset="UTF-8"/>
<title>Editing Dragon - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Dragon","wgTitle":"Dragon","wgCurRevisionId":15946,"wgRevisionId":0,"wgArticleId":661,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Dragon","wgRelevantArticleId":661,"wgRequestId":"WXWVllkfZokAAHq@g3AAAAAL","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia","wgEditMessage":"editing"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Dragon rootpage-Dragon skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Dragon</h1>
...
<p><strong>Warning:</strong> You are not logged in. Your IP address will be publicly visible if you make any edits. If you <strong><a class="external text" href="http://x3wiki.com/index.php?title=Special:UserLogin&amp;returnto=Dragon">log in</a></strong> or <strong><a class="external text" href="http://x3wiki.com/index.php?title=Special:CreateAccount&amp;returnto=Dragon">create an account</a></strong>, your edits will be attributed to your username, along with other benefits.
</p>
</div>
<div id="wikiPreview" class="ontop" style="display: none;"><div lang="en" dir="ltr" class="mw-content-ltr"></div></div><form id="editform" name="editform" method="post" action="/index.php?title=Dragon&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntispam">Anti-spam check.
...
<input type='hidden' value="20170724063710" name="wpStarttime" />
<input type='hidden' value="20140311092027" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="15946" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{Infobox open}}
{{Infobox variant
|Variant=Dragon
|Faction=Split
|Class={{M6class}}
|Priceblock={{Priceblock|Distinguished Associate| 7689771}}
|Minspeed=90.6
|Maxspeed=172.1
|Minaccel=10
|Maxaccel=19
...
{{Infobox close}}
==Overview==
Cheap, quick and powerful, the Dragon is an interesting ship. For experienced pilots, its speed makes it one of the best corvette choices around, but for inexperienced combat pilots, it will quickly explode under sustained fire and is liable to plough into anything in front of it. 

It is small and sleek, with a larger than average laser generator but poor turret coverage. A sound choice for bounty hunter and daredevil alike, but new pilots should avoid it.

==Background==
The Dragon is the Split's main corvette, which suffered early development problems. An inadequately designed reactor casing breached causing the destruction of the prototype and the original Family Pride shipyard. The shipyard's crew and workers were saved by the prototype [[Caiman]] that was undergoing tests at the facility.

The original, in the days of sub-classed weapons systems, was capable of using the lowest class of the [[PPC]] weapon series making it more of a 'laser bomber' than a real combat ship. However, removal of weapon subclasses and the new designs of corvette grade weapons has replaced the old PPC compatibility with newer weapons like the [[Ion Shard Railgun]].&lt;br>

==Physical Characteristics==
== Combat ==
The Dragon performs best executing strafing runs, bombarding the target with heavy weapons fire before moving away, turning and beginning again.
...
|-
! style="text-align:left;" | Dragon || x || x || x || x || x || x || x || x || x
|}

== Suggested Roles==
*Tug: High speed means it can get to locations quickly, a [[Tractor Beam]] in main array allows tractoring stations and asteroids. Towing limited to 80 m/s.

== See Also==
*[[Heavy Dragon|Split Heavy Dragon]]
{{M6}}
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Dragon" title="Dragon" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<li><a href="/index.php/Template:Colour/Split" title="Template:Colour/Split">Template:Colour/Split</a> (<a href="/index.php?title=Template:Colour/Split&amp;action=edit" title="Template:Colour/Split">edit</a>) </li><li><a href="/index.php/Template:Factionshipcat/" title="Template:Factionshipcat/">Template:Factionshipcat/</a> (<a href="/index.php?title=Template:Factionshipcat/&amp;action=edit" title="Template:Factionshipcat/">edit</a>) </li><li><a href="/index.php/Template:Gunicon/0" title="Template:Gunicon/0">Template:Gunicon/0</a> (<a href="/index.php?title=Template:Gunicon/0&amp;action=edit" title="Template:Gunicon/0">view source</a>) (semi-protected)</li><li><a href="/index.php/Template:Gunicon/1" title="Template:Gunicon/1">Template:Gunicon/1</a> (<a href="/index.php?title=Template:Gunicon/1&amp;action=edit" title="Template:Gunicon/1">view source</a>) (semi-protected)</li><li><a href="/index.php/Template:Gunslot" title="Template:Gunslot">Template:Gunslot</a> (<a href="/index.php?title=Template:Gunslot&amp;action=edit" title="Template:Gunslot">view source</a>) (semi-protected)</li><li><a href="/index.php/Template:Infobox_close" title="Template:Infobox close">Template:Infobox close</a> (<a href="/index.php?title=Template:Infobox_close&amp;action=edit" title="Template:Infobox close">view source</a>) (semi-protected)</li><li><a href="/index.php/Template:Infobox_open" title="Template:Infobox open">Template:Infobox open</a> (<a href="/index.php?title=Template:Infobox_open&amp;action=edit" title="Template:Infobox open">view source</a>) (semi-protected)</li><li><a href="/index.php/Template:Infobox_variant" title="Template:Infobox variant">Template:Infobox variant</a> (<a href="/index.php?title=Template:Infobox_variant&amp;action=edit" title="Template:Infobox variant">view source</a>) (semi-protected)</li><li><a href="/index.php/Template:M6" title="Template:M6">Template:M6</a> (<a href="/index.php?title=Template:M6&amp;action=edit" title="Template:M6">edit</a>) </li><li><a href="/index.php/Template:M6Table" title="Template:M6Table">Template:M6Table</a> (<a href="/index.php?title=Template:M6Table&amp;action=edit" title="Template:M6Table">edit</a>) </li><li><a href="/index.php/Template:M6category" title="Template:M6category">Template:M6category</a> (<a href="/index.php?title=Template:M6category&amp;action=edit" title="Template:M6category">view source</a>) (semi-protected)</li><li><a href="/index.php/Template:M6class" title="Template:M6class">Template:M6class</a> (<a href="/index.php?title=Template:M6class&amp;action=edit" title="Template:M6class">edit</a>) </li><li><a href="/index.php/Template:Priceblock" title="Template:Priceblock">Template:Priceblock</a> (<a href="/index.php?title=Template:Priceblock&amp;action=edit" title="Template:Priceblock">edit</a>) </li><li><a href="/index.php/Template:Shipbox" title="Template:Shipbox">Template:Shipbox</a> (<a href="/index.php?title=Template:Shipbox&amp;action=edit" title="Template:Shipbox">edit</a>) </li><li><a href="/index.php/Template:Shipclassbox" title="Template:Shipclassbox">Template:Shipclassbox</a> (<a href="/index.php?title=Template:Shipclassbox&amp;action=edit" title="Template:Shipclassbox">edit</a>) </li><li><a href="/index.php/Template:Split_Navbox" title="Template:Split Navbox">Template:Split Navbox</a> (<a href="/index.php?title=Template:Split_Navbox&amp;action=edit" title="Template:Split Navbox">edit</a>) </li></ul></div><div class="hiddencats"><div class="mw-hiddenCategoriesExplanation"><p>This page is a member of 11 hidden categories:
</p></div><ul>
...
Retrieved from "<a dir="ltr" href="http://x3wiki.com/index.php/Dragon">http://x3wiki.com/index.php/Dragon</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Dragon&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Dragon&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Dragon&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
