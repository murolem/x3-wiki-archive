...
<head>
<meta charset="UTF-8"/>
<title>Creating Talk:Mosquito Missile Factory - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"Talk","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":1,"wgPageName":"Talk:Mosquito_Missile_Factory","wgTitle":"Mosquito Missile Factory","wgCurRevisionId":0,"wgRevisionId":0,"wgArticleId":0,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Talk:Mosquito_Missile_Factory","wgRelevantArticleId":0,"wgRequestId":"WBwkC1kfZokAABGCoWIAAAAA","wgIsProbablyEditable":true,"wgRestrictionCreate":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia","wgEditMessage":"creating"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<link rel="alternate" type="application/x-wiki" title="Edit" href="/index.php?title=Talk:Mosquito_Missile_Factory&amp;action=edit"/>
<link rel="edit" title="Edit" href="/index.php?title=Talk:Mosquito_Missile_Factory&amp;action=edit"/>
...
<body class="mediawiki ltr sitedir-ltr ns-1 ns-talk page-Talk_Mosquito_Missile_Factory rootpage-Talk_Mosquito_Missile_Factory skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Creating Talk:Mosquito Missile Factory</h1>
...
<input type='hidden' value="20161104060043" name="wpStarttime" />
<input type='hidden' value="20161104060043" name="wpEdittime" />
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Talk:Mosquito_Missile_Factory" title="Talk:Mosquito Missile Factory" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Talk:Mosquito_Missile_Factory">http://www.x3wiki.com/index.php/Talk:Mosquito_Missile_Factory</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				<ul>
				<li id="ca-nstab-main"><a href="/index.php/Mosquito_Missile_Factory" title="View the content page [c]" accesskey="c">Page</a></li>
				<li id="ca-talk" class="selected new"><a href="/index.php?title=Talk:Mosquito_Missile_Factory&amp;action=edit&amp;redlink=1" rel="discussion" title="Discussion about the content page [t]" accesskey="t">Discussion</a></li>
				<li id="ca-edit" class="selected istalk"><a href="/index.php?title=Talk:Mosquito_Missile_Factory&amp;action=edit" title="Edit this page">Create</a></li>
				<li id="ca-addsection"><a href="/index.php?title=Talk:Mosquito_Missile_Factory&amp;action=edit&amp;section=new" title="Start a new section [+]" accesskey="+">+</a></li>
				</ul>
							</div>
		</div>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Talk%3AMosquito+Missile+Factory&amp;returntoquery=action%3Dedit%26redlink%3D1" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Talk%3AMosquito+Missile+Factory&amp;returntoquery=action%3Dedit%26redlink%3D1" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
		...
		<div class='pBody'>
			...
			<div class="pBody">
				<ul>
											<li id="t-whatlinkshere"><a href="/index.php/Special:WhatLinksHere/Talk:Mosquito_Missile_Factory" title="A list of all wiki pages that link here [j]" accesskey="j">What links here</a></li>
											<li id="t-specialpages"><a href="/index.php/Special:SpecialPages" title="A list of all special pages [q]" accesskey="q">Special pages</a></li>
											<li id="t-info"><a href="/index.php?title=Talk:Mosquito_Missile_Factory&amp;action=info" title="More information about this page">Page information</a></li>
									</ul>
							</div>
		</div>
