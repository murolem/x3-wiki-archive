...
<head>
<meta charset="UTF-8" /><title>Editing Tornado Missile - X3 Wiki</title>
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Tornado_Missile skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Tornado Missile</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Tornado_Missile&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20150331050802" name="wpStarttime" />
<input type='hidden' value="20131214140912" name="wpEdittime" />
...
{{Infobox missile|Missile=Tornado Missile|Yield=50000|Speed=312|Range=24.9|Cooldown=|Seeker=Autonomous|Submunitions=8|Fusing=Impact|Torpedoclass=|Guidance=Dumbfire|AoE=}}
{{Infobox ware|ware=Tornado Missile|cargoclass=M|volume=8 (AP:4)|minprice=|aveprice=16844|maxprice=}}
{{Infobox close}}
==Overview==
The Tornado [[Missiles#Overview|swarm dumbfire]] medium missile is most useful employed on fighters strafing larger targets, mainly bigger capital ships. Its ability to deal respectable damage to such a target makes it the most popular dumbfire missile, as well as the only useful one since all the others tend to be pitifully ineffective.
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Tornado_Missile" title="Tornado Missile" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a href="http://www.x3wiki.com/index.php/Tornado_Missile">http://www.x3wiki.com/index.php/Tornado_Missile</a>"</div>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Tornado_Missile&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Tornado+Missile&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Tornado+Missile&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
