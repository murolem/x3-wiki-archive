...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Repair_Laser rootpage-Repair_Laser skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Repair Laser</h1>
...
<input type='hidden' value="20161009190246" name="wpStarttime" />
<input type='hidden' value="20140129124307" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="14264" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{Infobox open}}
{{Infobox weapon
|weapon=Repair Laser
|hulldam=100 / 200 (AP)
|shielddam=0
...
{{Infobox close}}
==Overview==
The Repair Laser does not exist as an available ware in a [[Vanilla]] game, despite many ships listing it as compatible.

The only repair laser in-game is the one carried by the player's EVA suit.

==Encyclopedia Entry==
This weapon is installed on repair drones to assist in the welding of new Teladianium Panelling to stations if they need to be repaired.
==Commentary==
The Repair Laser is fitted as standard to the player's space suit, but does not exist otherwise, despite compatibility with multiple ships. It should be noted that despite the repair laser running out of energy while in use, it has no effect on the speed at which it repairs.
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Repair_Laser" title="Repair Laser" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Repair_Laser">http://www.x3wiki.com/index.php/Repair_Laser</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Repair_Laser&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Repair+Laser&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Repair+Laser&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
