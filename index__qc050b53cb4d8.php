...
<head>
<meta charset="UTF-8" /><title>Editing Category:Board to Capture - X3 Wiki</title>
...
<body class="mediawiki ltr sitedir-ltr ns-14 ns-subject page-Category_Board_to_Capture skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Category:Board to Capture</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Category:Board_to_Capture&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20160531093848" name="wpStarttime" />
<input type='hidden' value="20130702022941" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary" /><input type="hidden" value="0" name="oldid" /><input type="hidden" value="text/x-wiki" name="format" /><input type="hidden" value="wikitext" name="model" /><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">These ships must be [[Bigship Boarding|boarded]] by [[marines]] in order to be captured.

The sole exception are abandoned ships which may be claimed normally by the player.

As a rule of thumb, if a ship can carry marines then it must be boarded to be captured. An exception to this are {{TPclass}} ships.
Another exception are the special cases like the Kha'ak ships which do not appear to be capturable in general. However, if a Kha'ak capital ship ''could'' be captured it would have to be boarded.
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Category:Board_to_Capture" title="Category:Board to Capture" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<li><a href="/index.php/Template:Piracy" title="Template:Piracy">Template:Piracy</a> (<a href="/index.php?title=Template:Piracy&amp;action=edit" title="Template:Piracy">edit</a>) </li><li><a href="/index.php/Template:Shipcategory" title="Template:Shipcategory">Template:Shipcategory</a> (<a href="/index.php?title=Template:Shipcategory&amp;action=edit" title="Template:Shipcategory">edit</a>) </li><li><a href="/index.php/Template:TPclass" title="Template:TPclass">Template:TPclass</a> (<a href="/index.php?title=Template:TPclass&amp;action=edit" title="Template:TPclass">edit</a>) </li></ul></div><div class="hiddencats"></div><div class="limitreport"></div>
</form>
</div><div class="printfooter">
Retrieved from "<a href="http://www.x3wiki.com/index.php/Category:Board_to_Capture">http://www.x3wiki.com/index.php/Category:Board_to_Capture</a>"</div>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Category:Board_to_Capture&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Category%3ABoard+to+Capture&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Category%3ABoard+to+Capture&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
