...
<head>
<title>Editing USC Orbital Support Station - X3 Wiki</title>
<meta charset="UTF-8" />
...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"USC_Orbital_Support_Station","wgTitle":"USC Orbital Support Station","wgCurRevisionId":0,"wgArticleId":0,"wgIsArticle":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgRelevantPageName":"USC_Orbital_Support_Station","wgRestrictionCreate":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia"});
...
//]]>--></script>
	...
	<h1 id="firstHeading" class="firstHeading"><span dir="auto">Editing USC Orbital Support Station</span></h1>
...
<li class="mw-logline-delete">12:18, 11 May 2011 <a href="/index.php/User:Spychotic" title="User:Spychotic" class="mw-userlink">Spychotic</a> <span class="mw-usertoollinks">(<a href="/index.php/User_talk:Spychotic" title="User talk:Spychotic">Talk</a> | <a href="/index.php/Special:Contributions/Spychotic" title="Special:Contributions/Spychotic">contribs</a>)</span> deleted page <a href="/index.php?title=USC_Orbital_Support_Station&amp;action=edit&amp;redlink=1" class="new" title="USC Orbital Support Station (page does not exist)">USC Orbital Support Station</a> <span class="comment" dir="auto">(content was: &quot;I&#039;m not easily impressed. . . but that&#039;s iprmessing me! :)&quot; (and the only contributor was &quot;<a href="/index.php/Special:Contributions/193.90.12.26" title="Special:Contributions/193.90.12.26">193.90.12.26</a>&quot;))</span>  </li>
</ul>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=USC_Orbital_Support_Station&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="" name="wpSection" />
<input type='hidden' value="20130308141059" name="wpStarttime" />
<input type='hidden' value="20130308141059" name="wpEdittime" />
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='editHelp'><a href="/index.php/USC_Orbital_Support_Station" title="USC Orbital Support Station" id="mw-editform-cancel">Cancel</a> | <a target="helpwindow" href="/index.php/Help:Editing">Editing help</a> (opens in new window)</span>
</div><!-- editButtons -->
</div><!-- editOptions -->
...
<div id="column-one">
	<div id="p-cactions" class="portlet">
		...
		<div class="pBody">
			<ul>
				<li id="ca-nstab-main" class="selected new"><a href="/index.php?title=USC_Orbital_Support_Station&amp;action=edit&amp;redlink=1" primary="1" context="subject" title="View the content page [c]" accesskey="c">Page</a></li>
				<li id="ca-talk" class="new"><a href="/index.php?title=Talk:USC_Orbital_Support_Station&amp;action=edit&amp;redlink=1" primary="1" context="talk" title="Discussion about the content page [t]" accesskey="t">Discussion</a></li>
				<li id="ca-edit" class="selected"><a href="/index.php?title=USC_Orbital_Support_Station&amp;action=edit" primary="1" title="You can edit this page. Please use the preview button before saving">Create</a></li>
			</ul>
		</div>
	</div>
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=USC+Orbital+Support+Station&amp;returntoquery=action%3Dedit%26redlink%3D1" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
