...
<head>
<meta charset="UTF-8"/>
<title>Editing X3ap quests - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"X3ap_quests","wgTitle":"X3ap quests","wgCurRevisionId":20212,"wgRevisionId":0,"wgArticleId":2134,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"X3ap_quests","wgRelevantArticleId":2134,"wgRequestId":"WlfO3FkfZokAAC9SY90AAAAX","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia","wgEditMessage":"editing"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-X3ap_quests rootpage-X3ap_quests skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing X3ap quests</h1>
...
<p><strong>Warning:</strong> You are not logged in. Your IP address will be publicly visible if you make any edits. If you <strong><a class="external text" href="http://www.x3wiki.com/index.php?title=Special:UserLogin&amp;returnto=X3ap_quests">log in</a></strong> or <strong><a class="external text" href="http://www.x3wiki.com/index.php?title=Special:CreateAccount&amp;returnto=X3ap_quests">create an account</a></strong>, your edits will be attributed to your username, along with other benefits.
</p>
</div>
<div id="wikiPreview" class="ontop" style="display: none;"><div lang="en" dir="ltr" class="mw-content-ltr"></div></div><form id="editform" name="editform" method="post" action="/index.php?title=X3ap_quests&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntispam">Anti-spam check.
...
<input type='hidden' value="20180111205348" name="wpStarttime" />
<input type='hidden' value="20170924214342" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="20212" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">This is the page for the {{X3ap}} main plot line.
It is available for all starts except the [[Terran Commander]] Start.
...
# [[X3ap:1 Aiding the war efforts | Aiding the war efforts]]
# [[X3ap:2 Jonferco Eavesdrop | Jonferco Eavesdrop]]
# [[X3ap:3 Highway Patrol | Highway Patrol]]
# [[X3ap:4 Jonferco Under Attack! | Jonferco Under Attack!]]
# [[X3ap:5 Protecting the Heavy load transporter | Protecting the Heavy load transporter]]
# [[X3ap:6 Albion Defenceless | Albion Defenceless]]
# [[X3ap:7 The_Beryll | The Beryll]]
# [[X3ap:8 Plutarch Rising | Plutarch Rising]]
# [[X3ap:9 Trial by Fire | Trial by Fire]]
# [[X3ap:10 Uncovered | Uncovered]]
# [[X3ap:11 Albion Pride | Albion Pride]]
...
{{Spoiler|1 x Argon Advanced Discoverer (M5)&lt;br>1 x Argon Centaur (M6),&lt;br>3 x #deca.cefa (M3),&lt;br>1 x Argon Aamon Prototype (M3+),&lt;br>Steam achievement: Albion Pride,&lt;br>Millions of credits}}



===Reference===
# roguey.co.uk/x3ap/help/guides/plot/page1.php
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/X3ap_quests" title="X3ap quests" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<li><a href="/index.php/Template:Missions" title="Template:Missions">Template:Missions</a> (<a href="/index.php?title=Template:Missions&amp;action=edit" title="Template:Missions">edit</a>) </li><li><a href="/index.php/Template:Offers" title="Template:Offers">Template:Offers</a> (<a href="/index.php?title=Template:Offers&amp;action=edit" title="Template:Offers">edit</a>) </li><li><a href="/index.php/Template:Other_Missions" title="Template:Other Missions">Template:Other Missions</a> (<a href="/index.php?title=Template:Other_Missions&amp;action=edit" title="Template:Other Missions">edit</a>) </li><li><a href="/index.php/Template:Plot_Missions" title="Template:Plot Missions">Template:Plot Missions</a> (<a href="/index.php?title=Template:Plot_Missions&amp;action=edit" title="Template:Plot Missions">edit</a>) </li><li><a href="/index.php/Template:Spoiler" title="Template:Spoiler">Template:Spoiler</a> (<a href="/index.php?title=Template:Spoiler&amp;action=edit" title="Template:Spoiler">edit</a>) </li><li><a href="/index.php/Template:X3ap" title="Template:X3ap">Template:X3ap</a> (<a href="/index.php?title=Template:X3ap&amp;action=edit" title="Template:X3ap">edit</a>) </li></ul></div><div class="hiddencats"></div><div class="limitreport"></div><input type="hidden" value="1" name="wpUltimateParam"/>
</form>
...
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/X3ap_quests">http://www.x3wiki.com/index.php/X3ap_quests</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=X3ap_quests&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=X3ap+quests&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=X3ap+quests&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
