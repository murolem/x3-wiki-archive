...
<head>
<meta charset="UTF-8" /><title>Editing Follow Ship - X3 Wiki</title>
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Follow Ship</span></h1>
...
<input type='hidden' value="20160829084329" name="wpStarttime" />
<input type='hidden' value="20140914191752" name="wpEdittime" />
...
Retrieved from "<a href="http://www.x3wiki.com/index.php/Follow_Ship">http://www.x3wiki.com/index.php/Follow_Ship</a>"</div>
...
<div id="column-one">
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Follow+Ship&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Follow+Ship&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
