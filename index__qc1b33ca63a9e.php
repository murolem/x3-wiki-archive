...
<form id="editform" name="editform" method="post" action="/index.php?title=Atreus&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="12" name="wpSection" />
<input type='hidden' value="20110719150906" name="wpStarttime" />
<input type='hidden' value="20100802174710" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="c14f3f40281184f3db8a67dd5facce4a" name="wpAutoSummary" /><input type="hidden" value="0" name="oldid" /><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" name="wpTextbox1">==Border Worlds==
#
	...
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Atreus&amp;returntoquery=action%3Dedit%26section%3D12" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
