...
<head>
<meta charset="UTF-8" /><title>Editing Freight Scanner - X3 Wiki</title>
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Freight_Scanner skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Freight Scanner</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Freight_Scanner&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20140717225249" name="wpStarttime" />
<input type='hidden' value="20121006235035" name="wpEdittime" />
...
{{Infobox close}}
A '''freight scanners''' is a sensor that allows one to determine another ship's freight, shield, and weapons loadouts.  Required equipment [[Freight Scan|freight scanning missions]], the sensor has a maximum range of four kilometers.

It is considered illegal to scan someone's freight unless you have a [[police license]] for the race that owns the sector.

==Encyclopedia Entry==
Pilots whose [[Ships|spaceships]] are equipped with a freight scanner can see exactly what is inside other ships they scan.  Oftentimes this scanner is abused by [[pirates]] before they attack and rob peaceful pilots.
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Freight_Scanner" title="Freight Scanner" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Freight_Scanner&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Freight+Scanner&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Freight+Scanner&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
