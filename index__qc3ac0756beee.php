...
<head>
<meta charset="UTF-8" /><title>Editing Demeter (section) - X3 Wiki</title>
...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Demeter","wgTitle":"Demeter","wgCurRevisionId":14726,"wgRevisionId":0,"wgArticleId":349,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Demeter","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia"});
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Demeter skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Demeter (section)</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Demeter&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
Do <b>NOT</b> fill this in!</label><input type="text" name="wpAntispam" id="wpAntispam" value="" /></div><input type='hidden' value="14" name="wpSection" />
<input type='hidden' value="20160707202912" name="wpStarttime" />
<input type='hidden' value="20140225135503" name="wpEdittime" />
...
! Demeter                    || X ||   || X ||   || X ||  
|-
! Demeter Hauler             ||   ||   || X ||   || X || X
|-
! Demeter Miner              ||   || X || X || X || X ||  
|-
! Demeter Super Freighter    || X ||   || X ||   || X || 
|-
! Demeter Super Freighter XL ||   ||   || X ||   || X || X
|-
! Demeter Tanker             ||   || X || X || X || X || 
|}

The Demeter Prototype cannot be bought, and must be [[Bail|captured]]. Some Paranid Weapons Transporters are Demeter Prototypes (check ship stats to determine if it is a prototype or standard variant). 

=== [[Duke's|Dukes Buccaneers]] ===
A decent source of free {{TSclass}}s and {{TPclass}}s in the early game is the Demeters and [[Hermes]] that appear as Duke's Freight Transporters and Dangerous Materials Transporters.  The Demeters and Hermes may [[bail]], gaining the player a free TS or TP.  Since Duke's Buccaneers is a crime syndicate, attacking these vessels does not hurt your [[Reputation|legal status]] with the major governments of the [[Commonwealth]].  In fact, destroying the vessels if they do not bail actually ''improves'' your status with them.
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Demeter" title="Demeter" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Demeter&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Demeter&amp;returntoquery=action%3Dedit%26section%3D14&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Demeter&amp;returntoquery=action%3Dedit%26section%3D14" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
