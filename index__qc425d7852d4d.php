...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Starburst_Shockwave_Cannon rootpage-Starburst_Shockwave_Cannon skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Starburst Shockwave Cannon</h1>
...
<input type='hidden' value="20171009163446" name="wpStarttime" />
<input type='hidden' value="20140727131306" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="16362" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{Infobox open}}
{{Infobox weapon
|weapon=Starburst Shockwave Cannon
|hulldam=2100
|shielddam=13100
|range=2
|rof= 37
...
{{Infobox ware
|ware=Starburst Shockwave Cannon
|cargoclass=L
|volume=28
|minprice=604570
|aveprice=623268
...
{{Infobox close}}
==Overview==
The [[Terran]] option for anti-fighter armament, and for more powerful, energy-based M7 arming (compared to the corvette-level M/AML).
...
==Commentary==
The Terran analogue to the [[Flak Artillery Array]] this powerful weapon is slightly superior in damage output when compared to its (Teladian) Commonwealth counterpart. Its shot speed is slower and on par with the [[CFA]], though accuracy is not compromised. It has a massive drain on ship energy, so be sparing with your shots. While it's great as an anti-fighter weapon when mounted to turrets, the incredible energy drain can cause problems.
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Starburst_Shockwave_Cannon" title="Starburst Shockwave Cannon" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Starburst_Shockwave_Cannon">http://www.x3wiki.com/index.php/Starburst_Shockwave_Cannon</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Starburst_Shockwave_Cannon&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Starburst+Shockwave+Cannon&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Starburst+Shockwave+Cannon&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
