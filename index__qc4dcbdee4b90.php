...
<head>
<meta charset="UTF-8" />
<title>Editing Orbital Defence Station - X3 Wiki</title>
...
<body class="mediawiki ltr ns-0 ns-subject page-Orbital_Defence_Station skin-monobook">
<div id="globalWrapper">
<div id="column-content"><div id="content">
	<a id="top"></a>
	
	<h1 id="firstHeading" class="firstHeading">Editing Orbital Defence Station</h1>
	<div id="bodyContent">
...
<form id="editform" name="editform" method="post" action="/index.php?title=Orbital_Defence_Station&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="" name="wpSection" />
<input type='hidden' value="20110830165316" name="wpStarttime" />
<input type='hidden' value="20110830165316" name="wpEdittime" />
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='editHelp'><a href="/index.php/Orbital_Defence_Station" title="Orbital Defence Station" id="mw-editform-cancel">Cancel</a> | <a target="helpwindow" href="/index.php/Help:Editing">Editing help</a> (opens in new window)</span>
</div><!-- editButtons -->
</div><!-- editOptions -->
...
Retrieved from "<a href="http://www.x3wiki.com/index.php/Orbital_Defence_Station">http://www.x3wiki.com/index.php/Orbital_Defence_Station</a>"</div>
...
<div id="column-one">
	<div id="p-cactions" class="portlet">
		...
		<div class="pBody">
			<ul>
				 <li id="ca-nstab-main" class="selected new"><a href="/index.php?title=Orbital_Defence_Station&amp;action=edit&amp;redlink=1" title="View the content page [c]" accesskey="c">Page</a></li>
				 ...
				 <li id="ca-edit" class="selected"><a href="/index.php?title=Orbital_Defence_Station&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Create</a></li>
			</ul>
		</div>
	</div>
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Orbital_Defence_Station&amp;returntoquery=action%3Dedit%26redlink%3D1" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
	...
	<div class="portlet" id="p-tb">
		...
		<div class="pBody">
			<ul>
				<li id="t-whatlinkshere"><a href="/index.php/Special:WhatLinksHere/Orbital_Defence_Station" title="List of all wiki pages that link here [j]" accesskey="j">What links here</a></li>
...
<script>if ( window.mediaWiki ) {
	mediaWiki.config.set({"wgCanonicalNamespace": "", "wgCanonicalSpecialPageName": false, "wgNamespaceNumber": 0, "wgPageName": "Orbital_Defence_Station", "wgTitle": "Orbital Defence Station", "wgAction": "edit", "wgArticleId": 0, "wgIsArticle": false, "wgUserName": null, "wgUserGroups": ["*"], "wgCurRevisionId": 0, "wgCategories": [], "wgBreakFrames": true, "wgRestrictionCreate": []});
}
</script>
<script>if ( window.mediaWiki ) {
...
</script><!-- Served in 0.314 secs. --></body></html>