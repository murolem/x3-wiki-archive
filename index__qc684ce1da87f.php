...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en" dir="ltr">
	<head>
		...
		<title>Editing Osaka (section) - X3 Wiki</title>
...
<body class="mediawiki ltr ns-0 ns-subject page-Osaka skin-monobook">
	...
	<div id="content">
		<a name="top" id="top"></a>
				<h1 id="firstHeading" class="firstHeading">Editing Osaka (section)</h1>
		<div id="bodyContent">
...
<form id="editform" name="editform" method="post" action="/index.php?title=Osaka&amp;action=submit" enctype="multipart/form-data">
<input type='hidden' value="3" name="wpSection" />
<input type='hidden' value="20100605124036" name="wpStarttime" />

<input type='hidden' value="20100602020526" name="wpEdittime" />

<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />

<input name="wpAutoSummary" type="hidden" value="07697354b42b5996fa5bb9899abcd59b" />

<textarea name="wpTextbox1" id="wpTextbox1" cols="80" rows="25" tabindex="1" accesskey=",">==Combat==

The Osaka's shielding is the heaviest of all ships in the X-Universe at 12GJ. Along with the Tyr, it is the only ship that is guaranteed to survive the first volley of fire from a [[Xenon]] [[Q]] in OOS combat. This makes it an excellent choice for the role of penning up the Xenon in their home space.

It is also a potent ship in IS combat, however it has been shown that under AI control a bank of [[Point Singularity Projector|PSPs]] holds less destructive power than an equivalent bank of [[Photon Pulse Cannon|PPCs]] due to the PSP's low fire rate. Despite its weak firepower, its tough shields mean that it is just as likely to be left standing after a fight with another capital as any other M2.

It can equip [[Starburst Shockwave Cannon|SSCs]] in top and bottom turrets, giving it an impressive potency against fighters.
...
<div class="editOptions"><span class="mw-summary" id="wpSummaryLabel"><label for="wpSummary">Summary:</label></span> <input name="wpSummary" size="60" value="/* Combat */ " id="wpSummary" maxlength="200" tabindex="1" /><br/>
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='editHelp'><a href="/index.php/Osaka" title="Osaka">Cancel</a>&#32;|&#32;<a target="helpwindow" href="/index.php/Help:Editing">Editing help</a> (opens in new window)</span>
</div><!-- editButtons -->
</div><!-- editOptions -->
	...
	<div id="p-cactions" class="portlet">
		...
		<div class="pBody">
			<ul>
				 ...
				 <li id="ca-edit" class="selected"><a href="/index.php?title=Osaka&amp;action=edit" title="You can edit this page.&#10;Please use the preview button before saving">Edit</a></li>
