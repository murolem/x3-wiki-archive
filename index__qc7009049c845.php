...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Thresher&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="8" name="wpSection" />
<input type='hidden' value="20120830032540" name="wpStarttime" />
...
*[[M7M]] class;
**[[Kraken|Boron Kraken]]
Another ship with acharacteristic weapons:
*[[Truelight Seeker]]
	...
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Thresher&amp;returntoquery=action%3Dedit%26section%3D8" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
