...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Helios&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="7" name="wpSection" />
<input type='hidden' value="20131003132353" name="wpStarttime" />
	...
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Helios&amp;returntoquery=action%3Dedit%26section%3D7" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
