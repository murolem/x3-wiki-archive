...
wgNamespaceNumber=0,
wgPageName="Protein_Paste",
wgTitle="Protein Paste",
wgAction="edit",
wgArticleId=0,
wgIsArticle=false,
wgUserName=null,
...
<body class="mediawiki ltr ns-0 ns-subject page-Protein_Paste skin-monobook">
<div id="globalWrapper">
<div id="column-content"><div id="content" >
	<a id="top"></a>
	
	<h1 id="firstHeading" class="firstHeading">Protein Paste</h1>
	<div id="bodyContent">
...
<form id="editform" name="editform" method="post" action="/index.php?title=Protein_Paste&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="" name="wpSection" />
<input type='hidden' value="20110111140620" name="wpStarttime" />
<input type='hidden' value="20110111140620" name="wpEdittime" />
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='editHelp'><a href="/index.php/Protein_Paste" title="Protein Paste" id="mw-editform-cancel">Cancel</a> | <a target="helpwindow" href="/index.php/Help:Editing">Editing help</a> (opens in new window)</span>
</div><!-- editButtons -->
</div><!-- editOptions -->
...
<div id="column-one">
	<div id="p-cactions" class="portlet">
		...
		<div class="pBody">
			<ul>
				 <li id="ca-nstab-main" class="selected new"><a href="/index.php?title=Protein_Paste&amp;action=edit&amp;redlink=1" title="View the content page [c]" accesskey="c">Page</a></li>
				 ...
				 <li id="ca-edit" class="selected"><a href="/index.php?title=Protein_Paste&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Create</a></li>
			</ul>
		</div>
	</div>
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Protein_Paste&amp;returntoquery=action%3Dedit%26redlink%3D1" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
	...
	<div class="portlet" id="p-tb">
		...
		<div class="pBody">
			<ul>
				<li id="t-whatlinkshere"><a href="/index.php/Special:WhatLinksHere/Protein_Paste" title="List of all wiki pages that link here [j]" accesskey="j">What links here</a></li>
