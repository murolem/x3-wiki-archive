...
<head>
<meta charset="UTF-8" /><title>Editing Emperor's Ridge - X3 Wiki</title>
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Emperor_s_Ridge skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Emperor's Ridge</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Emperor%27s_Ridge&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20160907042808" name="wpStarttime" />
<input type='hidden' value="20140306123842" name="wpEdittime" />
...
{{Gateblock2|North|3000|	7500|	26490|[[Priest's Pity]]}}
{{Gateblock2|South|6750|	-9000|	-30240|[[Pontifex' Realm]]}}
{{Gateblock2|West|-28740|	-3750|	0|[[Duke's Domain]]}}
&lt;/table>
}}
==Description==
===Encyclopedia Entry===
This system contains the main [[Paranid Equipment Dock|Equipment Dock]] used to refit medium [[Paranid]] Fighters. These weapons are of the highest quality and Paranid technology is extremely reliable. This system was hit heavily in the last [[X: Beyond the Frontier|Xenon conflict]] and security is still tight. This system represents the far border of the 'Old Paranid Empire,' the 'New Empire' consisting of territories claimed since the conflict.
===Information===
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Emperor%27s_Ridge" title="Emperor's Ridge" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<li><a href="/index.php/Template:Colour/Paranid" title="Template:Colour/Paranid">Template:Colour/Paranid</a> (<a href="/index.php?title=Template:Colour/Paranid&amp;action=edit" title="Template:Colour/Paranid">edit</a>) </li><li><a href="/index.php/Template:Gateblock2" title="Template:Gateblock2">Template:Gateblock2</a> (<a href="/index.php?title=Template:Gateblock2&amp;action=edit" title="Template:Gateblock2">edit</a>) </li><li><a href="/index.php/Template:Infobox_Sector" title="Template:Infobox Sector">Template:Infobox Sector</a> (<a href="/index.php?title=Template:Infobox_Sector&amp;action=edit" title="Template:Infobox Sector">edit</a>) </li><li><a href="/index.php/Template:Paranid_Navbox" title="Template:Paranid Navbox">Template:Paranid Navbox</a> (<a href="/index.php?title=Template:Paranid_Navbox&amp;action=edit" title="Template:Paranid Navbox">edit</a>) </li></ul></div><div class="hiddencats"></div><div class="limitreport"></div>
</form>
</div><div class="printfooter">
Retrieved from "<a href="http://www.x3wiki.com/index.php/Emperor%27s_Ridge">http://www.x3wiki.com/index.php/Emperor%27s_Ridge</a>"</div>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Emperor%27s_Ridge&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Emperor%27s+Ridge&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Emperor%27s+Ridge&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
