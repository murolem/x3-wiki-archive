...
<head>
<meta charset="UTF-8"/>
<title>Editing Vali - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Vali","wgTitle":"Vali","wgCurRevisionId":13852,"wgRevisionId":0,"wgArticleId":557,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Vali","wgRelevantArticleId":557,"wgRequestId":"Wlxyp1kfZokAAE0mSVwAAAAO","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia","wgEditMessage":"editing"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Vali rootpage-Vali skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Vali</h1>
...
<p><strong>Warning:</strong> You are not logged in. Your IP address will be publicly visible if you make any edits. If you <strong><a class="external text" href="http://www.x3wiki.com/index.php?title=Special:UserLogin&amp;returnto=Vali">log in</a></strong> or <strong><a class="external text" href="http://www.x3wiki.com/index.php?title=Special:CreateAccount&amp;returnto=Vali">create an account</a></strong>, your edits will be attributed to your username, along with other benefits.
</p>
</div>
<div id="wikiPreview" class="ontop" style="display: none;"><div lang="en" dir="ltr" class="mw-content-ltr"></div></div><form id="editform" name="editform" method="post" action="/index.php?title=Vali&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntispam">Anti-spam check.
...
<input type='hidden' value="20180115092143" name="wpStarttime" />
<input type='hidden' value="20130909234756" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="13852" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{Infobox open}}
{{Infobox variant
|Variant=Vali
|Faction=ATF
|Class={{M6+class}}
|Priceblock={{priceblock||14606957}}
|Minspeed=55
|Maxspeed=110
|Minaccel=5
|Maxaccel=10
...
{{Infobox close}}
==Overview==
The Vali is nominally an improvement on the older [[Vidar|ATF Vidar]]. It has lighter frontal firepower than its predecessor, but better turret coverage and an extra [[Shields#200_MJ|200 MJ]] shield slot. It is slightly slower and has a smaller cargo capacity than the Vidar. While slower and larger than most other heavy corvettes, it is the best shielded and provides an excellent defense in a sentinel or escort role. 

==Background==
Superseding the previous corvette, the Vali's heavier shielding and weaponry mean that when on patrol or escorting a task group, the enemy will maintain a respectful distance.

==Physical Characteristics==
== Combat ==
The Vali is almost a very light [[:Category:Capital Ships|capital ship]]. The fighting style is certainly closer to an [[M7]] than an [[M6]], although the offensive power is definitely closer to the Corvette class. Due to its high survivability, it is one of the more effective [[M6+]]s.
...
Its small cargo bay leaves little room for [[Matter/Anti-Matter Warhead|Matter/Anti-Matter Warheads]], missiles, and [[jumpdrive]] energy, greatly limiting its range and endurance.

== Availability ==
Like all [[ATF]] ships, the Vali is not available for sale and must be [[boarding|pirated]] from an ATF patrol. It is commonly found escorting larger ATF ships like the [[ATF]] [[Aegir]] and [[ATF]] [[Skirnir]] or in small patrol groups of multiple Valis.

In Albion Prelude it is purchasable from the Shipyards in Megnir and The Moon.

== Suggested Roles==
The Vali excels as an escort or as a patrol or station defense craft in sectors frequented by pirates.
== See Also==
*[[Vidar|ATF Vidar]]
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Vali" title="Vali" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Vali">http://www.x3wiki.com/index.php/Vali</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Vali&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Vali&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Vali&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
