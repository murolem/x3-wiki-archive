...
<head>
<meta charset="UTF-8"/>
<title>Editing Hydra - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Hydra","wgTitle":"Hydra","wgCurRevisionId":13920,"wgRevisionId":0,"wgArticleId":240,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Hydra","wgRelevantArticleId":240,"wgRequestId":"WdivulkfZokAAGFoRHsAAAAA","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia","wgEditMessage":"editing"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Hydra rootpage-Hydra skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Hydra</h1>
...
<p><strong>Warning:</strong> You are not logged in. Your IP address will be publicly visible if you make any edits. If you <strong><a class="external text" href="http://x3wiki.com/index.php?title=Special:UserLogin&amp;returnto=Hydra">log in</a></strong> or <strong><a class="external text" href="http://x3wiki.com/index.php?title=Special:CreateAccount&amp;returnto=Hydra">create an account</a></strong>, your edits will be attributed to your username, along with other benefits.
</p>
</div>
<div id="wikiPreview" class="ontop" style="display: none;"><div lang="en" dir="ltr" class="mw-content-ltr"></div></div><form id="editform" name="editform" method="post" action="/index.php?title=Hydra&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntispam">Anti-spam check.
...
<input type='hidden' value="20171007104306" name="wpStarttime" />
<input type='hidden' value="20130930135415" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="13920" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{Infobox open}}
{{Infobox variant
|Variant= Hydra
|Faction=Boron
|Class={{M6class}}
|Priceblock={{Priceblock|| 8,766,030}}
|Minspeed=61.5
|Maxspeed= 147.60
|Minaccel=6
|Maxaccel=16
...
{{Infobox close}}
==Overview==
Not to be confused with the [[Heavy Hydra]], the Boron Hydra is fast, with average shielding for its class.
...
==Background==
===Encyclopedia Entry===
The Boron Hydra is a corvette-class ship, developed originally to give extra protection to convoys of freighters. The Hydra now sees widespread service both as part of regular sector patrols and as escorts for capital ships. Although many consider the Boron to be pacifists, this ship has been increasingly upgraded to pose a greater offensive threat to the enemies of the Boron Kingdom.
==Physical Characteristics==
The Hydra is odd-looking, even for a Boron ship. It is vaguely pentagonal in shape, with a long narrow nose and boxy body.  It shares the typical Boron feature of a green organic hull.
== Combat ==
The Hydra is not particularly able in a combat role, due to its inability to sustain fire at its target. Its main use is as a missile platform or military cargo transport due to its large freight bay, which also makes it a capable user of ammunition-based weaponry, which mitigates its energy problems. Like many Boron combat craft, it is capable of using the [[Ion Disruptor]], allowing it to fulfill a disabling or capturing role.
...
== Suggested Roles==
With a large cargobay and high speed, the Hydra is an effective armed freighter, as well as being an effective platform for deploying large amounts of ordnance such as missiles, drones, lasertowers and mines.  If armed with [[Energy Bolt Chaingun]]s, it is a capable threat on par with other M6s.

== See Also==
*[[Heavy Hydra|Boron Heavy Hydra]]
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Hydra" title="Hydra" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://x3wiki.com/index.php/Hydra">http://x3wiki.com/index.php/Hydra</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Hydra&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Hydra&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Hydra&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
