...
<head>
<meta charset="UTF-8" /><title>Editing USC Orbital Support Station - X3 Wiki</title>
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing USC Orbital Support Station</span></h1>
...
<input type='hidden' value="20160818002323" name="wpStarttime" />
...
|Name=USC Orbital Support Station
|Race=Terran
|Type=Dock
|Capacity=0
|Hull=15,000,000
...
|Production=none
|Docking=10 x [[TS]]/[[TP]]/[[M6]]/[[M8]]
}}

The Orbital Support Station is related to the Commonwealth's [[Trading Station]]s in that it supplies various goods to the race... However, since the Terrans do like to keep to themselves, it is used to help supply the Terran's fleet.
...
<div id="column-one">
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=USC+Orbital+Support+Station&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=USC+Orbital+Support+Station&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
