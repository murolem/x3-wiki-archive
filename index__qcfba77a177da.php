...
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"Special","wgCanonicalSpecialPageName":"Userlogin","wgNamespaceNumber":-1,"wgPageName":"Special:UserLogin","wgTitle":"UserLogin","wgCurRevisionId":0,"wgRevisionId":0,"wgArticleId":0,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"view","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Special:UserLogin","wgRelevantArticleId":0,"wgRequestId":"WalR21kfZokAAEDEYDsAAAAY","wgIsProbablyEditable":false,"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<div id="bodyContent" class="mw-body-content">
					...
					<!-- start content -->
					<div id="mw-content-text"><div class="mw-ui-container"><div id="userloginprompt"></div><div id="userloginForm"><form action="/index.php?title=Special:UserLogin&amp;returnto=****(1$866$866$1752)+icloud+email+signin+customer+support+number." method="post" name="userlogin" class="mw-ui-vform mw-ui-container visualClear"><div>
...
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Special:UserLogin">http://www.x3wiki.com/index.php/Special:UserLogin</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				<ul>
				<li id="ca-nstab-special" class="selected"><a href="/index.php?title=Special:UserLogin&amp;returnto=****(1$866$866$1752)+icloud+email+signin+customer+support+number." title="This is a special page, and it cannot be edited">Special page</a></li>
				</ul>
							</div>
		</div>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=%2A%2A%2A%2A%281%24866%24866%241752%29+icloud+email+signin+customer+support+number." title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login" class="active"><a href="/index.php?title=Special:UserLogin&amp;returnto=%2A%2A%2A%2A%281%24866%24866%241752%29+icloud+email+signin+customer+support+number." title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
		...
		<div class='pBody'>
			...
			<div class="pBody">
				<ul>
											...
											<li id="t-print"><a href="/index.php?title=Special:UserLogin&amp;returnto=%2A%2A%2A%2A%281%24866%24866%241752%29+icloud+email+signin+customer+support+number.&amp;printable=yes" rel="alternate" title="Printable version of this page [p]" accesskey="p">Printable version</a></li>
									</ul>
							</div>
		</div>
