...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Ion_Shard_Railgun rootpage-Ion_Shard_Railgun skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Ion Shard Railgun</h1>
...
<input type='hidden' value="20170722080921" name="wpStarttime" />
<input type='hidden' value="20140310163955" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="15941" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{Infobox open}}
{{Infobox weapon
|weapon=Ion Shard Railgun
|hulldam=3700
|shielddam=10200
|range=3.33
|rof= 230
...
{{Infobox close}}
==Overview==
A weapon equipped on medium-sized ships for brushing off attacks from fighters.

==Encyclopedia Entry==
A weapon found equipped on corvette or frigate-sized ships, used for fighter defense.

Developed from reverse-engineered Boron ion weapon technology, the Ion Shard Railgun fires ionised 'shards' of super-heated plasma, which are then accelerated to high speeds using magnets. This combination can wreak havoc on weapon systems.
==Commentary==
The ISR is a [[Split]] weapon that drains the laser energy of the target it scores. Despite low physical damage per shot, sustained fire can cause heavy damage on par with the [[Matter/Anti-Matter Launcher]] - however overall effectiveness may be limited by the weapon's relatively high power drain (a limitation not shared by the ammo-based MAML).
...
Produced by [[Ion Shard Railgun Forge]] spread all over the universe and sold to players by few [[Split Shipyard]].
{|
! style="{{colour/Split}}"|Split
|-
|
*Medium Weapons Complexes
*Equipment docks
|}
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Ion_Shard_Railgun" title="Ion Shard Railgun" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://x3wiki.com/index.php/Ion_Shard_Railgun">http://x3wiki.com/index.php/Ion_Shard_Railgun</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Ion_Shard_Railgun&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Ion+Shard+Railgun&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Ion+Shard+Railgun&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
