...
<head>
<meta charset="UTF-8"/>
<title>Editing Kingdom End Shipyard - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Kingdom_End_Shipyard","wgTitle":"Kingdom End Shipyard","wgCurRevisionId":14479,"wgRevisionId":0,"wgArticleId":1687,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Kingdom_End_Shipyard","wgRelevantArticleId":1687,"wgRequestId":"WHK-CFkfZokAAFzyKYgAAAAF","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia","wgEditMessage":"editing"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<link rel="alternate" type="application/x-wiki" title="Edit" href="/index.php?title=Kingdom_End_Shipyard&amp;action=edit"/>
<link rel="edit" title="Edit" href="/index.php?title=Kingdom_End_Shipyard&amp;action=edit"/>
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Kingdom_End_Shipyard rootpage-Kingdom_End_Shipyard skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Kingdom End Shipyard</h1>
...
<input type='hidden' value="20170108223656" name="wpStarttime" />
<input type='hidden' value="20140222121423" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="14479" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">==Overview==
[[Shipyard]] in the [[Boron]] sector [[Kingdom End]].
==Available Ships and Stations with Costs==
===Stations===
{| style="text-align:right;"  class="wikitable sortable" cellpadding="3"
! Available Stations&lt;bR>!! Cost [[Credits|Cr]]&lt;bR> 
|-
|Boron [[Complex Construction Kit]]	|| 259,696
|-
|Boron [[BoFu Chemical Lab]] L	|| 2,024,976
|-
|Boron [[Stott Mixery]] M	|| 1,103,708
|-
|Boron [[Bio Gas Factory]] L	|| 561,528
|-
|Boron [[Plankton Farm]] M	|| 320,008
|-
|Boron [[Crystal Fab]] M	|| 2,973,516
|}

===Ships===
{| style="text-align:right;"  class="wikitable sortable" cellpadding="3" name="ships"
! Available Ships&lt;bR>!! Cost [[Credits|Cr]]&lt;bR>
|-
|[[Skate]] || 5,984,203
|-
|[[Ray]] || 86,438,545
...
|[[Hydra]] || 8,766,030
|-
|[[Barracuda Raider]] || 2,864,863
|-
|[[Dolphin Super Freighter XL]] || 2,167,186
|-
|[[Dolphin Hauler]] || 1,029,447
|}
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Kingdom_End_Shipyard" title="Kingdom End Shipyard" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<li><a href="/index.php/Template:Stationcategory" title="Template:Stationcategory">Template:Stationcategory</a> (<a href="/index.php?title=Template:Stationcategory&amp;action=edit" title="Template:Stationcategory">edit</a>) </li><li><a href="/index.php/Template:Stub" title="Template:Stub">Template:Stub</a> (<a href="/index.php?title=Template:Stub&amp;action=edit" title="Template:Stub">edit</a>) </li></ul></div><div class="hiddencats"></div><div class="limitreport"></div><input type="hidden" value="1" name="wpUltimateParam"/>
</form>
</div><div class="printfooter">
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Kingdom_End_Shipyard">http://www.x3wiki.com/index.php/Kingdom_End_Shipyard</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				<ul>
				<li id="ca-nstab-main" class="selected"><a href="/index.php/Kingdom_End_Shipyard" title="View the content page [c]" accesskey="c">Page</a></li>
				<li id="ca-talk" class="new"><a href="/index.php?title=Talk:Kingdom_End_Shipyard&amp;action=edit&amp;redlink=1" rel="discussion" title="Discussion about the content page [t]" accesskey="t">Discussion</a></li>
				<li id="ca-edit" class="selected"><a href="/index.php?title=Kingdom_End_Shipyard&amp;action=edit" title="Edit this page">Edit</a></li>
				<li id="ca-history"><a href="/index.php?title=Kingdom_End_Shipyard&amp;action=history" title="Past revisions of this page [h]" accesskey="h">History</a></li>
				</ul>
							</div>
		</div>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Kingdom+End+Shipyard&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Kingdom+End+Shipyard&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
		...
		<div class='pBody'>
			...
			<div class="pBody">
				<ul>
											<li id="t-whatlinkshere"><a href="/index.php/Special:WhatLinksHere/Kingdom_End_Shipyard" title="A list of all wiki pages that link here [j]" accesskey="j">What links here</a></li>
											<li id="t-recentchangeslinked"><a href="/index.php/Special:RecentChangesLinked/Kingdom_End_Shipyard" title="Recent changes in pages linked from this page [k]" accesskey="k">Related changes</a></li>
											<li id="t-specialpages"><a href="/index.php/Special:SpecialPages" title="A list of all special pages [q]" accesskey="q">Special pages</a></li>
											<li id="t-info"><a href="/index.php?title=Kingdom_End_Shipyard&amp;action=info" title="More information about this page">Page information</a></li>
									</ul>
							</div>
		</div>
...
<script type="text/javascript" src="//geoiplookup.wikimedia.org/"></script><script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgBackendResponseTime":177});});</script></body></html>
