...
<head>
<meta charset="UTF-8"/>
<title>Editing Scan Asteroids - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Scan_Asteroids","wgTitle":"Scan Asteroids","wgCurRevisionId":13398,"wgRevisionId":0,"wgArticleId":448,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Scan_Asteroids","wgRelevantArticleId":448,"wgRequestId":"WW-211kfZokAAF@Qx1cAAAAD","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia","wgEditMessage":"editing"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Scan_Asteroids rootpage-Scan_Asteroids skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Scan Asteroids</h1>
...
<input type='hidden' value="20170720001831" name="wpStarttime" />
<input type='hidden' value="20130809233538" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="13398" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">A [[Missions#Other Mission|Mission]] usually offered at [[stations]] but may be offered by a spaceborne ship.



==Objective==
Scan the required number of asteroids as pointed out in the mission briefing within a set time limit.

==General Difficulty:==
Usually very easy; some tighter scheduled missions may class as 'normal'.

==What you will need: ==

* Any ship with [[Mineral Scanner]] installed - [[M5]] is best due to its speed.

==What you will find: ==

* Multiple asteroids in multiple Sectors, depending on time limit.

==Commentary and Strategy==
Go to each required sector and scan as many asteroids as needed. You will get paid quite a high sum for doing all of them. Keep an eye out for another pilot selling asteroid info, as you may get an instant win.

* Mission has been pointed out to have a possible bug after scanning the last asteroid that the mission fails.
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Scan_Asteroids" title="Scan Asteroids" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<li><a href="/index.php/Template:Missions" title="Template:Missions">Template:Missions</a> (<a href="/index.php?title=Template:Missions&amp;action=edit" title="Template:Missions">edit</a>) </li><li><a href="/index.php/Template:Offers" title="Template:Offers">Template:Offers</a> (<a href="/index.php?title=Template:Offers&amp;action=edit" title="Template:Offers">edit</a>) </li><li><a href="/index.php/Template:Other_Missions" title="Template:Other Missions">Template:Other Missions</a> (<a href="/index.php?title=Template:Other_Missions&amp;action=edit" title="Template:Other Missions">edit</a>) </li><li><a href="/index.php/Template:Plot_Missions" title="Template:Plot Missions">Template:Plot Missions</a> (<a href="/index.php?title=Template:Plot_Missions&amp;action=edit" title="Template:Plot Missions">edit</a>) </li></ul></div><div class="hiddencats"></div><div class="limitreport"></div><input type="hidden" value="1" name="wpUltimateParam"/>
</form>
...
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Scan_Asteroids">http://www.x3wiki.com/index.php/Scan_Asteroids</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Scan_Asteroids&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Scan+Asteroids&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Scan+Asteroids&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
...
<script type="text/javascript" src="//geoiplookup.wikimedia.org/"></script><script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgBackendResponseTime":134});});</script></body></html>
