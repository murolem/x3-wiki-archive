...
<head>
<meta charset="UTF-8" /><title>Creating Category talk:Phased Repeater Gun - X3 Wiki</title>
<meta name="generator" content="MediaWiki 1.22.6" />
<meta name="robots" content="noindex,nofollow" />
<link rel="alternate" type="application/x-wiki" title="Edit" href="/index.php?title=Category_talk:Phased_Repeater_Gun&amp;action=edit" />
<link rel="edit" title="Edit" href="/index.php?title=Category_talk:Phased_Repeater_Gun&amp;action=edit" />
...
<body class="mediawiki ltr sitedir-ltr ns-15 ns-talk page-Category_talk_Phased_Repeater_Gun skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Creating Category talk:Phased Repeater Gun</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Category_talk:Phased_Repeater_Gun&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20160611172830" name="wpStarttime" />
<input type='hidden' value="20160611172830" name="wpEdittime" />
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Category_talk:Phased_Repeater_Gun" title="Category talk:Phased Repeater Gun" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a href="http://x3wiki.com/index.php/Category_talk:Phased_Repeater_Gun">http://x3wiki.com/index.php/Category_talk:Phased_Repeater_Gun</a>"</div>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="ca-nstab-category"><a href="/index.php/Category:Phased_Repeater_Gun" title="View the category page [c]" accesskey="c">Category</a></li>
				<li id="ca-talk" class="selected new"><a href="/index.php?title=Category_talk:Phased_Repeater_Gun&amp;action=edit&amp;redlink=1" title="Discussion about the content page [t]" accesskey="t">Discussion</a></li>
				<li id="ca-edit" class="selected istalk"><a href="/index.php?title=Category_talk:Phased_Repeater_Gun&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Create</a></li>
				<li id="ca-addsection"><a href="/index.php?title=Category_talk:Phased_Repeater_Gun&amp;action=edit&amp;section=new" title="Start a new section [+]" accesskey="+">+</a></li>
			</ul>
		</div>
	</div>
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Category+talk%3APhased+Repeater+Gun&amp;returntoquery=action%3Dedit%26redlink%3D1&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Category+talk%3APhased+Repeater+Gun&amp;returntoquery=action%3Dedit%26redlink%3D1" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
...
<a href="/index.php/Main_Page" style="background-image: url(http://www.x3wiki.com/x3.jpg);" title="Visit the main page"></a>
	...
	<div class="portlet" id="p-tb" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="t-whatlinkshere"><a href="/index.php/Special:WhatLinksHere/Category_talk:Phased_Repeater_Gun" title="A list of all wiki pages that link here [j]" accesskey="j">What links here</a></li>
				<li id="t-specialpages"><a href="/index.php/Special:SpecialPages" title="A list of all special pages [q]" accesskey="q">Special pages</a></li>
				<li id="t-info"><a href="/index.php?title=Category_talk:Phased_Repeater_Gun&amp;action=info">Page information</a></li>
			</ul>
		</div>
	</div>
