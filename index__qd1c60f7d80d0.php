...
<div id="mw-content-text"><div class="mw-ui-container">
		...
		<form name="userlogin" class="mw-ui-vform" method="post" action="/index.php?title=Special:UserLogin&amp;action=submitlogin&amp;type=login&amp;returnto=Shield+Production+Facility+1MJ">
			...
			<div id="mw-userlogin-help">
				<a href="https://www.mediawiki.org/wiki/Special:MyLanguage/Help:Logging_in">Help with logging in</a>			</div>
						...
						<h3 id="mw-userloginlink">Don&#039;t have an account?<a href="/index.php?title=Special:UserLogin&amp;type=signup&amp;returnto=Shield+Production+Facility+1MJ" id="mw-createaccount-join" tabindex="7"  class="mw-ui-button mw-ui-constructive">Join X3 Wiki</a></h3>
					</div>
													<input type="hidden" name="wpLoginToken" value="3d487c2f35bc00a93d58b1061c384c79" />					</form>
	</div>
</div>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="ca-nstab-special" class="selected"><a href="/index.php?title=Special:UserLogin&amp;returnto=Shield+Production+Facility+1MJ" title="This is a special page, you cannot edit the page itself">Special page</a></li>
			</ul>
		</div>
	</div>
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Shield+Production+Facility+1MJ&amp;type=signup">Create account</a></li>
				<li id="pt-anonlogin" class="active"><a href="/index.php?title=Special:UserLogin&amp;returnto=Shield+Production+Facility+1MJ" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
	...
	<div class="portlet" id="p-tb" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="t-print"><a href="/index.php?title=Special:UserLogin&amp;returnto=Shield+Production+Facility+1MJ&amp;printable=yes" rel="alternate" title="Printable version of this page [p]" accesskey="p">Printable version</a></li>
			</ul>
		</div>
	</div>
