...
<script>if(window.mw){
	mw.config.set({"wgCanonicalNamespace": "Special", "wgCanonicalSpecialPageName": "Userlogin", "wgNamespaceNumber": -1, "wgPageName": "Special:UserLogin", "wgTitle": "UserLogin", "wgCurRevisionId": 0, "wgArticleId": 0, "wgIsArticle": true, "wgAction": "view", "wgUserName": null, "wgUserGroups": ["*"], "wgCategories": [], "wgBreakFrames": true, "Geo": {"city": "", "country": ""}, "wgNoticeProject": "wikipedia"});
}
...
<form name="userlogin2" id="userlogin2" method="post" action="/index.php?title=Special:UserLogin&amp;action=submitlogin&amp;type=signup&amp;returnto=Main_Page">
	...
	<p id="userloginlink">Already have an account? <a href="/index.php?title=Special:UserLogin&amp;type=login&amp;returnto=Main_Page">Log in</a>.</p>
	<div class='captcha'><p>To help protect against automated account creation, please select just the cat photos in the box below:
			...
			<script type="text/javascript" src="/extensions/ConfirmEdit/asirra_contentloaded.js"></script>
			<script type="text/javascript" src="/extensions/ConfirmEdit/asirra_humanverify.js"></script>
			...
			<noscript><p><b>Please enable JavaScript and resubmit the page.</b>
</p></noscript>
		</div>
		<table>
		<tr>
...
<input type="hidden" name="wpCreateaccountToken" value="1a65e6588f5153953928783e8eae270d" /></form>
</div>
...
<div id="column-one">
	<div id="p-cactions" class="portlet">
		...
		<div class="pBody">
			<ul>
				<li id="ca-nstab-special" class="selected"><a href="/index.php?title=Special:UserLogin&amp;type=signup&amp;returnto=Main_Page" title="This is a special page, you cannot edit the page itself">Special page</a></li>
			</ul>
		</div>
	</div>
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-anonlogin" class="active"><a href="/index.php?title=Special:UserLogin&amp;returnto=Main_Page&amp;returntoquery=type%3Dsignup" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
...
</script><script type="text/javascript" src="//geoiplookup.wikimedia.org/"></script><!-- Served in 0.198 secs. --></body></html>