...
<head>
<meta charset="UTF-8" /><title>Editing User talk:Rexde500 - X3 Wiki</title>
<meta name="generator" content="MediaWiki 1.22.6" />
<meta name="robots" content="noindex,nofollow" />
<link rel="alternate" type="application/x-wiki" title="Edit" href="/index.php?title=User_talk:Rexde500&amp;action=edit" />
<link rel="edit" title="Edit" href="/index.php?title=User_talk:Rexde500&amp;action=edit" />
...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"User_talk","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":3,"wgPageName":"User_talk:Rexde500","wgTitle":"Rexde500","wgCurRevisionId":16176,"wgRevisionId":0,"wgArticleId":1236,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"User_talk:Rexde500","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia"});
...
<body class="mediawiki ltr sitedir-ltr ns-3 ns-talk page-User_talk_Rexde500 skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing User talk:Rexde500</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=User_talk:Rexde500&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20140910202339" name="wpStarttime" />
<input type='hidden' value="20140402175857" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary" /><input type="hidden" value="0" name="oldid" /><input type="hidden" value="text/x-wiki" name="format" /><input type="hidden" value="wikitext" name="model" /><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">==Moderator request==
...
[[User:Anarchistica|Anarchistica]] 11:04, 10 May 2011 (CDT)
...
Also, if you can PM me on the [{{linky}}forum.egosoft.com/profile.php?mode=viewprofile&amp;u=315646 forums] with a contact address, we won't have to co-ordinate our work on this page and can work more immediately. [[User:Spychotic|Spychotic]] 19:52, 28 January 2011 (CST)

== spam filter suggestion ==

Hi,

I've noticed the spam filter mentions blacklisting. Is it possible to switch it to whitelisting and then select specific sites that are ok? ie: egosoft, x3tc.ru, rohrbecka's new place(rohrbecka.yaki-syndicate.de). [[User:Madned|Madned]] 23:50, 19 April 2011 (CDT)
...
:something else i've been observing lately is the ht-tp ban doesn't seem to be holding for user pages. not quite sure about a fix for that. [[User:Madned|Madned]] 16:00, 23 April 2012 (CDT)

:Another thing.
: found www.umasswiki.com/wiki/UMassWiki:Blocking_Spam_In_Mediawiki
: which mentions blocking blank user agents. via .htaccess. [[User:Madned|Madned]] 16:00, 23 April 2012 (CDT)

== spam filter ==
I removed http from the spamfilter so links should be possible. Lets see how it goes with the spam

--------
Not well, but I think I may have a solution. [[User:Spychotic|Spychotic]] 17:19, 9 May 2011 (CDT)

: I was thinking more along the lines of {{linky}}mediawiki.org/wiki/Extension:SpamBlacklist#Whitelist
...
Let me know if I can help out; I'm not an X series veteran but I would like to help out anyway. --[[User:Pallustris|Pallustris]] 18:36, 11 May 2011 (CDT)
...
I have plenty stored up in my steam account, and since I regularly take lots of them during gameplay, it wouldn't be too difficult to start adding.
[[User:Korlus|&lt;font color="red">'''Korlus'''&lt;/font>]] - [[User talk:Korlus|&lt;sup>(talk)&lt;/sup>]] [[Special:contributions/Korlus|&lt;sub>(contribs)&lt;/sub>]] 04:59, 17 July 2013 (CDT)


== Request (Section Transclusion) ==
...
{{linky}}mediawiki.org/wiki/Extension:Labeled_Section_Transclusion

[[User:Korlus|&lt;font color="red">'''Korlus'''&lt;/font>]] - [[User talk:Korlus|&lt;sup>(talk)&lt;/sup>]] [[Special:contributions/Korlus|&lt;sub>(contribs)&lt;/sub>]] 13:31, 31 July 2013 (CDT)


== remarks ==
Knighster35: What is your problem with my modification, I have nearly fill many missing data and you undo it. ???

I remark your last modification on main page, can you capitalize the "mission" words as other items? Thanks. [[User:Knighster35|Knighster35]] ([[User talk:Knighster35|talk]]) 12:58, 2 April 2014 (CDT)
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/User_talk:Rexde500" title="User talk:Rexde500" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a href="http://x3wiki.com/index.php/User_talk:Rexde500">http://x3wiki.com/index.php/User_talk:Rexde500</a>"</div>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="ca-nstab-user"><a href="/index.php/User:Rexde500" title="View the user page [c]" accesskey="c">User page</a></li>
				<li id="ca-talk" class="selected"><a href="/index.php/User_talk:Rexde500" title="Discussion about the content page [t]" accesskey="t">Discussion</a></li>
				<li id="ca-edit" class="selected istalk"><a href="/index.php?title=User_talk:Rexde500&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
				<li id="ca-addsection"><a href="/index.php?title=User_talk:Rexde500&amp;action=edit&amp;section=new" title="Start a new section [+]" accesskey="+">+</a></li>
				<li id="ca-history"><a href="/index.php?title=User_talk:Rexde500&amp;action=history" rel="archives" title="Past revisions of this page [h]" accesskey="h">History</a></li>
			</ul>
		</div>
	</div>
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=User+talk%3ARexde500&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=User+talk%3ARexde500&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
...
<a href="/index.php/Main_Page" style="background-image: url(http://www.x3wiki.com/x3.jpg);" title="Visit the main page"></a>
	...
	<div class="portlet" id="p-tb" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="t-whatlinkshere"><a href="/index.php/Special:WhatLinksHere/User_talk:Rexde500" title="A list of all wiki pages that link here [j]" accesskey="j">What links here</a></li>
				<li id="t-recentchangeslinked"><a href="/index.php/Special:RecentChangesLinked/User_talk:Rexde500" title="Recent changes in pages linked from this page [k]" accesskey="k">Related changes</a></li>
				...
				<li id="t-info"><a href="/index.php?title=User_talk:Rexde500&amp;action=info">Page information</a></li>
			</ul>
		</div>
	</div>
