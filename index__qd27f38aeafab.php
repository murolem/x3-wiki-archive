...
<input type='hidden' value="20140830114044" name="wpStarttime" />
...
Makes dumbfire missiles. The exception, however, is the Dragonfly Missile, which is actually programmed to be an image-recognition tracking missile, and the developers made an oversight in including it in this kind of factory when in fact, it should have been more appropriately included in the [[Image Recognition Production Complex]].
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Dumbfire+Missile+Production+Complex&amp;returntoquery=action%3Dedit%26section%3D1&amp;type=signup">Create account</a></li>
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Dumbfire+Missile+Production+Complex&amp;returntoquery=action%3Dedit%26section%3D1" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
