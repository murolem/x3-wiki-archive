...
<head>
<meta charset="UTF-8" /><title>Editing Main Page/sandbox - X3 Wiki</title>
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Main Page/sandbox</span></h1>
...
<input type='hidden' value="20150425045754" name="wpStarttime" />
...
Welcome to the X3 Wiki. This Wiki primarily refers to [[X3: Terran Conflict]] and [[X3: Albion Prelude]], although much of the information here is also relevant for [[X3: Reunion]].
...
|class="" width="50%" rowspan="2" valign="top"|

|}

{| width="100%" style="background: transparent;"
|class="MainPageLeft roseMainFrame" width="50%" rowspan="2" valign="top"|
&lt;center>
...
* [[Autopilot|Software]] - List of all Software.

| class="roseMainFrame" width="50%" valign="top"|
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Main+Page%2Fsandbox&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Main+Page%2Fsandbox&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
