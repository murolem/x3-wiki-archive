...
<input type='hidden' value="20140830051834" name="wpStarttime" />
...
The Crystal Fab manufactures [[Silicon]] into [[Crystals]], with the usual input of [[Energy Cells]] and appropriate foodstuffs for the station's workforce.

Crystals are used by player [[Solar Power Plant]]s to create Energy Cells. They perform the same function in NPC power plants, but as secondary resources, ensuring that the economy does not collapse due to a lack of energy production.
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Crystal+Fab&amp;returntoquery=action%3Dedit%26section%3D1&amp;type=signup">Create account</a></li>
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Crystal+Fab&amp;returntoquery=action%3Dedit%26section%3D1" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
