...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Aldrin_Ship_Production_Base rootpage-Aldrin_Ship_Production_Base skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Aldrin Ship Production Base</h1>
...
<input type='hidden' value="20171215172006" name="wpStarttime" />
<input type='hidden' value="20150225054718" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="16568" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{Infobox open}}
{{Infobox basicstation
|faction=Terran
|station=Aldrin Ship Production Base
|hull=4000000
|shield=40
|generator=6000
|hangar=7
|stationprice={{Priceblock||1624}}
}}
{{Infobox close}}
==Overview==
The Terran [[Shipyard]]s for the isolated group home based in [[Aldrin]]. 

===Encyclopedia Entry===
No information is available about the Aldrin colony installations.

==Products==
===Ships===
{| style="text-align:right;"  class="wikitable sortable" cellpadding="3"
! Available Stations&lt;bR>!! Cost&lt;bR> !! Aldrin ESYCB-60&lt;bR>!!  Aldrin ESYCB-73&lt;bR> 
|-
| [[Deca.cefa|#deca.cefa]] || 862,666 || x || x
|-
| [[Deca.deaf|#deca.deaf]] || 382,699 || x || x
|-
| [[Deca.fade|#deca.fade]] || 35,842 || x || x
|-
| [[Spitfyre]] || 2,652,501 || x || x
|-
| [[Springblossom]] || 5,892,808 || x || x
|}
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Aldrin_Ship_Production_Base" title="Aldrin Ship Production Base" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Aldrin_Ship_Production_Base">http://www.x3wiki.com/index.php/Aldrin_Ship_Production_Base</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Aldrin_Ship_Production_Base&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Aldrin+Ship+Production+Base&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Aldrin+Ship+Production+Base&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
