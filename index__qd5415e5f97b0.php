...
<h2> <span class="mw-headline" id="Pre_order_digital_edition_for_15_december_2011.21">Pre order digital edition for 15 december 2011!</span></h2>
...
<div id="column-one">
	...
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=X3_albion_prelude&amp;returntoquery=printable%3Dyes" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
...
<div id="footer">
	...
	<ul id="f-list">
		<li id="lastmod"> This page was last modified on 14 December 2011, at 14:13.</li>
		<li id="viewcount">This page has been accessed 5,018 times.</li>
...
</script><script type="text/javascript" src="//geoiplookup.wikimedia.org/"></script><!-- Served in 0.164 secs. --></body></html>