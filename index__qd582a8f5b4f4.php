...
</p><p>if you ever get one bring it to the hq and dissasmbale it and have hevy misle asembaleey to make a small wing of them to serve as bombers with a tm beter splt to have speed an strong wing
</p>
...
<!-- Saved in parser cache with key dailystunt_wiki:pcache:idhash:91-0!*!0!!en!*!edit=0 and timestamp 20110818070801 -->
	...
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Medusa_Prototype&amp;returntoquery=printable%3Dyes" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
...
<li id="t-specialpages"><a href="/index.php/Special:SpecialPages" title="List of all special pages [q]" accesskey="q">Special pages</a></li>
				<li id="t-permalink"><a href="/index.php?title=Medusa_Prototype&amp;oldid=6809" title="Permanent link to this revision of the page">Permanent link</a></li>			</ul>
		</div>
	</div>
...
<div id="footer">
	...
	<ul id="f-list">
		<li id="lastmod"> This page was last modified on 7 August 2011, at 18:58.</li>
		<li id="viewcount">This page has been accessed 843 times.</li>
...
<script>if ( window.mediaWiki ) {
	mediaWiki.config.set({"wgCanonicalNamespace": "", "wgCanonicalSpecialPageName": false, "wgNamespaceNumber": 0, "wgPageName": "Medusa_Prototype", "wgTitle": "Medusa Prototype", "wgAction": "view", "wgArticleId": 91, "wgIsArticle": true, "wgUserName": null, "wgUserGroups": ["*"], "wgCurRevisionId": 6809, "wgCategories": [], "wgBreakFrames": false, "wgRestrictionEdit": [], "wgRestrictionMove": []});
}
</script>
<script>if ( window.mediaWiki ) {
