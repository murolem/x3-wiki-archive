...
<input type='hidden' value="20141014184858" name="wpStarttime" />
...
This sector contains approx. 27 asteroids for the player's own uses. Out of all of the possible player owned sectors, Guiding Star has the least ore, but has the most silicon. However, the Unknown Sector south of it contains asteroids of varying yields in case this isn't enough for you.
...
<div id="column-one">
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Guiding+Star&amp;returntoquery=action%3Dedit%26section%3D3&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Guiding+Star&amp;returntoquery=action%3Dedit%26section%3D3" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
