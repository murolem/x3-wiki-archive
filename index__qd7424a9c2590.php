...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Panther&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="6" name="wpSection" />
<input type='hidden' value="20120812045312" name="wpStarttime" />
...
The Panther can carry a wide variety of laser weapons varying by turret.  Its most powerful available weapon is the [[IBL|incendiary bomb launcher]], which can be mounted on its forward and flank gun batteries.  Unlike most Split vessels, it is very well-shielded, even more so than most competing M7s.
{|
|+ '''Missiles'''
...
<div id="column-one">
	...
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Panther&amp;returntoquery=action%3Dedit%26section%3D6" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
