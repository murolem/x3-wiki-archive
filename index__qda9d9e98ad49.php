...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Lotan rootpage-Lotan skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Lotan</h1>
...
<p><strong>Warning:</strong> You are not logged in. Your IP address will be publicly visible if you make any edits. If you <strong><a class="external text" href="http://www.x3wiki.com/index.php?title=Special:UserLogin&amp;returnto=Lotan">log in</a></strong> or <strong><a class="external text" href="http://www.x3wiki.com/index.php?title=Special:CreateAccount&amp;returnto=Lotan">create an account</a></strong>, your edits will be attributed to your username, along with other benefits.
</p>
</div>
<div id="wikiPreview" class="ontop" style="display: none;"><div lang="en" dir="ltr" class="mw-content-ltr"></div></div><form id="editform" name="editform" method="post" action="/index.php?title=Lotan&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntispam">Anti-spam check.
...
<input type='hidden' value="20171222110948" name="wpStarttime" />
<input type='hidden' value="20151223061039" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="16781" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{Infobox open}}
{{Infobox variant
|Variant=Lotan
|Faction=Argon
|Class={{TS+class}}
|Priceblock={{Priceblock|Federation Guardian| 4097839}}
|Minspeed= 41.2
|Maxspeed= 65.9
|Minaccel=2
|Maxaccel=3
...
{{Infobox close}}
==Overview==
This ship, new to Albion Prelude as of patch 3.0, is the Argon's [[TS|TS+]] class ship, with an enormous cargo bay of 15,000 units at the cost of speed. It is capable of mounting relatively heavy weapons for its class fed by the best laser generator among TS+ ships and has a competitive speed/cargo ratio, but with a 60% higher cost than the next most expensive ship in its class, it is not recommended for general use. Much like other Argon ships, it is outclassed in almost every way by its OTAS equivalent, the [[Mistral|Mistral Super Freighter]] except that it is less cumbersome to equip with shielding. However, unlike most other OTAS comparisons, the MSF is much less expensive

==Background==
With the increased demand for weapons and shields on the front lines, the Argon federation required a ship to rival that of the [[Hayabusa|Terran Hayabusa]] freighter. At first the ship was only intended for military re-supply tasks, however after many successful missions it was decided to be put into mass production in order to recover the development costs.
==Physical Characteristics==

== Combat ==
The Lotan has the heaviest laser generator of any TS+ class ship and boasts slots for up to five lasers. However, it is still not a combat vessel by any means and cannot adequately protect itself from attack.
...
|+'''Availability'''
|- style="{{Colour/Argon}}"
! Variant !! [[Cloudbase South East]]
|-
! Lotan || x           
|}

== Suggested Roles==
Though the ship is extremely expensive, if one buys or captures a Lotan, it makes a good Sector or Universe trader, Commercial Agent. It is also useful as a fleet supply ship, where its speed is not a weakness when compared to the [[M1]]s or [[M2]]s it escorts.
== See Also==
{{TS+}}
{{TS+category}}
[[Category:Argon ships]]
{{Argon Navbox}}
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Lotan" title="Lotan" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<li><a href="/index.php/Template:Argon_Navbox" title="Template:Argon Navbox">Template:Argon Navbox</a> (<a href="/index.php?title=Template:Argon_Navbox&amp;action=edit" title="Template:Argon Navbox">edit</a>) </li><li><a href="/index.php/Template:Colour/Argon" title="Template:Colour/Argon">Template:Colour/Argon</a> (<a href="/index.php?title=Template:Colour/Argon&amp;action=edit" title="Template:Colour/Argon">edit</a>) </li><li><a href="/index.php/Template:Factionshipcat/" title="Template:Factionshipcat/">Template:Factionshipcat/</a> (<a href="/index.php?title=Template:Factionshipcat/&amp;action=edit" title="Template:Factionshipcat/">edit</a>) </li><li><a href="/index.php/Template:Gunicon/0" title="Template:Gunicon/0">Template:Gunicon/0</a> (<a href="/index.php?title=Template:Gunicon/0&amp;action=edit" title="Template:Gunicon/0">view source</a>) (semi-protected)</li><li><a href="/index.php/Template:Gunicon/1" title="Template:Gunicon/1">Template:Gunicon/1</a> (<a href="/index.php?title=Template:Gunicon/1&amp;action=edit" title="Template:Gunicon/1">view source</a>) (semi-protected)</li><li><a href="/index.php/Template:Gunslot" title="Template:Gunslot">Template:Gunslot</a> (<a href="/index.php?title=Template:Gunslot&amp;action=edit" title="Template:Gunslot">view source</a>) (semi-protected)</li><li><a href="/index.php/Template:Infobox_close" title="Template:Infobox close">Template:Infobox close</a> (<a href="/index.php?title=Template:Infobox_close&amp;action=edit" title="Template:Infobox close">view source</a>) (semi-protected)</li><li><a href="/index.php/Template:Infobox_open" title="Template:Infobox open">Template:Infobox open</a> (<a href="/index.php?title=Template:Infobox_open&amp;action=edit" title="Template:Infobox open">view source</a>) (semi-protected)</li><li><a href="/index.php/Template:Infobox_variant" title="Template:Infobox variant">Template:Infobox variant</a> (<a href="/index.php?title=Template:Infobox_variant&amp;action=edit" title="Template:Infobox variant">view source</a>) (semi-protected)</li><li><a href="/index.php/Template:Priceblock" title="Template:Priceblock">Template:Priceblock</a> (<a href="/index.php?title=Template:Priceblock&amp;action=edit" title="Template:Priceblock">edit</a>) </li><li><a href="/index.php/Template:Shipbox" title="Template:Shipbox">Template:Shipbox</a> (<a href="/index.php?title=Template:Shipbox&amp;action=edit" title="Template:Shipbox">edit</a>) </li><li><a href="/index.php/Template:Shipclassbox" title="Template:Shipclassbox">Template:Shipclassbox</a> (<a href="/index.php?title=Template:Shipclassbox&amp;action=edit" title="Template:Shipclassbox">edit</a>) </li><li><a href="/index.php/Template:TS%2B" title="Template:TS+">Template:TS+</a> (<a href="/index.php?title=Template:TS%2B&amp;action=edit" title="Template:TS+">edit</a>) </li><li><a href="/index.php/Template:TS%2BTable" title="Template:TS+Table">Template:TS+Table</a> (<a href="/index.php?title=Template:TS%2BTable&amp;action=edit" title="Template:TS+Table">edit</a>) </li><li><a href="/index.php/Template:TS%2Bcategory" title="Template:TS+category">Template:TS+category</a> (<a href="/index.php?title=Template:TS%2Bcategory&amp;action=edit" title="Template:TS+category">edit</a>) </li><li><a href="/index.php/Template:TS%2Bclass" title="Template:TS+class">Template:TS+class</a> (<a href="/index.php?title=Template:TS%2Bclass&amp;action=edit" title="Template:TS+class">edit</a>) </li></ul></div><div class="hiddencats"><div class="mw-hiddenCategoriesExplanation"><p>This page is a member of 8 hidden categories:
</p></div><ul>
...
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Lotan">http://www.x3wiki.com/index.php/Lotan</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Lotan&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Lotan&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Lotan&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
