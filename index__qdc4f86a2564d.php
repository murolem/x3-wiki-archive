...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Mako rootpage-Mako skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Mako</h1>
...
<p><strong>Warning:</strong> You are not logged in. Your IP address will be publicly visible if you make any edits. If you <strong><a class="external text" href="http://www.x3wiki.com/index.php?title=Special:UserLogin&amp;returnto=Mako">log in</a></strong> or <strong><a class="external text" href="http://www.x3wiki.com/index.php?title=Special:CreateAccount&amp;returnto=Mako">create an account</a></strong>, your edits will be attributed to your username, along with other benefits.
</p>
</div>
<div id="wikiPreview" class="ontop" style="display: none;"><div lang="en" dir="ltr" class="mw-content-ltr"></div></div><form id="editform" name="editform" method="post" action="/index.php?title=Mako&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntispam">Anti-spam check.
...
<input type='hidden' value="20180113022757" name="wpStarttime" />
<input type='hidden' value="20161016121736" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="16802" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{Infobox open}}
{{Infobox variant
|Variant=Mako
|Faction=Boron
|Class={{M4class}}
|Priceblock={{Priceblock|| 568452}}
|Minspeed=67.7
|Maxspeed=203.1
|Minaccel=26
|Maxaccel=80
...
{{Infobox variant
|Variant=Mako Sentinel
|Faction=Boron
|Class={{M4class}}
|Priceblock={{Priceblock|| 802572}}
|Minspeed=55.5
|Maxspeed=166.5
|Minaccel=21
|Maxaccel=65
...
{{Infobox variant
|Variant=Mako Vanguard
|Faction=Boron
|Class={{M4class}}
|Priceblock={{Priceblock|| 661278}}
|Minspeed=74.4
|Maxspeed=223.4
|Minaccel=29
|Maxaccel=88
...
{{Infobox close}}
==Overview==
With moderate/high speed and moderate/low shielding, the Mako's selling point is its large cargo capacity.
...
== Combat ==
The Mako's choice of weapons is somewhat limited; it can mount the [[Ion Disruptor]] but otherwise its only real choice of cannon is the [[PAC]]. Being relatively quick and nimble it is capable of taking on a larger target, but care must be taken as it won't survive long if caught in a volley of fire.
...
== Suggested Roles==
The Mako is commonly used as a very light fighter class freighter.
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Mako" title="Mako" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Mako">http://www.x3wiki.com/index.php/Mako</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Mako&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Mako&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Mako&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
