...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Mistral rootpage-Mistral skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Mistral</h1>
...
<p><strong>Warning:</strong> You are not logged in. Your IP address will be publicly visible if you make any edits. If you <strong><a class="external text" href="http://x3wiki.com/index.php?title=Special:UserLogin&amp;returnto=Mistral">log in</a></strong> or <strong><a class="external text" href="http://x3wiki.com/index.php?title=Special:CreateAccount&amp;returnto=Mistral">create an account</a></strong>, your edits will be attributed to your username, along with other benefits.
</p>
</div>
<div id="wikiPreview" class="ontop" style="display: none;"><div lang="en" dir="ltr" class="mw-content-ltr"></div></div><form id="editform" name="editform" method="post" action="/index.php?title=Mistral&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntispam">Anti-spam check.
...
<input type='hidden' value="20170913222609" name="wpStarttime" />
<input type='hidden' value="20140410061927" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="16192" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{Infobox open}}
{{Infobox variant
|Variant=Mistral
|Faction=OTAS
|Class={{TSclass}}
|Priceblock={{Priceblock|Argon|Confirmed Friend 298,482 }}
|Minspeed= 65 
|Maxspeed= 130 
|Minaccel=5
|Maxaccel=10
...
{{Infobox close}}
==Overview==
The Mistral is an advanced [[TS|transport]], incorporating the latest cutting-edge [[OTAS]] design. Not only is it the fastest freighter available, it is also the largest of the standard variants, and the most heavily armed and shielded. The Mistral freighter provides essential logistical support to the OTAS fleet and all of its activities.

A [[TS+]] variant exists called the [[Mistral Super Freighter]], which trades speed and armament in exchange for a much larger cargo bay and stronger shielding.

== Combat ==
If you had to take a TS into combat, the Mistral would be your choice. With turrets that cover it on all sides, then when fully equipped it is a match for any fighter. In the hands of a capable pilot, it can take on and beat an M3+.
...
|}
== Availability ==
The Mistral is available at the OTAS shipyard in [[Legend's Home]]

== Suggested Roles==

When armed to full capacity, Mistral is a capable battlefield resupply ship.
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Mistral" title="Mistral" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://x3wiki.com/index.php/Mistral">http://x3wiki.com/index.php/Mistral</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Mistral&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Mistral&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Mistral&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
