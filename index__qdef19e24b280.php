...
<head>
<title>Editing Susanowa (section) - X3 Wiki</title>
...
<form id="editform" name="editform" method="post" action="/index.php?title=Susanowa&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="9" name="wpSection" />
<input type='hidden' value="20110106234612" name="wpStarttime" />
<input type='hidden' value="20101020182530" name="wpEdittime" />
...
Due to its weakness, combat in the Susanowa takes care and attention given to evasion. The tactic of drawing off targets and walloping then one at a time is best for this ship. It should stay on the edge of a fight as if it gets into the middle its survival probability is low.
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='editHelp'><a href="/index.php/Susanowa" title="Susanowa" id="mw-editform-cancel">Cancel</a> | <a target="helpwindow" href="/index.php/Help:Editing">Editing help</a> (opens in new window)</span>
</div><!-- editButtons -->
</div><!-- editOptions -->
	...
	<div id="p-cactions" class="portlet">
		...
		<div class="pBody">
			<ul>
				 ...
				 <li id="ca-edit" class="selected"><a href="/index.php?title=Susanowa&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Susanowa&amp;returntoquery=action%3Dedit%26section%3D9" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
...
<!-- Served in 0.227 secs. --><script type="text/javascript">
