...
<head>
<meta charset="UTF-8" /><title>Editing Scanners - X3 Wiki</title>
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Scanners</span></h1>
...
<input type='hidden' value="20160820123412" name="wpStarttime" />
...
For instance:
{| cellspacing="0" cellpadding="4" border="1" style="text-align:center;"
...
Retrieved from "<a href="http://x3wiki.com/index.php/Scanners">http://x3wiki.com/index.php/Scanners</a>"</div>
...
<div id="column-one">
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Scanners&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Scanners&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
