...
<head>
<meta charset="UTF-8" /><title>Editing X3: Reunion - X3 Wiki</title>
...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"X3:_Reunion","wgTitle":"X3: Reunion","wgCurRevisionId":16299,"wgRevisionId":0,"wgArticleId":1120,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"X3:_Reunion","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia"});
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-X3_Reunion skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing X3: Reunion</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=X3:_Reunion&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20160916202657" name="wpStarttime" />
<input type='hidden' value="20140628192702" name="wpEdittime" />
...
===Map===
Yet more sectors were added, bringing the total to 158. Some of these only became available in later stages of the plot in later patches. Many maps exist, and can be found on the [{{linky}}forum.egosoft.com/viewtopic.php?t=162408 guides sticky] in the Egosoft forums.
...
===Expansions===
The game received at least one "official" expansion - the "Bala Gi" Missions, allowing the player to Construct their own personal [[Headquarters|Player Headquarters]], as well as giving the player the first [[M8]] - The [[Hyperion]].

==XTM Mod==
The XTM, or X-Tended Mod, is a [[Scripts &amp; Mods|gameplay modification]] for Reunion that was built by community modders and adds many scripts and functions to the game. It also adds many more sectors. Many of the additions were re-used by Egosoft when they created [[X3: Terran Conflict]]; including new [[Shipyard]] designs, and many of the additional [[ships]] added, especially the [[OTAS]].
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/X3:_Reunion" title="X3: Reunion" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=X3:_Reunion&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=X3%3A+Reunion&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=X3%3A+Reunion&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
