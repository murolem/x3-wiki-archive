...
<head>
<meta charset="UTF-8" /><title>Editing Military Outpost - X3 Wiki</title>
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Military_Outpost skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Military Outpost</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Military_Outpost&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20160525052721" name="wpStarttime" />
<input type='hidden' value="20130702020604" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary" /><input type="hidden" value="0" name="oldid" /><input type="hidden" value="text/x-wiki" name="format" /><input type="hidden" value="wikitext" name="model" /><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{Infobox Station
|Name=Military Outpost
|Race=Commonwealth
|Type=Dock
|Capacity=0
|Hull=15,000,000
|Shield=30 x [[2 GJ Shield]]
|Production=none
|Docking=Unlimited x [[M3+]]-[[M5]] &lt;br> 10 x [[TS]]/[[TP]]/[[M6]]/[[M8]] &lt;br> 2-4 x [[M1]]/[[M2]]/[[M7]]
}}


The Military Outpost is able to carry 36 [[Marines]] at a time. This makes the Military Outpost the prime spot for M7's who wish to fill up on [[Marines]] for [[Boarding]] Operations. The Military Outpost also carries an assortment of Goods, Weapons and Wares for the player to take advantage of, such as the [[Boarding Pod]]s, which are only found at Military Outposts.
...
!Max Stock
|-
|[[Police license|Law Enforcement License]]
|
| -
|Upgrade
|-
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Military_Outpost" title="Military Outpost" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<li><a href="/index.php/Template:Infobox_Station" title="Template:Infobox Station">Template:Infobox Station</a> (<a href="/index.php?title=Template:Infobox_Station&amp;action=edit" title="Template:Infobox Station">edit</a>) </li><li><a href="/index.php/Template:Piracy" title="Template:Piracy">Template:Piracy</a> (<a href="/index.php?title=Template:Piracy&amp;action=edit" title="Template:Piracy">edit</a>) </li></ul></div><div class="hiddencats"></div><div class="limitreport"></div>
</form>
</div><div class="printfooter">
Retrieved from "<a href="http://www.x3wiki.com/index.php/Military_Outpost">http://www.x3wiki.com/index.php/Military_Outpost</a>"</div>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Military_Outpost&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Military+Outpost&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Military+Outpost&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
