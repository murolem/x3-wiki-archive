...
<head>
<meta charset="UTF-8" /><title>Create account - X3 Wiki</title>
...
<link rel="stylesheet" href="http://x3wiki.com/load.php?debug=false&amp;lang=en&amp;modules=mediawiki.legacy.commonPrint%2Cshared%7Cmediawiki.special.createaccount%7Cmediawiki.ui%7Cskins.monobook&amp;only=styles&amp;skin=monobook&amp;*" />
...
<script>if(window.mw){
mw.loader.load(["mediawiki.special.createaccount.js","mediawiki.page.startup","mediawiki.legacy.wikibits","mediawiki.legacy.ajax"]);
}</script>
</head>
...
<div id="mw-content-text"><div class="mw-ui-container">
		...
		<form name="userlogin2" id="userlogin2" class="mw-ui-vform" method="post" action="/index.php?title=Special:UserLogin&amp;action=submitlogin&amp;type=signup&amp;returnto=Unknown+Sector+(Randomly+Created+UFJD+Sector)">
			<section class="mw-form-header">
				<div class='captcha'><p>To protect the wiki against automated account creation, we kindly ask you to select just the cat photos in the box below:
</p><script src="//challenge.asirra.com/js/AsirraClientSide.js"></script><script>var asirra_js_failed = '"Please correctly identify the cats."';</script><noscript><b>Please enable JavaScript and resubmit the page.</b></noscript></div>
			</section>
...
If you choose to provide it, this will be used for giving you attribution for your work.
				...
				<input class="mw-ui-button mw-ui-big mw-ui-block mw-ui-primary" id="wpCreateaccount" tabindex="10" type="submit" value="Create your account" name="wpCreateaccount" />			</div>
						<input type="hidden" name="wpCreateaccountToken" value="1bb2db6c2be6f7e83a7f56a3e3011b54" />		</form>
					<div id="signupend"></div>
			</div>
	<div class="mw-createacct-benefits-container">
		<h2>X3 Wiki is made by people like you.</h2>
...
Retrieved from "<a href="http://x3wiki.com/index.php/Special:UserLogin">http://x3wiki.com/index.php/Special:UserLogin</a>"</div>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="ca-nstab-special" class="selected"><a href="/index.php?title=Special:UserLogin&amp;returnto=Unknown+Sector+%28Randomly+Created+UFJD+Sector%29&amp;type=signup" title="This is a special page, you cannot edit the page itself">Special page</a></li>
			</ul>
		</div>
	</div>
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-anonuserpage"><a href="/index.php/User:207.241.229.198" class="new" title="The user page for the IP address you are editing as [.]" accesskey=".">207.241.229.198</a></li>
				<li id="pt-anontalk"><a href="/index.php/User_talk:207.241.229.198" class="new" title="Discussion about edits from this IP address [n]" accesskey="n">Talk for this IP address</a></li>
				<li id="pt-createaccount" class="active"><a href="/index.php?title=Special:UserLogin&amp;returnto=Unknown+Sector+%28Randomly+Created+UFJD+Sector%29&amp;returntoquery=type%3Dsignup&amp;type=signup">Create account</a></li>
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Unknown+Sector+%28Randomly+Created+UFJD+Sector%29&amp;returntoquery=type%3Dsignup" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
	...
	<div class="portlet" id="p-tb" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="t-print"><a href="/index.php?title=Special:UserLogin&amp;returnto=Unknown+Sector+%28Randomly+Created+UFJD+Sector%29&amp;type=signup&amp;printable=yes" rel="alternate" title="Printable version of this page [p]" accesskey="p">Printable version</a></li>
			</ul>
		</div>
	</div>
...
<script>if(window.mw){
mw.loader.load(["ext.confirmEdit.asirra","mediawiki.user","mediawiki.hidpi","mediawiki.page.ready","mediawiki.searchSuggest"],null,true);
}</script>
