...
<head>
<meta charset="UTF-8" /><title>Editing Matter/Anti-Matter Warhead - X3 Wiki</title>
...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Matter/Anti-Matter_Warhead","wgTitle":"Matter/Anti-Matter Warhead","wgCurRevisionId":11361,"wgRevisionId":0,"wgArticleId":877,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Matter/Anti-Matter_Warhead","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia"});
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Matter_Anti-Matter_Warhead skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Matter/Anti-Matter Warhead</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Matter/Anti-Matter_Warhead&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20160608204616" name="wpStarttime" />
<input type='hidden' value="20121214001913" name="wpEdittime" />
...
{{Infobox open}}
{{Infobox ware
|ware= Matter/Anti-Matter Warhead
|cargoclass=S
|volume=4
|minprice=720
|aveprice=900
...
==Overview==
Each crate contains 200 rounds of ammunition.
===Encyclopedia Entry===
Matter/Anti-matter Warheads contain an equal amount of matter and anti-matter separated by an energy field. When this field is compromised, by impact or failure, the two mix with devastating results.

==Weapons==

Used by both the [[Matter/Anti-Matter Launcher]] and the [[Prototype Matter/Anti-Matter Launcher]].

==Trading information==
{|
! Produced by  !! Secondary Resource at !! Traded at
|- valign="top"
|
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Matter/Anti-Matter_Warhead" title="Matter/Anti-Matter Warhead" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Matter/Anti-Matter_Warhead&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Matter%2FAnti-Matter+Warhead&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Matter%2FAnti-Matter+Warhead&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
...
<script type="text/javascript" src="//geoiplookup.wikimedia.org/"></script><!-- Served in 0.333 secs. --></body></html>