...
<head>
<title>Editing Capital ships - X3 Wiki</title>
<meta charset="UTF-8" />
...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Capital_ships","wgTitle":"Capital ships","wgCurRevisionId":7361,"wgArticleId":404,"wgIsArticle":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgRelevantPageName":"Capital_ships","wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia"});
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Capital_ships skin-monobook action-edit">
...
<div id="column-content"><div id="content">
	...
	<h1 id="firstHeading" class="firstHeading"><span dir="auto">Editing Capital ships</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Capital_ships&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="" name="wpSection" />
<input type='hidden' value="20120717161938" name="wpStarttime" />
<input type='hidden' value="20110917224219" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary" /><input type="hidden" value="0" name="oldid" /><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{Shipcategory}}
==Overview==
...
Capital Ships can only be [[capping|captured]] by [[boarding]] them with [[marines]].
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='editHelp'><a href="/index.php/Capital_ships" title="Capital ships" id="mw-editform-cancel">Cancel</a> | <a target="helpwindow" href="/index.php/Help:Editing">Editing help</a> (opens in new window)</span>
</div><!-- editButtons -->
</div><!-- editOptions -->
...
<li><a href="/index.php/Template:M1class" title="Template:M1class">Template:M1class</a> (<a href="/index.php?title=Template:M1class&amp;action=edit" title="Template:M1class">edit</a>) </li><li><a href="/index.php/Template:M2class" title="Template:M2class">Template:M2class</a> (<a href="/index.php?title=Template:M2class&amp;action=edit" title="Template:M2class">edit</a>) </li><li><a href="/index.php/Template:M7Mclass" title="Template:M7Mclass">Template:M7Mclass</a> (<a href="/index.php?title=Template:M7Mclass&amp;action=edit" title="Template:M7Mclass">edit</a>) </li><li><a href="/index.php/Template:M7class" title="Template:M7class">Template:M7class</a> (<a href="/index.php?title=Template:M7class&amp;action=edit" title="Template:M7class">edit</a>) </li><li><a href="/index.php/Template:Shipcategory" title="Template:Shipcategory">Template:Shipcategory</a> (<a href="/index.php?title=Template:Shipcategory&amp;action=edit" title="Template:Shipcategory">edit</a>) </li><li><a href="/index.php/Template:TLclass" title="Template:TLclass">Template:TLclass</a> (<a href="/index.php?title=Template:TLclass&amp;action=edit" title="Template:TLclass">edit</a>) </li></ul></div><div class="hiddencats"></div>
</form>
</div><div class="printfooter">
Retrieved from "<a href="http://www.x3wiki.com/index.php/Capital_ships">http://www.x3wiki.com/index.php/Capital_ships</a>"</div>
...
<div id="column-one">
	<div id="p-cactions" class="portlet">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Capital_ships&amp;action=edit" primary="1" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Capital+ships&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
