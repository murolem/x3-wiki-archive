...
<head>
<meta charset="UTF-8" /><title>Editing Talk:Ownerless ships - X3 Wiki</title>
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Talk:Ownerless ships</span></h1>
...
<input type='hidden' value="20140717142751" name="wpStarttime" />
<input type='hidden' value="20110630171737" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary" /><input type="hidden" value="0" name="oldid" /><input type="hidden" value="text/x-wiki" name="format" /><input type="hidden" value="wikitext" name="model" /><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">The Iguana is at position 38000,0,35500, not 0,0,40000 - but the spam filter won't let me save the page (because of the link to the external site?) [[Special:Contributions/124.168.125.34|124.168.125.34]] 07:52, 24 March 2011 (CDT)

yup. it's that little reference at the bottom to x3tc. way around that would be to unlink it. like so. [[User:Madned|Madned]] 05:14, 26 March 2011 (CDT)

== lampy ==

hello, all

== Зароботок на загрузке файловигры онлайн,игры новие,бесплатные игры,лучшие игры, новые игры,бесплатно скачать игры для мобильных телефо ==
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Talk%3AOwnerless+ships&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Talk%3AOwnerless+ships&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
