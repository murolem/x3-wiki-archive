...
<head>
<meta charset="UTF-8"/>
<title>Editing Return Ship - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Return_Ship","wgTitle":"Return Ship","wgCurRevisionId":16409,"wgRevisionId":0,"wgArticleId":445,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Return_Ship","wgRelevantArticleId":445,"wgRequestId":"WdKY2lkfZokAAA4ysOcAAAAA","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia","wgEditMessage":"editing"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Return_Ship rootpage-Return_Ship skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Return Ship</h1>
...
<p><strong>Warning:</strong> You are not logged in. Your IP address will be publicly visible if you make any edits. If you <strong><a class="external text" href="http://x3wiki.com/index.php?title=Special:UserLogin&amp;returnto=Return_Ship">log in</a></strong> or <strong><a class="external text" href="http://x3wiki.com/index.php?title=Special:CreateAccount&amp;returnto=Return_Ship">create an account</a></strong>, your edits will be attributed to your username, along with other benefits.
</p>
</div>
<div id="wikiPreview" class="ontop" style="display: none;"><div lang="en" dir="ltr" class="mw-content-ltr"></div></div><form id="editform" name="editform" method="post" action="/index.php?title=Return_Ship&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntispam">Anti-spam check.
...
<input type='hidden' value="20171002195154" name="wpStarttime" />
<input type='hidden' value="20140819121251" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="16409" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">A [[Missions#Other Mission|Mission]] offered at [[stations]].
...
In the beginning of the game, you will be usually asked to retreive [[M5]], [[M4]], or [[M3]] class ships. Later on, you can be asked to retreive [[M8]], [[TS]], [[TP]], [[M6]] or [[M7]] class ships; the latter two classes may be used for [[Return Ship#Boarding Practice|boarding practice]]. [[M1]], [[M2]], and [[TL]] class ships are never featured in Return Ship missions.
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Return_Ship" title="Return Ship" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<li><a href="/index.php/Template:Missions" title="Template:Missions">Template:Missions</a> (<a href="/index.php?title=Template:Missions&amp;action=edit" title="Template:Missions">edit</a>) </li><li><a href="/index.php/Template:Offers" title="Template:Offers">Template:Offers</a> (<a href="/index.php?title=Template:Offers&amp;action=edit" title="Template:Offers">edit</a>) </li><li><a href="/index.php/Template:Other_Missions" title="Template:Other Missions">Template:Other Missions</a> (<a href="/index.php?title=Template:Other_Missions&amp;action=edit" title="Template:Other Missions">edit</a>) </li><li><a href="/index.php/Template:Piracy" title="Template:Piracy">Template:Piracy</a> (<a href="/index.php?title=Template:Piracy&amp;action=edit" title="Template:Piracy">edit</a>) </li><li><a href="/index.php/Template:Plot_Missions" title="Template:Plot Missions">Template:Plot Missions</a> (<a href="/index.php?title=Template:Plot_Missions&amp;action=edit" title="Template:Plot Missions">edit</a>) </li></ul></div><div class="hiddencats"></div><div class="limitreport"></div><input type="hidden" value="1" name="wpUltimateParam"/>
</form>
</div><div class="printfooter">
Retrieved from "<a dir="ltr" href="http://x3wiki.com/index.php/Return_Ship">http://x3wiki.com/index.php/Return_Ship</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Return_Ship&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Return+Ship&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Return+Ship&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
