...
<head>
<title>Editing Simulation modeling (section) - X3 Wiki</title>
<meta charset="UTF-8" />
...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Simulation_modeling","wgTitle":"Simulation modeling","wgCurRevisionId":7378,"wgArticleId":1008,"wgIsArticle":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgRelevantPageName":"Simulation_modeling","wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia"});
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Simulation_modeling skin-monobook action-edit">
<div id="fb-root"></div>
...
//]]>--></script>
	...
	<h1 id="firstHeading" class="firstHeading"><span dir="auto">Editing Simulation modeling (section)</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Simulation_modeling&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="4" name="wpSection" />
<input type='hidden' value="20120923052529" name="wpStarttime" />
<input type='hidden' value="20110918051013" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="20c617a36112dfaa9891d194c6248aa7" name="wpAutoSummary" /><input type="hidden" value="0" name="oldid" /><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">==Combat Example: Out-of-Sector==
Turns run 30 seconds, 5s if monitored via sector map.

50 Jaguars w/ 4 IREs &amp; 2 1MJ shields costing about 70k credits each.&lt;br>
-vs-&lt;br>
Python w/ lots of guns &amp; 3 2GJ shields costing over 90M credits

4 IREs will cause 560 Hull/5.6 MJ Shield damage/sec, over 30s this is 16.8K/168MJ, for 50 this is 840K/8400MJ, on a 5s timestep this converts to 2.8K/28MJ per ship, and 140K/1400MJ for 50.

A Jaguar has 2MJ in shielding and 800 hull points.&lt;br>
...
If you watch the fight on the sector map what will probably happen is the Python will kill 5 Jaguars while they pare down the shields and inflict a little hull damage. It will then kill another 4-5 while the survivors destroy the rest of the hull.
...
The results of an In-Sector battle will go completely differently, especially if the Python is armed with Flak weapons. A number of the M5s are quite likely to collide with the M2 and cripple or destroy themselves. The Python's weapons fire will generally miss the small and maneuverable M5s. M5 traffic control will reduce the number of attackers that can effectively attack at a single time. Fighter maneuvers will reduce the time spent firing during each pass. It is most probable that the Jaguars will be completely annihilated without causing significant damage to the Python.
...
<span class="mw-summary" id="wpSummaryLabel"><label for="wpSummary">Summary:</label></span> <input class="mw-summary" id="wpSummary" maxlength="200" tabindex="1" size="60" spellcheck="true" title="Enter a short summary [b]" accesskey="b" value="/* Combat Example: Out-of-Sector */ " name="wpSummary" /><div class='editCheckboxes'>
</div>
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='editHelp'><a href="/index.php/Simulation_modeling" title="Simulation modeling" id="mw-editform-cancel">Cancel</a> | <a target="helpwindow" href="/index.php/Help:Editing">Editing help</a> (opens in new window)</span>
</div><!-- editButtons -->
</div><!-- editOptions -->
...
Retrieved from "<a href="http://www.x3wiki.com/index.php/Simulation_modeling">http://www.x3wiki.com/index.php/Simulation_modeling</a>"</div>
	...
	<div id="p-cactions" class="portlet">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Simulation_modeling&amp;action=edit" primary="1" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Simulation+modeling&amp;returntoquery=action%3Dedit%26section%3D4" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
