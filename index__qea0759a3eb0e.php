...
<head>
<meta charset="UTF-8" />
<title>Revision history of "Incendiary Bomb Launcher Forge" - X3 Wiki</title>
...
<link rel="alternate" type="application/atom+xml" title="&quot;Incendiary Bomb Launcher Forge&quot; Atom feed" href="/index.php?title=Incendiary_Bomb_Launcher_Forge&amp;feed=atom&amp;action=history" />
...
<div id="column-content"><div id="content">
	...
	<h1 id="firstHeading" class="firstHeading">Revision history of "Incendiary Bomb Launcher Forge"</h1>
	<div id="bodyContent">
		<div id="siteSub">From X3 Wiki</div>
		<div id="contentSub"><a href="/index.php?title=Special:Log&amp;page=Incendiary+Bomb+Launcher+Forge" title="Special:Log">View logs for this page</a></div>
		<div id="jump-to-nav">Jump to: <a href="#column-one">navigation</a>, <a href="#searchInput">search</a></div>
		<!-- start content -->
<form action="/index.php" method="get" id="mw-history-searchform"><fieldset id="mw-history-search">
<legend>Browse history</legend>
<input type="hidden" value="Incendiary_Bomb_Launcher_Forge" name="title" />
...
<li><span class="mw-history-histlinks">(cur | prev) </span> <a href="/index.php?title=Incendiary_Bomb_Launcher_Forge&amp;oldid=5070" title="Incendiary Bomb Launcher Forge">06:54, 5 February 2011</a> <span class='history-user'><a href="/index.php/User:Madned" title="User:Madned" class="mw-userlink">Madned</a>  <span class="mw-usertoollinks">(<a href="/index.php/User_talk:Madned" title="User talk:Madned">Talk</a> | <a href="/index.php/Special:Contributions/Madned" title="Special:Contributions/Madned">contribs</a>)</span></span> <span class="history-size">(717 bytes)</span> <span class="comment">(start)</span> </li>
</ul>
...
<div id="column-one">
	<div id="p-cactions" class="portlet">
		...
		<div class="pBody">
			<ul>
				 ...
				 <li id="ca-history" class="selected"><a href="/index.php?title=Incendiary_Bomb_Launcher_Forge&amp;action=history" title="Past revisions of this page [h]" accesskey="h">History</a></li>
			</ul>
		</div>
	</div>
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Incendiary_Bomb_Launcher_Forge&amp;returntoquery=action%3Dhistory" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
	...
	<div class="portlet" id="p-tb">
		...
		<div class="pBody">
			...
			<li id="feedlinks"><a id="feed-atom" href="/index.php?title=Incendiary_Bomb_Launcher_Forge&amp;feed=atom&amp;action=history" rel="alternate" type="application/atom+xml" class="feedlink" title="Atom feed for this page">Atom</a>&#160;
...
<script>if ( window.mediaWiki ) {
	mediaWiki.config.set({"wgCanonicalNamespace": "", "wgCanonicalSpecialPageName": false, "wgNamespaceNumber": 0, "wgPageName": "Incendiary_Bomb_Launcher_Forge", "wgTitle": "Incendiary Bomb Launcher Forge", "wgAction": "history", "wgArticleId": 1256, "wgIsArticle": false, "wgUserName": null, "wgUserGroups": ["*"], "wgCurRevisionId": 5070, "wgCategories": [], "wgBreakFrames": false, "wgRestrictionEdit": [], "wgRestrictionMove": []});
}
</script>
<script>if ( window.mediaWiki ) {
