...
<head>
<meta charset="UTF-8" /><title>Editing Keris - X3 Wiki</title>
...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Keris","wgTitle":"Keris","wgCurRevisionId":14257,"wgRevisionId":0,"wgArticleId":1271,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Keris","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia"});
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Keris skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Keris</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Keris&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20160415225523" name="wpStarttime" />
<input type='hidden' value="20140128030504" name="wpEdittime" />
...
==Overview==
===Encyclopedia Entry===
The USC fighter drone was named after a small curled dagger; very apt, with its ability to confound even the most agile ship.

==Commentary==
A heavily armed, but slow fighter drone. The Keris represents the cheapest way to put [[Electro-Magnetic Plasma Cannon|EMP cannons]] on the battlefield, especially considering a ship-mounted EMPC costs around 30 times as much to purchase alone, not even considering the cost of the ship it would be mounted to. 

Mounts one EMPC, plus a generator bettering that of the [[Sabre]] to run it. Lasts approximately 10 minutes, like the other fighter drones.

The Keris' prowess in combat tailors it towards battling against capital ships than fighter craft; in numbers, the EMPC that these drones mount can shred the shields and hull of capships within minutes to seconds, but the relatively slow firing speed and velocity of its shots mean that the Keris will have pronounced trouble in engaging against fighters, forcing the pilot to decide whether he or she should go into the action themselves.
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Keris" title="Keris" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a href="http://www.x3wiki.com/index.php/Keris">http://www.x3wiki.com/index.php/Keris</a>"</div>
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Keris&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Keris&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Keris&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
