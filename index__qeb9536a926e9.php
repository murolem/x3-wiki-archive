...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Pike rootpage-Pike skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Pike</h1>
...
<p><strong>Warning:</strong> You are not logged in. Your IP address will be publicly visible if you make any edits. If you <strong><a class="external text" href="http://x3wiki.com/index.php?title=Special:UserLogin&amp;returnto=Pike">log in</a></strong> or <strong><a class="external text" href="http://x3wiki.com/index.php?title=Special:CreateAccount&amp;returnto=Pike">create an account</a></strong>, your edits will be attributed to your username, along with other benefits.
</p>
</div>
<div id="wikiPreview" class="ontop" style="display: none;"><div lang="en" dir="ltr" class="mw-content-ltr"></div></div><form id="editform" name="editform" method="post" action="/index.php?title=Pike&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntispam">Anti-spam check.
...
<input type='hidden' value="20170720175001" name="wpStarttime" />
<input type='hidden' value="20170713092528" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="17004" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{Infobox open}}
{{Infobox variant
|Variant=Pike
|Faction=Boron
|Class={{M4+class}}
|Priceblock={{Priceblock||797,068}}
|Minspeed=65
|Maxspeed=195
|Minaccel=21
|Maxaccel=65
...
{{Infobox close}}
==Overview==
Smaller than an [[M3]], and lower priced, the Pike is a capable carrier fighter with good shielding and speed, along with enhanced weaponry over the [[Mako]].

The Pike's weapon selection changed significantly in Albion Prelude, dramatically changing the fighter's role.

==Background==
===Encyclopedia Entry===
Adding the Pike to the Royal Boron Navy's inventory was an inspired move. The Pike's agility, speed and improved weaponry makes it a fine interceptor.
==Physical Characteristics==
The Pike's hull is identical to the [[Mako]], an unusual feature among M4+s, which usually have distinct, if similar appearances compared to their sister M4s. It has been given a unique model in Albion Prelude.

== Combat ==
The Boron M4+ fighter is a large improvement on its predecessor, the [[Mako]], with heavier shielding and armament, and it can hold its own against other fighters. Thanks to its 25MJ shields, it can survive glancing blows from heavier weapons, and it has the speed and agility to dodge incoming fire. It also mounts enough weapon power to do reasonable damage to an adversary.

== Equipment ==
As with most [[Boron]] fighters, it can use the [[Ion Disruptor]], and can be used to strip shields and equipment for [[boarding]] operations.

In Albion Prelude, the Pike can no longer mount the [[Ion Disruptor]], but is compatible with the [[Energy Bolt Chaingun]], making the fighter a more capable destructive ship at the cost of its niche role.
{|
|+ '''Missiles - Terran Conflict'''
...
|- style="{{Colour/Boron}}"
! Game !! [[Depths of Silence]] !!  [[Great Reef]] !!  [[Kingdom End]] !! [[Lucky Planets]] !! [[Ocean of Fantasy]] !! [[Queen's Retribution]] 
|-
| Terran Conflict || x  || x  || x || x || x ||  ||
|-

| Albion Prelude || x || x || x || x || x || x
|}

== Suggested Roles==
The Pike's speed is competitive with other M4+s, a unusual quality for [[Boron]] small craft. It strikes a good balance between speed, shielding and firepower, making it a good escort ship and interceptor.

In Terran Conflict, it is useful as a escort for [[boarding]] operations, using the [[Ion Disruptor]] to strip weapons and shields while the player launches marines. It can also mount several very heavy missiles like the [[Hammerhead Missile]], [[Tornado Missile]] and [[Thunderbolt Missile]], allowing it a heavy strike capability.

In Albion Prelude, its weapon generator cannot adequately fuel the [[High Energy Plasma Thrower]] or [[Phased Repeater Gun]], but it has plenty of cargo space, so utilizing the [[Energy Bolt Chaingun]] is quite feasible.  Its ability to mount heavy missiles has also been removed; its selection is mostly anti-fighter. It can still mount the heavy [[Remote Guided Warhead]], but the missile is difficult to source, so it is unreliable for fleet action.
== See Also==
*[[M4]] class;
**[[Mako|Boron Mako]]

{{M4+}}
[[Category:Boron ships]]
{{Boron Navbox}}
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Pike" title="Pike" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://x3wiki.com/index.php/Pike">http://x3wiki.com/index.php/Pike</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Pike&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Pike&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Pike&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
