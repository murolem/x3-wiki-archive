...
<head>
<meta charset="UTF-8" /><title>Editing Bail - X3 Wiki</title>
...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Bail","wgTitle":"Bail","wgCurRevisionId":12971,"wgRevisionId":0,"wgArticleId":993,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Bail","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia"});
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Bail skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Bail</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Bail&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20160525055222" name="wpStarttime" />
<input type='hidden' value="20130702020339" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary" /><input type="hidden" value="0" name="oldid" /><input type="hidden" value="text/x-wiki" name="format" /><input type="hidden" value="wikitext" name="model" /><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">NPCs, in qualified ships, under fire from the player may bail; that is, the pilot will abandon his ship and fly in his space-suit to the nearest station.
...
The damaged ship will be left floating in space may then be [[claim]]ed by the player. The ship will sometimes still have some functioning weapons, equipment and upgrades left aboard, but often only the upgrades will be left behind.
...
[[:Category:Capital Ships|Capital ships]] must be [[boarding|boarded]] by [[marines]] to be [[claim]]ed, as must [[M6]] and [[TM]] class ships, except [[Return Ship]] mission ships which may be claimed normally.
...
*Hull damage
*Failed morale check
Consequently, [[Mass Driver]]s while they damage the hull, do not affect the shields and should not cause the pilot to bail.&lt;br>
...
It is often advantageous to use a low hull damage high shield damage weapon like the [[Pulsed Beam Emitter]], since that will preserve the hull through several [[capping]] attempts. However, many players believe that heavily damaging the hull most negatively affects morale and in any event permits players to most rapidly process a large number of candidate ships with the least attention. Both strategies attempt to increase the number of bail checks for a given amount of time.

PBEs are best suited to capturing specific ships.

Heavier weapon loads, like the [[Particle Accelerator Cannon]], are best suited to working through swarms.
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Bail" title="Bail" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<li><a href="/index.php/Template:Piracy" title="Template:Piracy">Template:Piracy</a> (<a href="/index.php?title=Template:Piracy&amp;action=edit" title="Template:Piracy">edit</a>) </li></ul></div><div class="hiddencats"></div><div class="limitreport"></div>
</form>
</div><div class="printfooter">
Retrieved from "<a href="http://www.x3wiki.com/index.php/Bail">http://www.x3wiki.com/index.php/Bail</a>"</div>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Bail&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Bail&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Bail&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
