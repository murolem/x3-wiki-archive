...
<head>
<meta charset="UTF-8" /><title>Editing Destroy Convoy - X3 Wiki</title>
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Destroy_Convoy skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Destroy Convoy</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Destroy_Convoy&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20150425044613" name="wpStarttime" />
<input type='hidden' value="20130809233737" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary" /><input type="hidden" value="0" name="oldid" /><input type="hidden" value="text/x-wiki" name="format" /><input type="hidden" value="wikitext" name="model" /><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">A [[Missions#Other Mission|Mission]] often offered at [[stations]].

==Objective==
Mission offered by various races to kill enemy ships in a convoy, useful if you are trying to improve your rep with the employers' faction. You will lose rep with the race you are attacking but it is nothing you can't fix with another mission for the victim race.
...
* M3/M4 ship. 
* Jumpdrive. 
* Decent rep with the race you are attacking to buffer yourself from some nasty trouble. 

==What you will find: ==

* A couple TS class ships, lightly armed. 
* Sector Police on your back if you're not careful.

==Commentary and Strategy==

Beware of police units and sector patrols. Also make sure you have a good rep with the race you're targeting, as you will take a hit here (albeit a smaller one than the gains you will get with the employer race).  Rep loss can be minimized by ramming the convoy instead of firing at them.
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Destroy_Convoy" title="Destroy Convoy" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<li><a href="/index.php/Template:Missions" title="Template:Missions">Template:Missions</a> (<a href="/index.php?title=Template:Missions&amp;action=edit" title="Template:Missions">edit</a>) </li><li><a href="/index.php/Template:Offers" title="Template:Offers">Template:Offers</a> (<a href="/index.php?title=Template:Offers&amp;action=edit" title="Template:Offers">edit</a>) </li><li><a href="/index.php/Template:Other_Missions" title="Template:Other Missions">Template:Other Missions</a> (<a href="/index.php?title=Template:Other_Missions&amp;action=edit" title="Template:Other Missions">edit</a>) </li><li><a href="/index.php/Template:Plot_Missions" title="Template:Plot Missions">Template:Plot Missions</a> (<a href="/index.php?title=Template:Plot_Missions&amp;action=edit" title="Template:Plot Missions">edit</a>) </li></ul></div><div class="hiddencats"></div><div class="limitreport"></div>
</form>
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Destroy_Convoy&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Destroy+Convoy&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Destroy+Convoy&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
