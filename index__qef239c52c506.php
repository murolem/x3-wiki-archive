...
<head>
<meta charset="UTF-8" /><title>Editing Heavy Hydra - X3 Wiki</title>
...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Heavy_Hydra","wgTitle":"Heavy Hydra","wgCurRevisionId":13921,"wgRevisionId":0,"wgArticleId":239,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Heavy_Hydra","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia"});
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Heavy_Hydra skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Heavy Hydra</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Heavy_Hydra&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20140910112702" name="wpStarttime" />
<input type='hidden' value="20130930135425" name="wpEdittime" />
...
|Faction=Boron
|Class={{M6+class}}
|Priceblock={{Priceblock|Queens Knight| 25382467}}
|Minspeed=86.2
|Maxspeed=138
|Minaccel=5
|Maxaccel=8
...
{{Infobox close}}
==Overview==
The heavy Hydra is greatly improved over [[Hydra|its predecessor]], with massively superior shield and weapon generators. It has excellent offensive turret coverage, along with good speed and weapon compatibility. However, the Heavy Hydra suffers from poor maneuverability and an ability to carry XL-class cargo.  It costs 10 million more credits than most other M6+ craft, but to a late-game player, the Heavy Hydra is a decent choice for a medium strike craft.

==Background==
===Encyclopedia Entry===
The redeveloped Hydra was the result of a review following the introduction of the [[M7|frigate]] class. The 'Heavy' Hydra is a huge improvement over the original design in almost every area.
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Heavy_Hydra" title="Heavy Hydra" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a href="http://x3wiki.com/index.php/Heavy_Hydra">http://x3wiki.com/index.php/Heavy_Hydra</a>"</div>
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Heavy_Hydra&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Heavy+Hydra&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=Heavy+Hydra&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
	...
	<div class="portlet" id="p-tb" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="t-info"><a href="/index.php?title=Heavy_Hydra&amp;action=info">Page information</a></li>
			</ul>
		</div>
	</div>
