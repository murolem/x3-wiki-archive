...
<head>
<meta charset="UTF-8"/>
<title>Editing Marlin - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Marlin","wgTitle":"Marlin","wgCurRevisionId":15936,"wgRevisionId":0,"wgArticleId":2082,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Marlin","wgRelevantArticleId":2082,"wgRequestId":"WdAI3lkfZokAADTtEPUAAAAE","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia","wgEditMessage":"editing"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Marlin rootpage-Marlin skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Marlin</h1>
...
<p><strong>Warning:</strong> You are not logged in. Your IP address will be publicly visible if you make any edits. If you <strong><a class="external text" href="http://www.x3wiki.com/index.php?title=Special:UserLogin&amp;returnto=Marlin">log in</a></strong> or <strong><a class="external text" href="http://www.x3wiki.com/index.php?title=Special:CreateAccount&amp;returnto=Marlin">create an account</a></strong>, your edits will be attributed to your username, along with other benefits.
</p>
</div>
<div id="wikiPreview" class="ontop" style="display: none;"><div lang="en" dir="ltr" class="mw-content-ltr"></div></div><form id="editform" name="editform" method="post" action="/index.php?title=Marlin&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntispam">Anti-spam check.
...
<input type='hidden' value="20170930211302" name="wpStarttime" />
<input type='hidden' value="20140310163052" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="15936" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{Infobox open}}
{{Infobox variant
|Variant=Marlin
|Faction=Boron
|Class={{M8class}}
|Priceblock={{Priceblock||5270638}}
|Minspeed=75.0
|Maxspeed=135.0
|Minaccel=14
|Maxaccel=25
...
{{Infobox close}}
==Overview==
The Boron [[M8|M8 Bomber]] was removed from Terran Conflict, but made it back in for Albion Prelude. It is relatively lightly shielded and has a small cargo bay for its class, but it is still capable of major strikes thanks to the powerful [[Tomahawk Heavy Missile]]

==Background==
The Marlin is the Royal Boron Navy's first foray into the tactical strike arena. The Marlin is able to approach with speed and deliver a considerable payload on heavily defended targets.

==Physical Characteristics==
The Marlin looks like a double-sized M3 fighter with typical Boron features, such as a green organic finish.

== Combat ==
Like other bombers, the Marlin should not be kept on the front line of combat, and should deploy its missile payload from afar. Typical of most bombers, its laser capacity and recharge rate are negligible, making it vulnerable to attacks from masses of M2s or interception by M3 class ships. As a result, it either has to rely on its missiles for self defense from fighter wings or its own escorts such as M3 or M6 class vessels.

== Equipment ==
The Marlin fires the [[Tomahawk Heavy Missile]].

== Availability ==
{| style="text-align:center;" cellpadding="3"
|- style="background-color:lightblue;"
! Variant !! [[Queen's Retribution]]
|-
! Marlin || x ||
|}

It may also be found among [[Boron]] patrols and [[Pirates|pirate]] wings spawned by [[Defend_Station| station defense]] missions and is vulnerable to the [[bail]] and [[claim]] mechanic.

In Terran Conflict v3 and upper, the Marlin is not sold in any shipyard.

== Suggested Roles==
The Marlin, like other bombers, is best used for long-range anti-capital or anti-station strikes.
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Marlin" title="Marlin" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Marlin">http://www.x3wiki.com/index.php/Marlin</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Marlin&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Marlin&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Marlin&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
