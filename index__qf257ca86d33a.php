...
<head>
<meta charset="UTF-8"/>
<title>Editing Aamon - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Aamon","wgTitle":"Aamon","wgCurRevisionId":16307,"wgRevisionId":0,"wgArticleId":1811,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Aamon","wgRelevantArticleId":1811,"wgRequestId":"Wh68VlkfZokAAG1dK7sAAAAG","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia","wgEditMessage":"editing"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Aamon rootpage-Aamon skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Aamon</h1>
...
<p><strong>Warning:</strong> You are not logged in. Your IP address will be publicly visible if you make any edits. If you <strong><a class="external text" href="http://www.x3wiki.com/index.php?title=Special:UserLogin&amp;returnto=Aamon">log in</a></strong> or <strong><a class="external text" href="http://www.x3wiki.com/index.php?title=Special:CreateAccount&amp;returnto=Aamon">create an account</a></strong>, your edits will be attributed to your username, along with other benefits.
</p>
</div>
<div id="wikiPreview" class="ontop" style="display: none;"><div lang="en" dir="ltr" class="mw-content-ltr"></div></div><form id="editform" name="editform" method="post" action="/index.php?title=Aamon&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntispam">Anti-spam check.
...
<input type='hidden' value="20171129135534" name="wpStarttime" />
<input type='hidden' value="20140704051140" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="16307" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">{{Infobox open}}
{{Infobox variant
|Variant=Aamon Prototype
|Faction=Argon
|Class={{M3+class}}
...
{{Infobox close}}
==Overview==
The final reward to Albion Prelude's plot, the Aamon Prototype is an extremely powerful heavy fighter.
...
== Combat ==
The Aamon is essentially an improved Notus Hauler, but with slightly better speed and handling, one additional 25 MJ shield, and higher laser capacity and recharge rate. The only other notable difference is that the Aamon can also mount Terran EMPCs and can launch the Terran Poltergeist and Spectre missiles.

It is one of the best [[M3+]] craft available. It is capable of carrying typical Commonwealth weapons for its class as well as Terran ones, and features two turrets unlike most heavy fighter designs. Combined with strong overall stats, it is both a flexible and powerful design. In terms of raw power its only real competitor is the deadly [[Fenrir]].

== Equipment ==
== Availability ==
The Aamon is only available as a prototype, and only attainable after finishing the Albion Prelude plot as a final reward.

== Suggested Roles==
An excellent playership, as only one is available. The  heavy shielding and weaponry, combined with good speed and passable cargo, make it a very competent ship.
...
! Ware !! Amount
|- valign="top"
|[[Energy Cells]]||{{formatnum:5502}}
|-
|[[Teladianium]]||{{formatnum:171}}
|-
|[[Cloth Rimes]]||57
|-
|[[Rastar Oil]]||114
...
|[[Ore]]||{{formatnum:229}}
|-
|[[Silicon|Silicon Wafers]]||{{formatnum:171}}
|-
|[[Crystals]]||57
|-
|[[Quantum Tubes]]||57
...
|-
|Shipwright Fee ([[Credits]])|| {{formatnum:1623097}}
|-
|Build Time (game time)&lt;bR>(hh:mm:ss)||4:52:48	
|}
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Aamon" title="Aamon" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<li><a href="/index.php/Template:Colour/Argon" title="Template:Colour/Argon">Template:Colour/Argon</a> (<a href="/index.php?title=Template:Colour/Argon&amp;action=edit" title="Template:Colour/Argon">edit</a>) </li><li><a href="/index.php/Template:Factionshipcat/" title="Template:Factionshipcat/">Template:Factionshipcat/</a> (<a href="/index.php?title=Template:Factionshipcat/&amp;action=edit" title="Template:Factionshipcat/">edit</a>) </li><li><a href="/index.php/Template:Gunicon/0" title="Template:Gunicon/0">Template:Gunicon/0</a> (<a href="/index.php?title=Template:Gunicon/0&amp;action=edit" title="Template:Gunicon/0">view source</a>) (semi-protected)</li><li><a href="/index.php/Template:Gunicon/1" title="Template:Gunicon/1">Template:Gunicon/1</a> (<a href="/index.php?title=Template:Gunicon/1&amp;action=edit" title="Template:Gunicon/1">view source</a>) (semi-protected)</li><li><a href="/index.php/Template:Gunslot" title="Template:Gunslot">Template:Gunslot</a> (<a href="/index.php?title=Template:Gunslot&amp;action=edit" title="Template:Gunslot">view source</a>) (semi-protected)</li><li><a href="/index.php/Template:Infobox_close" title="Template:Infobox close">Template:Infobox close</a> (<a href="/index.php?title=Template:Infobox_close&amp;action=edit" title="Template:Infobox close">view source</a>) (semi-protected)</li><li><a href="/index.php/Template:Infobox_open" title="Template:Infobox open">Template:Infobox open</a> (<a href="/index.php?title=Template:Infobox_open&amp;action=edit" title="Template:Infobox open">view source</a>) (semi-protected)</li><li><a href="/index.php/Template:Infobox_variant" title="Template:Infobox variant">Template:Infobox variant</a> (<a href="/index.php?title=Template:Infobox_variant&amp;action=edit" title="Template:Infobox variant">view source</a>) (semi-protected)</li><li><a href="/index.php/Template:M3%2Bcategory" title="Template:M3+category">Template:M3+category</a> (<a href="/index.php?title=Template:M3%2Bcategory&amp;action=edit" title="Template:M3+category">edit</a>) </li><li><a href="/index.php/Template:M3%2Bclass" title="Template:M3+class">Template:M3+class</a> (<a href="/index.php?title=Template:M3%2Bclass&amp;action=edit" title="Template:M3+class">edit</a>) </li><li><a href="/index.php/Template:Priceblock" title="Template:Priceblock">Template:Priceblock</a> (<a href="/index.php?title=Template:Priceblock&amp;action=edit" title="Template:Priceblock">edit</a>) </li></ul></div><div class="hiddencats"><div class="mw-hiddenCategoriesExplanation"><p>This page is a member of 9 hidden categories:
</p></div><ul>
...
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Aamon">http://www.x3wiki.com/index.php/Aamon</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Aamon&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Aamon&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Aamon&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
