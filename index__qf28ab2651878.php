...
<head>
<meta charset="UTF-8"/>
<title>Editing Transport Passenger - X3 Wiki</title>
<script>document.documentElement.className = document.documentElement.className.replace( /(^|\s)client-nojs(\s|$)/, "$1client-js$2" );</script>
<script>(window.RLQ=window.RLQ||[]).push(function(){mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Transport_Passenger","wgTitle":"Transport Passenger","wgCurRevisionId":13394,"wgRevisionId":0,"wgArticleId":443,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Transport_Passenger","wgRelevantArticleId":443,"wgRequestId":"WS21x1kfZokAAF2rnyAAAAAc","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia","wgEditMessage":"editing"});mw.loader.implement("user.options",function($,jQuery,require,module){mw.user.options.set({"variant":"en"});});mw.loader.implement("user.tokens",function ( $, jQuery, require, module ) {
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Transport_Passenger rootpage-Transport_Passenger skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
				...
				<h1 id="firstHeading" class="firstHeading" lang="en">Editing Transport Passenger</h1>
...
<input type='hidden' value="20170530181119" name="wpStarttime" />
<input type='hidden' value="20130809233345" name="wpEdittime" />
<input type='hidden' value="" name="wpScrolltop" id="wpScrolltop" />
<input type="hidden" value="d41d8cd98f00b204e9800998ecf8427e" name="wpAutoSummary"/><input type="hidden" value="0" name="oldid"/><input type="hidden" value="13394" name="parentRevId"/><input type="hidden" value="text/x-wiki" name="format"/><input type="hidden" value="wikitext" name="model"/><div id="toolbar"></div><textarea tabindex="1" accesskey="," id="wpTextbox1" cols="80" rows="25" style="" lang="en" dir="ltr" name="wpTextbox1">A [[Missions#Other Mission|Mission]] offered at [[stations]].&lt;br>
...
==What you will need==
===All Missions===
* Size M [[Cargo Class|cargo]] or bigger and [[Cargo Life Support System]]

It is recommended to also have:
* [[Docking Computer]], to save time.
* [[Jumpdrive]] and energy cells
===Transport Passenger===
...
<input id="wpDiff" name="wpDiff" tabindex="5" title="Show which changes you made to the text [v]" accesskey="v" type="submit" value="Show changes"/>
	<span class='cancelLink'><a href="/index.php/Transport_Passenger" title="Transport Passenger" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<li><a href="/index.php/Template:Missions" title="Template:Missions">Template:Missions</a> (<a href="/index.php?title=Template:Missions&amp;action=edit" title="Template:Missions">edit</a>) </li><li><a href="/index.php/Template:Offers" title="Template:Offers">Template:Offers</a> (<a href="/index.php?title=Template:Offers&amp;action=edit" title="Template:Offers">edit</a>) </li><li><a href="/index.php/Template:Other_Missions" title="Template:Other Missions">Template:Other Missions</a> (<a href="/index.php?title=Template:Other_Missions&amp;action=edit" title="Template:Other Missions">edit</a>) </li><li><a href="/index.php/Template:Plot_Missions" title="Template:Plot Missions">Template:Plot Missions</a> (<a href="/index.php?title=Template:Plot_Missions&amp;action=edit" title="Template:Plot Missions">edit</a>) </li><li><a href="/index.php/Template:TPclass" title="Template:TPclass">Template:TPclass</a> (<a href="/index.php?title=Template:TPclass&amp;action=edit" title="Template:TPclass">edit</a>) </li></ul></div><div class="hiddencats"></div><div class="limitreport"></div><input type="hidden" value="1" name="wpUltimateParam"/>
</form>
...
Retrieved from "<a dir="ltr" href="http://www.x3wiki.com/index.php/Transport_Passenger">http://www.x3wiki.com/index.php/Transport_Passenger</a>"</div>
		...
		<div id="column-one">
			...
			<div class="pBody">
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Transport_Passenger&amp;action=edit" title="Edit this page">Edit</a></li>
				...
				<div class="pBody">
					<ul>
						<li id="pt-anonuserpage">Not logged in</li>							<li id="pt-anontalk"><a href="/index.php/Special:MyTalk" title="Discussion about edits from this IP address [n]" accesskey="n">Talk</a></li>
													...
													<li id="pt-createaccount"><a href="/index.php?title=Special:CreateAccount&amp;returnto=Transport+Passenger&amp;returntoquery=action%3Dedit" title="You are encouraged to create an account and log in; however, it is not mandatory">Create account</a></li>
													<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Transport+Passenger&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
											</ul>
				</div>
			</div>
