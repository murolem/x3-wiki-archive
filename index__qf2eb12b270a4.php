...
<form name="userlogin" method="post" action="/index.php?title=Special:UserLogin&amp;action=submitlogin&amp;type=login&amp;returnto=Treasure_Hunt">
	<h2>Log in</h2>
	<p id="userloginlink"><p>Don't have an account? <a href="/index.php?title=Special:UserLogin&amp;type=signup&amp;returnto=Treasure_Hunt">Create an account</a>.
</p></p>
...
<div id="column-one">
	<div id="p-cactions" class="portlet">
		...
		<div class="pBody">
			<ul>
				 <li id="ca-nstab-special" class="selected"><a href="/index.php?title=Special:UserLogin&amp;returnto=Treasure_Hunt" title="This is a special page, you cannot edit the page itself">Special page</a></li>
			</ul>
		</div>
	</div>
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-anonlogin" class="active"><a href="/index.php?title=Special:UserLogin&amp;returnto=Treasure_Hunt" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
