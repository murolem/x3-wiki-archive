...
<head>
<meta charset="UTF-8" /><title>Editing User talk:Madned - X3 Wiki</title>
<meta name="generator" content="MediaWiki 1.22.6" />
<meta name="robots" content="noindex,nofollow" />
<link rel="alternate" type="application/x-wiki" title="Edit" href="/index.php?title=User_talk:Madned&amp;action=edit" />
<link rel="edit" title="Edit" href="/index.php?title=User_talk:Madned&amp;action=edit" />
...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"User_talk","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":3,"wgPageName":"User_talk:Madned","wgTitle":"Madned","wgCurRevisionId":13273,"wgRevisionId":0,"wgArticleId":232,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"User_talk:Madned","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia"});
...
<body class="mediawiki ltr sitedir-ltr ns-3 ns-talk page-User_talk_Madned skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing User talk:Madned</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=User_talk:Madned&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20140910203034" name="wpStarttime" />
<input type='hidden' value="20130731183358" name="wpEdittime" />
...
mostly what this wiki needs is traffic. more contributors. mostly i just format stuff. advertising on the egosoft forums would probably help a bunch. [[User:Madned|Madned]] 18:42, 27 August 2010 (UTC)

----
busy day today [[User:Madned|Madned]] 15:14, 21 September 2010 (CDT)

--

Hi,

I'll try to have a look at the whitelisting of urls this weekend.
--[[User:Rexde500|Rexde500]] 16:34, 25 April 2012 (CDT)

== Active Admins ==

I was wondering if you knew of any active admins? [[User:Rexde500|Rexde500]] doesn't seem to be around that much right now?

If you are a server-side admin, could you maybe take a look at the request and explanation I put on [[User_talk:Rexde500|his talk page]]?

I thought it would be useful to be able to collate ship data easily.
[[User:Korlus|&lt;font color="red">'''Korlus'''&lt;/font>]] - [[User talk:Korlus|&lt;sup>(talk)&lt;/sup>]] [[Special:contributions/Korlus|&lt;sub>(contribs)&lt;/sub>]] 13:33, 31 July 2013 (CDT)
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/User_talk:Madned" title="User talk:Madned" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a href="http://x3wiki.com/index.php/User_talk:Madned">http://x3wiki.com/index.php/User_talk:Madned</a>"</div>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="ca-nstab-user"><a href="/index.php/User:Madned" title="View the user page [c]" accesskey="c">User page</a></li>
				<li id="ca-talk" class="selected"><a href="/index.php/User_talk:Madned" title="Discussion about the content page [t]" accesskey="t">Discussion</a></li>
				<li id="ca-edit" class="selected istalk"><a href="/index.php?title=User_talk:Madned&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
				<li id="ca-addsection"><a href="/index.php?title=User_talk:Madned&amp;action=edit&amp;section=new" title="Start a new section [+]" accesskey="+">+</a></li>
				<li id="ca-history"><a href="/index.php?title=User_talk:Madned&amp;action=history" rel="archives" title="Past revisions of this page [h]" accesskey="h">History</a></li>
			</ul>
		</div>
	</div>
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=User+talk%3AMadned&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-anonlogin"><a href="/index.php?title=Special:UserLogin&amp;returnto=User+talk%3AMadned&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
...
<a href="/index.php/Main_Page" style="background-image: url(http://www.x3wiki.com/x3.jpg);" title="Visit the main page"></a>
	...
	<div class="portlet" id="p-tb" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="t-whatlinkshere"><a href="/index.php/Special:WhatLinksHere/User_talk:Madned" title="A list of all wiki pages that link here [j]" accesskey="j">What links here</a></li>
				<li id="t-recentchangeslinked"><a href="/index.php/Special:RecentChangesLinked/User_talk:Madned" title="Recent changes in pages linked from this page [k]" accesskey="k">Related changes</a></li>
				...
				<li id="t-info"><a href="/index.php?title=User_talk:Madned&amp;action=info">Page information</a></li>
			</ul>
		</div>
	</div>
