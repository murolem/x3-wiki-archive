...
<head>
<title>Editing PTNI Headquarters Shipyard - X3 Wiki</title>
<meta charset="UTF-8" />
<meta name="generator" content="MediaWiki 1.19.1" />
<meta name="robots" content="noindex,nofollow" />
<link rel="alternate" type="application/x-wiki" title="Edit" href="/index.php?title=PTNI_Headquarters_Shipyard&amp;action=edit" />
<link rel="edit" title="Edit" href="/index.php?title=PTNI_Headquarters_Shipyard&amp;action=edit" />
...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"PTNI_Headquarters_Shipyard","wgTitle":"PTNI Headquarters Shipyard","wgCurRevisionId":0,"wgArticleId":0,"wgIsArticle":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgRelevantPageName":"PTNI_Headquarters_Shipyard","wgRestrictionCreate":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia"});
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-PTNI_Headquarters_Shipyard skin-monobook action-edit">
<div id="fb-root"></div>
...
//]]>--></script>
	...
	<h1 id="firstHeading" class="firstHeading"><span dir="auto">Editing PTNI Headquarters Shipyard</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=PTNI_Headquarters_Shipyard&amp;action=submit" enctype="multipart/form-data"><input type='hidden' value="" name="wpSection" />
<input type='hidden' value="20130427155705" name="wpStarttime" />
<input type='hidden' value="20130427155705" name="wpEdittime" />
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='editHelp'><a href="/index.php/PTNI_Headquarters_Shipyard" title="PTNI Headquarters Shipyard" id="mw-editform-cancel">Cancel</a> | <a target="helpwindow" href="/index.php/Help:Editing">Editing help</a> (opens in new window)</span>
</div><!-- editButtons -->
</div><!-- editOptions -->
...
Retrieved from "<a href="http://www.x3wiki.com/index.php/PTNI_Headquarters_Shipyard">http://www.x3wiki.com/index.php/PTNI_Headquarters_Shipyard</a>"</div>
...
<div id="column-one">
	<div id="p-cactions" class="portlet">
		...
		<div class="pBody">
			<ul>
				<li id="ca-nstab-main" class="selected new"><a href="/index.php?title=PTNI_Headquarters_Shipyard&amp;action=edit&amp;redlink=1" primary="1" context="subject" title="View the content page [c]" accesskey="c">Page</a></li>
				<li id="ca-talk" class="new"><a href="/index.php?title=Talk:PTNI_Headquarters_Shipyard&amp;action=edit&amp;redlink=1" primary="1" context="talk" title="Discussion about the content page [t]" accesskey="t">Discussion</a></li>
				<li id="ca-edit" class="selected"><a href="/index.php?title=PTNI_Headquarters_Shipyard&amp;action=edit" primary="1" title="You can edit this page. Please use the preview button before saving">Create</a></li>
			</ul>
		</div>
	</div>
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=PTNI+Headquarters+Shipyard&amp;returntoquery=action%3Dedit%26redlink%3D1" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
...
<a href="/index.php/Main_Page" style="background-image: url(http://www.x3wiki.com/x3.jpg);" title="Visit the main page"></a>
	...
	<div class="portlet" id="p-tb">
		...
		<div class="pBody">
			<ul>
				<li id="t-whatlinkshere"><a href="/index.php/Special:WhatLinksHere/PTNI_Headquarters_Shipyard" title="A list of all wiki pages that link here [j]" accesskey="j">What links here</a></li>
