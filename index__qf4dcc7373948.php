...
<head>
<meta charset="UTF-8" /><title>Editing Sirokos - X3 Wiki</title>
...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Sirokos","wgTitle":"Sirokos","wgCurRevisionId":13891,"wgRevisionId":0,"wgArticleId":613,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Sirokos","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia"});
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Sirokos skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Sirokos</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Sirokos&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20160709132923" name="wpStarttime" />
<input type='hidden' value="20130915142517" name="wpEdittime" />
...
|Faction=OTAS
|Class={{M7Mclass}}
|Priceblock={{Priceblock|OTAS Legend|}}
|Minspeed=65.4
|Maxspeed=111.2
|Minaccel=6
|Maxaccel=11
...
{{Missileturret|Slot=Main|Lcount=8}}
{{Missileturret|Slot=2nd|Lcount=8}}
...
{{Infobox close}}
==Overview==
The Sirokos is the [[OTAS]] boarding craft, and the only ship dedicated solely to this role.

==Background==
Specifically designed around boarding and capturing enemy craft, the Sirokos heavy capture frigate is in a class of its own when it comes to seizing ships.
==Physical Characteristics==
== Combat ==
Since it cannot fire any missiles except Boarding Pods (and [[Mosquito Missile]]s in AP, and it has only a basic rear turret for protection, you should never allow the Sirokos to engage directly in combat.  Use other ships to clear fighters and take down your target's shields before firing the Boarding Pods from the Sirokos.
== Equipment ==
The Sirokos is a specialized [[:Category:Boarding Ship|boarding ship]]. As such it can only launch [[boarding pods]].

In the [[X-universe]], the Sirokos has the largest [[Marines]] capacity among M7M craft, at 30 marines to its counterparts' 20.

== Availability ==

The OTAS Sirokos is purchasable at the OTAS Shipyard in Legend's Home, after you reach maximum rank with OTAS.

In Albion Prelude, you must meet the Argon reputation requirement instead, making the Sirokos easier to qualify for.

== Suggested Roles==

As capital ships can carry a maximum of 21 soldiers during boarding operations, the 30 soldiers aboard the Sirokos are too many, and can even annoy the player, because you will have to deselect 9 marines before launching boarding pods, otherwise, 9 of your marines wont board the targeted ship and will wander in space until be vaporized by the ship's turrets. As this ship is harmless, you will have to use another ship to attack shields and maintain them down, that will complicate a lot boarding operations.

The Sirokos is best used for boarding difficult targets like Xenon capitals, where the 21 marines it can launch will have much better chance against internal defences then the usual 20. A must have for Xenon boarding ops.
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Sirokos" title="Sirokos" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Sirokos&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Sirokos&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Sirokos&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
