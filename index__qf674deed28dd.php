...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en" dir="ltr">
	<head>
		...
		<title>Editing Osprey - X3 Wiki</title>
...
<body class="mediawiki ltr ns-0 ns-subject page-Osprey skin-monobook">
	<div id="globalWrapper">
		<div id="column-content">
	<div id="content">
		<a name="top" id="top"></a>
				<h1 id="firstHeading" class="firstHeading">Editing Osprey</h1>
		<div id="bodyContent">
...
<form id="editform" name="editform" method="post" action="/index.php?title=Osprey&amp;action=submit" enctype="multipart/form-data">
<input type='hidden' value="" name="wpSection" />
<input type='hidden' value="20100606064854" name="wpStarttime" />

<input type='hidden' value="20100606064854" name="wpEdittime" />
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='editHelp'><a href="/index.php/Osprey" title="Osprey">Cancel</a>&#32;|&#32;<a target="helpwindow" href="/index.php/Help:Editing">Editing help</a> (opens in new window)</span>
</div><!-- editButtons -->
</div><!-- editOptions -->
...
Retrieved from "<a href="http://x3wiki.com/index.php/Osprey">http://x3wiki.com/index.php/Osprey</a>"</div>
						<!-- end content -->
	...
	<div id="p-cactions" class="portlet">
		...
		<div class="pBody">
			<ul>
				 ...
				 <li id="ca-nstab-main" class="selected new"><a href="/index.php?title=Osprey&amp;action=edit&amp;redlink=1" title="View the content page [c]" accesskey="c">Page</a></li>
				 ...
				 <li id="ca-edit" class="selected"><a href="/index.php?title=Osprey&amp;action=edit" title="You can edit this page.&#10;Please use the preview button before saving">Create</a></li>			</ul>
		</div>
	</div>
	<div class="portlet" id="p-personal">
		...
		<div class="pBody">
			<ul>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Osprey" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in / create account</a></li>
			</ul>
		</div>
	</div>
	...
	<div class="portlet" id="p-tb">
		...
		<div class="pBody">
			<ul>
				<li id="t-whatlinkshere"><a href="/index.php/Special:WhatLinksHere/Osprey" title="List of all wiki pages that link here [j]" accesskey="j">What links here</a></li>
