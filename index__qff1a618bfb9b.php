...
<head>
<meta charset="UTF-8" /><title>Editing Guppy - X3 Wiki</title>
...
<script>if(window.mw){
mw.config.set({"wgCanonicalNamespace":"","wgCanonicalSpecialPageName":false,"wgNamespaceNumber":0,"wgPageName":"Guppy","wgTitle":"Guppy","wgCurRevisionId":16313,"wgRevisionId":0,"wgArticleId":2079,"wgIsArticle":false,"wgIsRedirect":false,"wgAction":"edit","wgUserName":null,"wgUserGroups":["*"],"wgCategories":[],"wgBreakFrames":true,"wgPageContentLanguage":"en","wgPageContentModel":"wikitext","wgSeparatorTransformTable":["",""],"wgDigitTransformTable":["",""],"wgDefaultDateFormat":"dmy","wgMonthNames":["","January","February","March","April","May","June","July","August","September","October","November","December"],"wgMonthNamesShort":["","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],"wgRelevantPageName":"Guppy","wgIsProbablyEditable":true,"wgRestrictionEdit":[],"wgRestrictionMove":[],"Geo":{"city":"","country":""},"wgNoticeProject":"wikipedia"});
...
<body class="mediawiki ltr sitedir-ltr ns-0 ns-subject page-Guppy skin-monobook action-edit">
...
(adsbygoogle = window.adsbygoogle || []).push({});
	...
	<h1 id="firstHeading" class="firstHeading" lang="en"><span dir="auto">Editing Guppy</span></h1>
...
<div id="wikiPreview" class="ontop" style="display: none;"></div><form id="editform" name="editform" method="post" action="/index.php?title=Guppy&amp;action=submit" enctype="multipart/form-data"><div id="antispam-container" style="display: none;"><label for="wpAntiSpam">Anti-spam check.
...
<input type='hidden' value="20141106203206" name="wpStarttime" />
<input type='hidden' value="20140708055739" name="wpEdittime" />
...
|Faction=Boron
|Class={{M7Cclass}}
|Priceblock={{priceblock||16412847}}
|Minspeed=77.6
|Maxspeed=132.0
|Minaccel=7
|Maxaccel=12
...
&lt;/table>
|Dockbay={{Dockbay|12 [[M3+]]-[[M5]], 1 [[TP]]/[[TS]]}}
}}
{{Infobox close}}
==Overview==
The Boron Guppy, new to Albion Prelude, is the Boron's entry in the new M7C category, known in-game as Drone Frigates or colloquially as Carrier Frigates. The Guppy has the strongest armament and shields of the four new M7Cs.

==Background==
The latest result of the new Boron military diversification campaign, the Guppy is doubtlessly one of the most refined examples of specialty shipbuilding in Boron history. Sleek, spacious and menacing, the Guppy is an excellent border patrol leader. Though it is not the leading vessel in any one characteristic when compared to other drone frigates, the Guppy provides the most rounded and well-balanced performance. Although it is estimated to be almost twice as expensive to produce as regular frigates, the Guppy is still relatively affοrdable thanks to heavy government subsidization. This ship has acquired a status in the industry, serving as the yardstick for its class.

==Physical Characteristics==
The Guppy shares the Boron capital ship aesthetic of a green, organic finish with sleek curves. It has a light-blue liquid underside where it docks its fighters, a feature it shares with the Royal Boron Shipyard in [[Queen's Retribution]]. It can also dock a single [[TP]] or [[TS]] ship in its belly, a feature that shares with the Paranid [[Ariadne]].
== Combat ==
The Guppy is a force projector, like other M7Cs, but it is fast enough and well-armed enough to provide its own fire support against light targets.
...
! Variant !! [[Lucky Planets]]
|-
! Guppy || x ||
|}

== Suggested Roles==
In a fleet support role, the Guppy is well-shielded for its class and relatively well-protected.  It is also considered a good choice as a player ship, as it can even carry a TP for VIP transport or recovery missions.

== See Also==

*[[Kraken|Boron Kraken]]
*[[Thresher|Boron Thresher]]
...
<input id="wpDiff" name="wpDiff" type="submit" tabindex="5" value="Show changes" accesskey="v" title="Show which changes you made to the text [v]" />
	<span class='cancelLink'><a href="/index.php/Guppy" title="Guppy" id="mw-editform-cancel">Cancel</a><span class="mw-editButtons-pipe-separator"> | </span></span>
...
Retrieved from "<a href="http://www.x3wiki.com/index.php/Guppy">http://www.x3wiki.com/index.php/Guppy</a>"</div>
...
<div id="column-one">
	...
	<div id="p-cactions" class="portlet" role="navigation">
		...
		<div class="pBody">
			<ul>
				...
				<li id="ca-edit" class="selected"><a href="/index.php?title=Guppy&amp;action=edit" title="You can edit this page. Please use the preview button before saving">Edit</a></li>
	...
	<div class="portlet" id="p-personal" role="navigation">
		...
		<div class="pBody">
			<ul>
				<li id="pt-createaccount"><a href="/index.php?title=Special:UserLogin&amp;returnto=Guppy&amp;returntoquery=action%3Dedit&amp;type=signup">Create account</a></li>
				<li id="pt-login"><a href="/index.php?title=Special:UserLogin&amp;returnto=Guppy&amp;returntoquery=action%3Dedit" title="You are encouraged to log in; however, it is not mandatory [o]" accesskey="o">Log in</a></li>
			</ul>
		</div>
	</div>
